...
import com.boco.common.security.service.manager.RegionManager;
import com.boco.common.security.service.manager.RoleManager;
import com.boco.common.security.service.manager.UserManager;
...
public class DepartmentLdapDAO
    extends BaseLdapDAO
...
//   --------------------------------------------------------------------------------------------------------------------------------
  ...
  public String lookupDepartmentDN(LdapOperation ldap, Object department)
    ...
    if (department instanceof DepartmentDO) {
      dptid = ( (DepartmentDO) department).getDepartmentID();
    }
   ...
   */
  protected String getDepartmentDN(LdapOperation ldap, DepartmentDO dpt, RegionDO region)
      throws NamingException, ObjectNotExistException {
...
//    ------------------------------------------------------------------------------------------------------------------------------------------
   ...
   */
  public DepartmentDO createDepartment(DepartmentDO department, RegionDO region)
...
//        deptDN = getDepartmentDN(ldap, department,region);
   ...
   * @throws SecurityManagerDaoException
   */
  public void deleteDepartment(DepartmentDO department, RegionDO region)
    ...
    try {
      ...
      while (it.hasNext()) {
        DepartmentDO ddo = (DepartmentDO) it.next();
   ...
   * @throws SecurityManagerDaoException
   */
  public void updateDepartment(DepartmentDO department, RegionDO region)
      throws ObjectNotExistException, SecurityManagerDaoException {
    LdapOperation ldap = null;
   ...
   * @throws SecurityManagerDaoException
   */
  public DepartmentDO lookupDepartment(DepartmentDO department, RegionDO region)
      throws ObjectNotExistException, SecurityManagerDaoException {
    LdapOperation ldap = null;
    DepartmentDO retDept = null;
  ...
  public DepartmentDO lookupDepartment(String deptID)  //add by shenwei 2004-02-04
  throws ObjectNotExistException, SecurityManagerDaoException {
  	LdapOperation ldap = null;
  	DepartmentDO retDept = null;
...
// ------------------------------------------------
  ...
  public void removeUser(DepartmentDO department, RegionDO region, UserDO user)
    ...
    try {
      ...
      //modify the attributes
      Attribute attr = new BasicAttribute("uniqueMember");
      DepartmentDO dept = this.lookupDepartment(department, region);
      Vector deptVec = dept.getUserList();
  		...
  		deptDN = "ou=Region_2,ou=Region_0"  + "," + getDeptClassDirectoryContext();
			...
			if (vct.size()>0){
				for(int m=0;m<vct.size();m++){
					DepartmentDO retDept = (DepartmentDO)vct.get(m);
...
// ------------------------------------------------
   ...
   * @throws SecurityManagerDaoException
   */
  public void setRole(DepartmentDO department, RegionDO region, RoleDO role)
   ...
   * @throws SecurityManagerDaoException
   */
  public void removeRole(DepartmentDO department, RegionDO region, RoleDO role)
      throws ObjectNotExistException, SecurityManagerDaoException {
  ...
  public void clearupRoles(DepartmentDO department, RegionDO region, Set all, Vector trash)
      throws ObjectNotExistException, SecurityManagerDaoException {
    LdapOperation ldap = null;
   ...
   * @throws SecurityManagerDaoException
   */
  public Vector getRoleList(DepartmentDO department, RegionDO region)
      throws SecurityManagerDaoException {
    LdapOperation ldap = null;
    Vector retVec = new Vector();
   ...
   * @throws SecurityManagerDaoException
   */
  public void clearRoles(DepartmentDO department, RegionDO region)
      throws SecurityManagerDaoException {
    LdapOperation ldap = null;
...
// ------------------------------------------------
  ...
  public static DepartmentDO createDepartmentFromLdapResult(LdapOperation ldap) {
    DepartmentDO dept = null;
    ...
    try {
      ...
      DepartmentLdapDAO dao = new DepartmentLdapDAO();
  ...
  public Vector getRolesOfDepartment(String deptID, String regionID, boolean up)
    ...
    try {
      RegionDO tmpRDO = new RegionDO();
      DepartmentDO tmpDDO = new DepartmentDO();
      ...
      if (up) {
        if (tmpDDO.getDepartmentParentID() == null
          ...
          DepartmentDO tmp = new DepartmentDO();
...
/*          RangeDO currRDO = RangeManager.lookupRange(tmpRDO.getRegionID());
  ...
  public Vector getSubDepartment(String deptID, String regionID)
    ...
    try {
      ...
      while (ldap.nextResult()) {
        DepartmentDO retDept = createDepartmentFromLdapResult(ldap);
        result.add(retDept);
      }
    }
    catch (ObjectNotExistException ex) {
