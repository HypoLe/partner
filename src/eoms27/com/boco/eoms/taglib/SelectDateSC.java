...
public class SelectDateSC extends BodyTagSupport {
 private String name="";
  ...
  public String getName() {
    ...
    public int doEndTag() throws JspTagException {
        ...
        try {
          ...
          if (_dd < 10)
            _ddstr = "0"+_dd;
          String nowvalue = _mm+"/"+_dd+"/"+_yy;
          String nowvaluestr =  _mmstr+"/"+_ddstr+"/"+_yystr;
          ...
          ls_display += "window."+formName+"."+name+".value = monthstr +\"/\"+ daystr +\"/\"+ yearstr;";
          ls_display += "}";
          ls_display += "</SCRIPT>";
