...
public class SelectNMVendor extends BodyTagSupport {
  private String name;
  private String formName;
  private String value;
  public SelectNMVendor() {
  }
  ...
  public int doEndTag() throws JspTagException {
        ...
        try {
          ...
          String SQL = "  SELECT TYPE,VENDOR_TEXT FROM VENDOR_NAME";
          rs.executeSql("BocoNM",SQL);
          String srcStr = "";
          String desStr = "";
          String valueStr = ","+value+",";
          while (rs.next()) {
            String now_id = ","+rs.getString("TYPE")+",";
            if (valueStr.indexOf(now_id) == -1) {
              srcStr += " <option value=\""+rs.getString("TYPE")+"\">";
              srcStr += rs.getString("VENDOR_TEXT");
              srcStr += " </option>";
            }else{
              desStr += " <option value=\""+rs.getString("TYPE")+"\">";
              desStr += rs.getString("VENDOR_TEXT");
              desStr += " </option>";
            }
          }
