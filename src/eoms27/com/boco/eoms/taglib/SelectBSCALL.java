...
public class SelectBSCALL extends BodyTagSupport {
  ...
  public int doEndTag() throws JspTagException {
   ...
   try {
     ...
     String SQL = " select soa_get_nename(ne_id,200) name ,ne_id from tcc_ne_frame where ne_type=200 order by  name";
