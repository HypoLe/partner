...
/**
 * <p>Title:nmmis </p>
 * <p>Description: for chengdu yinxiaozhongxin </p>
...
public class SelectCDRegion extends BodyTagSupport {
  private String formName;
  private String name;
  private String value;
  public SelectCDRegion() {
  }
  ...
  public int doEndTag() throws JspTagException {
     ...
     try {
       ...
       String SQL = "SELECT  DISTINCT soa_get_nename(CITY_ID,10004) REGION,CITY_ID FROM TCC_NE_FRAME WHERE NE_TYPE=10014 AND REGION_ID=-1483444163  ";
       rs.executeSql("BocoNM",SQL);
       String srcStr = "";
       String desStr = "";
       String valueStr = ","+value+",";
       while (rs.next()) {
         String now_id = ","+rs.getString("CITY_ID")+",";
         if (valueStr.indexOf(now_id) == -1) {
           srcStr += " <option value=\""+rs.getString("CITY_ID")+"\">";
           srcStr += rs.getString("REGION");
           srcStr += " </option>";
         }else{
           desStr += " <option value=\""+rs.getString("CITY_ID")+"\">";
           desStr += rs.getString("REGION");
           desStr += " </option>";
         }
       }
