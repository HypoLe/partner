...
public class SelectCDCountry extends BodyTagSupport {
  private String formName;
  private String name;
  private String value;
  public SelectCDCountry() {
  }
  ...
  public int doEndTag() throws JspTagException {
   ...
   try {
     ...
     String SQL = "select distinct soa_get_nename(ne_id,ne_type) COUNTRY_NAME, NE_ID from tcc_ne_frame where ne_type=10014 AND REGION_ID=-1483444163";
     ...
     while (rs.next()) {
       ...
       if (valueStr.indexOf(now_id) == -1) {
         ...
         srcStr += rs.getString("COUNTRY_NAME");
         srcStr += " </option>";
       }else{
         desStr += " <option value=\""+rs.getString("NE_ID")+"\">";
         desStr += rs.getString("COUNTRY_NAME");
         desStr += " </option>";
       }
     }
