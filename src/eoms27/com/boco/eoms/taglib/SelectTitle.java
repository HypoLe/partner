...
public class SelectTitle extends BodyTagSupport {
  ...
  public int doEndTag() throws JspTagException {
   ...
   try {
     ...
     String SQL = "SELECT TITLE,TITLE_ID FROM NMOSDB@NMOSSERVER1: TFU_ALARM_TITLE  ORDER BY TITLE_ID";
     rs.executeSql("BocoNM",SQL);
     String srcStr = "";
     String desStr = "";
     String valueStr = ","+value+",";
     while (rs.next()) {
       String now_id = ","+rs.getString("TITLE_ID")+",";
       if (valueStr.indexOf(now_id) == -1) {
         srcStr += " <option value=\""+rs.getString("TITLE_ID")+"\">";
         srcStr += rs.getString("TITLE");
         srcStr += " </option>";
       }else{
         desStr += " <option value=\""+rs.getString("TITLE_ID")+"\">";
         desStr += rs.getString("TITLE");
         desStr += " </option>";
       }
     }
     ...
     ls_display += " <select size=5 name=\""+selectSrcName+"\" style=\"width:200\" onclick=\"return "+name+"_single_move(this.form."+selectSrcName+",this.form."+selectDesName+")\">";
     ls_display += srcStr;
     ls_display += " </select>";
     ls_display += " </td>";
     ...
     ls_display += " </td>";
     ls_display += " <td width=\"40%\" align=\"center\">";
     ls_display += " <select size=5 name=\""+selectDesName+"\" style=\"width:200\" onclick=\"return "+name+"_single_move(this.form."+selectDesName+",this.form."+selectSrcName+")\">";
     ls_display += desStr;
