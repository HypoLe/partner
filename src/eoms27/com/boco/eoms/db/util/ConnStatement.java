...
public class ConnStatement {
  ...
  private int connectionType=StaticMethod.getIntValue(prop.getProperty("ConnectionType"),1);
  ...
  public void setStatementSql (String sqlstring,boolean flag)  throws SQLException {
    //if(conn == null) conn = getConnection() ;
    if(conn != null) conn.close();
    conn = getConnection() ;
    if(ps != null)
  ...
  public void setBigDecimal(int sequenceid, BigDecimal value)  throws SQLException {
    ps.setBigDecimal(sequenceid , value);
  }

  public void setBinaryStream(int sequenceid, InputStream value, int length)  throws SQLException {
