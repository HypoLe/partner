...
public class BaseStationFaultRecordServiceImpl extends
		CommonGenericServiceImpl<BaseStationFaultRecord> implements
		BaseStationFaultRecordService {

	public void setBaseStationFaultRecordDao(
			BaseStationFaultRecordDao baseStationFaultRecordDao) {
		this.setCommonGenericDao(baseStationFaultRecordDao);
	}
	 ...
	 * 将每行数据构建为考核指标对象
	 */
	public BaseStationFaultRecord fromRow2NewExamineInfor(HSSFRow row,Map<String,String> params) throws Exception {
