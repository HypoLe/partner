...
import com.boco.eoms.deviceManagement.busi.line.dao.MaintainDao;
...
public class MaintainServiceImpl extends
		CommonGenericServiceImpl<Maintain> implements
		MaintainService {

	public void setMaintainDao(
			MaintainDao maintainDao) {
		this.setCommonGenericDao(maintainDao);
	}
