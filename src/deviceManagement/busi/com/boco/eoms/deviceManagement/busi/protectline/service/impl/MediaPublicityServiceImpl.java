...
import com.boco.eoms.deviceManagement.busi.protectline.dao.MediaPublicityDao;
...
public class MediaPublicityServiceImpl extends
		CommonGenericServiceImpl<MediaPublicity> implements
		MediaPublicityService {

	public void setMediaPublicityDao(
			MediaPublicityDao mediaPublicityDao) {
		this.setCommonGenericDao(mediaPublicityDao);
	}
