...
public class PublicityCatchlineForm extends BaseForm implements java.io.Serializable {
	...
	private String creatArea; // 所属城市

	private String approvalUser; // 提交审核人
	
	private String publicityCatchline; // 宣传标语
	...
	public String getPublicityCatchline() {
		return publicityCatchline;
	}
	...
	public void setPublicityCatchline(String publicityCatchline) {
		this.publicityCatchline = publicityCatchline;
	}
	...
	public boolean equals(Object o) {
		if (o instanceof PublicityCatchlineForm) {
			PublicityCatchlineForm a = (PublicityCatchlineForm) o;
