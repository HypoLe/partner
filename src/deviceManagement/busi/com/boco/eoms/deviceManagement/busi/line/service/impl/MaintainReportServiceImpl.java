...
import com.boco.eoms.deviceManagement.busi.line.dao.MaintainReportDao;
...
public class MaintainReportServiceImpl extends
		CommonGenericServiceImpl<MaintainReport> implements
		MaintainReportService {
	public void setMaintainReportDao(
			MaintainReportDao maintainReportDao) {
		this.setCommonGenericDao(maintainReportDao);
	}
