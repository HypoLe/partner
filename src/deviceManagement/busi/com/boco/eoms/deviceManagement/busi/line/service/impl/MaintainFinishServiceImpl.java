...
import com.boco.eoms.deviceManagement.busi.line.dao.MaintainFinishDao;
...
public class MaintainFinishServiceImpl extends
		CommonGenericServiceImpl<MaintainFinish> implements
		MaintainFinishService {
	public void setMaintainFinishDao(
			MaintainFinishDao maintainFinishDao) {
		this.setCommonGenericDao(maintainFinishDao);
	}
