...
import com.boco.eoms.deviceManagement.busi.protectline.dao.PublicityCatchlineApprovalDao;
...
public class PublicityCatchlineApprovalServiceImpl extends
		CommonGenericServiceImpl<PublicityCatchlineApproval> implements
		PublicityCatchlineApprovalService {

	public void setPublicityCatchlineApprovalDao(
			PublicityCatchlineApprovalDao publicityCatchlineApprovalDao) {
		this.setCommonGenericDao(publicityCatchlineApprovalDao);
	}
