...
import com.boco.eoms.deviceManagement.busi.line.dao.MaintainApprovalDao;
...
public class MaintainApprovalServiceImpl extends
		CommonGenericServiceImpl<MaintainApproval> implements
		MaintainApprovalService {

	public void setMaintainApprovalDao(
			MaintainApprovalDao maintainApprovalDao) {
		this.setCommonGenericDao(maintainApprovalDao);
	}
