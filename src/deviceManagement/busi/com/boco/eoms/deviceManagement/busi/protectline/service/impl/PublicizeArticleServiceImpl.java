...
import com.boco.eoms.deviceManagement.busi.protectline.dao.PublicizeArticleDao;
...
public class PublicizeArticleServiceImpl extends
		CommonGenericServiceImpl<PublicizeArticle> implements
		PublicizeArticleService {

	public void setPublicizeArticleDao(
			PublicizeArticleDao publicizeArticleDao) {
		this.setCommonGenericDao(publicizeArticleDao);
			}
