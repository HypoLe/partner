...
public class WarningBoardOperate  extends BaseObject{

	private static final long serialVersionUID = 1L;

	private String id; // 主键
	
	private String warningBoardId;//协议ID
	...
	public boolean equals(Object o) {
		if (o instanceof WarningBoardOperate) {
			WarningBoardOperate a = (WarningBoardOperate) o;
