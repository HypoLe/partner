...
import com.boco.eoms.deviceManagement.busi.protectline.dao.PublicityCatchlineDao;
...
public class PublicityCatchlineServiceImpl extends
		CommonGenericServiceImpl<PublicityCatchline> implements
		PublicityCatchlineService {

	public void setPublicityCatchlineDao(
			PublicityCatchlineDao publicityCatchlineDao) {
		this.setCommonGenericDao(publicityCatchlineDao);
	}
