...
import com.boco.eoms.deviceManagement.busi.protectline.dao.AdvertisementApprovalDao;
...
public class AdvertisementApprovalServiceImpl extends
		CommonGenericServiceImpl<AdvertisementApproval> implements
		AdvertisementApprovalService {

	public void setAdvertisementApprovalDao(
			AdvertisementApprovalDao advertisementApprovalDao) {
		this.setCommonGenericDao(advertisementApprovalDao);
	}
