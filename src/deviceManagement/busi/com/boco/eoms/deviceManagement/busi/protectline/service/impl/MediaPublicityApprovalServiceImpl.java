...
import com.boco.eoms.deviceManagement.busi.protectline.dao.MediaPublicityApprovalDao;
...
public class MediaPublicityApprovalServiceImpl extends
		CommonGenericServiceImpl<MediaPublicityApproval> implements
		MediaPublicityApprovalService {

	public void setMediaPublicityApprovalDao(
			MediaPublicityApprovalDao mediaPublicityApprovalApprovalDao) {
		this.setCommonGenericDao(mediaPublicityApprovalApprovalDao);
	}
