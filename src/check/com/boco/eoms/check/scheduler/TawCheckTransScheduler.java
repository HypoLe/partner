...
public class TawCheckTransScheduler implements Job
{
  public void execute(JobExecutionContext context) throws org.quartz.JobExecutionException
  {
      BocoLog.info(this,0,"G网厂商考核算分入库");
      TawCheckTransSchedulerBO tawCheckTransSchedulerBO=new TawCheckTransSchedulerBO();
      tawCheckTransSchedulerBO.getMothScore(this.getNowTime());
  }
  /**
   * 得到现在的时间
   */
