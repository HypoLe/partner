...
public class EvaKpiInstanceMgrImpl implements IEvaKpiInstanceMgr {
	...
	public List getKpiInstanceByScope(final String taskDetailId, final String scope){
		return evaKpiInstanceDao.getKpiInstanceByScope(taskDetailId, scope);
	}
	/**
	 * 查询某任务某时间所属周期的所有指标考核实例
	 * 王思轩 2009-1-22
	...
	public List getKpiInstanceListByTask(final String taskId){
		return evaKpiInstanceDao.getKpiInstanceListByTask(taskId);
	}
