...
public class EvaKpiMgrImpl implements IEvaKpiMgr {
	...
	public void saveKpiAndNode(EvaKpi kpi, String parentNodeId,String isActived) {
...
//				if(isActived.equals(EvaConstants.TEMPLATE_ACTIVATED)){//如果模版激活则复制指标
				...
				kpi2.setEvaStartTime(kpi.getEvaStartTime());
				kpi2.setEvaEndTime(kpi.getEvaEndTime());
				kpi2.setEvaSource(kpi.getEvaSource());
	//			// 保存新指标
...
//			}
	...
	public Boolean isunique(final String kpiName,final String parentNodeId){
		return evaKpiDao.isunique(kpiName, parentNodeId);
	}
	
	public void removeEvaKpi(String id){
		evaKpiDao.removeEvaKpi(id);
	}	
}
