...
public class EvaTaskDetailDaoHibernate extends BaseDaoHibernate implements
	...
	public int getMaxListNoOfTask(final String taskId) {
		HibernateCallback callback = new HibernateCallback() {
			public Object doInHibernate(Session session)
				...
				String hql = "select max(cast(detail.listNo as integer)) from EvaTaskDetail detail where detail.taskId='"
						+ taskId + "'";
    ...
    public void removeTaskDetail(EvaTaskDetail taskDetail) {
