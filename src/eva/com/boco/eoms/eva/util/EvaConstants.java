...
public class EvaConstants {
	 ...
	 * 考核周期半年
	 */
	public final static String CYCLE_HALFYEAR = "halfYear";
	 ...
	 * 模板已关闭
	 */
	public final static String TEMPLATE_CLOSED = "2";
	 ...
	 * 是否发布（草稿，未发布,审核,驳回）
	 */
	public final static String TASK_DENY = "3";
	
	/**
	 * 是否发布（草稿，未发布,审核）
	 */
	public final static String TASK_AUDIT = "2";
	/**
	 * 是否发布（草稿，未发布）
	 */
	 ...
	 * 模板待审核
	 */
	public final static String AUDIT_WAIT = "0";

	/**
	 * 模板审核驳回
	 */
	public final static String AUDIT_DENY = "1";
