...
public class AssEvaOrgMgrImpl implements IAssEvaOrgMgr {

	private IAssEvaOrgDao orgDao;
	...
	public void saveAssEvaOrg(AssEvaOrg assEvaOrg) {
		orgDao.saveAssEvaOrg(assEvaOrg);
	}

	public AssEvaOrg getAssEvaOrg(String id) {
		return orgDao.getAssEvaOrg(id);
	}

	public void removeAssEvaOrg(AssEvaOrg assEvaOrg) {
		orgDao.removeAssEvaOrg(assEvaOrg);
	}
