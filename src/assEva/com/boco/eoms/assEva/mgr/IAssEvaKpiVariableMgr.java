...
import com.boco.eoms.assEva.model.AssEvaKpiVariable;
 ...
 * 
 */
public interface IAssEvaKpiVariableMgr {
	 ...
	 * @return
	 */
	public AssEvaKpi getKpiVariable(String id);
	 ...
	 *            指标
	 */
	public void saveKpiVariable(AssEvaKpiVariable kpiVariable);
