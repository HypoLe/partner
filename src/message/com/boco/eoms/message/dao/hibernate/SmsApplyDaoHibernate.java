...
//		}
	...
	public List getCustomApplys(String receiverId) {
		String hql = "from SmsApply where receiverId='"+receiverId+"' and deleted='"+MsgConstants.DIYED+"'";
		return getHibernateTemplate().find(hql);
	}
/**
 * 得到个性化全部列表
 ...
 */
	...
	public List getApplysByReceiverId(String receiverId) {
		String hql = "from SmsApply where receiverId='"+receiverId+"'";
		return getHibernateTemplate().find(hql);
	}
