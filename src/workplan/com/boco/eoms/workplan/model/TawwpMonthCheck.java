...
/**
 * <p>Title: 月度作业计划审批类</p>
 * <p>Description: 月度作业计划批类信息，其中包括审批人，审批部门，审批内容，状态，时间等</p>
...
/**
 * @hibernate.class
 * table="TAW_WP_MONTHCHECK"
 */

public class TawwpMonthCheck
  ...
  private String type; //审批类型 null：新增作业计划 1：删除网元作业计划（通过审批之后）

  private TawwpMonthPlan tawwpMonthPlan; //月度作业计划对象
  private TawwpExecuteAssess tawwpExecuteAssess; //上步骤信息对象

  public TawwpMonthCheck() {
  }

  public TawwpMonthCheck(String _deptId, String _checkUser, String _content,
                            String _state, String _crtime, String _checktime,
                            String _flowSerial, String _stepSerial, String _type,
                            TawwpMonthPlan _tawwpMonthPlan,TawwpExecuteAssess _tawwpExecuteAssess) {
    this.deptId = _deptId;
