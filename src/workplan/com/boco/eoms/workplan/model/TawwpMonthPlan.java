...
public class TawwpMonthPlan
  ...
  public int compareTo(Object otherObject){
                       ...
                       if( (yearFlag+monthFlag).compareTo(other.getYearFlag()+other.getMonthFlag()) < 0 ) return 1;     //比较以时间作为标准，返回1代表对象大
                       else if ((yearFlag+monthFlag).compareTo(other.getYearFlag()+other.getMonthFlag()) > 0) return -1;    //返回－1代表对象小
                       else return 0;           //0表示相等
                   }
