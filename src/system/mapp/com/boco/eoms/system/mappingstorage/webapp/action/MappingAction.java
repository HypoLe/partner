...
public final class MappingAction extends BaseAction {
	...
	public ActionForward save(ActionMapping mapping, ActionForm form,
		...
		boolean isNew = (null == mappingForm.getId() || "".equals(mappingForm
				.getId()));
		Mapping mapping2 = (Mapping) convert(mappingForm);
		if (isNew) {
			mappingMgr.saveMapping(mapping2);
			String dbType = ApplicationContextHolder.getInstance()
					.getHQLDialect();
	...
	public ActionForward search(ActionMapping mapping, ActionForm form,
		...
		MappingMgr mappingMgr = (MappingMgr) getBean("mappingMgr");
		Map map = (Map) mappingMgr.getMappings(pageIndex, pageSize,
				" where mapping.deleted='0'");
	...
	public ActionForward insertValue(ActionMapping mapping, ActionForm form,
		...
		if ("true".equals(sequenceOpen)) {
			...
			// 把mgr撇队列里
			sequenceFacade.put(mgr, "insertValue", new Class[] {
					appcode.getClass(), sheetkey.getClass(), rootId.getClass(),
					dictid.getClass() }, new Object[] { appcode, sheetkey,
					rootId, dictid }, null, mappingSequence);
