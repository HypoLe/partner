...
//�����������������������·���ʵ�ֲ��Կ����ղ������������������������
 ...
 public void renew(TawTestcardManager tawTestcardManager) throws SQLException {
        ...
        Date date = new Date();
         ...
         String time=this.getDateString(tawTestcardManager.getBelongtime(),tawTestcardManager.getRenewlimit());
        
        
   try {
     conn = ds.getConnection();
     String sql = "UPDATE taw_testcard_manager SET renewlimit=?,belongtime=?,reason=?,renewer=?,relenddept=?,leantime=? where id=?";
     pstmt = conn.prepareStatement(sql);
     pstmt.setInt(1,tawTestcardManager.getRenewlimit());
     pstmt.setTimestamp(2,StaticMethod.getTimestamp(time));
 ...
 public TawTestcardManager retrieve(int id) throws SQLException {
   ...
   try {
     ...
     if (rs.next()) {
       ...
       if(tawTestcardManager.getLeave()!=null && !"".equals(tawTestcardManager.getLeave())){
