...
public class TawWorkbenchContactDaoHibernate extends BaseDaoHibernate implements
	...
	public List getLikeContacts(String kw) {
		// TODO Auto-generated method stub
		List list = new ArrayList();
		String tele = "";
		String hql = " from TawWorkbenchContact work where work.tele like '%" + 
					 kw + "%' or work.contactName like '%" + kw + "%' or" + " work.email like '%"
					 + kw +"%' or work.position like '%" + kw + "%' or work.contactSpellName like '" + kw + "%'";
		list = (ArrayList) getHibernateTemplate().find(hql);
		return list;
	}
	...
	public List getLikeName(String name){
		List list = new ArrayList();
		String tele = "";
		String hql = " from TawWorkbenchContact work where work.contactName like '%" + name
		+ "' or work.contactSpellName like '" + name + "%'";
		list = (ArrayList) getHibernateTemplate().find(hql);
		return list;
	}
