...
public class ThreadForm extends BaseForm implements java.io.Serializable {
	 ...
	 * 回复附件
	 */
	private String replyAccessories;
	...
	public String getNoValidity() {
		return noValidity;
	}

	public void setNoValidity(String noValidity) {
		this.noValidity = noValidity;
	}
	...
	public String getPorjectCV() {
		return porjectCV;
	}

	public void setPorjectCV(String porjectCV) {
		this.porjectCV = porjectCV;
	}
	...
	public String getReplyAccessories() {
		return replyAccessories;
	}

	public void setReplyAccessories(String replyAccessories) {
		this.replyAccessories = replyAccessories;
	}
