...
public final class ThreadHistoryAction extends BaseAction {
	...
	public ActionForward save(ActionMapping mapping, ActionForm form,
		...
		try {
			System.out.println("crmconfirmBulletin=================>!!!!!!!!!");	
			BulletinMgr bullMgr= (BulletinMgr) getBean(BulletinMgrLocator.getAttributes().getCallMethod());
			InterfaceUtil interfaceUtil = new InterfaceUtil();
			System.out.println("crmconfirmBulletin=================>!!!!!!!!!"+bullMgr.confirmBulletin(new Integer(031), new Integer(999), thread.getSerialNo(),
