...
public class TawRmRecordBO extends BO {
	public TawRmRecordBO(com.boco.eoms.db.util.ConnectionPool ds) {
		super(ds);
	}
...
//			url = sysTemPaht + "/" + uploadPath + timeTag + ".xls";
	...
	public void insert(TawRmAddonsTableForm tawRmAddonsTableForm) {
		TawRmRecordDAO tawRmRecordDAO = null;
