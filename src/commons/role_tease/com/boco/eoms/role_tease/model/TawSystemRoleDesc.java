 ...
 * 
 */
public class TawSystemRoleDesc extends BaseObject {
	...
	public boolean equals(Object o) {
		if( o instanceof TawSystemRoleDesc ) {
			TawSystemRoleDesc tawSystemRoleDesc=(TawSystemRoleDesc)o;
			if (this.id != null || this.id.equals(tawSystemRoleDesc.getId())) {
				return true;
			} else {
				return false;
			}
