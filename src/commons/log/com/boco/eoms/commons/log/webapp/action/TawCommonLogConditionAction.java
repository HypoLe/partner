...
//			String endtime = (String) formMap.get("searchbyendtime");
			...
			String remoteip = StaticMethod.null2String(request.getParameter("searchbyremoteip"));
			String code = StaticMethod.null2String(request.getParameter("code"));
			String notemessage = StaticMethod.null2String(request.getParameter("notemessage"));
			String opreatetime = StaticMethod.null2String(request.getParameter("opreatetime"));
			...
			parameterMap.put("modeid", modeid);
			parameterMap.put("operid", operid);
			parameterMap.put("issucess", issucess);
			parameterMap.put("starttime", starttime);
			parameterMap.put("endtime", endtime);
			parameterMap.put("remoteip", remoteip);
			parameterMap.put("code", code);
			parameterMap.put("notemessage", notemessage);
			parameterMap.put("opreatetime", opreatetime);
			Map map = null;
			
			map = dao.getAllbyUseridModelidOperids(pageIndex, pageSize,parameterMap);
			List list = (List) map.get("result");
			request.setAttribute("logList", list);
			request.setAttribute("resultSize", map.get("total"));
			request.setAttribute("pageSize", pageSize);
			request.setAttribute("searchbyoper", operid);
