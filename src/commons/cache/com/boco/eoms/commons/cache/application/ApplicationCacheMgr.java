...
public class ApplicationCacheMgr {
    ...
    public List getKeys(String cacheName) throws EHCacheMgrException {
        ...
        if (cache == null) {
            throw new EHCacheMgrException("no " + cacheName + " cacheName in cache");
        }
...
//		appCache.setCacheHits( stat.getCacheHits());
        appCache.setCacheHits(new Long(stat.getCacheHits()).intValue());
//		appCache.setCacheMisses(stat.getCacheMisses());
        appCache.setCacheMisses(new Long(stat.getCacheMisses()).intValue());
//		appCache.setInMemoryHits(stat.getInMemoryHits());
        appCache.setInMemoryHits(new Long(stat.getInMemoryHits()).intValue());
//		appCache.setObjectCount(stat.getObjectCount());
        appCache.setObjectCount(new Long(stat.getObjectCount()).intValue());
//		appCache.setOnDiskHits(stat.getOnDiskHits());
        appCache.setOnDiskHits(new Long(stat.getOnDiskHits()).intValue());
//        appCache.setStatisticsAccuracy(stat.getStatisticsAccuracy());
        appCache.setStatisticsAccuracy(new Long(stat.getStatisticsAccuracy()).intValue());
