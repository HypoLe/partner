...
public class XboxTag extends TagSupport {
	...
	public int doEndTag() {
		...
		try {
			...
			try{
				if(this.jsCfg != null) config = JSONObject.fromString("{"+this.jsCfg+"}");	
			}
			...
			if(this.panels != null) config.put("panelsConfig", this.panels);
	...
	public String getJsCfg() {
		return jsCfg;
	}

	public void setJsCfg(String jsCfg) {
		this.jsCfg = jsCfg;
	}
