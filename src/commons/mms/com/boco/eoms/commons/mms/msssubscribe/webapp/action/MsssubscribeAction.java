...
public final class MsssubscribeAction extends BaseAction {
    ...
    public ActionForward modify(ActionMapping mapping, ActionForm form,
		...
		String receiveTime = msssubscribeForm.getReceiveTime();
		Date d = smf.parse(receiveTime);
		request.setAttribute("receiveTime_hour", new Integer(d.getHours()));
		request.setAttribute("receiveTime_min",  new Integer(d.getMinutes()));
		updateFormBean(mapping, request, msssubscribeForm);
	...
	public ActionForward save(ActionMapping mapping, ActionForm form,
		...
		String receiveTime = receiveTime_hour+":"+receiveTime_min+":"+"00";
		msssubscribeForm.setReceiveTime(receiveTime);
