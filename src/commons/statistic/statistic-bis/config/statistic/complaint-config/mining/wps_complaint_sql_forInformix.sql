...
null::varchar(255)  TOORGDEPTID,
null::varchar(255) TOORGROLEID,
case when to_date(to_char(task.ACCEPTTIMELIMIT,'YYYY-MM-DD HH24:MI:SS'),'YYYY-MM-DD HH24:MI:SS')>current then 1 else 2 end ACCEPTFLAG,
