...
import com.boco.eoms.commons.statistic.notflow.partner.baseinfo.vo.StatDetailVOSPartnerOil;
 ...
 */
public class OilStatListDisplayHelper extends TableDecorator {
...
*/
	...
	public String getKind() {
		StatDetailVOSPartnerOil vo = (StatDetailVOSPartnerOil) getCurrentRowObject();
		return StatUtil.id2Name(vo.getKind(), "statDictId2name_v35");
	}
