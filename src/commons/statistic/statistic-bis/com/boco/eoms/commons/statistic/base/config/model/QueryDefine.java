...
//	private String listPercentCount;	
	...
	// 组成最终sql后再加到sql前面的语句 <fist-sql>
	private String fistSql="";
	//组成最终sql后再加到sql后面的语句<last-sql>
	...
	/**
	 * @param percentCountSql
	 *            The percentCountSql to set.
	 */
...
//	}
	...
	public String getFistSql() {
		return fistSql;
	}

	public void setFistSql(String fistSql) {
		this.fistSql = fistSql;
	}
