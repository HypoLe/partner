...
/**
 * 
 * @author panlong 下午05:38:39
 */
public class TawSheetSpecialManagerImpl extends BaseManager implements
		ITawSheetSpecialManager {
	...
	/**
	 * @see com.boco.eoms.commons.sheet.special.service.ITawSheetSpecialManager#getTawSheetSpecial(String
	 *      id)
	 */
	...
	/**
	 * @see com.boco.eoms.commons.sheet.special.service.ITawSheetSpecialManager#saveTawSheetSpecial(TawSheetSpecial
	 *      tawSheetSpecial)
	 */
	...
	/**
	 * @see com.boco.eoms.commons.sheet.special.service.ITawSheetSpecialManager#removeTawSheetSpecial(String
	 *      id)
	 */
	...
	public String getMaxSpecialId(String paraspeid) {
		...
		newspeid = daojdbc.getMaxSpecialId(paraspeid, paraspeid.length()
				+ StaticVariable.AREAID_BETWEEN_LENGTH);
		if (newspeid.equals(paraspeid)) {
			...
			if (newspeid.compareTo(paraspeid + StaticVariable.AREAID_IF_MAXID) < StaticVariable.AREA_DEFAULT_INTVAL) {
				newspeid = String.valueOf(areaidvar
						+ StaticVariable.AREA_DEFAULT_INTHVAL);
			} else {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.boco.eoms.commons.sheet.special.service.ITawSheetSpecialManager#listSpecialsByType(java.lang.String)
	 */
	public List listSpecialsByType(String specialType) {
		return dao.listSpecialsByType(specialType);
	}
