		...
		try {
			nodes = (SubRoleSchema) ParseXmlService
					...
					.xml2object(SubRoleSchema.class, "classpath:com/boco/eoms/commons/system/role/util/SubRoleMapping.xml",
							"classpath:com/boco/eoms/commons/system/role/config/eomsRoleSchema.xml",false);

		} catch (ParseXMLException e) {
			e.printStackTrace();
			throw new Exception("读取配置文件'com/boco/eoms/commons/system/role/config/eomsRoleSchema.xml'出错");
		}
	}
