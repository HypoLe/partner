...
public class TawSystemRoleImportManagerImpl extends BaseManager implements
	...
	/**
	 * @param fmImportFileManager
	 *            the fmImportFileManager to set
	 */
		...
		if (list != null) {
			for (Iterator it = list.iterator(); it.hasNext();) {
				...
				tawSystemSubRole.setType4(getLastWord(tawSystemRoleImportExcel
						.getFourthType(), "-"));
				tawSystemSubRole.setType5(getLastWord(tawSystemRoleImportExcel
						.getFifthType(), "-"));
				tawSystemSubRole.setType6(getLastWord(tawSystemRoleImportExcel
						.getSixthType(), "-"));
				tawSystemSubRole.setType7(getLastWord(tawSystemRoleImportExcel
						.getSeventhType(), "-"));
				tawSystemSubRole.setType8(getLastWord(tawSystemRoleImportExcel
						.getEighthType(), "-"));
				// 版本
	...
	private String togetherLogo(
		...
		+ getLastWord(tawSystemRoleImportExcel.getFirstType(), "-")
		+ getLastWord(tawSystemRoleImportExcel.getSecondType(), "-")
		+ getLastWord(tawSystemRoleImportExcel.getThirdType(), "-")
		+ getLastWord(tawSystemRoleImportExcel.getFourthType(), "-")
		+ getLastWord(tawSystemRoleImportExcel.getFifthType(), "-")
		+ getLastWord(tawSystemRoleImportExcel.getSixthType(), "-")
		+ getLastWord(tawSystemRoleImportExcel.getSeventhType(), "-")
		+ getLastWord(tawSystemRoleImportExcel.getEighthType(), "-")
		+ getLastWord(tawSystemRoleImportExcel.getRoleId(), "-");
	}

	/**
	 * @param tawSystemSubRoleDao
	 *            the tawSystemSubRoleDao to set
	 */
