...
public class TawSystemRoleManagerImpl extends BaseManager implements
	...
	/**
	 * @see com.boco.eoms.commons.system.role.service.ITawSystemRoleManager#listFirstLevelAreaByRoleId
	 */	
	...
	/**
	 * @see com.boco.eoms.commons.system.role.service.ITawSystemRoleManager#listSubLevelAreaByRoleId
	 */	
	public List listSubLevelAreaByRoleId(long roleId, String areaId) {
		return dao.listSubLevelAreaByRoleId(roleId, areaId);
	}	
