...
public class TawSystemRoleImportExcel implements Serializable {
	 ...
	 * 六级类别
	 */
	private String sixthType;
	
	/**
	 * 七级类别
	 */
	private String seventhType;
	
	/**
	 * 八级类别
	 */
	private String eighthType;
	...
	public String getEighthType() {
		return eighthType;
	}

	public void setEighthType(String eighthType) {
		this.eighthType = eighthType;
	}
	...
	public String getSeventhType() {
		return seventhType;
	}

	public void setSeventhType(String seventhType) {
		this.seventhType = seventhType;
	}

	public String getSixthType() {
		return sixthType;
	}

	public void setSixthType(String sixthType) {
		this.sixthType = sixthType;
	}
