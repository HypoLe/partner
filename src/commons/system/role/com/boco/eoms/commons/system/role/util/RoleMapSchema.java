	...
	private static void loadXml() throws Exception{
		try {
			nodes = (RoleMappings) ParseXmlService
					.create()
					.xml2object(RoleMappings.class,"classpath:com/boco/eoms/commons/system/role/util/RoleMapping.xml", "classpath:com/boco/eoms/commons/system/role/config/roleConfig.xml",false);
			int i=0;

		} catch (ParseXMLException e) {
			e.printStackTrace();
			throw new Exception("读取配置文件'com/boco/eoms/commons/system/role/config/roleConfig.xml'出错");
		}
	}
	/**
	 * 根据模块ID，获取对应的XML文件路径
