...
public class UserPasswdHistory extends BaseObject implements Serializable {
	 ...
	 * 密码明文备份
	 */
	private String plaintextRecord;
	...
	public UserPasswdHistory(String userId, String passwd, Date updateTime,String plaintextRecord) {
		super();
		this.userId = userId;
		this.passwd = passwd;
		this.updateTime = updateTime;
		this.plaintextRecord=plaintextRecord;
	}
	...
	public String getPlaintextRecord() {
		return plaintextRecord;
	}

	public void setPlaintextRecord(String plaintextRecord) {
		this.plaintextRecord = plaintextRecord;
	}
