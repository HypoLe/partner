...
public class TawSystemUserBoImpl implements ITawSystemUserBo {
	...
	public List getUserBydeptids(String deptid,String level) {
		...
		list = usermanager.getUserBydeptids(deptid,level);
	...
	public List getUserBydeptidsNoSelf(String deptid, String userid,String level) {
		...
		list = usermanager.getUserBydeptidsNoSelf(deptid, userid,level);
	...
	public List getUserBydeptidsNoSelfTask(String deptid, String userid,String rootId,String level) {
		...
		list = usermanager.getUserBydeptidsNoSelfTask(deptid, userid,rootId,level);
		return list;
	}
	@Override
	public List getUserBydeptidsTask(String deptid, String rootId,String level) {
		...
		list = usermanager.getUserBydeptidsTask(deptid,rootId,level);
		return list;
	}
