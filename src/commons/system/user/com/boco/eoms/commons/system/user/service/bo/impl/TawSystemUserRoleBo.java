...
public class TawSystemUserRoleBo {
	...
	public List getUserBydeptids(String deptid,String level) {
		...
		.getInstance().getBean("iTawSystemUserBo");
		List list = new ArrayList();
		list = sysuserbo.getUserBydeptids(deptid,level);
	...
	public List getUserBydeptidsTask(String deptid,String rootId,String level) {
		...
		.getInstance().getBean("iTawSystemUserBo");
		List list = new ArrayList();
		list = sysuserbo.getUserBydeptidsTask(deptid,rootId,level);
	...
	public List getUserByCompids(String deptid) {
		...
		PartnerUserMgr sysuserbo = (PartnerUserMgr) ApplicationContextHolder
		.getInstance().getBean("partnerUserMgr");
		List list = new ArrayList();
		list = sysuserbo.getUserByCompids(deptid);
	...
	public List getUserBydeptidsNoSelf(String deptid,String userid,String level) {
		...
		.getInstance().getBean("iTawSystemUserBo");
		List list = new ArrayList();
		list = sysuserbo.getUserBydeptidsNoSelf(deptid,userid,level);
	...
	public List getUserBydeptidsNoSelfTask(String deptid,String userid,String rootId,String level) {
		...
		.getInstance().getBean("iTawSystemUserBo");
		List list = new ArrayList();
		list = sysuserbo.getUserBydeptidsNoSelfTask(deptid,userid,rootId,level);
	 ...
	 * @return
	 */
	public List getUserByCompsNoSelf(String deptid,String userid) {
		PartnerUserMgr sysuserbo = (PartnerUserMgr) ApplicationContextHolder
				.getInstance().getBean("partnerUserMgr");
		List list = new ArrayList();
		list = sysuserbo.getUserByCompidNoSelf(deptid,userid);
