...
public class TawSystemPrivRegionImpl extends BaseManager implements
	 ...
	 * @param objecttype
	 */
	public void removeOjbectregion(String objectid, String objecttype,String regiontype) {
		tawSystemPrivRegionJdbc.removeOjbectregion(objectid, objecttype, regiontype);
	}
