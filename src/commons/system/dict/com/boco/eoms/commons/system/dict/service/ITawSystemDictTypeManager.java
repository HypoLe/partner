...
public interface ITawSystemDictTypeManager extends Manager {
    ...
    * 通过名字获取对象,
    * @param dicName
    * @param parentdictid 上级ID
    * @param length 截取parentdictid的长度
     * @return
    */
    public List<TawSystemDictType> getTawSystemDictTypeByName(String dicName,String parentdictid,int length);
    
    public PageModel searchPaginated(final String hql, final Object[] params, final int offset,final int pagesize);
