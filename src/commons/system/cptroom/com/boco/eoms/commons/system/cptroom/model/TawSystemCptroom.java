...
public class TawSystemCptroom extends BaseObject {
	...
	private String leaf;
	private int dutyUserCout;//机房值班人员数
	
	
	

	public int getDutyUserCout() {
		return dutyUserCout;
	}

	public void setDutyUserCout(int dutyUserCout) {
		this.dutyUserCout = dutyUserCout;
	}

	public boolean equals(Object o) {
		if (o instanceof TawSystemCptroom) {
			TawSystemCptroom cpRoom = (TawSystemCptroom) o;
