...
public class TawSystemAreaManagerImpl extends BaseManager implements ITawSystemAreaManager {
	...
	public boolean getAreaNameByName(String areaName,String parentAreaid,String id){
		return dao.getAreaNameByName(areaName,parentAreaid,id);
	}
	/*
	 * 获得地域
	 */

	public List<TawSystemArea> getareas(String where) {
		return dao.getAreas(where);
	}


	public List<TawSystemArea> getTawareas(String areaName) {
		// TODO Auto-generated method stub
		List<TawSystemArea> list=null;
		StringBuffer sql = new StringBuffer();
		sql.append("from TawSystemArea a where a.areaname='").append(areaName).append("'");
