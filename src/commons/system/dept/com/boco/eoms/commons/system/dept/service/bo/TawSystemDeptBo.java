...
public class TawSystemDeptBo {
	...
	public List getNextLevecDeptsTask(String deptid, String delid,String rootId) {
		List list = null;
		try {
			ITawSystemDeptManager deptmag = (ITawSystemDeptManager) ApplicationContextHolder
			.getInstance().getBean("ItawSystemDeptManager");
			list = new ArrayList();
			list = deptmag.getNextLevecDeptsTask(deptid, delid,rootId);
		} catch (Exception ex) {
			BocoLog.error(TawSystemDeptBo.class, " 查询部门 " + deptid
					+ " 的所有子部门信息出错 " + ex.getMessage());
		}
	 ...
	 * @param userdeptid
	 * @param isPartner
	 * 人员类型 是否代维－1 为全部 0为代维 1为自维
	 * @return
	 */
	public List getNextLevecCompDW(String deptid, String delid,String userdeptid,int isPartner) {
		List list = null;
		try {
			...
			list = new ArrayList();
			list = partnerAppopsDeptService.getNextLevecDepts(deptid, delid,userdeptid,isPartner);
		} catch (Exception ex) {
			BocoLog.error(TawSystemDeptBo.class, " 查询部门 " + deptid
					+ " 的所有子部门信息出错 " + ex.getMessage());
		}
	 ...
	 * @return
	 */
	public List getNextLevecComp(String deptid, String delid,String userdeptid,int isPartner) {
		List list = null;
		try {
			PartnerDeptMgr deptmag = (PartnerDeptMgr) ApplicationContextHolder
			.getInstance().getBean("PartnerDeptMgrImplFlush");
			list = new ArrayList();
			list = deptmag.getNextLevecDepts(deptid, delid,userdeptid,isPartner);
		} catch (Exception ex) {
			BocoLog.error(TawSystemDeptBo.class, " 查询部门 " + deptid
					+ " 的所有子部门信息出错 " + ex.getMessage());
		}
...
//			ITawSystemDeptManager mgr = (ITawSystemDeptManager) getBean("ItawSystemDeptManagerFlush");
	...
	public List getNextLikeComps(String deptid, String delid,int isPartner) {
		List list = null;
		try {
			PartnerDeptMgr deptmag = (PartnerDeptMgr) ApplicationContextHolder
			.getInstance().getBean("PartnerDeptMgrImplFlush");
//			ITawSystemDeptManager mgr = (ITawSystemDeptManager) getBean("ItawSystemDeptManagerFlush");
			list = new ArrayList();
			list = deptmag.getNextLevecDepts(deptid, delid,"",isPartner);
		} catch (Exception ex) {
			BocoLog.error(TawSystemDeptBo.class, " 查询部门 " + deptid
					+ " 的所有子部门信息出错 " + ex.getMessage());
		}
	...
	public List getNextArea(String areaid, String delid) {
		List list = null;
		try {
			ITawSystemAreaManager deptmag = (ITawSystemAreaManager) ApplicationContextHolder
			.getInstance().getBean("ItawSystemAreaManager");
			list = new ArrayList();
			list = deptmag.getSonAreaByAreaId(areaid);
		} catch (Exception ex) {
			BocoLog.error(TawSystemDeptBo.class, " 查询部门 " + areaid
					+ " 的所有子部门信息出错 " + ex.getMessage());
		}
		return list;
	}
	 ...
	 * 该方法暂时不提供
	 */
	public List getNextAreaComp(String areaid, String delid) {
		List list = null;
		try {
			PartnerDeptMgr deptmag = (PartnerDeptMgr) ApplicationContextHolder
			.getInstance().getBean("ItawSystemAreaManager");
...
//			list = deptmag.getSonAreaByAreaId(areaid);
	...
	/**
	 * 运维人员管理
	 *@Title: getNextLevecCompByAreaidDW 
	 ...
	 *@throws
	 */
	public List getNextLevecCompByAreaidDW(String parentdeptid, String delid,String areaId,int isPartner) {
		List list = null;
		try {
			PartnerAppopsDeptService partnerAppopsDeptService = (PartnerAppopsDeptService) ApplicationContextHolder.getInstance().getBean("pnrAppopsDeptService");

			list = new ArrayList();
			list = partnerAppopsDeptService.getNextLevecCompByAreaid(parentdeptid, delid,areaId, isPartner);
		} catch (Exception ex) {
			BocoLog.error(TawSystemDeptBo.class, " 查询部门 " + parentdeptid+ " 的所有子部门信息出错 " + ex.getMessage());
		}
		return list;
	}
	/**
	...
	*@throws
	...
	public List getNextLevecCompByAreaid(String parentdeptid, String delid,String areaId,int isPartner) {
		...
		try {
			...
			.getInstance().getBean("PartnerDeptMgrImplFlush");
			list = new ArrayList();
			list = deptmag.getNextLevecCompByAreaid(parentdeptid, delid,areaId, isPartner);
		} catch (Exception ex) {
			BocoLog.error(TawSystemDeptBo.class, " 查询部门 " + parentdeptid+ " 的所有子部门信息出错 " + ex.getMessage());
		}
		return list;
