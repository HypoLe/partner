...
public class TawCommonsAccessoriesDaoJdbc extends JdbcDaoSupport {
  ...
  public  List getTawSystemApplications() {
	  ...
	  * 根据时间戳名字取汉语名字
	  */
	 public String getNameByDateName(String name){
		 String realName="";
		 String sql="from taw_commons_accessories where accessoriesname="+name;
		 List list = getJdbcTemplate().queryForList(sql);
		 TawCommonsAccessories tawCommonsAccessories=(TawCommonsAccessories)list.get(0);
		 realName=tawCommonsAccessories.getAccessoriesCnName();
