 ...
 * </p>
 * <p>
 * Description:附件管理DAO类实现类
 * </p>
 * <p>
 * Apr 10, 2007 10:58:30 AM
 * </p>
 * 
 * @author 秦敏
 * @version 1.0
...
public class TawCommonsAccessoriesDaoHibernate extends BaseDaoHibernate
	...
	public List getAllFileByName(String accesspriesFileNames) {
		if (accesspriesFileNames == null
				|| "".equals(accesspriesFileNames.trim())) {
...
//		int len=list.size();
//		for (int i = 0; i < len; i++) {
//			TawCommonsAccessories tawCommonsAccessories = (TawCommonsAccessories) list
//					.get(i);
