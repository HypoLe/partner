...
/**
 * 类说明：网络资源--基站设备及配套--风电控制器:风电控制器DaoJdbcImpl实现类
 * 创建人： zhangkeqi
 * 创建时间：2012-11-16 23:11:36
 */
public class IrmsBsWpcDaoJdbcImpl extends AbstractDataSynchDaoJdbc {
		/**
		 * 批量插入语句
		 */
		public String getBatchInsertSql(String table){
			return "insert into "+table+"_irms_bs_wpc("+
						"id,"+
						"related_room,"+
						"device_type,"+
						"device_subclass,"+
		...
		public PreparedStatement addPsBatch(PreparedStatement ps,Map<String,Object> data) throws Exception{
			...
			/*下挂风机数量(个)*/
			ps.setString(16,StaticMethod.nullObject2String(data.get("fan_count")));
			/*输出额定容量(KW)*/
