 ...
 */
public class IrmsTransPipeMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/trans/dataSynch-rule-IrmsTransPipe.xml");
		AbstractDataMappingRule rule = (IrmsTransPipeMappingRule) Unmarshaller.unmarshal(IrmsTransPipeMappingRule.class, reader);
		buildRuleMap(rule);
	}
}