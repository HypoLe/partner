...
/**
 * 类说明：网络资源--基站设备及配套--风能设备:风能设备DaoJdbcImpl实现类
 * 创建人： zhangkeqi
 * 创建时间：2012-11-16 23:11:36
 */
public class IrmsBsWepDaoJdbcImpl extends AbstractDataSynchDaoJdbc {
		/**
		 * 批量插入语句
		 */
		public String getBatchInsertSql(String table){
			return "insert into "+table+"_irms_bs_wep("+
						"id,"+
						"related_room,"+
						"device_type,"+
						"device_subclass,"+
		...
		public PreparedStatement addPsBatch(PreparedStatement ps,Map<String,Object> data) throws Exception{
			...
			/*枚举值：水平轴，垂直轴*/
			ps.setString(18,StaticMethod.nullObject2String(data.get("fan_form")));
			/*移动公司该设备的负责人*/
