 ...
 */
public class IrmsTransOdfMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/trans/dataSynch-rule-IrmsTransOdf.xml");
		AbstractDataMappingRule rule = (IrmsTransOdfMappingRule) Unmarshaller.unmarshal(IrmsTransOdfMappingRule.class, reader);
		buildRuleMap(rule);
	}
}