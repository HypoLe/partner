 ...
 */
public class IrmsGroupMmsMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/group/dataSynch-rule-IrmsGroupMms.xml");
		AbstractDataMappingRule rule = (IrmsGroupMmsMappingRule) Unmarshaller.unmarshal(IrmsGroupMmsMappingRule.class, reader);
		buildRuleMap(rule);
	}
}