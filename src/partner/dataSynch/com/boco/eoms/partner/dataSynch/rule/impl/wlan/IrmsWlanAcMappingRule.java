 ...
 */
public class IrmsWlanAcMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/wlan/dataSynch-rule-IrmsWlanAc.xml");
		AbstractDataMappingRule rule = (IrmsWlanAcMappingRule) Unmarshaller.unmarshal(IrmsWlanAcMappingRule.class, reader);
		buildRuleMap(rule);
	}
}