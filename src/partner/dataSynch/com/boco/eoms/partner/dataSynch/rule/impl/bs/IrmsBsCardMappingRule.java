 ...
 */
public class IrmsBsCardMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsCard.xml");
		AbstractDataMappingRule rule = (IrmsBsCardMappingRule) Unmarshaller.unmarshal(IrmsBsCardMappingRule.class, reader);
		buildRuleMap(rule);
	}
}