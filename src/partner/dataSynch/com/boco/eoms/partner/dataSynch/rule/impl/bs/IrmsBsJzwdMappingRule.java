 ...
 */
public class IrmsBsJzwdMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsJzwd.xml");
		AbstractDataMappingRule rule = (IrmsBsJzwdMappingRule) Unmarshaller.unmarshal(IrmsBsJzwdMappingRule.class, reader);
		buildRuleMap(rule);
	}
}