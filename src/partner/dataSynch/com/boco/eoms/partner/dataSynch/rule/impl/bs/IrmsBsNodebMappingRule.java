 ...
 */
public class IrmsBsNodebMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsNodeb.xml");
		AbstractDataMappingRule rule = (IrmsBsNodebMappingRule) Unmarshaller.unmarshal(IrmsBsNodebMappingRule.class, reader);
		buildRuleMap(rule);
	}
}