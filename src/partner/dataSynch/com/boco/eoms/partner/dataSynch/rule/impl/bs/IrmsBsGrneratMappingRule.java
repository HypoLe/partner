 ...
 */
public class IrmsBsGrneratMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsGrnerat.xml");
		AbstractDataMappingRule rule = (IrmsBsGrneratMappingRule) Unmarshaller.unmarshal(IrmsBsGrneratMappingRule.class, reader);
		buildRuleMap(rule);
	}
}