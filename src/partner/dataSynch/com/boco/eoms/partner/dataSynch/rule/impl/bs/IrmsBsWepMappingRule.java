 ...
 */
public class IrmsBsWepMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsWep.xml");
		AbstractDataMappingRule rule = (IrmsBsWepMappingRule) Unmarshaller.unmarshal(IrmsBsWepMappingRule.class, reader);
		buildRuleMap(rule);
	}
}