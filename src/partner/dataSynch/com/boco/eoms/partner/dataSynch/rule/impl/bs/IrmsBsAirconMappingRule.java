 ...
 */
public class IrmsBsAirconMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsAircon.xml");
		AbstractDataMappingRule rule = (IrmsBsAirconMappingRule) Unmarshaller.unmarshal(IrmsBsAirconMappingRule.class, reader);
		buildRuleMap(rule);
	}
}