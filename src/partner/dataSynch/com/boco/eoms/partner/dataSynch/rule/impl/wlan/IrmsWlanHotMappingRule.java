 ...
 */
public class IrmsWlanHotMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/wlan/dataSynch-rule-IrmsWlanHot.xml");
		AbstractDataMappingRule rule = (IrmsWlanHotMappingRule) Unmarshaller.unmarshal(IrmsWlanHotMappingRule.class, reader);
		buildRuleMap(rule);
	}
}