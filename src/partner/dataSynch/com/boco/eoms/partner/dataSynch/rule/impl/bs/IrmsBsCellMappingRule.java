 ...
 */
public class IrmsBsCellMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsCell.xml");
		AbstractDataMappingRule rule = (IrmsBsCellMappingRule) Unmarshaller.unmarshal(IrmsBsCellMappingRule.class, reader);
		buildRuleMap(rule);
	}
}