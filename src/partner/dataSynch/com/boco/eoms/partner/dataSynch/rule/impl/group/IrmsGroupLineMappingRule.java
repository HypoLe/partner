 ...
 */
public class IrmsGroupLineMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/group/dataSynch-rule-IrmsGroupLine.xml");
		AbstractDataMappingRule rule = (IrmsGroupLineMappingRule) Unmarshaller.unmarshal(IrmsGroupLineMappingRule.class, reader);
		buildRuleMap(rule);
	}
}