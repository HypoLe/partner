 ...
 */
public class IrmsBsHesMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsHes.xml");
		AbstractDataMappingRule rule = (IrmsBsHesMappingRule) Unmarshaller.unmarshal(IrmsBsHesMappingRule.class, reader);
		buildRuleMap(rule);
	}
}