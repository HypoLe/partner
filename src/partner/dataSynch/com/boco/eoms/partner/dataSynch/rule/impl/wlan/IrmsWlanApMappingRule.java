 ...
 */
public class IrmsWlanApMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/wlan/dataSynch-rule-IrmsWlanAp.xml");
		AbstractDataMappingRule rule = (IrmsWlanApMappingRule) Unmarshaller.unmarshal(IrmsWlanApMappingRule.class, reader);
		buildRuleMap(rule);
	}
}