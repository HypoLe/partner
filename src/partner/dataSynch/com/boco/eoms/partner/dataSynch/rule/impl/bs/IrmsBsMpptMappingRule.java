 ...
 */
public class IrmsBsMpptMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsMppt.xml");
		AbstractDataMappingRule rule = (IrmsBsMpptMappingRule) Unmarshaller.unmarshal(IrmsBsMpptMappingRule.class, reader);
		buildRuleMap(rule);
	}
}