 ...
 */
public class IrmsBsWpcMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsWpc.xml");
		AbstractDataMappingRule rule = (IrmsBsWpcMappingRule) Unmarshaller.unmarshal(IrmsBsWpcMappingRule.class, reader);
		buildRuleMap(rule);
	}
}