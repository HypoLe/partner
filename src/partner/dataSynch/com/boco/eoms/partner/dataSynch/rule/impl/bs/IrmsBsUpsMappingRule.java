 ...
 */
public class IrmsBsUpsMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsUps.xml");
		AbstractDataMappingRule rule = (IrmsBsUpsMappingRule) Unmarshaller.unmarshal(IrmsBsUpsMappingRule.class, reader);
		buildRuleMap(rule);
	}
}