 ...
 */
public class IrmsGroupGprsMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/group/dataSynch-rule-IrmsGroupGprs.xml");
		AbstractDataMappingRule rule = (IrmsGroupGprsMappingRule) Unmarshaller.unmarshal(IrmsGroupGprsMappingRule.class, reader);
		buildRuleMap(rule);
	}
}