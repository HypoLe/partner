 ...
 */
public class IrmsTransWellMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/trans/dataSynch-rule-IrmsTransWell.xml");
		AbstractDataMappingRule rule = (IrmsTransWellMappingRule) Unmarshaller.unmarshal(IrmsTransWellMappingRule.class, reader);
		buildRuleMap(rule);
	}
}