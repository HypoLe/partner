 ...
 */
public class IrmsBsRackMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsRack.xml");
		AbstractDataMappingRule rule = (IrmsBsRackMappingRule) Unmarshaller.unmarshal(IrmsBsRackMappingRule.class, reader);
		buildRuleMap(rule);
	}
}