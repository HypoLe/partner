...
/**
 * 类说明：网络资源--基站设备及配套--太阳能控制器:太阳能控制器DaoJdbcImpl实现类
 * 创建人： zhangkeqi
 * 创建时间：2012-11-16 23:11:36
 */
public class IrmsBsMpptDaoJdbcImpl extends AbstractDataSynchDaoJdbc {
		/**
		 * 批量插入语句
		 */
		public String getBatchInsertSql(String table){
			return "insert into "+table+"_irms_bs_mppt("+
						"id,"+
						"related_room,"+
						"device_type,"+
						"device_subclass,"+
		...
		public PreparedStatement addPsBatch(PreparedStatement ps,Map<String,Object> data) throws Exception{
			...
			/**/
			ps.setString(17,StaticMethod.nullObject2String(data.get("exp_rating_capacit")));
			/*移动公司该设备的负责人*/
