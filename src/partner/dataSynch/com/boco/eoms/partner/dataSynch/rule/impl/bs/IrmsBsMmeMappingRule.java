 ...
 */
public class IrmsBsMmeMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsMme.xml");
		AbstractDataMappingRule rule = (IrmsBsMmeMappingRule) Unmarshaller.unmarshal(IrmsBsMmeMappingRule.class, reader);
		buildRuleMap(rule);
	}
}