 ...
 */
public class IrmsSpaceRoomMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/space/dataSynch-rule-IrmsSpaceRoom.xml");
		AbstractDataMappingRule rule = (IrmsSpaceRoomMappingRule) Unmarshaller.unmarshal(IrmsSpaceRoomMappingRule.class, reader);
		buildRuleMap(rule);
	}
}