 ...
 */
public class IrmsBsVensMappingRule extends AbstractDataMappingRule{
	/**
	 * 初始化映射规则
	 */
	public void initMappingRule() throws Exception{
		Reader reader = getMappingFileReader("/bs/dataSynch-rule-IrmsBsVens.xml");
		AbstractDataMappingRule rule = (IrmsBsVensMappingRule) Unmarshaller.unmarshal(IrmsBsVensMappingRule.class, reader);
		buildRuleMap(rule);
	}
}