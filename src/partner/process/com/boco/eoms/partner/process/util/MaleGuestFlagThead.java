 ...
 * Date:2014-05-28
 */
public class MaleGuestFlagThead
  implements Runnable
{
...
public String getTimeString()
  ...
  public MaleGuestFlagThead(String timeString, String workOrderNo, String methodName, String msg) {
    this.timeString = timeString;
    this.workOrderNo = workOrderNo;
    this.methodName = methodName;
    this.msg = msg;
  }
  public MaleGuestFlagThead(String timeString,String methodName,TransferMaleGuestFlag maleGuestFlag){
	  this.timeString = timeString;
	    this.methodName = methodName;
	    this.maleGuestFlag = maleGuestFlag;
  };
  public void run()
  {
	  ...
	  String getMsg = CommonUtils.maleGuestFlagAndReturn(this.timeString,this.methodName,this.maleGuestFlag);
