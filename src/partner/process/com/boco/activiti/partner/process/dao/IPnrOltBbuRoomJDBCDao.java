...
public interface IPnrOltBbuRoomJDBCDao {
	/**
	 * olt-bbu机房优化申请--待回复或待办工单--工单总数
	 * 
	 * @author chujingang
	 * @title: getOltBbuCount
	 ...
	 * olt-bbu机房优化--待回复或待办工单--工单集合
	  ...
	  * @param endResult
	  * @param pageSize
	  * @return List<PnrOltBbuOfficeMainModel>
	 */
	public List<PnrOltBbuOfficeMainModel> getOltBbuList(String userid, String flag,
			String processKey, ConditionQueryModel conditionQueryModel,
	 ...
	 * 本地网-预检预修工单集合
	  ...
	  * @return List<TaskModel>
	 */
	public List<PnrOltBbuOfficeMainModel> getOltBbuWorkOrderList(String areaid,String userid, String flag,
			String processKey, ConditionQueryModel conditionQueryModel,
			int firstResult, int endResult, int pageSize);
	 ...
	 * @author chujingang
	 */
	public List<PnrOltBbuRoom> selectOltBbuRoolList(String processKey, ConditionQueryModel conditionQueryModel,
			int firstResult, int endResult, int pageSize);
	/**
	 * 机房优化申请-获取机房清单信息集合
	 * 
