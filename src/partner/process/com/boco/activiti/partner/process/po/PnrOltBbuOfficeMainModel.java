 ...
 * 
 */
public class PnrOltBbuOfficeMainModel implements Serializable {
	...
	// 区分接口与传输局 transferOffice抢修工单；maleGuest 公客；interface 本地网预检预修；arteryPrecheck
	// 干线预检预修；overhaul 大修工单；reform 改造工单；
	...
	// 状态
	// <0：正常>；<1：删除>;<3：待办状态>;<5:归档>;<6:正在会审>;<7：会审结束>;<8:等待运维商城接口调用>；<9:概预算系统已返回金额>；<10:手机端已提交抽查，等待WEB端添加信息>
	...
	/**
	 * 工单编号 工单编号： 本地网： 预检预修：B-JN-CQ-JX-20150215-1 抢修：B-JN-CQ-QX-20150215-1 干线：
	 * 预检预修：G- JN-CQ-JX-20150215-1 抢修：G-JN-CQ-QX-20150215-1 注释：B代表本地网 G代表干线
	 * JN代表济南 CQ代表长清 20150215代表时间 1：代表第几个工单
	 * 
	 */
	...
	private String roomThemeInterface;
	// 序号
	...
	public PnrOltBbuOfficeMainModel() {
	...
	public String getRoomThemeInterface() {
		return roomThemeInterface;
	}

	public void setRoomThemeInterface(String roomThemeInterface) {
		this.roomThemeInterface = roomThemeInterface;
	}
