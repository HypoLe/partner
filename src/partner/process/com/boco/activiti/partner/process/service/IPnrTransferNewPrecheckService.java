 ...
 */
public interface IPnrTransferNewPrecheckService extends CommonGenericService<PnrTransferOffice> {
	/**
	 * 预检预修--待回复或待办工单--工单总数
	  * @author wangyue
	 ...
	 * 工单集合数
	 */
	public int getLocalNetworkWorkOrderListCount(String areaid,String userid, String flag,String processKey,
			ConditionQueryModel conditionQueryModel);
