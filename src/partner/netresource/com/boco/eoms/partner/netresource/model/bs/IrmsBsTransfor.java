...
/**
 * 类说明：网络资源--基站设备及配套--变压器或调压器
 * 创建人： zhangkeqi
 * 创建时间：2012-11-27 18:49:18
 */
public class IrmsBsTransfor extends EomsModel{
	...
	/**输入额定电压，单位：KV*/
	private String impRatingVoltage;
		
	/**输出额定电压，单位：V*/
	private String extRatingVoltage;
	...
	public String getImpRatingVoltage() {
		return this.impRatingVoltage;
	}
	
	public void setImpRatingVoltage(String impRatingVoltage) {
		this.impRatingVoltage = impRatingVoltage;
	}
	public String getExtRatingVoltage() {
		return this.extRatingVoltage;
	}
	
	public void setExtRatingVoltage(String extRatingVoltage) {
		this.extRatingVoltage = extRatingVoltage;
	}
