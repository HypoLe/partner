...
/**
 * 类说明：网络资源--基站设备及配套--太阳能设备
 * 创建人： zhangkeqi
 * 创建时间：2012-11-27 18:49:19
 */
public class IrmsBsSee extends EomsModel{
	...
	/**额定输出功率，单位：KVA*/
	private String solarPanelsRatin;
		
	/**枚举值：48,24*/
	private String expVoltage;
	...
	public String getSolarPanelsRatin() {
		return this.solarPanelsRatin;
	}
	
	public void setSolarPanelsRatin(String solarPanelsRatin) {
		this.solarPanelsRatin = solarPanelsRatin;
	}
	public String getExpVoltage() {
		return this.expVoltage;
	}
	
	public void setExpVoltage(String expVoltage) {
		this.expVoltage = expVoltage;
	}
