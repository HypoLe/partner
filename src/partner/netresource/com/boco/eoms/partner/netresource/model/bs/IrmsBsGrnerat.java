...
/**
 * 类说明：网络资源--基站设备及配套--发电机组
 * 创建人： zhangkeqi
 * 创建时间：2012-11-27 18:49:19
 */
public class IrmsBsGrnerat extends EomsModel{
...
符合设备命名规范*/
	...
	/**包括品牌、型号*/
	private String startBatteryMode;
		
	/**单位：组*/
	private String startBatteryCoun;
		
	/**单位：AH*/
	private String startBatteryCapa;
	...
	public String getStartBatteryMode() {
		return this.startBatteryMode;
	}
	
	public void setStartBatteryMode(String startBatteryMode) {
		this.startBatteryMode = startBatteryMode;
	}
	public String getStartBatteryCoun() {
		return this.startBatteryCoun;
	}
	
	public void setStartBatteryCoun(String startBatteryCoun) {
		this.startBatteryCoun = startBatteryCoun;
	}
	public String getStartBatteryCapa() {
		return this.startBatteryCapa;
	}
	
	public void setStartBatteryCapa(String startBatteryCapa) {
		this.startBatteryCapa = startBatteryCapa;
	}
