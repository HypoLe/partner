...
/**
 * 类说明：网络资源--基站设备及配套--蓄电池组
 * 创建人： zhangkeqi
 * 创建时间：2012-11-27 18:49:19
 */
public class IrmsBsStorage extends EomsModel{
	...
	/**电池组所属的电源设备编码，可选项*/
	private String relatedDeivceSeq;
	...
	/**单位：只*/
	private String accumulatorGroup;
	...
	public String getRelatedDeivceSeq() {
		return this.relatedDeivceSeq;
	}
	
	public void setRelatedDeivceSeq(String relatedDeivceSeq) {
		this.relatedDeivceSeq = relatedDeivceSeq;
	}
	...
	public String getAccumulatorGroup() {
		return this.accumulatorGroup;
	}
	
	public void setAccumulatorGroup(String accumulatorGroup) {
		this.accumulatorGroup = accumulatorGroup;
	}
