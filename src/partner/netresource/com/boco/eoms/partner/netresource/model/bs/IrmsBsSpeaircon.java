...
/**
 * 类说明：网络资源--基站设备及配套--专用空调
 * 创建人： zhangkeqi
 * 创建时间：2012-11-27 18:49:19
 */
public class IrmsBsSpeaircon extends EomsModel{
	...
	/**单位：KW*/
	private String hotingVal;
		
	/**额定用电功率，单位KW*/
	private String impRatingPower;
	...
	public String getCoolingVal() {
		return this.coolingVal;
	}
	
	public void setCoolingVal(String coolingVal) {
		this.coolingVal = coolingVal;
	}
	public String getHotingVal() {
		return this.hotingVal;
	}
	
	public void setHotingVal(String hotingVal) {
		this.hotingVal = hotingVal;
	}
	public String getImpRatingPower() {
		return this.impRatingPower;
	}
	
	public void setImpRatingPower(String impRatingPower) {
		this.impRatingPower = impRatingPower;
	}
