...
/**
 * 类说明：网络资源--基站设备及配套--太阳能控制器
 * 创建人： zhangkeqi
 * 创建时间：2012-11-27 18:49:19
 */
public class IrmsBsMppt extends EomsModel{
	...
	/***/
	private String solarPanelsCount;
		
	/***/
	private String expRatingCapacit;
	...
	public String getSolarPanelsCount() {
		return this.solarPanelsCount;
	}
	
	public void setSolarPanelsCount(String solarPanelsCount) {
		this.solarPanelsCount = solarPanelsCount;
	}
	public String getExpRatingCapacit() {
		return this.expRatingCapacit;
	}
	
	public void setExpRatingCapacit(String expRatingCapacit) {
		this.expRatingCapacit = expRatingCapacit;
	}
