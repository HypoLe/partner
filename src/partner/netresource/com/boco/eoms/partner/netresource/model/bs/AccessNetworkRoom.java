 ...
 *接入网机房资源
 */
public class AccessNetworkRoom implements Serializable {
	/**主键*/
	private String id;
	/**机房名称*/
	...
	/**二期机房名*/
	private String twoAnrName;
	/**机房别名*/
	private String anotherAnrName;
	/**机房类型*/
	private String anrType;
	/**机房级别*/
	private String anrLevel;
	/**机房位置*/
	private String anrAddress;
	/**所在楼层*/
	private String foor;
	/**序号*/
	private String no;
	...
	/**集团机房归属*/
	private String  anrVested;
	/**集团是否共享*/
	private String  isShare;
	/**集团共享运营商*/
	private String  shareOperators;
	/**机房大类*/
	private String  anrCategories;
	/**机房小类*/
	private String  anrSmallClass;
	/**集团机房类型*/
	private String  groupAnrTypes;
	/**集团机房承重*/
	...
	public String getTwoAnrName() {
		return twoAnrName;
	}
	public void setTwoAnrName(String twoAnrName) {
		this.twoAnrName = twoAnrName;
	}
	public String getAnotherAnrName() {
		return anotherAnrName;
	}
	public void setAnotherAnrName(String anotherAnrName) {
		this.anotherAnrName = anotherAnrName;
	}
	public String getAnrType() {
		return anrType;
	}
	public void setAnrType(String anrType) {
		this.anrType = anrType;
	}
	public String getAnrLevel() {
		return anrLevel;
	}
	public void setAnrLevel(String anrLevel) {
		this.anrLevel = anrLevel;
	}
	public String getAnrAddress() {
		return anrAddress;
	}
	public void setAnrAddress(String anrAddress) {
		this.anrAddress = anrAddress;
	}
	...
	public String getAnrClassify() {
		return anrClassify;
	}
	public void setAnrClassify(String anrClassify) {
		this.anrClassify = anrClassify;
	}
	...
	public String getAnrVested() {
		return anrVested;
	}
	public void setAnrVested(String anrVested) {
		this.anrVested = anrVested;
	}
	...
	public String getAnrCategories() {
		return anrCategories;
	}
	public void setAnrCategories(String anrCategories) {
		this.anrCategories = anrCategories;
	}
	public String getAnrSmallClass() {
		return anrSmallClass;
	}
	public void setAnrSmallClass(String anrSmallClass) {
		this.anrSmallClass = anrSmallClass;
	}
	public String getGroupAnrTypes() {
		return groupAnrTypes;
	}
	public void setGroupAnrTypes(String groupAnrTypes) {
		this.groupAnrTypes = groupAnrTypes;
	}
