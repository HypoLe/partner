...
public class BsBtApDaoJdbcImpl extends JdbcDaoSupport implements IBsBtApDaoJdbc {
...
// TODO Auto-generated method stub
		...
		for(int i=0;i<mainList.size();i++){
			...
			st1.setString(23, pnr.getApVested());
			st1.setString(24, pnr.getIsShare());
			st1.setString(25, pnr.getShareOperators());
			st1.setString(26, pnr.getApCategories());
			st1.setString(27, pnr.getApSmallClass());
			st1.setString(28, pnr.getGroupApTypes());
