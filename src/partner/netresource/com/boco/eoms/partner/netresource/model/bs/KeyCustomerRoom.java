 ...
 * 创建时间：2015-02-03 
 */
public class KeyCustomerRoom implements Serializable{
	...
	/**集团机房归属*/
	private String  kcroomVested;
	/**集团是否共享*/
	private String  isShare;
	/**集团共享运营商*/
	private String  shareOperators;
	/**机房大类*/
	private String  kcroomCategories;
	/**机房小类*/
	private String  kcroomSmallClass;
	/**集团机房类型*/
	private String  groupKcroomTypes;
	/**集团机房承重*/
	...
	public KeyCustomerRoom() {
		
	}

	public KeyCustomerRoom(String id, String kcroomName) {
		this.id = id;
		this.kcroomName = kcroomName;
	}
	...
	public String getKcroomName() {
		return kcroomName;
	}
	public void setKcroomName(String kcroomName) {
		this.kcroomName = kcroomName;
	}
	...
	public String getKcroomAddress() {
		return kcroomAddress;
	}
	public void setKcroomAddress(String kcroomAddress) {
		this.kcroomAddress = kcroomAddress;
	}
	...
	public String getKcroomVested() {
		return kcroomVested;
	}
	public void setKcroomVested(String kcroomVested) {
		this.kcroomVested = kcroomVested;
	}
	...
	public String getKcroomCategories() {
		return kcroomCategories;
	}
	public void setKcroomCategories(String kcroomCategories) {
		this.kcroomCategories = kcroomCategories;
	}
	public String getKcroomSmallClass() {
		return kcroomSmallClass;
	}
	public void setKcroomSmallClass(String kcroomSmallClass) {
		this.kcroomSmallClass = kcroomSmallClass;
	}
	public String getGroupKcroomTypes() {
		return groupKcroomTypes;
	}
	public void setGroupKcroomTypes(String groupKcroomTypes) {
		this.groupKcroomTypes = groupKcroomTypes;
	}
