 ...
 * 
 */
public class IPnrPartnerAppOpsDeptForm extends BaseForm implements java.io.Serializable {
	...
	private int pro7;//便于后续扩展
	private int pro8;//便于后续扩展
	private int pro9;//便于后续扩展
