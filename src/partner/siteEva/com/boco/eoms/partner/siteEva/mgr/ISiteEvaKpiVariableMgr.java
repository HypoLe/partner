...
import com.boco.eoms.partner.siteEva.model.SiteEvaKpiVariable;
 ...
 * 
 */
public interface ISiteEvaKpiVariableMgr {
	 ...
	 * @return
	 */
	public SiteEvaKpi getKpiVariable(String id);
	 ...
	 *            指标
	 */
	public void saveKpiVariable(SiteEvaKpiVariable kpiVariable);
