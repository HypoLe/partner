...
public class SiteEvaOrgMgrImpl implements ISiteEvaOrgMgr {

	private ISiteEvaOrgDao orgDao;
	...
	public void saveSiteEvaOrg(SiteEvaOrg siteEvaOrg) {
		orgDao.saveSiteEvaOrg(siteEvaOrg);
	}

	public SiteEvaOrg getSiteEvaOrg(String id) {
		return orgDao.getSiteEvaOrg(id);
	}

	public void removeSiteEvaOrg(SiteEvaOrg siteEvaOrg) {
		orgDao.removeSiteEvaOrg(siteEvaOrg);
	}
