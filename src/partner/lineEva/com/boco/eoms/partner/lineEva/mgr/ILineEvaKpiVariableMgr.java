...
import com.boco.eoms.partner.lineEva.model.LineEvaKpiVariable;
 ...
 * 
 */
public interface ILineEvaKpiVariableMgr {
	 ...
	 * @return
	 */
	public LineEvaKpi getKpiVariable(String id);
	 ...
	 *            指标
	 */
	public void saveKpiVariable(LineEvaKpiVariable kpiVariable);
