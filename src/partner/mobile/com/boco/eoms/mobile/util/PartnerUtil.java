...
public class PartnerUtil {
	...
	@Test
	public void testConvertImageDataToBASE64(){
		String filePath = "E:\\work\\project\\DEV\\partner_qg\\eoms_qg\\partner\\web\\partnerfile\\LEE_TEST.png";
		try {
			System.out.println(convertImageDataToBASE64(filePath));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
