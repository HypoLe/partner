...
public final class InspectPlanExecuteAction extends BaseAction {
	...
	public void getTypeAndLevel(ActionMapping mapping, ActionForm form,HttpServletRequest request,
		...
		String[][] type = {{"请选择","基站","接入网","直放站室分","WLAN","铁塔及天馈","重点客户机房","光缆网-光交接箱","光缆网-电杆","光缆网-人井","接入机房"},{"","112250103","112250502","112250302","112250601","112250404","112250901","112251201","112251202","112251203","112251301"}};
		
		String[][][] level ={{{"请选择 "},{""}},{{"VIP基站","A类","B类","C类"},{"11225010301","11225010302","11225010303","11225010304"}},{{"A类","B类","C类"},{"11225050201","11225050202","11225050203"}},{{"标准","VIP","A类","B类"},{"11225030201","11225030202","11225030203","11225030204"}},{{"A类","B类","C类"},{"11225060101","11225060102","11225060103"}},{{"铁塔","季度","铁塔天馈"},{"11225040401","11225040402","11225040403"}},{{"VIP","A类","B类","C类"},{"11225090101","11225090102","11225090103","11225090104"}},{{"VIP","A类","B类","C类"},{"11225120101","11225120102","11225120103","11225120104"}},{{"VIP","A类","B类","C类"},{"11225120201","11225120202","11225120203","11225120204"}},{{"VIP","A类","B类","C类"},{"11225120301","11225120302","11225120303","11225120304"}},{{"VIP","A类","B类","C类"},{"11225130101","11225130102","11225130103","11225130104"}}};
...
//		String netResId="a08180804019231801401928ef550009";
	...
	public void getCheckInfo(ActionMapping mapping, ActionForm form,HttpServletRequest request,
		...
		if(!"".equals(StaticMethod.nullObject2String(request.getParameter("resType")))){
			...
			Search search = new Search();
			String temp=request.getParameter("resType");
...
//		System.out.println("fileString    "+fileString);
	...
	throws Exception {
		...
		whereStr += " and specialty != '1122511'";//排除资源清查
