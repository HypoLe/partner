 ...
 * @author:     Liuchang 
 * @version:    1.0 
 * Create at:   Aug 1, 2012 3:50:38 PM 
 */
public interface IInspectPlanStatisticMgr {
	/**
	 * 统计当前月地市巡检情况
	 * @return
	 */
	 ...
	 */
	public void saveStatisticCityPartnerData(List<Map<String,String>> partnerList,String year,
			String month,String parentPartnerId);
	/**
	 * 采集所有区县公司巡检数据
	 * @param partnerList
	 * @param year
	 ...
	 * @param parentPartnerId
	 */
	public void saveStatisticCountryPartnerData(List<Map<String,String>> partnerList,
