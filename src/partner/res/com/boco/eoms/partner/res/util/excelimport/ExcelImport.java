package com.boco.eoms.partner.res.util.excelimport;
...
public class ExcelImport {
	 ...
	 * @throws Exception
	 */
	public ImportResult importFromFile(FormFile formFile,DataSaveCallback callBack) throws Exception{
...
//			result.setRestultMsg("导入错误:错误行数是:"+msg + (point + 1));
	 ...
	 * @throws Exception
	 */
	public ImportResult importFromFile(File file,DataSaveCallback callBack) throws Exception{
		int count = 0;
		int point = 0;
		ImportResult result = new ImportResult();
		try {
