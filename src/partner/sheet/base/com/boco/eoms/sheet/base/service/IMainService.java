...
public interface IMainService {
	...
	public abstract Map getHolds(final Map condition,final Integer curPage, final Integer pageSize)
	 ...
	 * @throws SheetException
	 */
	public abstract String getSheetId(String workType) throws SheetException;
	 ...
	 * 取隐藏工单列表
	 * 
	 * @param condition 保存main、link、task对象
	 * @param curPage 当前页
	 * @param pageSize 一页显示条数
	 * @return
	 * @throws SheetException
