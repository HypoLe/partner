...
public class HibernateConfigurationHelper {
	...
	public static String getColumnNameByProperName(Class clazz,String properName) {
		PersistentClass persistentClass = getPersistentClass(clazz);
		  Property property = persistentClass.getProperty(properName);
	...
	public static String getPkColumnNameByProperName(Class clazz) {
		PersistentClass persistentClass = getPersistentClass(clazz);
