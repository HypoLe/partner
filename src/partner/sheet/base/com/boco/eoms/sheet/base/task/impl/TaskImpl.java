...
public class TaskImpl implements ITask {
	...
	public String getNeedDealReply() {
		return needDealReply;
	}

	public void setNeedDealReply(String needDealReply) {
		this.needDealReply = needDealReply;
	}
