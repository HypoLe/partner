 ...
 * 
 */
public class PnrTempTaskAudit extends BaseObject {
	...
	public boolean equals(Object o) {
		if( o instanceof PnrTempTaskAudit ) {
			PnrTempTaskAudit pnrTempTaskAudit=(PnrTempTaskAudit)o;
			if (this.id != null || this.id.equals(pnrTempTaskAudit.getId())) {
				return true;
			} else {
				return false;
			}
