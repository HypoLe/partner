/**
 * LoadingRequestSoapBindingSkeleton.java
 *
...
public class LoadingRequestSoapBindingSkeleton implements com.boco.eoms.partner.interfaces.services.LoadingRequest.LoadingRequestPortType, org.apache.axis.wsdl.Skeleton {
    private com.boco.eoms.partner.interfaces.services.LoadingRequest.LoadingRequestPortType impl;
    ...
    */
    ...
    static {
        ...
        _params = new org.apache.axis.description.ParameterDesc [] {
            ...
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "FeedbackUri"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false), 
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "LoadingFlag"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false), 
            ...
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "LineSeparator"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false), 
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "FieldSeparator"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false), 
        ...
        _oper = new org.apache.axis.description.OperationDesc("loadingRequestRequest", _params, null);
        _oper.setElementQName(new javax.xml.namespace.QName("http://ws.apache.org/axis2/services/LoadingRequest/types", "LoadingRequestRequest"));
        _oper.setSoapAction("LoadingRequest#LoadingRequestRequest");
        _myOperationsList.add(_oper);
        if (_myOperations.get("loadingRequestRequest") == null) {
            _myOperations.put("loadingRequestRequest", new java.util.ArrayList());
        }
        ((java.util.List)_myOperations.get("loadingRequestRequest")).add(_oper);
    }

    public LoadingRequestSoapBindingSkeleton() {
        this.impl = new com.boco.eoms.partner.interfaces.services.LoadingRequest.LoadingRequestSoapBindingImpl();
    }

    public LoadingRequestSoapBindingSkeleton(com.boco.eoms.partner.interfaces.services.LoadingRequest.LoadingRequestPortType impl) {
        this.impl = impl;
    }
    ...
    {
        impl.loadingRequestRequest(eventID, systemID, sendTime, feedbackUri, loadingFlag, workMode, fileFormat, charSet, lineSeparator, fieldSeparator, fieldNameList, xmlSchema, dataInfo);
    }
