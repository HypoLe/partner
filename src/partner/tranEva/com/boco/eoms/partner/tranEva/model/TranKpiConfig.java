 ...
 * 
 */
public class TranKpiConfig extends BaseObject {
	...
	public boolean equals(Object o) {
		if( o instanceof TranKpiConfig ) {
			TranKpiConfig tranKpiConfig=(TranKpiConfig)o;
			if (this.id != null || this.id.equals(tranKpiConfig.getId())) {
				return true;
			} else {
				return false;
			}
