 ...
 */
public class PnrRentBillsCount {
	...
	/**一年以付费用总和*/
	private double paidTotalBills;
	
	/**一年未付费用总和*/
	private double unpaidTotalBills;
	...
	public double getPaidTotalBills() {
		return paidTotalBills;
	}

	public void setPaidTotalBills(double paidTotalBills) {
		this.paidTotalBills = paidTotalBills;
	}

	public double getUnpaidTotalBills() {
		return unpaidTotalBills;
	}

	public void setUnpaidTotalBills(double unpaidTotalBills) {
		this.unpaidTotalBills = unpaidTotalBills;
	}
