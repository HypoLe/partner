 ...
 * 
 */
public class PnrBaseSiteForm extends BaseForm implements java.io.Serializable {
	...
	public String getAddTime(){
		if(addTime!=null&&!addTime.equals("")){
			addTime = StaticMethod.getCurrentDateTime(addTime, "yyyy-MM-dd HH:mm:ss");
		}
		return this.addTime;
	}
	...
	public String getUpdateTime(){
		if(updateTime!=null&&!updateTime.equals("")){
			updateTime = StaticMethod.getCurrentDateTime(updateTime, "yyyy-MM-dd HH:mm:ss");
		}
	...
	public String getDelTime(){
		if(delTime!=null&&!delTime.equals("")){
			delTime = StaticMethod.getCurrentDateTime(delTime, "yyyy-MM-dd HH:mm:ss");
		}
		return this.delTime;
	}
	...
	public String getProductDate(){
		if(productDate!=null&&!productDate.equals("")){
			productDate = StaticMethod.getCurrentDateTime(productDate, "yyyy-MM-dd HH:mm:ss");
		}
	...
	public String getSetDate(){
		if(setDate!=null&&!setDate.equals("")){
			setDate = StaticMethod.getCurrentDateTime(setDate, "yyyy-MM-dd HH:mm:ss");
		}
		return this.setDate;
	}
