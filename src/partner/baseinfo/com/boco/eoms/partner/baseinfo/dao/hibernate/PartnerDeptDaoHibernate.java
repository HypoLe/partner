 ...
 * 
 */
public class PartnerDeptDaoHibernate extends BaseDaoHibernate implements
		PartnerDeptDao, ID2NameDAO, Name2IDDao {
	 ...
	 */
	public List<PartnerDept> getPartnerDeptsByHql(final String hql) {
		HibernateCallback callback = new HibernateCallback() {
			public Object doInHibernate(Session session)
					throws HibernateException {
	...
	public List<PartnerDept> getCompanyByProvience(String id,
		...
		return (List<PartnerDept>) getHibernateTemplate().find(_strHQL);
	}
...
//		String magId = dept.getDeptMagId();
		String hql = "";
		String baseSql = "from PartnerDept partnerDept where  ";
...
//					}
	...
	*@throws
	...
	public List getNextLevecCompByAreaid(String parentdeptid, String delid,String areaId,int isPartner) {
		List list=null;
		String hql="";
		String baseSql = "from PartnerDept partnerDept where  partnerDept.interfaceHeadId ";
		...
		if ("-1".equals(parentdeptid)) {
			...
			PartnerDept dept=this.getPartnerDept(parentdeptid);
