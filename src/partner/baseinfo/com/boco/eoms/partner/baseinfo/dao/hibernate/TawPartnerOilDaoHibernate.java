...
public class TawPartnerOilDaoHibernate extends BaseDaoHibernate implements TawPartnerOilDao,
	...
	public List getTawPartnerOils() {
		...
		HibernateCallback callback = new HibernateCallback() {
			public Object doInHibernate(Session session)
				...
				String queryStr = "from TawPartnerOil tawPartnerOil where tawPartnerOil.deleted <> '1'";
	...
	public Map getTawPartnerOils(final Integer curPage, final Integer pageSize,
		...
		HibernateCallback callback = new HibernateCallback() {
			public Object doInHibernate(Session session)
					throws HibernateException {
				String queryStr = "from TawPartnerOil tawPartnerOil where deleted <> '1' ";
	...
	/**
	 * id:EOMS-liujinlong-20090921110714
	 * 开发人邮箱：liujinlong@boco.com.cn
	 * 时间：2009-09-21
	 * 开发目的：将删除改为设置删除字段置deleted为1
	 * 参数deptID：地域部门树中的合作伙伴节点ID
	 */
	public void removeTawPartnerOilByDeptID(final String deptID){
    	final String hql = "update TawPartnerOil tawPartnerOil set deleted = '1' where tawPartnerOil.dept_id = '"
			+ deptID + "'";
	HibernateCallback callback = new HibernateCallback() {
		public Object doInHibernate(Session session)
				throws HibernateException {
