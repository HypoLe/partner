...
public class TawApparatusDaoHibernate extends BaseDaoHibernate implements TawApparatusDao,
	...
	public List getTawApparatuss() {
		...
		HibernateCallback callback = new HibernateCallback() {
			public Object doInHibernate(Session session)
				...
				String queryStr = "from TawApparatus tawApparatus where tawApparatus.deleted <> '1'";
	...
	public Map getTawApparatuss(final Integer curPage, final Integer pageSize,
		...
		HibernateCallback callback = new HibernateCallback() {
			public Object doInHibernate(Session session)
					throws HibernateException {
				String queryStr = "from TawApparatus tawApparatus where deleted <> '1' ";
	...
	public void removeTawApparatusByDeptID(final String deptID){
    	final String hql = "update TawApparatus tawApparatus set deleted = '1' where tawApparatus.dept_id = '"
			+ deptID + "'";
	HibernateCallback callback = new HibernateCallback() {
		public Object doInHibernate(Session session)
				throws HibernateException {
