 ...
 */
 public interface PartnerDeptMgr {
	...
	public Map getPartnerDeptsByDeptLevel(final Integer curPage, final Integer pageSize,
			PartnerDept dept,String deptid,String hasRight,String deptLevel);
	...
	public PartnerDept updateStatisticInfo(PartnerDept partnerDept) throws Exception;
	/**
	 * 
	...
	* @throws
	...
	public Map getPartnerDeptsByAreaidOrDeptid(final Integer curPage, final Integer pageSize,String areaid,
			String deptid,PartnerDept dept,String deptLevel, String interfaceHeadId,int isPartner);
	/**
	 * 
	...
	* @throws
	 */
	public List<PartnerDept> getPartnerDeptsByUserRight(HttpServletRequest request) throws Exception;
	/**
	 * 
	...
	* @throws
	 */
	public  boolean saveDeptAndRelatedQualification(PartnerDept dept,List<PnrQualification> list,String level) throws Exception;
	/**
	 * 
	...
	*@throws
	 ...
	 *@throws Exception
	 */
	public void updateDeptAndUser(String oldDeptName,HttpServletRequest request,PartnerDept partnerDept,List qualifyList,String deptLevel) throws Exception;
}