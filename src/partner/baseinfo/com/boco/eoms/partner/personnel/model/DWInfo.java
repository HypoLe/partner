...
public class DWInfo extends BaseObject {
	/**
	 * 主键
	 */
	 private String id;
	...
	public boolean equals(Object o) {
		if ( o instanceof DWInfo) {
			try {
				if(((DWInfo)o).id.equals(this.id))
					return true;
			} catch (Exception e) {
				return false;
			}
	...
	public int getJuniorSkillLevel() {
		return juniorSkillLevel;
	}
	public void setJuniorSkillLevel(int juniorSkillLevel) {
		this.juniorSkillLevel = juniorSkillLevel;
	}
	public int getMiddleSkillLevel() {
		return middleSkillLevel;
	}
	public void setMiddleSkillLevel(int middleSkillLevel) {
		this.middleSkillLevel = middleSkillLevel;
	}
	public int getAdvancedSkillLevel() {
		return advancedSkillLevel;
	}
	public void setAdvancedSkillLevel(int advancedSkillLevel) {
		this.advancedSkillLevel = advancedSkillLevel;
	}
