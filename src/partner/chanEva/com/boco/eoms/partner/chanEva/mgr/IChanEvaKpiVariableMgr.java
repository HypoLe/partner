...
import com.boco.eoms.partner.chanEva.model.ChanEvaKpiVariable;
 ...
 * 
 */
public interface IChanEvaKpiVariableMgr {
	 ...
	 * @return
	 */
	public ChanEvaKpi getKpiVariable(String id);
	 ...
	 *            指标
	 */
	public void saveKpiVariable(ChanEvaKpiVariable kpiVariable);
