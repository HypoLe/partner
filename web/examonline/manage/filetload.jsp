...
<%
  ...
  String    equipIdSel=StaticMethod.null2String(request.getParameter("equipIdSel"));
  String issueType=StaticMethod.null2String(request.getParameter("issueType"));
   ...
   try {
       tip2 = studyOnlineBO.importwordWarehouse( fileName ,Integer.parseInt(specialtySel),Integer.parseInt(manufacturerSel),Integer.parseInt(equipIdSel),Integer.parseInt(issueType),userName );
       tip = "提示";
   } catch (Exception ex) {
       ex.printStackTrace();
