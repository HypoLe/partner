	 ...
	 Ext.onReady(function(){
	 	var tabConfig = {
			items : [{
				...
				text : '网络部',
				url : '<%=basePath%>examonline/getAdminExamList.do?examType=net',
				isIframe : true
			}, {
				text : '地市级',
				url : '<%=basePath%>examonline/getAdminExamList.do?examType=city',
				isIframe : true
			}, {
				text : '统计',
				url : '<%=basePath%>examonline/getAdminSelectExamList.do?firstTime=true',
				isIframe : true
			}]
		};
	  ...
	  <div id="sheet-detail-page">
		<div id="proGrid" class="tabContent">
			<iframe id="history" width="100%" height="520" frameborder="no" border="0" framespacing="0"
				name="history" src="<%=basePath%>examonline/getAdminExamList.do?examType=prov">
			</iframe>
		</div>
