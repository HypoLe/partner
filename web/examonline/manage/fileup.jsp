...
<%!
  private static final String ERR_MSG = "<strong>上传文件失败，可能是由于以下原因：</strong>"+
  										   ...
  										   "<div align='left'> 3. 您的文件格式不对。系统允许的文件格式为excel。</div>"+
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#ffffff" onload="location.replace('filetodb.jsp?fileName=<%=fileName%>')">
