  ...
  for (i=0;i < onecount; i++){
	...
	userViewer = new Ext.JsonView("user-list",	
		...
		userTree = new xbox({
			...
			viewer:userViewer,saveChkFldId:'deptid',callback:ifcheck
		});
	})
	function ifcheck(){
...
//-->
Ext.onReady(function(){
	var	treeActions='${app}/xtree.do?method=dept';
	
	//创建xbox对象
	var config = {
		btnId:'usert',
		treeDataUrl:treeActions,treeRootId:'-1',treeRootText:'部门树',treeChkType:'dept',
  ...
  <table border="0"  width="600" class="formTable">
    ...
    <tr>
      ...
      <td width="500" colspan="5">
        <select size=1 name="systype" class="select" onChange="changelocation(document.tawwpquerymonthplan.systype.options[document.tawwpquerymonthplan.systype.selectedIndex].value)">
    ...
    <tr>
      ...
      <tr>
	      ...
	      <td width="500" colspan="5">
	        <input type="button" name="usert" id="usert" value="选择" class="btn"/> 
	        <input type ="text" name="name" id = "showd2">
      ...
      <td width="500" colspan="5">
        ...
        <input type="button" value="<bean:message key="queryyearplan.title.formSelectDept" />" id="userTreeBtn" class="btn"/>
...
<%--<tr id ="flag" style="display:none">
	 <td width="100" class="label" >
      ...
      <td width="300" colspan="5" class="select">
    ...
    <tr id="flag" style="display:none">
      ...
      <td width="500" colspan="5">
        <input type=radio name='flag' value='0' checked >是
    ...
    <tr>
      ...
      <td width="500" colspan="5">
        ...
        <input type="button" value="<bean:message key="querymonthplan.title.formSelectNet"/>" name="B1" class="button" Onclick="javascript:onNet();">
      </td>
    </tr>
