...
<%String yearFlag = StaticMethod.null2String((String) request
					.getAttribute("yearflag"));
			String monthFlag = StaticMethod.null2String((String) request
					.getAttribute("monthflag"));
			String type = StaticMethod.null2String((String) request
					.getAttribute("type"));
			String systype = StaticMethod.null2String((String) request
					.getAttribute("systype"));
			String nettype = StaticMethod.null2String((String) request
					.getAttribute("nettype"));
			String netlist = StaticMethod.null2String((String) request
...
<script language='javascript'>
 ...
 {document.statyear.submit();}
  ...
  function down()
{
  location.href="downexcel.do?type=<%=type%>&yearflag=<%=yearFlag%>&monthflag=<%=monthFlag%>&systype=<%=systype%>&nettype=<%=nettype%>&netlist=<%=netlist%>";
}
 </script>
...
<br>
<input type="button" class="button" value="导出" onclick="javascript:down();">
