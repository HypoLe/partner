...
<%@ page import ="com.boco.eoms.base.util.StaticMethod"%>
 <%
      ...
      String  systype = StaticMethod.null2String((String)request.getAttribute("systype")); 
      String  nettype = StaticMethod.null2String((String)request.getAttribute("nettype")); 
      String  netlist = StaticMethod.null2String((String)request.getAttribute("netlist")); 
  ...
  function down()
{
 ...
 <tr >
 <td rowspan='2' style="{background-color:#EDF5FD;}">网元</td><td rowspan='2'style="{background-color:#EDF5FD;}">作业计划</td>
