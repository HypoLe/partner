...
<%@ page import ="com.boco.eoms.base.util.StaticMethod"%>
 ...
 <%
      ...
      String  deptid = StaticMethod.null2String((String)request.getAttribute("deptid")); 
      String  userid = StaticMethod.null2String((String)request.getAttribute("userid")); 
 ...
 {document.statyear.submit();}
  ...
  function down()
{
  location.href="downexcel.do?type=<%=type%>&yearflag=<%=yearFlag%>&monthflag=<%=monthFlag%>&deptid=<%=deptid%>&userid=<%=userid%>";
}
 </script>
 ...
 <td rowspan='2' style="{background-color:#EDF5FD;}">执行人</td><td rowspan='2'style="{background-color:#EDF5FD;}">作业计划</td>
