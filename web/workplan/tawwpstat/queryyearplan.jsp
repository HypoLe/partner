  ...
  <table class="formTable">
    ...
    <tr>
      ...
      <td width="500" colspan="5">
        <select size=1 name="systype" class="select" onChange="changelocation(document.tawwpqueryyearplan.systype.options[document.tawwpqueryyearplan.systype.selectedIndex].value)">
    ...
    <tr>
      ...
      <td width="500" colspan="5">
        ...
        <input type="button" value="<bean:message key="queryyearplan.title.formSelectModel" />" name="B1" class="button" Onclick="javascript:onModel();">
    ...
    <tr>
      ...
      <td width="500" colspan="5">
        ...
        <div id="user-list" class="viewer-list"></div><input type="button" value="<bean:message key="queryyearplan.title.formSelectDept" />" id="userTreeBtn" class="btn"/>
