...
<table class="formTable">
  ...
  <%
     TawwpExecuteCheck tawwpExecuteCheck=new TawwpExecuteCheck();
  	 if(request.getAttribute("tawwpExecuteCheck")!=null){
  	 	tawwpExecuteCheck=(TawwpExecuteCheck)request.getAttribute("tawwpExecuteCheck");
  	 }
  
  %> 
  <form name="executeCheckForm" action="../tawwpexecute/checkAdd.do" method="post">
  <!--  tr>
    <td width="100" class="label">
     检查人:
    </td>
    ...
    <td width="310">
       <input type="hidden" name="executeId" value=" //tawwpExecuteContentVO.getId() 
       <input type="hidden" name="id" value=" //StaticMethod.null2String(tawwpExecuteCheck.getId())  
    	 //StaticMethod.null2String(tawwpExecuteCheck.getChecker()) 
     </td>
  </tr>
  ...
  <tr>
    ...
    <td width="310">
       <textarea name="checkContent" class="textarea max"  > StaticMethod.null2String(tawwpExecuteCheck.getCheckContent(),"") </textarea>
  ...
  <!-- 
    ...
    <td width="310">
        StaticMethod.null2String(tawwpExecuteCheck.getCheckTime()) 
    </td>
  </tr>
   -->
</table>
...
<!-- input type="submit" value="提交检查"   class="button" -->
<!--  body end  -->
