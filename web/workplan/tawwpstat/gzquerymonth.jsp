...
function changelocation(locationid){
  ...
  for (i=0;i < onecount; i++){
	...
	function ifcheck(){
		document.getElementById("isNext").style.display = "";
	}
//-->
...
<form name="tawwpquerymonthplan" method="post" action="gzlistmonthplan.do" onsubmit='return SubmitCheck()'>
  ...
  <tr id="isNext" style="display:none">
      <td width="100" class="label">
        是否关联子部门
      </td>
      <td width="500" colspan="6">
        <input type=radio name='isNext' value='1' checked >是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name='isNext' value='0'>否
      </td>
    </tr>
    <tr>
      <td width="100" class="label">
      ...
      <%--<td width="300">
      <input type="radio" name="type" value="week" onclick="javascript:show();"><bean:message key="gzquerymonth.title.formWeekly" />
      <input type="radio" name="type" value="month" onclick="javascript:hidden();" checked="checked"><bean:message key="gzquerymonth.title.formMonthly" />
     </td>
    --%></tr>
