...
<table width="100%" class="listTable" id="list-table" >
 ...
 %>
   <tr>
     ...
     <td><%=tawwpYearPlanVO.getDeptName()%></td>
...
<br>
<input type="button" value="<bean:message key="listyearplan.title.btnBack" />" onclick="javascript:window.history.back();" class="button">
