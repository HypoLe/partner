...
<%@ page import ="com.boco.eoms.base.util.StaticMethod"%>
 <%
      ...
      String  roomid = StaticMethod.null2String((String)request.getAttribute("roomid")); 
 ...
 {document.statyear.submit();}
  ...
  function down()
{
  location.href="downexcel.do?type=<%=type%>&yearflag=<%=yearFlag%>&monthflag=<%=monthFlag%>&roomid=<%=roomid%>";
}
 </script>
 ...
 <tr >
 <td rowspan='2' style="{background-color:#EDF5FD;}">机房</td><td rowspan='2'style="{background-color:#EDF5FD;}">作业计划</td>
