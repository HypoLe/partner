...
function SubmitCheck(){
  ...
  if(frmReg.roomid.value == '0'){
   ...
   if(frmReg.vendorsel.value == ''&& !JustifyNull1(frmReg.vendor)){
    alert("请选择或者填写生产厂商");
    return false;
  }
...
<table width="500" class="formTable">
  ...
  <tr>
    ...
    <td width="400">
     <eoms:comboBox name="systype" id="a1" sub="a2" initDicId="50"/><%--
  ...
  <tr>
    ...
    <td width="400">
      <eoms:comboBox name="nettype" id="a2" sub="a3" styleClass="border" />
  ...
  <tr>
    ...
    <td width="400">
     <eoms:comboBox name="mynettype" id="a3"/>
