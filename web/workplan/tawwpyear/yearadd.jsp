...
function SubmitCheck(){
  ...
  if(frmReg.content.value.length>50)
  {
    alert("作业计划内容不能超过50个字符！");
    frmReg.content.focus();
    return false;
  }
  if(frmReg.remark.value.length>100)
  {
    alert("备注不能超过100个字符！");
    frmReg.remark.focus();
    return false;
...
<form name="tawwpyearaddform" method="post" action="../tawwpyear/yearsave.do" onsubmit='return SubmitCheck()'>
  ...
  <table class="formTable">
    ...
    <tr>
      ...
      <td width="400">
        <select size=1 name="systype" class="select" onChange="changelocation(document.tawwpyearaddform.systype.options[document.tawwpyearaddform.systype.selectedIndex].value)">
    ...
    <tr>
      ...
      <td width="500">
        ...
        <input type="button" value="<bean:message key="yearadd.title.btnModelList" />" name="B1" class="button" Onclick="javascript:onTitle();">
      ...
      <td  >
        <input type="text" name="command" size="40" class="text">
      </td>
    </tr>
    <tr>
      <td width="100" class="label">
...
%>
    ...
    <tr>
      <td width="100" class="label">
        <bean:message key="yearadd.title.formContent" />
      </td>
      <td width="500">
    ...
    <tr>
      <td width="100" class="label">
        <bean:message key="yearadd.title.formRemark" />
      </td>
      <td width="500">
...
<input type="button" value="<bean:message key="yearadd.title.btnBack" />" onclick="javascript:window.history.back();" class="button">
