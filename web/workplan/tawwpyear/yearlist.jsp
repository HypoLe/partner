...
<form name="yearplanform">
  <input type="hidden" name="yearplanid">
          ...
          <table width="100%" class="listTable" id="list">
            ...
            <thead>
            <tr>
              <td onclick="sort('list',0,'char')"><span style="cursor: hand"><bean:message key="yearlist.title.formPlanName" /></span></td>
              <td onclick="sort('list',1,'char')"><span style="cursor: hand"><bean:message key="yearlist.title.formSystem" /></span></td>
              <td onclick="sort('list',2,'char')"><span style="cursor: hand"><bean:message key="yearlist.title.formNetType" /></span></td>
              <td onclick="sort('list',3,'char')"><span style="cursor: hand"><bean:message key="yearlist.title.formCreateTime" /></span></td>
              <td onclick="sort('list',4,'char')"><span style="cursor: hand"><bean:message key="yearlist.title.formCreater" /></span></td>
              <td onclick="sort('list',5,'char')"><span style="cursor: hand"><bean:message key="yearlist.title.formState" /></span></td>
