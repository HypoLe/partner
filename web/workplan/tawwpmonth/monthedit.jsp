...
<form name="tawwpmonthplanform" method="post" action="../tawwpmonth/monthmodify.do?monthplanid=<%=tawwpMonthPlanVO.getId()%>" onsubmit='return SubmitCheck()'>
...
<table class="formTable">
 ...
 <br>
      ...
      <input type="button" value="<bean:message key="monthedit.title.btnBack" />" name="B1" class="button" onclick="javascript:GoBack();">
