...
Ext.onReady(function(){
	...
	var config = {
		btnId:'usert',
		treeDataUrl:treeAction,treeRootId:'-1',treeRootText:'部门树',treeChkType:'dept',
...
<form name="dailyexecuteplan" >
  ...
  <table class="listTable" id="list"  >
    ...
    <tr>
      <td width="14%">
      选择<input type="checkbox" name="selectAll" value="" onclick='checkAll()' id="selectAll" />  
      </td>
      <td width="14%">
      执行内容名称
      </td>
 ...
 <%
    ...
    %>
	      ...
	      <input type="button" name="usert" id="usert" value="请选择人员" class="btn" style="display:none"/>
	        <textarea id="showd2" class="textarea" style="display:none"></textarea>
  			<input type="hidden" name="saved2" id="saved2"/>   
  			<input type="hidden" name="executer" id="executer"/> 
  			<input type="hidden" name="executeType" id="executeType"/>   
    <tr>
