...
<%@ include file="/common/header_eoms_ext.jsp"%>
  ...
  var config = {
	...
	onClick:{url:"${app}/workplan/tawwpmonth/monthlists.do?flag=1&Mtype=",text:"本月计划列表"},
    //onClick:{url:"${app}/workplan/tawwpmonth/monthlists.do?yearid=2009&monthid=5&type=",text:"本月计划列表"},
	//ctxMenu:[
		//{id:'Changenet', text:'修改网元',cls:'new-mi',url:'${app}/workplan/tawwpmonth/monthlists.do?flag=1&Mtype='}
	//],
