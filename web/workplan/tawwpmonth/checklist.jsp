...
<form name="monthplan" action="${app}/workplan/tawwpmonth/checklistpass.do" method="post">
  ...
  <table width="700" class="listTable" id="list-table">
    ...
    <tr>
      ...
      <td width="10%">
        <!--a href="../tawwpmonth/checkviews.do?monthcheckid=<%=tawwpMonthPlanVO.getMonthCheckId()%>&monthplanid=<%=tawwpMonthPlanVO.getId()%>"-->
         <a href="../tawwpmonth/checkviews.do?yearPlanId=<%=tawwpMonthPlanVO.getYearPlanId()%>">
    ...
    <tr>
      <td colspan="7">
        <input type="submit" name="b1" value="批量通过"  Class="button">
      </td>
    </tr>
    </tbody>
  </table>
