...
<%   
  ...
  String commondId = StaticMethod.null2String(tawwpExecuteContentVO.getCommand());
...
function submitform()
{
  document.forms[0].action = "../tawwpexecute/executeinterfacesave.do?monthplanid=<%=monthPlanId%>&commondId=<%=commondId%>";
...
<form name="executecontentform" method="POST" action="../tawwpexecute/executeeditsavenew.do?monthplanid=<%=monthPlanId%>">
<!--  body begin  -->
<br>
...
%>
  ...
  <tr>
    ...
    <td width="310">
      <INPUT type="textoggleDatePickert" size="20" name="crtime" readonly value="<%=tawwpExecuteContentVO.getCrtime()%>">
    </td>
  </tr>
  <tr>
    ...
    <td width="310">
      <input type="text" name="writeDate" size="20" onclick="popUpCalendar(this, this);" readonly="readonly" class="text" value="<%=writeDate %>">
    </td>
  </tr>
  <tr>
    <td class="label">
  ...
  <tr>
    ...
    <td width="310">
      <textarea name="remark" rows="5" cols="40" class="textarea"><%=tawwpExecuteContentVO.getRemark()%></textarea>
    </td>
  </tr>
  <tr>
    <td class="label">
  ...
  <tr>
    ...
    <td width="310">
      ...
      <input type="button" class="button" name="count" onclick="javascript:onFile(filename,count,executecontentid,executecontentuserid,cruser,stubuser,'showLink');" value="<%=tawwpExecuteContentVO.getFileCount()%>"><bean:message key="executeedit.title.labFile" />
    </td>
  </tr>
   <tr>
    <td width="100" class="label">
  ...
  <tr>
    ...
    <td width="310">
        <textarea name="reason"  rows=3 cols="45" class="textarea"><%=tawwpExecuteContentVO.getReason()%></textarea>
    </td>
  </tr>
 <%}%>
  <tr>
...
%>
<INPUT type="button" value="<bean:message key="executeedit.title.btnBack" />"  name=b2 Onclick="GoBack();"  class="button">
