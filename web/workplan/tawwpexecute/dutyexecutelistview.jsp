...
<%
    ...
    int day =StaticMethod.null2int((String)request.getAttribute("day"));     
...
function changeDateSubmit(){
  ...
  tawwpexecutelistviewform.action='../tawwpexecute/dutyexecutelistview.do?year='+year+'&month='+month;
  tawwpexecutelistviewform.submit(); 
}

function onExecuteAdd( _executeContentId, _monthPlanId, _userByStub){
  location.href="../tawwpexecute/dutyexecuteadd.do?executecontentid=" + _executeContentId + "&monthplanid=" + _monthPlanId + "&userbystub=" + _userByStub;
}

function onExecuteEdit(_executeContentId, _monthPlanId, _userByStub, _executeType){
  location.href="../tawwpexecute/dutyexecuteedit.do?executecontentid=" + _executeContentId + "&monthplanid=" + _monthPlanId + "&executetype=" + _executeType + "&userbystub=" + _userByStub;
}
...
<table class="formTable large">
  <thead>	
    <tr>
      ...
      %>
      <td>
        <a href="../tawwpexecute/dutyexecutelistadds.do"><%=i%></a>
      </td>
      <%
      }else{
      %>
  ...
  <tr class="complete">
    ...
    %>
    <td> <img src="${app }/images/icons/nodetype/empty.gif">   </td>
    <%
            }else{
