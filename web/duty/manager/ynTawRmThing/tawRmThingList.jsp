...
<display:table name="tawRmArticleList" cellspacing="0" cellpadding="0"
   ...
   <display:column property="loanNum"  titleKey="tawRmArticleForm.loanNum"/>
    ...
    <html:link href='${app}/duty/tawRmArticle.do?method=xdetail'paramId="id" paramProperty="id" paramName="tawRmArticleList" target="_blank">
    <fmt:message key="tawRmArticleForm.search" />
    </html:link>
    </display:column>
   
   <display:column   titleKey="tawRmArticleForm.loan">
    <html:link href='${app}/duty/tawRmArticle.do?method=xloan 'paramId="id" paramProperty="id" paramName="tawRmArticleList">
    <fmt:message key="tawRmArticleForm.loan" />
    </html:link>
    </display:column>
   
   <display:column  titleKey="tawRmArticleForm.change">
				<html:link href="${app}/duty/tawRmArticle.do?method=xchange"  paramId="id"  paramProperty="id" paramName="tawRmArticleList">
