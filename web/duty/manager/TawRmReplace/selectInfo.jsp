 ...
 function checkform(){
   ...
   if(lengthfrom==0){
    ...
    var form = document.forms[0];
      form.workapplyfrom.value = "";
      for (var i = 0; i < form.elements.length; i++){
        var obj = form.elements[i];
        if ( obj.name != 'chkall'  && obj.type=='checkbox')
          if ( obj.checked )
            form.workapplyfrom.value = form.workapplyfrom.value + "@" + obj.name;
      }
      return true;
	}
...
<form method="post" action="${app}/duty/tawRmReplace.do?method=xsave">
...
<td>
	...
	<td width="45%" valign = "top">
		...
		<tr class="tr_show">
		<td>
		<input  type="checkbox" name="<%="from,"+String.valueOf(getWorkserial_from.elementAt(i))+","+String.valueOf(getDutyman_from.elementAt(i))+","+String.valueOf(getStarttime_from.elementAt(i))%>" 	value="<%=String.valueOf(getStarttime_from.elementAt(i))%>" onclick="javascript:add_from(this)";>
		 </td>
		<td>
...
<tr align="center" valign="middle">
	      ...
	      <table cellpadding="0" cellspacing="0" border="0" width="700" class="listTable">
            ...
            <%if (getWorkserial_from.size()>0){%>
            <tr>
              <td class="label" width="25%"><bean:message key="TawRmChangeduty.applyreson"/>
                </td>
              <td width="75%">
              ...
              <tr>
             <td class="label" width="25%">  ${eoms:a2u('备注')}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
             </td>
               <td width="75%">
            ...
            <tr>
              <td height="32" align="left"  colspan=3> <input type="submit"  class="submit" onclick="return checkform();" value="<bean:message key="TawRmChangeduty.apply"/>">
                 </td>
