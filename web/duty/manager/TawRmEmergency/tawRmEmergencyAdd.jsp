...
<html:form action="/tawRmEmergency.do?method=save" method="post" styleId="tawRmEmergencyForm">
	...
	<table border=0 cellspacing="1" cellpadding="1" class="listTable">
		...
		<tr>
			...
			<td>
				<input type="hidden" name="deptid" value="${tawPostSetForm.deptid}">
				<html:text property="deptName" styleId="deptName" styleClass="text medium" readonly="true" alt="allowBlank:false,vtext:'部门'" />
