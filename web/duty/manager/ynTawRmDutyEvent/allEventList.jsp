...
function fun_goTab(object,roomid,region){	
	document.frames["iframe"].location.href ="${app}/duty/yndutyevent.do?method=eventList&roomid="+roomid+"&region="+region;
 }
			...
			<TABLE cellSpacing="0" cellPadding="0" width="95%" borderColorLight="#709FD5" borderColorDark="#ffffff" align="center" bgColor="#f3f3f3" border="1">
				<TR style="display: inline" id='dispTr'>
					<TD colSpan="6" class="clsfth">
						<IFRAME ID=iframe FRAMEBORDER=0 width="100%" height=8500 SCROLLING=NO SRC='${app}/duty/yndutyevent.do?method=eventList&roomid=${roomid}'></IFRAME>
					</TD>
				</TR>
			</TABLE>
		</td>
