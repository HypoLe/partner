...
document.forms[0].action="../TawRmSysteminfo/save.do";
...
<INPUT id="transmit" type="button" Class="button" value='<bean:message key="entry.TawUserRoom.btn_new"/>'  name=button Onclick="window.location.href ='../TawUserRoom/new.do?roomId=<bean:write name="tawRmSysteminfoForm" property="roomId"/>'">&nbsp;&nbsp;
