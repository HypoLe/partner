...
Ext.onReady(function(){
	userTree = new xbox({
		...
		treeDataUrl:userTreeAction,treeRootId:'-1',treeRootText:'所属部门域',treeChkMode:'single',treeChkType:'dept',
...
<input type="button" value="部门域列表" id="userTreeBtn" class="btn" />
...
<td align="center">
<p>
<input type="button" class="button" name="btnIn" value="向上" onclick=javascript:del_RoomFalse();>
<input type="button" class="button" name="btnOut" value="向下" onclick=javascript:add_RoomFalse();>
</td>
</tr>
<tr>
<td align="center" class="label">
