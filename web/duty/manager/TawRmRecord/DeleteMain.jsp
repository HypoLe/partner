...
<%@ page import="java.util.*,java.lang.*, org.apache.struts.util.*,com.boco.eoms.duty.controller.TawRmRecordForm,com.boco.eoms.duty.model.TawRmDutyfile,com.boco.eoms.common.util.StaticMethod,com.boco.eoms.duty.util.StaticDutycheck,com.boco.eoms.duty.model.TawRmRecord"%>
...
<%
String workserial = request.getAttribute("workserial").toString();
...
<table border="0" width="95%" cellspacing="1" cellpadding="1" class="listTable" align=center>
  ...
  <TR class="tr_show">
    ...
    <TD colSpan="3">
    <INPUT id="RoomName" style="BACKGROUND-COLOR: lightgrey" readOnly maxLength=150 value="<%=roomName%>" name="RoomName" >
  <TR class="tr_show">
	<TD class="label">
...
<TR class="tr_show">
  ...
  <TR class="tr_show">
    ...
    <TD>
        <input name="starttime" type="text" style="BACKGROUND-COLOR: lightgrey" readOnly="" size="18" value=<bean:write name="tawRmRecordForm" property="starttime" scope="request"/> />
    </TD>
    ...
    <TD colspan="3" >
        ...
        <c:choose>
          <c:when test="${requestScope['tawRmRecordForm'].flag == 0}">
            <input name="flag" id="flag" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext" readOnly="" size="12" value='<bean:message key="TawRmRecord.compltetNo" />' />
          </c:when>
          <c:when test="${requestScope['tawRmRecordForm'].flag == 1}">
           <input name="flag" id="flag" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext" readOnly="" size="12" value='<bean:message key="TawRmRecord.compltetYes" />' />
          </c:when>
       </c:choose>
    </TD>
<TR class="tr_show">
...
<TR class="tr_show">
	...
	<TD ><html:hidden property="clean" /><input name="tempStr" id="tempStr" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext" readOnly="" size="8" value="<bean:write name="tawRmRecordForm" property="clean" scope="request"/>" />**
	</TD>
        <html:hidden property="clean1" />
        <TD class="label"><bean:message key="TawRmRecord.conditioner"/></TD>
        <TD colspan="3" ><html:hidden property="conditioner" /><input name="tempStr" id="tempStr" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext" readOnly="" size="8" value="<bean:write name="tawRmRecordForm" property="conditioner" scope="request"/>" />**</TD>
</TR>

<TR class="tr_show">
	<TD noWrap align="center" class="label"><bean:message key="TawRmHangover.prehangquestion"/></TD>
	<TD colSpan="8">
        <TEXTAREA id="hangQuestion0" name="hangQuestion0" rows=4 cols=80 style="BACKGROUND-COLOR: lightgrey" readOnly=""><%=String.valueOf(request.getAttribute("strHangQuestion"))%></TEXTAREA>
        </TD>
</TR>
...
<tr class="tr_show">
  ...
  <TR class="tr_show">
    ...
    <TD noWrap align=left colSpan=6><TEXTAREA id="dutyrecord" name="dutyrecord" rows=6 cols=80 style="BACKGROUND-COLOR: lightgrey" readOnly=""><bean:write name="tawRmRecordForm" property="dutyrecord" scope="request"/></TEXTAREA>
  ...
  <TR class="tr_show">
    ...
    <TD colSpan=6><TEXTAREA id=notes name=notes rows=4 cols=80 style="BACKGROUND-COLOR: lightgrey" readOnly=""><bean:write name="tawRmRecordForm" property="notes" scope="request"/></TEXTAREA>
...
<%}%>
  ...
  <!-- add by sunshengtai start -->
	<tr class="tr_show">
		...
		<td colspan="2">			
			<textarea id="importantnetfault" name="importantnetfault" rows="3" cols="71" readonly="readonly" style="BACKGROUND-COLOR: lightgrey"><bean:write name="tawRmRecordForm" property="importantnetfault" scope="request"/>
			</textarea>
		</td>
	</tr>
	...
	<tr>
		...
		<td colspan="2">
			<textarea id="importantsocietydisaster" name="importantsocietydisaster" rows="3" cols="71" readonly="readonly" style="BACKGROUND-COLOR: lightgrey"><bean:write name="tawRmRecordForm" property="importantsocietydisaster" scope="request"/>
			</textarea>
		</td>
	</tr>
	...
	<tr>
		...
		<td colspan="2">
			<textarea id="needcorrespond" name="needcorrespond" rows="3" cols="71" readonly="readonly" style="BACKGROUND-COLOR: lightgrey"><bean:write name="tawRmRecordForm" property="needcorrespond" scope="request"/>
			</textarea>
		</td>
	</tr>
	...
	<tr>
		...
		<td colspan="2">
			<textarea id="handoverproceeding" name="handoverproceeding" rows="3" cols="71" readonly="readonly" style="BACKGROUND-COLOR: lightgrey"><bean:write name="tawRmRecordForm" property="handoverproceeding" scope="request"/>
			</textarea>
		</td>
	</tr>
	<tr>
  	<td class="label">相关工单</td>
  	<td colSpan=5><a href="../dutysheet/show.do?workSerial=<%=workserial %>" target="_parent">相关工单</a></td>
  </tr>
	<!-- add by sunshengtai end -->
  
       <!--TR class="tr_show">
					<TD  class="label" colSpan="7" align="center">
						${eoms:a2u('å¼ç­æé´å¤ççå·¥ååä½ä¸è®¡å')}
					</TD></TR>
 <TR class="tr_show">
					<TD  class="label">
						${eoms:a2u('æé')}
...
<TR >
  ...
  <input type="button" Class="clsbtn2" name="button" value='<bean:message key="TawRmRecord.reject"/>' onclick="goto_transmit();">&nbsp;&nbsp;&nbsp;
  </TD>
</TR>
</table>
<%}%>
