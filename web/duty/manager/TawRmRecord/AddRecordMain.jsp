...
<TR class="tr_show">
        ...
        <%if (StatusInt ==0){%>
          <TD colSpan="8"><textarea name="statement" id="statement" rows="8" cols="90" Class="clstext"><%=request.getAttribute("STATEMENT")%></textarea>
        <%}else{%>
          <TD colSpan="5"><textarea name="statement" id="statement" readonly="" style="BACKGROUND-COLOR: lightgrey" rows="6" cols="60" Class="clstext"><%=request.getAttribute("STATEMENT")%></textarea>
        <%}%>
...
<tr>
<td class="label">${eoms:a2u("相关工单") }</td>
<td colSpan="3"><a href="../dutysheet/show.do" target="_parent">${eoms:a2u("相关工单") }</a></td>
</tr>
