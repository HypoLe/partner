...
<br>
<form  name="form1" id="form1" method="post"  action="../../duty/TawRmAssignwork/assign.do"  onsubmit="return checkForm()" >
...
<tr class="tr_show">
<td width="20%"   class="label" rowspan="4">
...
function model_copy()
{
  ...
  document.all.form1.action = "../../duty/TawRmAssignwork/modelCopy.do";
  document.all.form1.submit();
}
function xls_input()
{
  
  document.all.form1.action = "../../duty/TawRmAssignwork/select.do";
  document.all.form1.submit();
}
function checkForm()
{
