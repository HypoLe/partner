...
<display:table name="faultrecordlist" cellspacing="0" cellpadding="0"
    ...
    requestURI="${app}/duty/Faultrecord/list.do" 
    ...
    <display:column titleKey="Faultrecord.view" paramId="id" paramProperty="id" href="${app}/duty/Faultrecord/view.do">${eoms:a2u('查看')}</display:column>

    <display:column titleKey="Faultrecord.edit" paramId="id" paramProperty="id" href="${app}/duty/Faultrecord/edit.do">${eoms:a2u('编辑')}</display:column>

    <display:column titleKey="Faultrecord.delete" paramId="id" paramProperty="id" href="${app}/duty/Faultrecord/del.do">${eoms:a2u('删除')}</display:column>
