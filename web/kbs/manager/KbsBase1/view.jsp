...
<table border="0" width="95%" cellspacing="0">
  <tr>
    <td width="100%" class="table_title" align="center">
        &nbsp;&nbsp;<bean:message key="label.view"/>案例&nbsp;　</td>
  </tr>
</table>
...
<logic:present name="kbsBaseForm" scope="request">
  ...
  <%=StaticMethod.getGBString(StaticMethod.null2String(zuozhe,""))%></td>
...
%>
  ...
  <tr class="tr_show">
    ...
    <td width="70%" height="25">
     <eoms:attachment name="kbsBaseForm" property="attachName" scope="request"  idField="attachName"  appCode="kbs"  viewFlag="Y" />
...
<input type="button" Class="clsbtn2" value="<bean:message key="label.remove" />" onclick="return onRemove();">
