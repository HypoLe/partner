  ...
  <tr class="tr_show">
   <td width="30%" height="25" class="clsfth">&nbsp;
    ...
    <td width="70%" height="25">
       ...
       <a href="/EOMS_J2EE/newworksheet/Faultsheet/detail.do?id=<%=worksheetId.toString()%>"><%=sheetId.toString()%></a>
       <%}else{%>
       <a href="/EOMS_J2EE/newworksheet/Applysheet/detail.do?id=<%=worksheetId.toString()%>"><%=sheetId.toString()%></a>
       <%}%>
     </td>
  </tr>
  <%}%>
...
<bean:define id="authorDeptName" name="kbsBaseForm" property="authorDeptName" type="java.lang.String"/>
  <bean:define id="authorName" name="kbsBaseForm" property="authorName" type="java.lang.String"/>
  <td width="75%"><%=authorDeptName%> <%=authorName%></td>
...
<tr class="tr_show">
  ...
  <td width="75%"><%=StaticMethod.getGBString(StaticMethod.null2String(zuozhe,""))%></td>
...
<%}%>
 ...
 <tr class="tr_show">
    ...
    <td width="70%" height="25">
      <eoms:attachment name="kbsBaseForm" property="attachName" scope="request" idField="attachName" appCode="kbs" />
     </td>
  </tr>
</table>
<br/>
  ...
  <tr>
    <td width="100%" height="32" align="right">
     <html:hidden property="id"/>
      <input type="submit" class="clsbtn2"  onclick="checkInput()" value=<bean:message key="label.save"/> name="button1" >&nbsp;&nbsp;
      <html:reset styleClass="clsbtn2">
         <bean:message key="label.reset"/>
      </html:reset>
      <input type="button" class="clsbtn2"  value="<bean:message key="label.cancel"/>"  name="button" onclick="history.back();">
     &nbsp;&nbsp;</td>
  </tr>
</table>
</center>
