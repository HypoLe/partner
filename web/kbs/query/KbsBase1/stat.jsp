...
<table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
    ...
    <td>
    <bean:message key="label.from"/><!--从--><eoms:SelectTime name="statFromDate"  formName="kbsBaseForm" day="-60" /> <br>
    <bean:message key="label.to"/><!--到--><eoms:SelectTime name="statToDate"  formName="kbsBaseForm"  day="1"/>
    </td>
    </tr>
