   ...
   function onSave()
{
    ...
    if ((projectForm.project_executor.value)=="")
  {
    ...
    if ((projectForm.check_project_group.value)=="")
  {
    alert("选择审核人");
    return false;
  }
...
<html:form method="post" action="/project/save">
<SCRIPT language=javascript>
<!--
//以下四行用于日历显示
var outObject;
...
<table border="0" width="95%" cellspacing="0">
  <tr>
    <td width="106%" class="table_title" align="center"><center>新增项目信息</center></td>
  </tr>
</table>
...
<html:hidden name="projectForm" property="project_send_user" value="<%=userName%>"/>
     <tr class="tr_show">
      ...
      <tr class="tr_show">
		...
		<td width="75%" height="25">
          <html:text styleClass="clstext" property="project_exec_time" readonly="true" size="20" onfocus="setday(this)"  /><font color=crimson>*</font>
...
<html:hidden property="dept_id"/><font color=crimson>*</font>
  ...
  <tr class="tr_show">
    <td width="30%" height="25" class="clsfth"><center>责任人</center></td>
    <td width="70%" height="25">
  ...
  <tr class="tr_show">
 <td width="30%" height="25" class="clsfth"><center>审核人</center></td>
    <td colspan=3>


	 	<bean:message key="Worksheet.audit"/>:<span id="sort1_text"></span>
