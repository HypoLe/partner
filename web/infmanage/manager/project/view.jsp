...
<bean:define id="audit" name="projectForm" property="pro_audit" type="java.lang.String"/>
<bean:define id="check_content" name="projectForm" property="pro_check_content" type="java.lang.String"/>
<bean:define id="check_project_group" name="projectForm" property="check_project_group" type="java.lang.String"/>



  <tr>
    <td width="106%" class="table_title" align="center"><center><%=name%>----详细项目信息</center></td>
  </tr>
</table>
