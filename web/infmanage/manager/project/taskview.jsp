...
<body >
<html:form action="/project/list" method="post">
...
<bean:define id="audit" name="projectForm" property="task_audit" type="java.lang.String"/>
<bean:define id="check_content" name="projectForm" property="task_check_content" type="java.lang.String"/>

<tr>
    <td width="106%" class="table_title" align="center"><center><%=project_name%>项目----<%=task_name%>子任务信息</center></td>
  </tr>
</table>
...
<%=remark%>
      ...
      <% if(!audit.trim().equals("")){  %>
 <tr class="tr_show">
		<td width="25%" height="25"   ><center>
		  考核意见</center>
		</td>
		<td width="75%" height="25">
 <%=check_content%>
