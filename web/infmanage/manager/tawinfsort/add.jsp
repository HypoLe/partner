...
<body onload="refresh()">
<html:form action="/TawInfSort/save" method="post">
  <br>
    <table border="0" width="50%" cellspacing="0" align="center">
        <tr>
	      <td width="100%" align="center" class="table_title">
		    <b>
              <bean:message key="label.add"/>&nbsp;<bean:message key="TawInfSort.Name"/>
			</b>
	      </td>
	    </tr>
    </table>
...
<script language="javascript">
  ...
  function refresh()
  {
	window.document.tawInfSortForm.infSortName.value = "";
  }
</script>