...
Object attachObj=request.getAttribute("attName");
Object imgObj=request.getAttribute("attText");
if (attachObj!=null)
{
  ...
  //attValue=attachObj.toString();
  //attText=attText;
  attValue=(String)request.getAttribute("attValue");
  attText=(String)request.getAttribute("attText");
}
if (imgObj!=null)
{
...
<html:html>
<head>
<title><bean:message key="label.edit"/><bean:write name="tawInfInfoForm" property="infSortName" scope="request"/></title>
<html:base/>
...
<body>
<html:form action="/TawInfAppu/updatedone" method="post">
  ...
  <br>
    <table border="0" width="100%" cellspacing="0" align="center">
      <tr>
        <td width="100%" align="center" class="table_title">
          <b>
            <bean:message key="label.edit"/>&nbsp;<bean:write name="tawInfInfoForm" property="infSortName" scope="request"/>
          </b>
        </td>
      </tr>
	</table>
	...
	<table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align="center">
      ...
      <tr class="tr_show">
        ...
        <td width="75%" height="25">
          <html:text styleClass="clstext" property="infUpName"/>
        </td>
      </tr>
	  <tr class="tr_show">
		<td width="25%" height="25" class="clsfth">&nbsp;
	  ...
	  <tr class="tr_show">
                              <td noWrap width="100">
                                   <bean:message key="TawInfAppu.InfUpfileName"/>
                              </td>
...
<IFRAME ID=IFrame1 FRAMEBORDER=0 width="100%" SCROLLING=NO SRC="<%=request.getContextPath()%>/infmanage/TawInfAppu/file.do?attValue=<%=attValue.trim()%>&attText=<%=attText.trim()%>&imgValue=<%=imgValue.trim()%>&imgText=<%=imgText.trim()%>"></IFRAME>
