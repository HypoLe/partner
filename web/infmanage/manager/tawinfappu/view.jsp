...
<html:html>
<head>
<title><bean:message key="label.view"/><bean:write name="tawInfInfoForm" property="infSortName" scope="request"/></title>
<html:base/>
  ...
  <table border="0" width="100%" cellspacing="0" align="center">
	<tr>
      <td width="100%" align="center" class="table_title">
        <b>
          <bean:message key="label.view"/>&nbsp;<bean:write name="tawInfInfoForm" property="infSortName" scope="request"/>
        </b>
      </td>
    </tr>
  </table>
