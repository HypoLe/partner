    ...
    <br>
	  <table border="0" width="100%" cellspacing="0" align="center">
        <tr>
	      <td width="100%" align="center" class="table_title">
		    <b>
              <bean:message key="label.add"/>&nbsp;<bean:message key="TawInfMaintainer.Name"/>
			</b>
	      </td>
	    </tr>
	  </table>
      <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
	    ...
	    <tr class="tr_show">
          ...
          <td width="70%" height="25">
		    <html:text styleClass="clstext" property="maintainerName" size="10"/>
		  </td>
		</tr>
		<tr class="tr_show">
		  <td width="30%" height="25" class="clsfth">&nbsp;
			&nbsp<bean:message key="TawInfMaintainer.Maintainer_Sex"/><font color="#FFOOOO">**</font>
		  </td>
          <td width="70%" height="25">
		...
		<tr class="tr_show">
          ...
          <td width="70%" height="25">
			<html:text styleClass="clstext" property="tele" size="20"/>
		  </td>
		</tr>
	  	<tr class="tr_show">
		  <td width="30%" height="25" class="clsfth">&nbsp;
		  ...
		  <td width="70%" height="25">
			<html:text styleClass="clstext" property="teleMobile" size="20"/>
          </td>
		</tr>
		<tr class="tr_show">
		  <td width="30%" height="25" class="clsfth">&nbsp;
          ...
          <td width="70%" height="25">
			<html:text styleClass="clstext" property="teleHome" size="20"/>
		  </td>
		</tr>
		<tr class="tr_show">
		  <td width="30%" height="25" class="clsfth">&nbsp;
		...
		<tr class="tr_show">
		  ...
		  <td width="70%" height="25">
			<html:textarea styleClass="clstext" property="special" rows="10" cols="60"/>
          </td>
		</tr>
	  </table>
      <table border="0" width="100%" cellspacing="0" align="center">
...
<script language="javascript">
  ...
  function refreshIt(){
    window.document.tawInfMaintainerForm.deptName.value = "";
    window.document.tawInfMaintainerForm.maintainerName.value = "";
    window.document.tawInfMaintainerForm.tele.value = "";
    window.document.tawInfMaintainerForm.teleMobile.value = "";
    window.document.tawInfMaintainerForm.teleHome.value = "";
    window.document.tawInfMaintainerForm.email.value = "";
    window.document.tawInfMaintainerForm.special.value = "";
  }
</script>