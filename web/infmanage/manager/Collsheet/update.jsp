...
<html:html>
<head>
<title>修改综合经验库记录</title>
<html:base/>

</head>
<body >
<html:form action="/Collsheet/updatedone" method="post">
<style type="text/css">
  ...
  <br>
	<table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align="center">
      ...
      <tr class="tr_show">
		...
		<td width="75%" height="25">
          <html:text styleClass="clstext" property="region_code"   name="CollsheetForm" size="20"/>
		</td>
      </tr>
      <tr class="tr_show">
        <td width="25%" height="25" class="clsfth">&nbsp;
	  ...
	  <tr class="tr_show">
		...
		<td width="75%" height="25">
		  <html:text styleClass="clstext" property="key_word"  name="CollsheetForm"  size="30"/>
		</td>
      </tr>
       <tr class="tr_show">
		<td width="25%" height="25" class="clsfth">&nbsp;
		...
		<td width="75%" height="25">
                  <html:textarea property="fault_description" rows="4" style="width:100%" name="CollsheetForm" title="问题描述"/>
		</td>
      </tr>
       <tr class="tr_show">
		<td width="25%" height="25" class="clsfth">&nbsp;
		...
		<td width="75%" height="25">
                  <html:textarea property="fault_anolyize" rows="4" style="width:100%"   name="CollsheetForm"  title="问题分析"/>
		</td>
      </tr>
      <tr class="tr_show">
		<td width="25%" height="25" class="clsfth">&nbsp;
		...
		<td width="75%" height="25">
                  <html:textarea property="resovl_process" rows="4" style="width:100%"  name="CollsheetForm"  title="处理过程"/>
		</td>
      </tr>
 <tr class="tr_show">
