  ...
  <body>
	<br>
      ...
      <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
		<tr class="tr_show">
		 <td width="100%" colspan="11" height="25" align="center"><bean:write name="pagerHeader" scope="request" filter="false"/><%! String key;%></td>
        </tr>
	   ...
	   <td width="5%" height="25" class="clsfth" align="center"><center>重要程度</center></td>
           ...
           <td width="25%" height="25" class="clsfth" align="center">相应操作</td>
           </tr>
...
<logic:iterate id="project" name="Project_LIST" type="com.boco.eoms.infmanage.model.Project">
 ...
 <bean:define id="scale" name="project" property="project_scale" type="java.lang.Integer"/>
		  ...
		  <td width="20%" height="25" class="clsfth" align="center">
                   ...
                   <html:link page="/project/tasklist.do" name="map" scope="page">
                     <center> <font color="red"><bean:write name="project" property="project_name" scope="page"/></font></center>
                     </html:link></td>
...
<%}  else {%>
 ...
 <%}
 if(Integer.parseInt(scale.toString())<100){ %>
 <td width="25%" height="25"class="clsfth" align="center">
   <html:link page="/project/childtask_distri.do" name="map" scope="page">
     <font color="red">子任务分配</font></html:link></td>
<%}  else{%>
      <td width="15%" height="25" class="clsfth" align="center">
                      <center><font color="red">已全部分配</font></center></td>
