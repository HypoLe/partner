      ...
      <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
        ...
        <tr class="tr_show">
          <td width="10%"  height="25" class="clsfth" align="center"><center>项目名称</center></td>
           ...
           <td width="5%" height="25" class="clsfth" align="center"><center>考核成绩</center></td>
...
<html:link page="/project/taskview.do" name="map" scope="page">
                  ...
                  <td width="5%" height="25" class="clsfth" align="center">
                     <center><font color="red"><bean:write name="project" property="task_audit" scope="page"/></font></center></td>
