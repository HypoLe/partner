  ...
  <body>
	<br>
      ...
      <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
        ...
        <tr class="tr_show">
            <td width="25%" height="25" class="clsfth" align="center"><center>执行时间</center></td>
            <td width="25%" height="25" class="clsfth" align="center"><center>完成比例</center></td>
            <td width="25%" height="25" class="clsfth" align="center"><center>执行人</center></td>
            <td width="25%" height="25" class="clsfth" align="center"><center>任务描述</center></td>
...
<logic:iterate id="project" name="Project_LIST" type="com.boco.eoms.infmanage.model.Project">
    ...
    <tr class="tr_show">
 	...
 	<center><bean:write name="project" property="track_exec_time" scope="page"/></center>
                      ...
                      <td width="25%" height="25" class="clsfth" align="center">
 	<center><bean:write name="project" property="task_sign" scope="page"/>%</center>
                     </td>
                      <td width="25%" height="25" class="clsfth" align="center">
 	<center><bean:write name="project" property="task_executor_name" scope="page"/></center>
                     </td>
                      <td width="25%" height="25" class="clsfth" align="center">
 	<center><bean:write name="project" property="track_info" scope="page"/></center>
                     </td>
