...
<html:form method="post" action="/project/querydone">
<SCRIPT language=javascript>
<!--
//以下四行用于日历显示
var outObject;
...
<html:hidden property="dept_id"/>
  ...
  <tr class="tr_show">
    ...
    <tr class="tr_show">
    <td width="30%" height="25" class="clsfth"><center>项目进度</center></td>
    <td width="70%" height="25">
       下限<select size=1 name="down" style="width:50;z-index:-1">
       ...
       上限
      <select size=1 name="up" style="width:50;z-index:-1">
