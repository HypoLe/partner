...
function onRemove(listNo)
{
  ...
  if (str!="")
  {
    if (confirm("你确认要订阅吗 ？")==true)
    {
      document.form1.infoid.value=str;
      document.form1.action="../../TawInfAppu/taker.do";
...
%>
		...
		<tr class="tr_show">
          ...
          %>
           ...
           <td width="5%" height="25" align="center"><font color="#cc0000"><html:link page="/TawInfAppu/update.do" name="map" scope="page"><img src="<%=request.getContextPath()%>/images/bottom/an_bj.gif" border="0" alt="编辑"></html:link>&nbsp;</font></td>

           <td width="5%" height="25" align="center"><font color="#cc0000"><html:link page="/TawInfAppu/del.do" name="map" scope="page"><img src="<%=request.getContextPath()%>/images/bottom/an_sc.gif" border="0" alt="删除"></html:link>&nbsp;</font></td>
     	</tr>
		</logic:iterate>
    　</table>
 ...
 <input type="button" Class="clsbtn2"  value="订阅" onclick="return onRemove(<%=listNum%>);">
