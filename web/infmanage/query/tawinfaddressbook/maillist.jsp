...
<table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
  ...
  <tr class="tr_show">
    <td width="6%" height="25"><input type="checkbox" name="mail" value='<bean:write name="tawInfAddressBook" property="email" scope="page"/>'></td>
    <td width="20%" height="25"><bean:write name="tawInfAddressBook" property="company" scope="page"/></td>
    <td width="20%" height="25"><bean:write name="tawInfAddressBook" property="deptName" scope="page"/></td>
    <td width="20%" height="25"><bean:write name="tawInfAddressBook" property="name" scope="page"/></td>
    <td width="34%" height="25"><a href='mailto:<bean:write name="tawInfAddressBook" property="email" scope="page"/>'><bean:write name="tawInfAddressBook" property="email" scope="page"/></a></td>
