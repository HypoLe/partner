...
<table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
  ...
  <tr class="tr_show">
    ...
    <td width="40%" height="25" align="center"><bean:write name="tawInfGroup" property="groupName" scope="page"/></td>
    ...
    %>
		    ...
		    <td width="30%" align="center">
			    <html:link page="/TawInfGroup/edit.do" name="map" scope="page"><img src="<%=request.getContextPath()%>/images/bottom/an_bj.gif" border="0" alt="±à¼­"></html:link>&nbsp;</td>
		    <td width="30%" align="center">
		        <html:link page="/TawInfGroup/delDo.do" name="map" scope="page"><img src="<%=request.getContextPath()%>/images/bottom/an_sc.gif" border="0" alt="É¾³ý"></html:link></td>
