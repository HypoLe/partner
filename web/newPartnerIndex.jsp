...
<%@page import ="com.boco.activiti.partner.process.service.IPnrTransferOfficeService" %>
<%@page import ="com.boco.eoms.base.webapp.form.PersonNameUrlForm" %>
<%@page import ="com.boco.activiti.partner.process.po.WorkOrderStatisticsModel" %>
...
IPnrTransferOfficeService pnrTransferOfficeService = (IPnrTransferOfficeService)ApplicationContextHolder
	...
	List<PersonNameUrlForm> roleList = (List<PersonNameUrlForm>)pnrTransferOfficeService.getLoginRole(userid);

	List<WorkOrderStatisticsModel> taskList = (List<WorkOrderStatisticsModel>)pnrTransferOfficeService.transferOfficeStatistics();
					...
					<div class="sidebar-left-1">
					  ...
					  <div class="service_main">
					    ...
					    <%
					    	...
					    	for(PersonNameUrlForm one :roleList){
					    	%>
					    	<li>
					    	<span>
					    	<img src="images/partnerIndex/images/main_icon_2.png"  align="absmiddle" />
					    	</span>
					    	<a target="_blank" href="${app }<%=one.getUrl() %>"><%=one.getName() %></a>
					    	</li>
				...
				<div id="content">
					<div class="undojob-tabs">
						<ul class="ui-tabs-nav box-top">
							<li class="btl">
									<span class="ui-tabs-li bt-text ui-tabs-selected">传输局工单统计</span>
							</li>							
							<li class="btr">
                        ...
                        <!-- 工单统计 begin -->
                        <div id="taskTicketStatisticsDIV" class="box-content ui-tabs-panel " style="height:430px;">
                            <iframe id="taskTicketStatisticsList" name="taskTicketList" frameborder="0" style="width:100%;height:100%" src="${app}/activiti/pnrTransferOffice/pnrTransferOffice.do?method=personWorkOrderStatisticstijiao"></iframe>
                        </div>
                        <!-- 工单统计 end -->
						<!-- 业务联系函 begin-->
...
loadGongGaoData();
//loadSheetStatistics();
window.frames['taskTicketList'].location.reload();
