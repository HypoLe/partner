...
dojo.registerModulePath("dojo", (location.protocol === 'file:' ? 'http:' : location.protocol) + '//' + arcgisURL+"/deviceManagement/gis/arcgis/arcgis_js_api/library/2.4/arcgis/js/dojo/dojo");
dojo.registerModulePath("dijit", (location.protocol === 'file:' ? 'http:' : location.protocol) + '//' + arcgisURL+"/deviceManagement/gis/arcgis/arcgis_js_api/library/2.4/arcgis/js/dojo/dijit");
dojo.registerModulePath("dojox", (location.protocol === 'file:' ? 'http:' : location.protocol) + '//' + arcgisURL+"/deviceManagement/gis/arcgis/arcgis_js_api/library/2.4/arcgis/js/dojo/dojox");
