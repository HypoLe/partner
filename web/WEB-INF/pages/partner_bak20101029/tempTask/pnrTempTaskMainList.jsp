...
<c:set var="buttons">
	<input type="button" style="margin-right: 5px"
		onclick="location.href='<html:rewrite page='/pnrTempTaskMains.do?method=add'/>'"
...
<c:if test="${resultSize!='0'}">
	...
	<display:column property="startTime" sortable="true"
			headerClass="sortable" titleKey="pnrTempTaskMain.startTime"  format="{0,date,yyyy-MM-dd HH:mm:ss}" paramId="id" paramProperty="id"/>

	<display:column property="endTime" sortable="true"
			headerClass="sortable" titleKey="pnrTempTaskMain.endTime"  format="{0,date,yyyy-MM-dd HH:mm:ss}" paramId="id" paramProperty="id"/>
