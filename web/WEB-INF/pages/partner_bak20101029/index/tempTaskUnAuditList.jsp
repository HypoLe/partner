...
<a href="${app}/partner/tempTask/pnrTempTaskMains.do?method=getUnAuditList" target="pnrFrame" >
...
<td>
	<display:table name="unAuditList" cellspacing="0" cellpadding="0"
		...
		export="false"
		requestURI="${app}/partner/baseinfo/index.do?method=tempTaskUnAuditList"
