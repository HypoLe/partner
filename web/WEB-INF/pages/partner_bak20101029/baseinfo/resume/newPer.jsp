...
<script type="text/javascript">
    ...
    Ext.onReady(function(){
        var tabConfig = {
            items:[
                {id:'sheet-person',  text:'人力信息', url:eoms.appPath+'/partner/baseinfo/partnerUsers.do?method=detail&nodeId=${nodeId}&personCardNo=${personCardNo}&personCardNo1=${personCardNo1}', isIframe : true},
                {id:'sheet-resume',   text:'工作简历', url:eoms.appPath+'/partner/baseinfo/resumes.do?method=searchOne&personCardNo=${personCardNo}&personCardNo1=${personCardNo1}', isIframe : true}
            ]
        };
