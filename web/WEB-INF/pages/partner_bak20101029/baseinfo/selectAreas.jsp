...
<table class="formTable">
 ...
 <c:if test="${provinceLists!=null}">
	...
	<tr>
		<td class="content">
            <input type="checkbox"  name="province" value="${province.nodeName}" onclick="if(this.checked==true)hiddenArea();else showArea();">${province.nodeName}
		</td>
	</tr>
    </c:forEach>
  ...
  <c:if test="${areaLists!=null}">
	...
	<tr>
		<td class="content">
            <input type="checkbox"  name="area" value="${area.nodeName}" onclick="if(this.checked==true)hiddenProvince();else showProvince();">${area.nodeName}
		</td>
	</tr>
	</c:forEach>
  </c:if>
