...
function sub(){
	...
	var year =document.getElementById("year").value;
		...
		if(year!="" && month==""){
			...
			$("baseinfoReportFrom").submit();
		}
	}
</script>
<html:form action="/pnrStats.do?method=getBaseinfoByCtiy" styleId="baseinfoReportFrom" method="post" onsubmit="return sub();"> 
<center> 
<div style="width:400px">
<table class="formTable">
	<caption>
		<div class="header center">合作伙伴信息统计</div>
	</caption>
	<!-- 区域地市 -->
	<tr>
		<td class="label">
...
<table>
    <tr>
	    <td>
	    	<input type="button" class="btn" value="统计" onclick="sub();"/>&nbsp;&nbsp;
		</td>
	</tr>
</table>
</div>
