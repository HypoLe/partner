...
<%	    if("1".equals(formNo)){
		    ...
		    if("1".equals(picNo)){ %> 
				 window.opener.document.all.imgNo.src="${app}/<%=defaultPic%>";
		         window.opener.document.all.noThumbnail.value="<%=photoName%>";
		
	<%	}		 
	 		 
	        
	        if("2".equals(picNo) ){	%>
	 		 window.opener.document.all.imgApparatus.src="${app}/<%=defaultPic%>";
	         window.opener.document.all.thumbnail.value="<%=photoName%>";
	...
	<%    }  
		    ...
		    if("1".equals(picNo)){ %> 
				 window.opener.document.all.imgphoto.src="${app}/<%=defaultPic%>";
		         window.opener.document.all.thumbnail.value="<%=photoName%>";
	...
	<%	}		 
	        ...
	        if("2".equals(picNo) ){	%>
	 		 window.opener.document.all.imgdriving.src="${app}/<%=defaultPic%>";
	         window.opener.document.all.drivingLicenseThumbnail.value="<%=photoName%>";
...
<div>
	...
	<div class="left">
		...
		<div id="Step2Container">
			...
			<form action="${app}/partner/baseinfo/pnrBasePhotos.do?method=zoomPhotoDo&picNo=${picNo}&formNo=${formNo}" method="post">				
				<div class="uploaddiv">
	...
	<!-- 界面右半部分 -->
	<form  method="post" action="${app}/partner/baseinfo/pnrBasePhotos.do?method=uploadPhotoDo&picNo=${picNo}&formNo=${formNo}" enctype="multipart/form-data"  styleId="kmExpertPhotoForm"> 	
		<div class="right">
			<!--Step 1-->
