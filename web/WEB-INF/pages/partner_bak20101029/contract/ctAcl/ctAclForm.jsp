		...
		<table class="tableEdit" style="width: 560px;" cellspacing="0"
			...
			<c:forEach items="${list1}" var="Pnode">
				<tr>
					...
					<td>
						<!-- 
				<input type="checkbox" id="${Pnode.nodeId }_C" onclick="saveOrUpdateCtAcl(this)" moduleId="${Pnode.nodeId}" permission="0" >C
				<input type="checkbox" id="${Pnode.nodeId }_R" onclick="saveOrUpdateCtAcl(this)" moduleId="${Pnode.nodeId}" permission="1" >R
				<input type="checkbox" id="${Pnode.nodeId }_U" onclick="saveOrUpdateCtAcl(this)" moduleId="${Pnode.nodeId}" permission="2" >U
				<input type="checkbox" id="${Pnode.nodeId }_D" onclick="saveOrUpdateCtAcl(this)" moduleId="${Pnode.nodeId}" permission="3" >D
				 -->
					</td>
					<td>
