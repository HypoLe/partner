...
<table class="formTable">
	...
	<tr>
	    <td class="label">
			<fmt:message key="ctTableColumn.colName" />
		</td>
		<td class="content" colspan="3">
		    ${ctTableColumnForm.colName}		    
		</td>		
	</tr>
	...
	<tr>
		...
		<td class="content">
			<html:text property="colChname" styleId="colChname" styleClass="text medium" alt="allowBlank:false,vtext:'请填写字段名称'" value="${ctTableColumnForm.colChname}" />
	...
	<tr>	
		...
		<td class="content">
			<input type="text"   id="colDictName" name="colDictName" class="text" readonly="readonly" value='<eoms:id2nameDB id="${ctTableColumnForm.colDictId}" beanId="IItawSystemDictTypeDao" />' alt="allowBlank:false'"/>
	...
	<tr>
		...
		<td class="content">
			<html:text property="colSize" styleId="colSize" styleClass="text medium" alt="vtype:'number'" value="${ctTableColumnForm.colSize}" />
		...
		<td class="content">
			<html:text property="colDefault" styleId="colDefault" styleClass="text medium" alt="allowBlank:true,vtext:'请填写字段默认值'" value="${ctTableColumnForm.colDefault}" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="content">
			<html:text property="orderBy" styleId="orderBy" styleClass="text medium" alt="allowBlank:false,vtype:'number',vtext:'请填写排序值(数字)'" value="${ctTableColumnForm.orderBy}" />
		</td>
		<td class="label">
	...
	<tr>
		<td class="label">
			<fmt:message key="ctTableColumn.subNode" />
		</td>
		<td class="content" colspan="3">
	...
	<html:hidden property="parentNode" value="${ctTableColumnForm.parentNode}" />
</table>
