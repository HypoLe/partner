...
function findSubscribe() {
  ...
  if(subscribeId==1){
    var url="${app}/partner/contract/ctContentsSubscribes.do?method=subscribeCreateUser";
    window.location.href = url;
  }else if(subscribeId==2){
    var url="${app}/partner/contract/ctContentsSubscribes.do?method=subscribeTable";
    window.location.href = url;
  }
}
