...
<fmt:bundle	basename="com/boco/eoms/partner/contract/config/applicationResource-partner-contract">
	...
	<display:table name="ctContentsList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="true" headerClass="sortable" titleKey="ctContents.contractStatus">
		...
		<display:column title="推荐" headerClass="imageColumn">
			<a href="javascript:void(0)" onclick="recommend('${ctContentsList.tableId}','${ctContentsList.id }','${ctContentsList.isBest }')">
