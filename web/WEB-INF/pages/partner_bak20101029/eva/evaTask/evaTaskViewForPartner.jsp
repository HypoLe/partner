...
function changeTemplateType()
		{    
			...
			var url="<%=request.getContextPath()%>/partner/eva/evaTasks.do?method=changeTemplateType&templateTypeId="+templateTypeId;
...
function isSubmit(){
    if(checkEvaTime())return true;//document.getElementById("pnrEvaKpiInstanceForm").submit();
...
<html:form action="/evaTasks.do?method=choosePartnerForAll" styleId="pnrEvaKpiInstanceForm" method="post" > 
