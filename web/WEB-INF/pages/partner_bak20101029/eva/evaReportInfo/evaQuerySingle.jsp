...
function changeTemplateTypeAndTime()
		{    		    
		    ...
		    if(year1!=""&&month1!=""&&templateTypeId!=""){
				...
				var url="<%=request.getContextPath()%>/partner/eva/evaTasks.do?method=changeTemplateTypeAndTime&templateTypeId="+templateTypeId;
...
<html:form action="/evaReportInfos.do?method=reportSingle" styleId="pnrEvaKpiInstanceForm" method="post"> 
