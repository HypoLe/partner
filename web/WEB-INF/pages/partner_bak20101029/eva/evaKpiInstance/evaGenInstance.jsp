...
<html:form action="/evaKpiInstances.do?method=genInstance" styleId="pnrEvaKpiInstanceForm" method="post"> 
...
<iframe id="fileList" name="fileList" frameborder="0" width="100%" height="100%" 
	src="${app}/partner/eva/evaKpis.do?method=listKpiOfTemplate&templateId=${template.id}">
</iframe>
</c:if>
