     ...
     var r,re;
           ...
           r = document.forms[0].money.value.match(re);
           	if(r!=document.forms[0].money.value){   
           		...
           		alert("只能输入数字或者数字与小数点组合,小数点后不超过6位！");	
...
<html:form action="/tawContractPays.do?method=paysave"
		...
		<table class="formTable">
			<caption>
				<div class="header center">
					<fmt:message key="tawContractPay.form.heading" />
				</div>
			</caption>
			...
			<tr>
				...
				<td class="content">
					...
					<input id="paytime" name="paytime" type="text" class="text"
						readonly="readonly" alt="allowBlank:false,link:'endTime',vtext:''"
						onclick="popUpCalendar(this, this,null,null,null,false,-1);" />&nbsp&nbsp
					<font color="red">*</font>
				</td>
			</tr>
		...
		<tr>
			<td>			
				<input type="submit" class="btn"
					value="<fmt:message key="button.save"/>" onclick="fucCheck();"/>
