...
<form id="mainForm" name="mainForm" action="oilEngineStatistics.do?method=statisticsNumber" method="post"> 
<table class="formTable">
	...
	<tr>
	   <td class="label">驻点名称</td>
		<td class="content">
		<input id="residentSiteName" name="residentSiteName" type="hidden" value="${residentSiteName}" > 
	...
	<tr>
		...
		<td class="content">
		<input class="text" type="text" name="beginTime" value="${beginTime}"
...
<table class="formTable">
	 ...
	 <tr>	 
		 <td class="label">动环油机告警次数</td>
		 <td><input  id="alarmNumber" type="checkbox" name="cardNumber"
				value="alarmNumber" /></td>
		 <td class="label">代维油机发电总次数</td>
		 <td><input  id="generateNumber" type="checkbox" name="cardNumber"
				value="generateNumber" /></td>
		 <td class="label">普通发电次数次数</td>
		 <td><input  id="NormalGenerateNumber" type="checkbox" name="cardNumber"
				value="NormalGenerateNumber" /></td>
		 <td class="label">应急发电次数</td>
		 <td><input  id="emerGenerateNumber" type="checkbox" name="cardNumber"
				value="emerGenerateNumber" /></td>
		 <td class="label">能耗信息</td>
		 <td><input  id="energyInfo" type="checkbox" name="cardNumber"
				value="energyInfo" />
		</td>		
