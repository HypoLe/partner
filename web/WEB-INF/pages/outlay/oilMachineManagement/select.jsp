...
<table cellSpacing="0" cellPadding="0" width="85%" border="0" style="height: 50px;">
	<tr>
		<td class="table_title" align="center"><b>动环告警Excle导入</b></TD>
	</tr>
</table>
                            
<!---正文开始-------NetOilEngineManagement.do?method=performImport------------------------------------>
<form method="post" action="NetOilEngineManagement.do?method=performImport_excel" enctype="multipart/form-data" onsubmit="return validateForm(this);">
<table border="1" width="80%" cellspacing="1" class="table_show" >
	...
	<tr class="tr_show">
        ...
        Excel文件</td>
    <td width="80%" class="clsfth1">
        <input type="file" name="upfile" id="upfile" size="40" style="height: 20px;" ></td>
	</tr>
</table>
...
window.onload = function(){
  ...
  alert('a');
   return true ;
      ...
      if( frm.modelName.value == "jdbc"){
      	  ...
      	  frm.action += "&modelName="+frm.modelName.value;
      }
      if( frm.upfile.value == ""){
  ...
  function download(){
	var modstr = "${dow}";
    window.location.href = '${app}/partner/oilmachine/NetOilEngineManagement.do?method=download&mod='+modstr;
