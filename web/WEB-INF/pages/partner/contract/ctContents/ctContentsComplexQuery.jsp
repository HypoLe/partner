...
<html:form action="/ctContentss.do?method=complexQueryDo" styleId="ctContentsForm" method="post"> 
...
function onTableChg(table){
	...
	var url = '${app}/partner/contract/ctContentss.do?method=complexQuery&TABLE_ID='+ selValue;
	location.href = url;
}
...
function hidden_submit_param(){	
	...
	var submitURL='${app}/partner/contract/ctRules.do?method=checkSql';
	var oGet = null;
	var oReq = null;
	var regS = new RegExp("\\?","gi");
...
<table class="formTable">
	...
	<tr>
        <td style="width:10%;" rowspan="4">
	        ...
	        <html:optionsCollection label="colChname" name="CtTableColumnList" value="colName" />
	        </html:select>
        </td>
	...
	<tr>	    
	    <td class="content">
	         合同难易程度：<eoms:dict key="dict-partner-contract" dictId="levelFlag" isQuery="false" defaultId="" selectId="levelFlag" 
	                     beanId="selectXML" alt="allowBlank:true" onchange="appendDict(this)"/>&nbsp;&nbsp;
	         合同等级：<eoms:dict key="dict-partner-contract" dictId="rolestrFlag" isQuery="false" defaultId="" selectId="rolestrFlag" 
	                      beanId="selectXML" alt="allowBlank:true" onchange="appendDict(this)"/>&nbsp;&nbsp;
	         合同状态：<eoms:dict key="dict-partner-contract" dictId="contentStatus" isQuery="false" defaultId="" selectId="contentStatus" 
	                   beanId="selectXML" alt="allowBlank:true" onchange="appendDict(this)"/>&nbsp;&nbsp;
	         是否：<eoms:dict key="dict-partner-contract" dictId="isOrNot" isQuery="false" defaultId="" selectId="isOrNot" 
	                beanId="selectXML" alt="allowBlank:true" onchange="appendDict(this)"/>&nbsp;&nbsp;
	    </td>
	</tr>
