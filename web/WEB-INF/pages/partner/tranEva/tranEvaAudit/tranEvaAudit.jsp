...
function check(flag){
   if(flag == 0){
     if(tranEvaAuditForm.auditInfo.value == ""){
       alert("请填写审批意见！");
       return false;
     }
     tranEvaAuditForm.auditFlag.value = "0";
     tranEvaAuditForm.submit();
     return true;
   }
   else{
     if(tranEvaAuditForm.auditInfo.value == ""){
     ...
     tranEvaAuditForm.auditFlag.value = "1";
     tranEvaAuditForm.submit();
     return true;
   }
}
...
<html:form action="/tranEvaAudit.do?method=audit" styleId="tranEvaAuditForm" method="post"> 
<table>
	...
	<tr height="30">
		...
		<td width="70%">
			<html:textarea property="auditInfo" styleId="auditInfo"
						styleClass="text medium"  value="${tranEvaAuditForm.auditInfo}" />
		</td>
	</tr>
	<tr height="30">
		<td colspan="2">
...
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-tranEva" dictId="cycle" itemId="${template.cycle}" beanId="id2nameXML" />
		</td>
	</tr>
	<tr>
		<td class="label">
	...
	<tr>
		...
		<td class="content">
			<a href="${app}/partner/tranEva/tranEvaAudit.do?method=auditInfoList&nodeId=${org.id}"
				 target="_blank">
				点击查看审核意见
			</a>
		</td>
...
<table class="listTable" id="list">
	...
	<tr>
		...
		<td>
			<bean:write name="kpiList" property="tranEvaScore"/>
		</td>
	</tr>
	</logic:iterate>
	</tbody>
