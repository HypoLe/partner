...
function changeTemplateType()
		{    
			...
			var url="<%=request.getContextPath()%>/partner/tranEva/tranEvaTasks.do?method=changeTemplateType&templateTypeId="+templateTypeId;
...
function isSubmit(){
    if(checkTranEvaTime())return true;//document.getElementById("tranEvaKpiInstanceForm").submit();
    else if(!checkTranEvaTime()){
       alert("考核月份在模板激活时间之后！");
       return false;
    }
}
...
<html:form action="/tranEvaTasks.do?method=taskDetailList" styleId="tranEvaKpiInstanceForm" method="post" > 
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-tranEva" dictId="cycle" defaultId="month" onchange="changeCycle();"
