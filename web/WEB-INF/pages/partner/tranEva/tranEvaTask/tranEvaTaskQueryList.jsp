...
<html:form action="/tranEvaTasks.do?method=saveTaskDetail"
	styleId="tranEvaKpiInstanceForm" method="post">
		...
		<tbody>
			<logic:iterate id="taskDetail" name="taskDetailList" indexId="index">
				<tr>
					...
					<td>
						<eoms:dict key="dict-partner-tranEva" dictId="cycle" itemId="${taskDetail.timeType}" beanId="id2nameXML" />
					</td>
					<td>
					...
					<td>
						...
						<%if(TranEvaConstants.TASK_PUBLISHED.equals(isPublish)){%>
						已发布
						<%}else{%>
						未发布
						<%}%>
