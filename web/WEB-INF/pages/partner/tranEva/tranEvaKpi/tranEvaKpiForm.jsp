...
Ext.onReady(function() {
	v = new eoms.form.Validation({form:'tranEvaKpiForm'});
});
</script>

<html:form action="/tranEvaKpis.do?method=saveKpi" styleId="tranEvaKpiForm" method="post"> 
	...
	<tr>
		...
		<td class="content">
			<html:text property="kpiName" styleId="kpiName" style="width:88%" 
						...
						alt="allowBlank:false,vtext:'请输入指标名称'" value="${tranEvaKpiForm.kpiName}" />
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
			<html:textarea property="remark" styleId="remark" style="width:88%" 
						styleClass="textarea"  value="${tranEvaKpiForm.remark}" />
		</td>
	</tr>
</table>
...
<html:hidden property="id" value="${tranEvaKpiForm.id}" />
</html:form>
