...
<html:form action="/tranEvaTasks.do?method=saveTaskDetail" styleId="tranEvaReportMultiDeptForm" method="post">
...
function  queryBack()
    {
      document.forms[0].action="tranEvaReportMultiDepts.do?method=queryInitMultiDept";
    };
</script>