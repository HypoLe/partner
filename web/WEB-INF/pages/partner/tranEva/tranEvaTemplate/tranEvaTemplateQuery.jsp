...
<html:form action="/tranEvaTemplates.do?method=search" styleId="tranEvaTemplateForm" method="post"> 
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-tranEva" dictId="templateStatus" defaultId="<%=TranEvaConstants.TEMPLATE_REPORTED%>"
