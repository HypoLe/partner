...
<html:hidden property="id" value="${tranEvaTemplateForm.id}" />
</html:form>
<c:if test="${tranEvaTemplateForm.id != null}">
<iframe id="fileList" name="fileList" frameborder="0" width="100%" height="100%" 
	src="${app}/partner/tranEva/tranEvaTemplateKpis.do?method=listKpiOfTemplate&templateId=${tranEvaTemplateForm.id}">
</iframe>
</c:if>
<script type="text/javascript">
  try{
