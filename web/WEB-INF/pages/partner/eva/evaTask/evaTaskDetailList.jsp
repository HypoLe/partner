...
<table class="listTable" id="list-table">
	...
	<tr>
		...
		<script type="text/javascript">
		inputStr =inputStr + ',${taskDetail.nodeId}_${taskDetail.area}_sc';
		</script>
...
<table>
	<tr>
		<td>	
			...
			&nbsp;
			<input type="button" class="btn" value="发布" onclick="commit()" style="${requestScope.isPublishButton}"/>	
			&nbsp;
...
function  countScore()
    {
      ...
      for(var i=1;i<str.length;i++){
       lastScore = lastScore - document.getElementById(str[i]).value; 
      }
