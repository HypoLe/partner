...
<table class="formTable">
	...
	<tr>
	<td colspan="4">
	<span style="font-weight:bold;" >工作任务</span><img align=right src="${app}/images/icons/add_c.gif" alt="添加工作任务" onclick="javascript:addWork();" />
	<div id="workTemplate">
	<table class="formTable">
		<tr>	
			<td class="label" style="vertical-align:middle">
...
<!-- 
 ...
 -->		
		<tr>
			<th colspan="4"><img align=right src="${app}/images/icons/add_c.gif" alt="添加工作任务" onclick="javascript:addWork();" /><img align=right src="${app}/images/icons/delete_c.gif" alt="删除上方内容" onclick="removeNodes(parentNode.parentNode.parentNode);"/></th>
		</tr>
		</table>
