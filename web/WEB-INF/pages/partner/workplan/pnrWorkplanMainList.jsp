...
<c:if test="${resultSize!='0'}">
	...
	<display:column property="startTime" sortable="true"
			headerClass="sortable" titleKey="pnrWorkplanMain.startTime"  format="{0,date,yyyy-MM-dd}" paramId="id" paramProperty="id"/>

	<display:column property="endTime" sortable="true"
			headerClass="sortable" titleKey="pnrWorkplanMain.endTime"  format="{0,date,yyyy-MM-dd}" paramId="id" paramProperty="id"/>
