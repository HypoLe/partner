...
<head>
  ...
  <script type="text/javascript" src="${app}/scripts/form/validation.js"></script>
	...
	<script type="text/javascript" src="${app}/deviceManagement/gis/js/history.js"></script>
    ...
    <script type="text/javascript">
		...
		function waitDataFrameReady() { 
	        if(parent.frames["left-panel-page"].document.readyState === "complete") {
	        	setAllHistoryGraphics(parent.frames["left-panel-page"].historyListJSON);
	        } else {
