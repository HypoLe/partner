...
<head>
  ...
  <script type="text/javascript" src="${app}/scripts/form/validation.js"></script>
	...
	<script type="text/javascript" src="${app}/deviceManagement/gis/js/grid.js"></script>
    ...
    <script type="text/javascript">
		...
		function waitDataFrameReady() { 
	        ...
	        if(ready === "complete" && typeof (parent.frames["left-panel-page"].gridListJSON) != "undefined") {
	        	setAllGridGraphics(parent.frames["left-panel-page"].gridListJSON);
	        } else {
	        	setTimeout("waitDataFrameReady();",1500);
	        } 
		} 
    </script>
</head>
