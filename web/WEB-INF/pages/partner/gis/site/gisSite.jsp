  ...
  <script type="text/javascript" src="${app}/scripts/form/validation.js"></script>
    ...
    <script type="text/javascript">
			var paramConfig = {
				...
				icon5:"${app}/deviceManagement/gis/image/map/siteblue.gif",
	...
	<script type="text/javascript" src="${app}/deviceManagement/gis/js/site.js"></script>
    ...
    <script type="text/javascript">
		...
		function waitDataFrameReady() { 
	        ...
	        if(ready === "complete" && typeof (parent.frames["left-panel-page"].siteListJSON) != "undefined") {
	        	setAllSiteGraphics(parent.frames["left-panel-page"].siteListJSON);
	        } else {
