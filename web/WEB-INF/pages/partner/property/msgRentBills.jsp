...
<div id="main">
	<table  width="100%">
		<tr>
			<td>
				<c:if test="${resultSize > 0}">
					<a href="${app}/partner/property/remind.do?method=rentBillsList" target="pnrFrame" >
		...
		<tr>
			<td>
				<display:table name="rentBillsList" cellspacing="0" cellpadding="0"	id="rentBillsList" pagesize="${pageSize}" class="table rentBillsList"
					export="false"	requestURI="${app}/partner/property/remind.do?method=rentBillsList"
					sort="list" partialList="true" size="resultSize">
					<display:column sortable="true"	headerClass="sortable" title="提醒内容" >
							${rentBillsList.content}
					</display:column>
					<display:column sortable="true"	headerClass="sortable" title="批阅" >
						<a href="${app}/partner/property/remind.do?method=readRentBillsMsg&id=${rentBillsList.id}">已阅</a>
					</display:column>
					<display:column sortable="false" headerClass="sortable" title="详情" media="html">
						<a href="${app}/partner/property/remind.do?method=rentBillsRemindMsgDetail&id=${rentBillsList.id}" target="blank" shape="rect">
