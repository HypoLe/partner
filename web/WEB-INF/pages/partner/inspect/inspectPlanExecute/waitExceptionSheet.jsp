...
<div id="listQueryObject" 
	...
	<html:form action="inspectPlanExecute.do?method=waitExceptionSheet" method="post">
...
<logic:present name="list" scope="request">
	<display:table name="list" cellspacing="0" cellpadding="0"
		...
		pagesize="${pagesize}" requestURI="inspectPlanExecute.do?method=waitExceptionSheet" 
		...
		<display:column sortable="false" headerClass="sortable" title="查看巡检任务"
			media="html">
			<a id="${list.id }"
				href="${app }/partner/inspect/inspectPlanExecute.do?method=getInspectPlanMainDetailSheet&id=${list.id}&finsh=no"
