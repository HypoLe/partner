...
<div id="listQueryObject" 
	...
	<html:form action="inspectPlanExecute.do?method=findOwnInspectPlanSheet" method="post">
...
<logic:present name="list" scope="request">
	<display:table name="list" cellspacing="0" cellpadding="0"
		...
		<display:column title="计划完成进度" >
			<div style="width: 100%;background: #D3E686;">
				<span   id="progess_${list.id}" style=" display:block;background-color:#839C20;width: ${list.planNumber*100/list.resNumber}">
					<fmt:formatNumber value="${list.planNumber*100/list.resNumber}" pattern="#.##"></fmt:formatNumber>% 
				</span>
			</div>
			<script>setProgessToDiv('progess_${list.id}','${list.resNumber}','${list.planNumber}')</script>
		</display:column>
		...
		<display:column title="计划变更" >
			<a href="${app }/partner/inspect/inspectPlanChange.do?method=findInspectPlanChangeList&id=${list.id}"> 
