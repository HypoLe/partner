...
<div id="listQueryObject" 
	...
	<form action="${app }/partner/inspect/inspectPlanChange.do?method=findInspectPlanMainList" method="post">
...
<logic:present name="list" scope="request">
	<display:table name="list" cellspacing="0" cellpadding="0"
		...
		pagesize="${pagesize}" requestURI="inspectPlanChange.do?method=findInspectPlanMainList" 
		...
		<display:column sortable="false" headerClass="sortable" title="变更历史" media="html">
