...
<form action="${app }/partner/res/pnrTransLineAction.do?method=addArrivedRate" method="post" id="arrivedRateForm" name="arrivedRateForm" >
	<table id="sheet" class="formTable">
		...
		<tr>
			<td class="label">
			 标准到点率<font color='red'>*</font></td>
			</td>
			<td class="content" colspan="3">
				<input name="arrivedRate" id="arrivedRate" type="text" alt="re:/^(\d+)(\.\d+)?$/,re_vt:'请输入整数或小数',allowBlank:false,vtext:'请输入标准到点率'"/>%
			</td>
		</tr>
	</table>
