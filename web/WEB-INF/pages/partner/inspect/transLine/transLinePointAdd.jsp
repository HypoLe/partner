...
function saveImport() {
	...
	method : 'post',
		url : "${app}/partner/res/pnrTransLineAction.do?method=importTransLinePoint",
	  	waitTitle : '请稍后...',
		waitMsg : '正在导入数据,请稍后...',
  ...
  <div id="listQueryObject" 
	 ...
	 <form action="pnrTransLineAction.do?method=importTransLinePoint"
			...
			<tr>
				...
				<td>
					<input type="button" class="btn" value="下载导入文件模板" 
							onclick="javascript:location.href='${app}/partner/res/pnrTransLineAction.do?method=download&type=tlp'"/>
				</td>
			</tr>
			<tr >
				<td class="label">
					光缆敷设点导入<font color="red">*
				</td>
				<td>
