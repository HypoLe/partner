...
<div id="listQueryObject" 
	...
	<html:form action="inspectPlanGisAction.do?method=inspectPlanGisTaskFindList" method="post">
		<table id="sheet" class="listTable">
			<tr>		
				<td class="label">任务名称:</td>
				<td class="content"><input type="text" class="text medium" name="resName"/></td>
