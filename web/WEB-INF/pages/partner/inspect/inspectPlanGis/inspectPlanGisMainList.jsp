...
<div id="listQueryObject" 
	...
	<html:form action="inspectPlanGisAction.do?method=getAllInspectMainPlan" method="post">
...
<logic:present name="list" scope="request">
	<display:table name="list" cellspacing="0" cellpadding="0"
		...
		pagesize="${pagesize}" requestURI="inspectPlanGisAction.do?method=getAllInspectMainPlan" 
		...
		<display:column sortable="false" headerClass="sortable" title="查看巡检资源"
			media="html">
			<a id="${list.id }"
				href="${app }/partner/inspect/inspectPlanGisAction.do?method=getInspectPlanMainDetail&id=${list.id}"
