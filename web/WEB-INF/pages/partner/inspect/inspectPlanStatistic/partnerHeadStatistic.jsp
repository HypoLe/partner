...
<form  action="inspectPlanStatistic.do?method=findHearPartnerStatistic" id="gridForm" method="post" > 
...
<logic:present name="list" scope="request">
	<display:table name="list" cellspacing="0" cellpadding="0"
        requestURI="inspectPlanStatistic.do?method=findHearPartnerStatistic"
		id="list" class="table list" export="false" sort="list" >
		<display:column  sortable="true" headerClass="sortable" title="总巡检单位">
			<a href="${app }/partner/inspect/inspectPlanStatistic.do?method=findCityPartnerStatistic&partnerId=${list.partnerId }&year=${list.year}&month=${list.month} "> 
				<eoms:id2nameDB id="${list.partnerId}" beanId="partnerDeptDao"/><a>
		</display:column>	
