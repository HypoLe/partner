...
<form  action="inspectPlanStatistic.do?method=findCityPartnerStatistic" id="gridForm" method="post" > 
...
<logic:present name="list" scope="request">
	<display:table name="list" cellspacing="0" cellpadding="0"
        requestURI="inspectPlanStatistic.do?method=findCityPartnerStatistic"
		id="list" class="table list" export="false" sort="list" >
		<display:column  sortable="true" headerClass="sortable" title="地市代维公司">
			<a href="${app }/partner/inspect/inspectPlanStatistic.do?method=findCountryPartnerStatistic&partnerId=${list.partnerId }&year=${list.year}&month=${list.month} "> 
