...
<div id="listQueryObject" 
	...
	<form action="inspectPlanHis.do?method=findInspectPlanMainHisList" method="post">
...
<logic:present name="list" scope="request">
	<display:table name="list" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="false" headerClass="sortable" title="计划详情"
			media="html">
			<a id="${list.id }"
				href="${app }/partner/inspect/inspectPlanHis.do?method=getInspectPlanMainHisDetail&id=${list.id}"
				target="blank" shape="rect"> <img
				src="${app }/images/icons/table.gif"> </a>
		</display:column>
		<display:column sortable="false" headerClass="sortable" title="资源详情"
			media="html">
			<a id="${list.id }"
				href="${app }/partner/inspect/inspectPlanHis.do?method=findInspectPlanResHisList&id=${list.id}"
				target="blank" shape="rect"> <img src="${app }/images/icons/table.gif"> </a>
		</display:column>
	</display:table>
</logic:present>
	</br>
