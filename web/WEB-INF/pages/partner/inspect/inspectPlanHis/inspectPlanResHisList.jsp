...
<div id="listQueryObject" 
	...
	<form action="${app }/partner/inspect/inspectPlanHis.do?method=findInspectPlanResHisList" method="post">
...
<display:table name="list" cellspacing="0" cellpadding="0"
		...
		export="false" 
		requestURI="inspectPlanHis.do?method=findInspectPlanResHisList"
