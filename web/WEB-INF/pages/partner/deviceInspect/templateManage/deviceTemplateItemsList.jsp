...
<div style="border: 1px solid #98c0f4; padding: 5px;"
		...
		<tr><td colspan="4"><input type="button" id="addNetResourceTemplateItem" value="新增网络资源模版项" class="btn" style="margin-left: 260px;"  />
			<input type="button" value="返回" class="btn" onclick="javascript:window.history.back();" /></td></tr>
		...
		<display:column sortable="true" headerClass="sortable" title="正常值范围">
			<c:choose>
			<c:when test="${inspectTemplateItemList.inputType == 'radio'|| inspectTemplateItemList.inputType=='multiple'}">
			<eoms:id2nameDB beanId="ItawSystemDictTypeDao"
