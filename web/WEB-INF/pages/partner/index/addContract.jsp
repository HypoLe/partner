		...
		<table  width="100%">
			<tr>
				<td>
					...
					<display:column title="关联合同" headerClass="imageColumn">
						<a href="${app}/partner/agreement/pnrAgreementMains.do?method=queryContractDoAgr&id=${pnrAgreementMainList.id}&partyBId=${pnrAgreementMainList.partyBId }" target="_blank">
							选择 </a>/
						<a href="${app}/partner/feeInfo/pnrFeeInfoMains.do?method=edit&contractNew=contractNew&agreementId=${pnrAgreementMainList.id}" target="_blank">
							新增 </a>							
					</display:column>
					</display:table>
				</td>
