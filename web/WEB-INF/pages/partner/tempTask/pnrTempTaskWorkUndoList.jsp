...
<table class="formTable">
	...
	<img align=right src="${app}/images/icons/open.gif" alt="隐藏/显示工作内容" onclick="javascript:showWork('<%=pnrTempTaskWork.getTempTaskId() %>');" />临时任务名称：
	...
	<tr  id="<%=pnrTempTaskWork.getTempTaskId() %>" style="display:block;">
	<td colspan="4">
	工作子项:
	<table class="formTable" >
...
<tr>
		...
		%>
			<input  type="button" class="btn" value="结束报告"onclick="window.open('${app}/partner/tempTask/pnrTempTaskWorks.do?method=workExecute&workId=<%=pnrTempTaskWork.getId() %>');"	/>
		</td>
	</tr>
		<tr>
		<td class="label" style="vertical-align:middle">
