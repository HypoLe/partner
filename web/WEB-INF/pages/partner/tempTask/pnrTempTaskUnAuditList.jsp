...
<c:if test="${resultSize!=0}">
	<display:table name="unAuditList" cellspacing="0" cellpadding="0"
		...
		export="false"
		requestURI="${app}/partner/tempTask/pnrTempTaskMains.do?method=getUnAuditList"
		sort="list" partialList="true" size="resultSize">
		
	
	<display:column sortable="true"	headerClass="sortable" title="临时任务名称" >
			<eoms:id2nameDB id="${unAuditList.tempTaskId}" beanId="pnrTempTaskMainDao" />
	</display:column>
	...
	<display:column sortable="true"	headerClass="sortable" title="提交人" >
		...
		<display:column title="查看" headerClass="imageColumn">
			<a href="javascript:var tempTaskId = '${unAuditList.tempTaskId }';
		                        var url=eoms.appPath+'/partner/tempTask/pnrTempTaskMains.do?method=detail&id='+tempTaskId;
		...
		<display:column title="审核" headerClass="imageColumn">
			<a href="javascript:var tempTaskId = '${unAuditList.tempTaskId }';
		                        ...
		                        var url=eoms.appPath+'/partner/tempTask/pnrTempTaskMains.do?method=audit&tempTaskId='+tempTaskId+'&id='+id;
		                        void(window.open(url));
		                        //location.href=url">
