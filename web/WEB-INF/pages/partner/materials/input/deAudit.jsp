...
<body><div align="center"><h2>入库单反向审核</h2></div>
	<body>
		
		<form action="storeInput.do?method=deAudit" method="post">
			<table class="formTable">
				<tr>
				<input type="hidden" name="id" value="${storeInput.id}" readOnly="true">
					<td class="label">
						入库日期
						<input type="text" name="storeBillingDate" value="${storeInput.storeBillingDate}" readOnly="true">
					</td>

					<td class="label">
						供应商
						<input type="text" name="storeCompany" value="${storeInput.storeCompany}" readOnly="true">
					</td>
				</tr>
				<tr>
					<td class="label" >
						仓库
						<input type="text" naem="storeSname" value="${storeInput.storeSname}" readOnly="true">
						
					</td>

					<td class="label">
						经办人
						<input type="text" name="storeRequisitioner" value="${storeInput.storeRequisitioner}" readOnly="true">
					</td>
				</tr>
				<tr>
					...
					<td class="label">
						制单人
						<input type="text" name="storeMakeBillPeople" value="${storeInput.storeMakeBillPeople}" readOnly="true">
					</td>
					<td class="label">
						备注
						<input type="text" name="remark" value="${storeInput.storeRemark}" readOnly="true">
					</td>
				</tr>
