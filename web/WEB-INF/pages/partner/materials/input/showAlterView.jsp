...
//	alert("kaish");	
	...
	<body>
		<form action="storeInput.do?method=alter" method="post">
			<div>
				<p>
				<center>
					<span style="font-size: 20px">修改入库单</span>
				</center>
				<br />
				</p>
				<p>
			...
			<table class="formTable">
				<tr>
					...
					<td class="content">
						<input class="text" type="text" name="storeCompany" id="storeCompany"
							value="${storeCompany}" />
					</td>
				</tr>
				...
				<tr>
					...
					<td class="content">
						<input class="text" name="storeOriginalNum" id="storeOriginalNum"
			...
			<input type="button" value="返回"
				onClick="window.location.href='${app}/materials/storeInput.do?method=view&fh=1&billId=${billId}'" />
