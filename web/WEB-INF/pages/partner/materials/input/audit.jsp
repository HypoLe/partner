...
<body>
	<body>
		...
		<form action="storeInput.do?method=audit" method="post">
		<input type="hidden" name="id" value="${storeInput.id}" />
		<input type="hidden" name="storeExamineStatus" value="${storeInput.storeExamineStatus}" />
...
<table class="formTable">
	...
	<tr>
		...
		<td class="content" colspan="3">
		    <input readonly="true" type="text" value="${storeInput.storeRemark}" class="text max" />
		</td>
	</tr>
		</table>
