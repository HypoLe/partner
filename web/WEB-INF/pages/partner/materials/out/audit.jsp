...
<body>
	<body>
		...
		<form action="storeOut.do?method=audit" method="post">
		<input type="hidden" name="id" value="${storeOut.id}" />
		<input type="hidden" name="storeExamineStatus" value="${storeOut.storeExamineStatus}" />
...
<table class="formTable">
	...
	<tr>
		...
		<td class="content" colspan="3">
		    <input readonly="true" type="text" value="${storeOut.storeRemark}" class="text max" />
		</td>
	</tr>
		</table>
