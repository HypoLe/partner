...
<html:form action="/siteEvaTasks.do?method=saveTaskDetail" styleId="siteEvaReportMultiDeptForm" method="post">
...
function  queryBack()
    {
      document.forms[0].action="siteEvaReportMultiDepts.do?method=queryInitMultiDept";
    };
</script>