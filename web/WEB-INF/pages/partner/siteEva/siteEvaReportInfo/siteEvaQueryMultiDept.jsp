...
function changeTemplateTypeAndTime()
		{    		    
		    ...
		    if(year1!=""&&month1!=""&&templateTypeId!=""){
				...
				var url="<%=request.getContextPath()%>/partner/siteEva/siteEvaTasks.do?method=changeTemplateTypeAndTime&templateTypeId="+templateTypeId;
...
<html:form action="/siteEvaReportMultiDepts.do?method=reportMultiDept" styleId="siteEvaKpiInstanceForm" method="post"> 
