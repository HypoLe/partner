...
<table class="listTable" id="list-table">
	...
	<tr>
		...
		<td rowspan="${taskDetail.rowspan}" colspan="${taskDetail.colspan}" class="label" style="vertical-align:middle;text-align:left">
			<eoms:id2nameDB id="${taskDetail.kpiId}" beanId="siteEvaKpiDao" />
		</td>
		<%if (SiteEvaConstants.NODE_LEAF.equals(leaf)) { %>
		<td align="left">
...
function  queryBack()
    {
      document.forms[0].action="siteEvaReportInfos.do?method=queryInitMultiMonth";
    };
</script>