...
<html:form action="/siteEvaKpiInstances.do?method=genInstance" styleId="siteEvaKpiInstanceForm" method="post"> 
...
<iframe id="fileList" name="fileList" frameborder="0" width="100%" height="100%" 
	src="${app}/partner/siteEva/siteEvaKpis.do?method=listKpiOfTemplate&templateId=${template.id}">
</iframe>
</c:if>
