...
function check(flag){
   if(flag == 0){
     if(siteEvaAuditForm.auditInfo.value == ""){
       alert("请填写审批意见！");
       return false;
     }
     siteEvaAuditForm.auditFlag.value = "0";
     siteEvaAuditForm.submit();
     return true;
   }
   else{
     if(siteEvaAuditForm.auditInfo.value == ""){
     ...
     siteEvaAuditForm.auditFlag.value = "1";
     siteEvaAuditForm.submit();
     return true;
   }
}
...
<html:form action="/siteEvaAudit.do?method=audit" styleId="siteEvaAuditForm" method="post"> 
<table>
	...
	<tr height="30">
		...
		<td width="70%">
			<html:textarea property="auditInfo" styleId="auditInfo"
						styleClass="text medium"  value="${siteEvaAuditForm.auditInfo}" />
		</td>
	</tr>
	<tr height="30">
		<td colspan="2">
...
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-siteEva" dictId="cycle" itemId="${template.cycle}" beanId="id2nameXML" />
		</td>
	</tr>
	<tr>
		<td class="label">
	...
	<tr>
		...
		<td class="content">
			<a href="${app}/partner/siteEva/siteEvaAudit.do?method=auditInfoList&nodeId=${org.id}"
				 target="_blank">
				点击查看审核意见
			</a>
		</td>
...
<table class="listTable" id="list">
	...
	<tr>
		...
		<td>
			<bean:write name="kpiList" property="siteEvaScore"/>
		</td>
	</tr>
	</logic:iterate>
	</tbody>
