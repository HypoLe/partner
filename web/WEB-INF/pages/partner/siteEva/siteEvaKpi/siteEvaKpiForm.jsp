...
Ext.onReady(function() {
	v = new eoms.form.Validation({form:'siteEvaKpiForm'});
});
</script>

<html:form action="/siteEvaKpis.do?method=saveKpi" styleId="siteEvaKpiForm" method="post"> 
	...
	<tr>
		...
		<td class="content">
			<html:text property="kpiName" styleId="kpiName" style="width:88%" 
						...
						alt="allowBlank:false,vtext:'请输入指标名称'" value="${siteEvaKpiForm.kpiName}" />
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
			<html:textarea property="remark" styleId="remark" style="width:88%" 
						styleClass="textarea"  value="${siteEvaKpiForm.remark}" />
		</td>
	</tr>
</table>
...
<html:hidden property="id" value="${siteEvaKpiForm.id}" />
</html:form>
