...
<html:form action="/siteEvaTemplates.do?method=search" styleId="siteEvaTemplateForm" method="post"> 
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-siteEva" dictId="templateStatus" defaultId="<%=SiteEvaConstants.TEMPLATE_REPORTED%>"
