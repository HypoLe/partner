...
<table id="applicationDtlTable" name="applicationDtlTable" class="formTable">	
	      <tr><td colspan="8"><font style="color:red;font-weight:bold;">明细信息   (注：该费用将归结到审批通过实际的月份！)</font></td></tr>
	      <tr>	    
			<td class="label">
			...
			<td class="content">
				...
				<eoms:xbox id="compTree" dataUrl="${app}/xtree.do?method=userFromComp&popedom=true&checktype=excludeBigNodAndLeaf&showPartnerLevelType=2"
					rootId="" rootText="公司树" valueField="comp"
   ...
   <table   class="table protocolMainList"  name="applicationDtlListTable" id="applicationDtlListTable">
	...
	<table id="sheet" class="formTable">
		<tr>
			...
			<td class="content">
				<textarea name="remark" id="remark" class="text medium" style="width: 300px; height: 80px;" 
	...
	<input type="submit" class="btn" value="保存" onClick="beforeSave();"/>&nbsp;&nbsp;&nbsp;
	<input type="submit" class="btn" value="提交" onClick="beforeSubmit();"/>
</form>
