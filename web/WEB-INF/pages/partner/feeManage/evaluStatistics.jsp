...
function toXLSFile(){
		    $("exportFlag").value="2";
			document.getElementById("feeStatisticsForm").submit();
...
<form  action="feeManage.do?method=${method}&pageType=${pageType}" method="post"   id="feeStatisticsForm">
		<fieldset>
			<legend>查询</legend>
	     ...
	     <td class="label">代维公司 </td>
			<td class="content">
				...
				<eoms:xbox id="compTree" dataUrl="${app}/xtree.do?method=userFromComp&popedom=true&checktype=excludeBigNodAndLeaf&showPartnerLevelType=1"
	    ...
	    <input type="button" name="查询" value="查询" onclick="sendStatistics()" />    
	       &nbsp;&nbsp;&nbsp;    
