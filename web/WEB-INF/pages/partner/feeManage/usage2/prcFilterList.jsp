...
<style>
	...
	<display:table name="prcFilterList" cellspacing="0" cellpadding="0"
		...
		<display:column title="修改" 
		  url="/partner/feeManageUsage2/usage2.do?method=prcFilterEdit"  paramProperty="id"
...
<table class="table">
  <tr>
    <td><a href="${app}/partner/feeManageUsage2/usage2.do?method=prcFilterEdit&parentId=${parentId}"><input type="button" value="新增"/></a></td>
  </tr>
</table>
