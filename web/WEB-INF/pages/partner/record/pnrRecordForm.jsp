...
<table class="formTable">
    ...
    <tr>
	    <td class="label">
	       档案分类<font color="red" > *</font>
			...
			<td class="content">
				<eoms:comboBox name="recordType" id="recordType" defaultValue="${specialty}"
	...
	<tr>
	    ...
	    <td colspan="3">
              <textarea class="textarea max" name="summary" id="summary" ></textarea>
	    </td>
	</tr>
	<tr>
	    <td class="label">
	    ...
	    <td colspan="3">
	       <input  type="text" class="text" name="keyword" id="keyword"  style="width: 80%"
					...
					value=""/><font color="red" > 多个关键词用,隔开</font>
	    </td>
	</tr>
	<tr>
	    <td class="label">
        ...
        <td class="content" colspan="3" height="100px">
               <eoms:attachment scope="request"  name="${pnrRecord.attachment}"   idField="attachment" property="attachment"  appCode="pnrcontact"  alt="allowBlank:true,vtext:'证书附件'"  />
        </td> 
	</tr>
