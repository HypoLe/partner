...
<div id="sheetform">
			<html:form action="/netResInspect.do?method=listInvolvedFinishedProcessInstances"
				styleId="theform">
...
<bean:define id="url" value="netResInspect.do"/>
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		sort="list" size="total" partialList="true" >
			...
			<a href="${app}/activiti/netResInspect/netResInspect.do?method=gotoDetail&processInstanceId=${taskList.processInstanceId}" target="_blank">
		...
		<display:column sortable="false" headerClass="sortable" title="地市">
			...
			<display:column property="sendTime" sortable="true"	headerClass="sortable" title="上报时间"
				format="{0,date,yyyy-MM-dd HH:mm:ss}" />
			<display:column property="endTime" sortable="true"	headerClass="sortable" title="归档时间"
				format="{0,date,yyyy-MM-dd HH:mm:ss}" />
