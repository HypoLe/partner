...
function changeCity(con)
 ...
 function delAllOption(elementid){
	...
	<div id="sheetform">
			<html:form action="/netResInspect.do?method=listInvolvedUnfinishedProcessInstances"
				styleId="theform">
...
<form id="testform" name="testform" action="${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=listInvolvedUnfinishedProcessInstances" method="post">	
