...
<bean:define id="url" value="pnrTransferOfficeMaleGuest.do?method=workOrderQuery" />
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		id="taskList" pagesize="${pageSize}" class="table businessdesignMain"
		export="true" requestURI="pnrTransferOfficeMaleGuest.do?method=workOrderQuery"
