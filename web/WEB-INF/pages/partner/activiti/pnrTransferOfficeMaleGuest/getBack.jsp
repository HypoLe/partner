...
function selectSheet(){
        ...
        <div id="sheetform">
			<html:form action="/pnrTransferOfficeMaleGuest.do?method=getBack"
				styleId="theform">
...
<bean:define id="url" value="pnrTransferOfficeMaleGuest.do"/>
	...
	<display:column sortable="true"
			headerClass="sortable" title="处理">
					<a href="${app}/activiti/pnrTransferMaleGuest/pnrTransferOfficeMaleGuest.do?method=rollback&handle=transferHandle&taskId=${taskList.taskId}&initiator=${taskList.initiator}&processInstanceId=${taskList.processInstanceId}" title="回退">
					 抓回
					</a>
		</display:column>
