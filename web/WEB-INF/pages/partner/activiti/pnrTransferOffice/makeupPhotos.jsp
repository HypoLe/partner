...
function refresh(){
	   ...
	   // window.location.href = "${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=listBacklog"+condition;
	    window.location.href = "${app}/activiti/pnrTransferOffice/pnrTransferOffice.do?method=makeupPhotos";
} 
...
inputs[i].checked = true;  
 ...
 inputs[i].checked = false;  
 	...
 	<script type="text/javascript">
		...
		<div id="sheetform">
			<html:form action="/pnrTransferOffice.do?method=makeupPhotos"
				styleId="theform">
...
//查看补录照片列表
	function viewMakeupPhoto(processInstanceId){
		var url = '${app}/activiti/pnrTransferMaleGuest/pnrTransferOfficeMaleGuest.do?method=conditionSelectPhoto&photoType=myTransferProcess&processInstanceId='+processInstanceId;
		var _sHeight = 600;
	    var _sWidth = 820;
