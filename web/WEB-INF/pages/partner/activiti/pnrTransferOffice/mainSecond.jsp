...
Ext.onReady(function(){
   ...
   function changeType1(){
	...
	<html:form action="/pnrTransferOffice.do?method=mainSecond" styleId="theform" >
     <input id="transferState" type="hidden" name="transferState" value="handle">
...
<fieldset>
    ...
    <div class="x-form-item" >
		<eoms:chooser id="sendObject" panels="[{text:'部门与人员',dataUrl:'${app}/xtree.do?method=userFromDeptTask&dh=${country}&level=2',rootId:'${country}'}]"  config="{returnJSON:true,showLeader:true}"
		   category="[{id:'auditor',text:'接收',allowBlank:false,childType:'user',limit:1,vtext:'请选择接收对象'}]"
		  data="" />
	</div>	
</fieldset>
