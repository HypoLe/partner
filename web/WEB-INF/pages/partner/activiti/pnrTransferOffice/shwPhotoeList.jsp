...
//先获得屏幕的宽度和高度
		...
		var src =document.getElementById(curPage).src;
	//	jq("#showImg").html("<img width='600' height='480'  src='"+src+"'>");
		jq("#showImg").html("<img width='600' height='480'  src='${app}/activiti/pnrTransferOffice/pnrTransferOffice.do?method=showPicture&id="+id+"&curPage="+curPage+"'>");
...
<br/><br/><br/>
	<display:table name="list" cellspacing="0" cellpadding="0"
			...
			<img src="${app}/activiti/pnrTransferOffice/pnrTransferOffice.do?method=showPicture&id=${list.id}" border="0" height="20px" width="50px" id="${list_rowNum}" onclick="pictureId('${list.id}','${list_rowNum}')"/>
			 </display:column>
