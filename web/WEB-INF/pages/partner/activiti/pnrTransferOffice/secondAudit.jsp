...
<div style="TEXT-ALIGN: center; height:20"></div>
 <!-- 工单基本信息end --> 
	...
	<html:form action="/pnrTransferOffice.do?method=secondAudit" styleId="theform" >	
	
			    <input type="hidden" name="teskAssignee" value="${auditor}" />
...
<table id="sheet" class="formTable" >
		<tr>
		  ...
		  <td class="content" colspan="3">
		    <input type="radio" name="transferAudit" value="handle"  checked=”checked”/>通过
		    <input type="radio" name="transferAudit" value="rollback"/>不通过
		  </td>	
