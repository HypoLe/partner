...
<div style="TEXT-ALIGN: center; height:20"></div>
 <!-- 工单基本信息end --> 
	...
	<html:form action="/pnrTransferOffice.do?method=epibolyAudit" styleId="theform" >	
...
<table id="sheet" class="formTable" >
		<tr>
		  ...
		  <td class="content" colspan="3">
		    <input type="radio" name="epibolyState" value="handle"  checked=”checked”/>通过
		    <input type="radio" name="epibolyState" value="rollback"/>不通过
		  </td>	
