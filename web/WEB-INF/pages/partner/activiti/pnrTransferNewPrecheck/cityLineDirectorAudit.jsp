...
<html:form action="/pnrTransferNewPrecheck.do?method=transferProgram" styleId="theform" >
            ...
            <input type="hidden" id="rejectState" name="rejectState" value="cityLineDirectorState#rollback"><!--驳回状态名值对  -->
			...
			<input type="hidden" name="nextPerson" value="${pnrTransferOffice.cityManageCharge}">
