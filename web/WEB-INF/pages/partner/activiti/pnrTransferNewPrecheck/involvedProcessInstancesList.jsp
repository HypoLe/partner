...
<div id="sheetform">
			<html:form action="/pnrTransferNewPrecheck.do?method=listInvolvedUnfinishedProcessInstances"
				styleId="theform">
	...
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="false" headerClass="sortable" title="地市">
			...
			<display:column sortable="true" property="compensate" headerClass="sortable" title="赔补收入"/>
