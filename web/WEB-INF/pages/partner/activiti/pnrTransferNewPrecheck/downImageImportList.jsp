...
<script type="text/javascript">
   ...
   //此刷新函数被弹出的子模态窗口调用
   function refresh(){
	    window.location.href = "${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=downImageImport";
	} 
	
   //分页设置
   function changePage(v) {
		location.href = '${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=downImageImport&pagesize='+v;
	}
...
-->
			...
			<table>
	  			<tr>
	  				<td>
	  					<input type="button" name="button" class="button" value="图片下载" onclick="download()" >
	  				</td>
	  			</tr>
	  		</table>
		</form>
