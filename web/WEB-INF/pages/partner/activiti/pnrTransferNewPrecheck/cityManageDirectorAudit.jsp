...
var v;
  ...
  function selectRes(){
		...
		var url = '${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=showCommonRejectPage&sign=above';
		//var _sHeight = 180;
		var _sHeight = 200;
	    var _sWidth = 820;
...
<html:form action="/pnrTransferNewPrecheck.do?method=cityManageDirectorAudit" styleId="theform" >
			<!-- 带注释为驳回时需要的参数 -->
			<input type="hidden" id="marker" name="marker" value="cityManageDirectorAudit" /><!-- 流程标识 marker和linkName隐藏域的值应该保持一致-->	
            ...
            <input type="hidden" id="returnPerson" name="returnPerson" value="${pnrTransferOffice.cityManageCharge}"><!-- 驳回人 -->
            <input type="hidden" id="rejectState" name="rejectState" value="cityManageDirectorState#rollback"><!--驳回状态名值对  -->
			...
			<input type="hidden" name="cityManageDirectorAudit" value="${pnrTransferOffice.provinceManage}">
			<input type="hidden" name="linkName" value="cityManageDirectorAudit">
			 		...
			 		<tr>
						...
						<td class="content" >
							<eoms:attachment name="sheetMain" property="sheetAccessories" 
					            scope="request" idField="cityManageDirector" appCode="pnrActTransferOffice" alt="allowBlank:false;请选择保存的附件"/> 
						</td>
			 			<td class="label">
							审批人*
						</td>
						<td class="content" >
						<input class="text" type="text" name="assignee" alt="allowBlank:false,maxLength:500,vtext:'请填写审批人'"/>
						</td>
