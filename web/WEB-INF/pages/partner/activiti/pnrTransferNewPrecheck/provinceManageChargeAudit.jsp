...
<html:form action="/pnrTransferNewPrecheck.do?method=transferProgram" styleId="theform" >
			...
			<input type="hidden" name="provinceManageVice" value="${pnrTransferOffice.provinceManage}">
			<input type="hidden" name="nextPerson" value="${pnrTransferOffice.provinceManage}">
