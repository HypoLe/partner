...
<html>
	<head>
		...
		<script type="text/javascript">
		 ...
		 $(function() {
		 	...
		 	if(signFlag=='under'){
		 		...
		 		$("<option value='need'>发起人</option>").appendTo("#rejectLinkSelect");
		 	}else if(signFlag=='above'){
		 		$("<option value='last'>上一环节</option>").appendTo("#rejectLinkSelect");
		 		$("<option value='cityManageExamine'>市运维业务主管</option>").appendTo("#rejectLinkSelect");
		 		$("<option value='need'>发起人</option>").appendTo("#rejectLinkSelect");
		 	}
	        ...
	        $("#submitButton").click(function() {
	        	...
	        	$.ajax({
	        		type:"POST",
	        		url:"${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=linkRejected",
		...
		<div id="sheetform">
			<html:form action="/pnrTransferNewPrecheck.do?method=rollback"
				styleId="theform">
