...
<script type="text/javascript">
	...
	function deleteData(id){
		if(window.confirm("确定删除?")){
			...
			window.location="${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=removeProcessInstance&processInstanceId="+id+condition;
		}
	}
</script>
...
<div id="sheetform">
			<html:form action="/pnrTransferNewPrecheck.do?method=listRunningProcessInstances"
				styleId="theform">
	...
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		<display:column property="distributedInterfaceTime" sortable="true"
			headerClass="sortable" title="省公司批复时间"
			format="{0,date,yyyy-MM-dd HH:mm:ss}" />
		...
		<display:column sortable="true"
			...
			<c:choose>
				<c:when test="${taskList.taskDefKey eq 'need' && taskList.statusName ne '已删除' }">
