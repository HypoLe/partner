...
var v;
  ...
  Ext.onReady(function(){
	...
	var keyWord='${pnrTransferOffice.keyWord}';
	if (values!=null&&keyWord!='101230807'){
   ...
   function changeType1(){
   	  ...
   	  if(_projectAmount<=50000){
   	  	  jq("#keyWord").attr("disabled",false);
...
//编辑表头内容，影响显示
function editFirstTrContent(str){
	var tempStr=str;
	var len = tempStr.length;
	if( len > 4){
		tempStr=str.substring(0,4)+"<br />"+str.substring(4);
	}
	return tempStr;
}
...
function setMaste(vals,texts){
	 ...
	 success: function (data) {
		 ...
		 tabelStr="<table class='formTable' id='"+childSceneValue+"_table' name='"+childSceneValue+"_table'>"+firstTr+twoTr+"</table><br />";
		...
		<table id="sheet" class="formTable">
			...
			<tr>
				...
				<td class="content" style="width: 24%">
					${mobilePhone}
					<input type="hidden" id="initiatorMobilePhone" name="initiatorMobilePhone" value="${mobilePhone}" />
				</td>
			</tr>
			...
			<tr>
				...
				<td class="content" style="width: 23%">
					 <input type="text" class="text" id="deptHead"  name="deptHead" value="${pnrTransferOffice.deptHead}" alt="allowBlank:false,maxLength:100,vtext:'请输入部门负责人，最大长度为50个汉字！'" />
				</td>
				<td class="label" style="width: 10%">
					区县维护负责人电话*
				</td>
				<td class="content" style="width: 23%">
					  <input type="text" class="text" id="deptHeadMobilePhone"  name="deptHeadMobilePhone" value="${pnrTransferOffice.deptHeadMobilePhone}" alt="allowBlank:false,maxLength:100,vtext:'请输入部门负责人电话，最大长度为50个汉字！'" />
				</td>
				<td class="label" style="width: 10%">
					应急/常规*
				</td>
				<td class="content" style="width: 24%">
					...
					alt="allowBlank:false" styleClass="select" /><br/><br/>应急工单仅限应急资金解决工单
				</td>
			</tr>
		...
		<table id="sheet" class="formTable">
			<tr>
				...
				<td class="content" style="width: 23%" colspan="3">
					<input type="text" style="width: 84%" class="text" id="lineName"  name="lineName" onfocus="changeColorTwo(this)" onblur="changeColorOne(this)" value="${pnrTransferOffice.lineName==null||pnrTransferOffice.lineName==''?'与资源系统一致':pnrTransferOffice.lineName}" alt="allowBlank:false,maxLength:100,vtext:'请输入线路名称，最大长度为50个汉字！'" />
				</td>
				<td class="label" style="width: 10%">
					线路级别*
				</td>
	...
	<fieldset style="border-width: 2px; border-color: #98C0F4;">
		...
		<table id="sheet" class="formTable">
			<tr>
				...
				<td class="content" style="width: 23%">
					<input type="text" id="layingCable" name="layingCable" class="text" 
						value="${pnrTransferOffice.layingCable}" onblur="checkMainEngineeringQuantity(this,'光缆');" />&nbsp;皮长公里
				</td>
				...
				<td class="content" style="width: 23%">
					<input type="text" id="rightingDemolitionPole" name="rightingDemolitionPole" class="text" 
						...
						onblur="checkMainEngineeringQuantity(this,'电杆');" />&nbsp;棵
				</td>
				<td class="label" style="width: 10%">
					管道
				</td>
				<td class="content" style="width: 24%">
					<input type="text" id="repairPipeline" name="repairPipeline" class="text" 
						...
						onblur="checkMainEngineeringQuantity(this,'管道');" />&nbsp;孔公里
				</td>
			</tr>
			...
			<tr>
				...
				<td class="content" style="width: 23%">
					<input type="text" id="wireLaying" name="wireLaying" class="text" 
						...
						onblur="checkMainEngineeringQuantity(this,'钢绞线');" />&nbsp;公里
				</td>
				<td class="label" style="width: 10%">
					光交接箱
				</td>
				<td class="content" style="width: 23%">
					<input type="text" id="excavationTrench" name="excavationTrench" class="text" 
						...
						onblur="checkMainEngineeringQuantity(this,'光交接箱');" />&nbsp;个
				</td>
				<td class="label" style="width: 10%">
					光分路器箱
				</td>
				<td class="content" style="width: 24%">
					<input type="text" id="fiberOpticCableConnector" name="fiberOpticCableConnector" class="text" 
						...
						onblur="checkMainEngineeringQuantity(this,'光分路器箱');" />&nbsp;个
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="5" style="width:90%">
					<textarea id="mainQuantityOther" name="mainQuantityOther" class="textarea max" alt="allowBlank:true,maxLength:1000,vtext:'请输入其它，最大长度为500个汉字！'">${pnrTransferOffice.mainQuantityOther}</textarea>
				</td>
			</tr>
	...
	<fieldset style="border-width: 2px; border-color: #98C0F4;">
		...
		<table id="sheet" class="formTable">
			...
			<!--<tr>
				...
				<td colspan="5" style="width:90%">
					<textarea id="networkStatus" name="networkStatus" class="textarea max" alt="allowBlank:false,maxLength:1000,vtext:'请输入网络现状描述，最大长度为500个汉字！'">${pnrTransferOffice.networkStatus}</textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="5" style="width:90%">
					<textarea id="constructionMainContent" name="constructionMainContent" class="textarea max" alt="allowBlank:false,maxLength:1000,vtext:'请输入主要建设内容及规模，最大长度为500个汉字！'">${pnrTransferOffice.constructionMainContent}</textarea>
				</td>
			</tr>
			
			-->
			<c:choose>
				<c:when test="${pnrTransferOffice.keyWord =='101230807'}">
					<tr>
					  <td class="label" style="width:10%">照片清单</td>
					  <td colspan="5" style="width:20%">
					  	<input type="button" class="btn" id="showPhotos" name="showPhotos" value="查看照片" onclick="selectPhoto1()">
					...
					<tr>
						...
						<td colspan="5" style="width:90%">
							...
							<input class="text" type="hidden" name="photoIds" readonly="true"
								id="photoIds" alt="allowBlank:false" value="${photoIds }" />
...
<br/>
	...
	function setdisable(){
		var keyWord='${pnrTransferOffice.keyWord}';
		if(keyWord=='101230807'){
			jq("#keyWord").attr("disabled",true);
		}else{
	...
	*/
	function selectPhoto(){	
		...
		var photoType="transferNewPrechechProcess";	//本地网预检预修
	...
	*/
	function selectPhoto1(){	
		...
		//alert(pid);
		var url = '${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=showCreateWorkPhoto&pid='+pid;
        //window.open(url);
		var _sHeight = 600;
	    var _sWidth = 820;
	    var sTop=(window.screen.availHeight-_sHeight)/2;
