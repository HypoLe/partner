	...
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		sort="list" size="total" partialList="true" >
			...
			<display:column sortable="true" headerClass="sortable" title="处理"
				media="html">
				<a
					href="${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=catchBackWorkOrder&processInstanceId=${taskList.processInstanceId}&taskId=${taskList.taskId}&taskDefKey=${taskList.taskDefKey}${condition}"
					title="抓回"> 抓回 </a>
			</display:column>
