...
<!-- 根据后台数据呈现表格 -->
<c:forEach  items="${materialTableList}" var="materialTable" >
	<table class="formTable">
	<tr>
		<c:forEach items="${materialTable.tableHeader}" var="tableHeader">
			<td style="background-color: #f7f7f7;vertical-align: top;">${tableHeader}</td>
		</c:forEach>
	</tr>
	
	<c:forEach items="${materialTable.tableData}" var="ds">
		<tr>
