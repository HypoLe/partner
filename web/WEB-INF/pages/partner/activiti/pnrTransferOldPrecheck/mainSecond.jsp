...
Ext.onReady(function(){
   v = new eoms.form.Validation({form:'theform'});
	...
	<html:form action="/pnrTransferOldPrecheck.do?method=mainSecond" styleId="theform" >
...
<%@ include file="/WEB-INF/pages/partner/activiti/pnrTransferOldPrecheck/transfer_all_basis.jsp"%>
<!--派单树-->
<br/>
<fieldset>
 	<legend>
