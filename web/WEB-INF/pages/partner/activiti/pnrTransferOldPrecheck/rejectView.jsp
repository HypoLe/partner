	...
	<head>
		...
		<script type="text/javascript">
		 ...
		 $(function() {
		    ...
		    //提交 /pnrTransferOldPrecheck.do?method=rollback
	        $("#submitButton").click(function() {
	        	...
	        	$.ajax({
	        		type:"POST",
	        		url:"${app}/activiti/pnrTransferOldPrecheck/pnrTransferOldPrecheck.do?method=rollback",
		...
		<div id="sheetform">
			<html:form action="/pnrTransferOldPrecheck.do?method=rollback"
				styleId="theform">
