...
<%@ include file="/WEB-INF/pages/partner/activiti/pnrTransferOldPrecheck/transfer_do_msg.jsp"%>

<div style="TEXT-ALIGN: center; height:20"></div>
 <!-- 工单基本信息end --> 

	<html:form action="/pnrTransferOldPrecheck.do?method=secondAudit" styleId="theform" >	
