...
<html:form action="/pnrTransferOldPrecheck.do?method=transferProgramSGS" styleId="theform" >
			<!-- 驳回需要的参数 -->
            ...
            <input type="hidden" name="countryCSJ" value="${pnrTransferOffice.countryCSJ}">
