...
<div id="sheetform">
			<html:form action="/pnrTransferPrecheck.do?method=listInvolvedUnfinishedProcessInstances"
				styleId="theform">
					...
					<tr>
						...
						<td colspan="3">
							<select id="status" name="status" class="text" 
								...
								<option value="manageExamineCompleted" ${wsStatus == "manageExamineCompleted" ? 'selected="selected"':'' }>
									市公司审批完毕
								</option>
							</select>
						</td>
