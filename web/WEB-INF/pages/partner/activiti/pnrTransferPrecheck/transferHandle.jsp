...
<%@ include file="/WEB-INF/pages/partner/activiti/pnrTransferPrecheck/showAudit_basis.jsp"%>


<div style="height:20"></div>

<html:form action="/pnrTransferPrecheck.do?method=transferHandle" styleId="theform" >
