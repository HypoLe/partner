...
Ext.onReady(function(){
   v = new eoms.form.Validation({form:'theform'});
	...
	<html:form action="/pnrTransferPrecheck.do?method=mainSecond" styleId="theform" >
...
<%@ include file="/WEB-INF/pages/partner/activiti/pnrTransferPrecheck/transfer_all_basis.jsp"%>
<!--派单树-->
<br/>
<fieldset>
 	<legend>
