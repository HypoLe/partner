...
<%@ include file="/WEB-INF/pages/partner/activiti/pnrTransferPrecheck/transfer_do_msg.jsp"%>

<div style="TEXT-ALIGN: center; height:20"></div>
 <!-- 工单基本信息end --> 

	<html:form action="/pnrTransferPrecheck.do?method=secondAudit" styleId="theform" >	
