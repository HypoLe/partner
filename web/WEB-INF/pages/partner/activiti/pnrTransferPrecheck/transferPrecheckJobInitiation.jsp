...
<script type="text/javascript">
	...
	function distributeOrder(){		
		window.location.href="${app}/activiti/pnrTransferPrecheck/pnrTransferPrecheck.do?method=performAdd&initiator=${pnrTransferOffice.initiator}&taskAssignee=${pnrTransferOffice.taskAssignee}&processInstanceId=${pnrTransferOffice.processInstanceId}";
	}
	...
	jq(function(){
		jq("#updateButton").click(function(){
			var urlStr = "${app}/activiti/pnrTransferPrecheck/pnrTransferPrecheck.do?method=updateProjectAmount";
			...
			jq.ajax({
				type : "POST",
				url : urlStr, 
				data : {"processInstanceId":jq_processInstanceId,"theme":jq_theme,"themeId":jq_themeId},
...
<html:form action="/pnrTransferPrecheck.do?method=performSave" styleId="theform" >
	<input type="hidden" id="viewFlag" name="viewFlag" value="updateJob" /><!-- 保存标识 -->
...
<table class="formTable">
	<tr>
	  ...
	  <td colspan="3">
	    <input type="hidden" name="title" id="title" value="${pnrTransferOffice.theme}" />
