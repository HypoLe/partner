...
function chooseRes(){
			...
			if(count >= 6){
			//alert(photoIds);
			 var url="${app}/activiti/roomDemolition/roomDemolition.do?method=selectPhotoTodo&photoes="+photoIds;
...
<form action="${app}/activiti/roomDemolition/roomDemolition.do?method=conditionSelectPhoto" method="post" >
		...
		<div class="header center">图片列表</div>
			...
			<tr>
				...
				<td class="label">故障地点</td>
					<td class="content">
						<input type="text" name="faultLocation" value="${faultLocation }" styleClass="text medium" >
				</td>
				<td class="label">
					拍照人
				</td>
