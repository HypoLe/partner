...
<html:form action="/roomDemolition.do?method=transferProgram" styleId="theform" >
			<!-- 市公司运维部主管审批 页面 -->
			<!-- 带注释为驳回时需要的参数 -->
			<input type="hidden" id="marker" name="marker" value="cityManageExamine" /><!-- 流程标识 marker和linkName隐藏域的值应该保持一致-->	
            ...
            <input type="hidden" id="returnPerson" name="returnPerson" value="${roomDemolition.createWork}"><!-- 驳回人 -->
			...
			<input type="hidden" name="provinceManageCharge" value="${roomDemolition.provinceManageCharge}">
