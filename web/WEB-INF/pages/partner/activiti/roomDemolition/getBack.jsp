...
<div id="sheetform">
			<html:form action="/pnrTransferNewPrecheck.do?method=getBack"
				styleId="theform">
...
<bean:define id="url" value="pnrTransferNewPrecheck.do"/>
	...
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		export="${export}" requestURI="pnrTransferNewPrecheck.do"
		sort="list" size="total" partialList="true" >

			<display:column sortable="true" headerClass="sortable" title="工单号">
				<a
					href="${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=gotoDetail&processInstanceId=${taskList.processInstanceId}"
					target="_blank"> ${taskList.processInstanceId} </a>
			</display:column>

			<display:column property="sheetId" sortable="false" headerClass="sortable" title="工单编码" />
			...
			<display:column sortable="true" headerClass="sortable" title="处理"
				media="html">
				<a
					href="${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=catchBackWorkOrder&processInstanceId=${taskList.processInstanceId}&taskId=${taskList.taskId}&taskDefKey=${taskList.taskDefKey}"
					title="抓回"> 抓回 </a>
			</display:column>
