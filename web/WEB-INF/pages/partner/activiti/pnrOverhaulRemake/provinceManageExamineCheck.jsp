...
var v;
  ...
  function countersign(){
	  if(confirm("是否确定进行专家会审?")){
		window.location="${app}/activiti/pnrTransferPrecheck/pnrOverhaulRemake.do?method=countersign&processInstanceId=${processInstanceId}&city=${pnrTransferOffice.city}";
	  }
...
<%@ include file="/WEB-INF/pages/partner/activiti/pnrOverhaulRemake/showTriage_basis.jsp"%>

<div style="height:20"></div>

<html:form action="/pnrOverhaulRemake.do?method=transferProgramSGS" styleId="theform" >
			<!-- 带注释为驳回时需要的参数 -->
            ...
            <input type="hidden" name="provinceManageHandleState" value="handle">
