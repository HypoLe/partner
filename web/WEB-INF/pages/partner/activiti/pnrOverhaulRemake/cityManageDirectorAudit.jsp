...
<html:form action="/pnrOverhaulRemake.do?method=transferProgram" styleId="theform" >
            ...
            <input type="hidden" name="cityManageDirectorState" value="handle">
            <input type="hidden" name="step" value="6">
			<input type="hidden" name="nextTaskAssignee" value="${pnrTransferOffice.cityGS}">
			<input type="hidden" name="nextPerson" value="${pnrTransferOffice.cityGS}">
 		...
 		<tr>
			...
			<td class="content" >
				<eoms:attachment name="sheetMain" property="sheetAccessories" 
		            scope="request" idField="cityManageDirectorAudit" appCode="pnrActTransferOffice" alt="allowBlank:false;请选择保存的附件"/> 
			</td>
