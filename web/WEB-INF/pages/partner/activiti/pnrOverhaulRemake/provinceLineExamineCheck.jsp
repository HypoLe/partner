...
<html:form action="/pnrOverhaulRemake.do?method=transferProgram" styleId="theform" >
            ...
            <input type="hidden" id="returnPerson" name="returnPerson" value="${pnrTransferOffice.cityCSJ}"><!-- 驳回人 -->
            ...
            <input type="hidden" name="provinceLineHandleState" value="handle">
            <input type="hidden" name="step" value="5">
			<input type="hidden" name="provinceManageCheck" value="${pnrTransferOffice.provinceManage}">
			<input type="hidden" name="linkName" value="provincialOperationApproval">
