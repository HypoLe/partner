...
Ext.onReady(function(){
   v = new eoms.form.Validation({form:'theform'});
	...
	<html:form action="/pnrOverhaulRemake.do?method=mainSecond" styleId="theform" >
...
<%@ include file="/WEB-INF/pages/partner/activiti/pnrOverhaulRemake/transfer_all_basis.jsp"%>
<!--派单树-->
<br/>
<fieldset>
 	<legend>
