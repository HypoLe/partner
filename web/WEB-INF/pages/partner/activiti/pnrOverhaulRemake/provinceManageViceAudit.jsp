...
<html:form action="/pnrOverhaulRemake.do?method=provinceManageViceAudit" styleId="theform" >
			<!-- 带注释为驳回时需要的参数 -->
		...
		<!-- 	<input type="hidden" name="cityManageDirectorAudit" value="${pnrTransferOffice.provinceManage}">  -->
			...
			<input type="hidden" id="themeInterface" name="themeInterface" value="${pnrTransferOffice.themeInterface}">
