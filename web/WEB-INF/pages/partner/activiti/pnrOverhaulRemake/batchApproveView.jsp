...
<html>
	<head>
		...
		<script type="text/javascript">
		 ...
		 $(function() {
		 	// var wsStatusVale= window.dialogArguments.document.getElementById("wsStatusFlag").value;
		 	//alert("wsStatusVale="+wsStatusVale);
	        ...
	        $("#submitButton").click(function() {
	        	...
	        	$.ajax({
	        		type:"POST",
	        		url:"${app}/activiti/pnrTransferPrecheck/pnrOverhaulRemake.do?method=doBatchApprove",
		...
		<div id="sheetform">
			<html:form action="/pnrOverhaulRemake.do?method=doBatchApprove"
				styleId="theform">
