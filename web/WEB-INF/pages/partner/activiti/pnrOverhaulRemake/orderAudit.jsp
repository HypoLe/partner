...
<%@ include file="/WEB-INF/pages/partner/activiti/pnrOverhaulRemake/transfer_basis_noAttachment.jsp"%>


<div style="height:20"></div>

<html:form action="/pnrOverhaulRemake.do?method=doOneWorkOrderArchiving" styleId="theform" >
	...
	<table id="sheet" class="formTable" >				
		...
		<div class="form-btns" id="btns" style="display:block">
			...
			<c:if test="${pnrTransferOffice.state ne '10'}">
				<html:submit styleClass="btn" property="method.save" onclick="javascript:return confirm('确定不需要手机端抽查，直接归档吗？');" styleId="method.save">
					归档
				</html:submit>&nbsp;&nbsp;
