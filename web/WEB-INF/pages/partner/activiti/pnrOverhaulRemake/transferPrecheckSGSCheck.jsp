...
<html:form action="/pnrOverhaulRemake.do?method=transferProgram" styleId="theform" >
			<!-- 带注释为驳回时需要的参数 -->
			<input type="hidden" id="marker" name="marker" value="cityOperationApproval" /><!-- 流程标识 -->	
            ...
            <input type="hidden" name="cityManageHandleState" value="handle">
			<input type="hidden" name="nextTaskAssignee" value="${pnrTransferOffice.cityCSJ}">
			 <input type="hidden" name="step" value="4">
			 <input type="hidden" name="linkName" value="cityOperationApproval">
