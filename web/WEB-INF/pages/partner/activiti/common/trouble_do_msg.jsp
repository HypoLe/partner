...
<c:forEach var="item" items="${PnrTroubleHandleList}"  varStatus="status"> 
...
<table id="sheet1" class="formTable" >
		...
		<tr>
		    ...
		    <eoms:attachment name="sheetReply${status.index}" property="sheetAccessories" 
		            scope="request" idList="sheetAccessories" idField="sheetAccessories" appCode="pnrActTrodubleTicket" 
		             viewFlag="Y"/> 
		    </td>
	   </tr>
