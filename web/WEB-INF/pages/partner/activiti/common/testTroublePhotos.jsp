...
//			Ext.get(document.body).mask('请稍等......');
		var src =document.getElementById(curPage).src;
		jq("#showImg").html("<img width='600' height='480'  src='"+src+"'>");
//				jq("#showImg").html("<img width='600' height='480'  src='${app}/activiti/pnrTroubleTicket/pnrTroubleTicket.do?method=testShowPicture&id="+pid+"&curPage="+curPage+"&idType=inspectPlan'>");
...
//先获得屏幕的宽度和高度
		...
		var src =document.getElementById(curPage).src;
	//	jq("#showImg").html("<img width='600' height='480'  src='"+src+"'>");
		jq("#showImg").html("<img width='600' height='480'  src='${app}/activiti/pnrTroubleTicket/pnrTroubleTicket.do?method=testShowPicture&id="+id+"&curPage="+curPage+"'>");
...
<style type="text/css">
  .labelpartner {
	...
	<display:table name="list" cellspacing="0" cellpadding="0"
			...
			headerClass="sortable" title="照片qqq">
			<img src="${app}/activiti/pnrTroubleTicket/pnrTroubleTicket.do?method=testShowPicture&id=${list.id}" border="0" height="20px" width="50px" id="${list_rowNum}" onclick="pictureId('${list.id}','${list_rowNum}')"/>
			 </display:column>
