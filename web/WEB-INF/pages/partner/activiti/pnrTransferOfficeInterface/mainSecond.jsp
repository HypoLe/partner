...
Ext.onReady(function(){
   v = new eoms.form.Validation({form:'theform'});
	...
	<html:form action="/pnrTransferInterface.do?method=mainSecond" styleId="theform" >
...
<%@ include file="/WEB-INF/pages/partner/activiti/pnrTransferOfficeInterface/transfer_basis.jsp"%>
<!--派单树-->
<br/>
<fieldset>
 	<legend>
