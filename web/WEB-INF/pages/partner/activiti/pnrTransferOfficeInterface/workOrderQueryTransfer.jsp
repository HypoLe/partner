...
<div id="sheetform">
    <html:form action="/pnrTransferInterface.do?method=workOrderQuery" styleId="theform">
        <table class="formTable">
            <tr>
                ...
                <td colspan="3">
                   <input type="radio" id="1012301" value="1012301" name="taskType" onclick="javascript:eoms.ComboBox.doCombo(this,'mainFaultNet');" checked/>传输局运维商城接口&nbsp;&nbsp;
