...
<div style="TEXT-ALIGN: center; height:20"></div>
 <!-- 工单基本信息end --> 
	...
	<html:form action="/pnrTransferInterface.do?method=goTransferCheck" styleId="theform" >	
...
<table id="sheet" class="formTable" >
		<tr>
		  ...
		  <td class="content" colspan="3">
		    <input type="radio" name="auditState" value="through"  checked=”checked”/>通过		  
		    <input type="radio" name="auditState" value="dismiss"/>不通过
		  </td>	
