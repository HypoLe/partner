...
<div style="TEXT-ALIGN: center; height:20"></div>
 <!-- 工单基本信息end --> 
	...
	<html:form action="/pnrTransferInterface.do?method=secondAudit" styleId="theform" >	
...
<table id="sheet" class="formTable" >
		<tr>
		  ...
		  <td class="content" colspan="3">
		    <input type="radio" name="transferAudit" value="pass"  checked=”checked”/>通过
		    <input type="radio" name="transferAudit" value="reject"/>不通过
		  </td>	
