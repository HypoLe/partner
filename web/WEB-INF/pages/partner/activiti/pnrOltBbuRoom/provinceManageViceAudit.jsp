...
<html:form action="/pnrTransferNewPrecheck.do?method=provinceManageViceAudit" styleId="theform" >
			<!-- 带注释为驳回时需要的参数 -->
			<input type="hidden" id="marker" name="marker" value="provinceManageViceAudit" /><!-- 流程标识 marker和linkName隐藏域的值应该保持一致-->	
            ...
            <input type="hidden" id="returnPerson" name="returnPerson" value="${pnrTransferOffice.provinceManageCharge}"><!-- 驳回人 -->
            <input type="hidden" id="rejectState" name="rejectState" value="provinceManageViceState#rollback"><!--驳回状态名值对  -->
			...
			<input type="hidden" name="linkName" value="provinceManageViceAudit">
		 		...
		 		<tr>
					...
					<td class="content" >
						<eoms:attachment name="sheetMain" property="sheetAccessories" 
				            scope="request" idField="provinceManageViceAudit" appCode="pnrActTransferOffice" alt="allowBlank:false;请选择保存的附件"/> 
					</td>
		 			<td class="label">
						审批人
					</td>
