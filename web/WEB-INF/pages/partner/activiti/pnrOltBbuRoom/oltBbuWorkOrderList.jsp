...
<script type="text/javascript">
	...
	*/
	...
	function changeType1(){
		...
		<div id="sheetform">
			<html:form action="/pnrOltBbuRoom.do?method=oltBbuWorkOrderList"
				styleId="theform">
...
<!--					<html:button property="" styleClass="btn" onclick="batchRegression()">批量回退</html:button>-->
	 ...
	 <!-- 	<c:if test="${!empty taskList && taskList ne null}">
		...
		<display:table name="taskList" cellspacing="0" cellpadding="0"
			...
			<display:column sortable="false" headerClass="sortable" property="statusName" title="工单状态"></display:column>
...
<c:if test="${!empty taskList}">
	<eoms:excelExportToProcess modelName="com.boco.activiti.partner.process.po.PnrOltBbuOfficeMainModel" serviceBeanId="pnrOltBbuRoomService" title="olt-bbu机房优化申请工单查询" queryFlag="oltBbuWorkOrderList" processKey="oltBbuProcess" flag="backlog">		
