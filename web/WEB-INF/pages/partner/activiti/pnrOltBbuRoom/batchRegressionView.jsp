...
<html>
	<head>
		...
		<script type="text/javascript">
		 ...
		 $(function() {
	        ...
	        $("#submitButton").click(function() {
	        	alert("请点击确定开始批量回退！由于处理的工单数较多，过程较慢，处理过程中请勿关闭该窗口！");
		        var rejectReason1 = $("#rejectReason").val(); //审批人
	        
	        	$.ajax({
	        		type:"POST",
	        		url:"${app}/activiti/pnrOltBbuRoom/pnrOltBbuRoom.do?method=doBatchRegression",
		...
		<div id="sheetform">
			<html:form action="/pnrOltBbuRoom.do?method=doBatchApprove"
				styleId="theform">
