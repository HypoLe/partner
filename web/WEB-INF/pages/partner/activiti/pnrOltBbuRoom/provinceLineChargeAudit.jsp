...
<html:form action="/pnrOltBbuRoom.do?method=transferProgram" styleId="theform" >
            ...
            <input type="hidden" id="rejectState" name="rejectState" value="provinceLineChargeState#rollback"><!--驳回状态名值对  -->
			...
			<input type="hidden" name="nextPerson" value="${pnrTransferOffice.provinceManageCharge}"><!-- 发短信指定派发到的人 -->
			<input type="hidden" id="nextTaskLinkName" name="nextTaskLinkName" value="省运维主管审核"><!-- 发短信指定派发到的环节名 -->
