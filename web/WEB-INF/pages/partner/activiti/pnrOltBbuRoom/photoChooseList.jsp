...
function chooseRes(){
			...
			//alert("photoIds="+photoIds);
			var url="${app}/activiti/pnrOltBbuRoom/pnrOltBbuRoom.do?method=selectPhotoTodo&photoes="+photoIds;
			...
			Ext.Ajax.request({
				...
				success: function ( result, request ) { 
	               ...
	               // if(eoms.isIE){
					...
					window.dialogArguments.setPhoto(sum,photoIds,tagName,photoType);
...
<form action="${app}/activiti/pnrOltBbuRoom/pnrOltBbuRoom.do?method=conditionSelectPhoto" method="post" >
