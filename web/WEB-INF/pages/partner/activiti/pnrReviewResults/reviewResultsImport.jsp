...
function saveImport() {
	...
	new Ext.form.BasicForm('importForm').submit({
		timeout:600000,
		method :'post',
		url : "${app}/activiti/pnrTransferOffice/pnrReviewResults.do?method=importReviewResults",
	  	waitTitle : '请稍后...',
		waitMsg : '正在导入数据,请稍后...',
...
<div style="border:1px solid #98c0f4;padding:5px;"
  ...
  <div id="listQueryObject" 
	 ...
	 <form action="${app}/activiti/pnrTransferOffice/pnrReviewResults.do?method=importReviewResults"
		method="post" id="importForm" name="importForm"
		enctype="multipart/form-data" onsubmit="return checkForm()">
		<table border=0 cellspacing="1" cellpadding="1" class="listTable">
			<!--附加表以及XML文件基本属性表格：开始-->
			<tr >
				<td  COLSPAN="2" class="label" width="20%">模板下载<font color="red">*</font></td>
				<td width="40%" style="border-right-style: none; border-right-width: medium">
                    <input type="button" class="button" name="save" value="下载导入模板"
                           onclick="javascript:location.href='${app}/activiti/pnrTransferOffice/pnrReviewResults.do?method=downloadReviewResultsImportModel'" />
                </td>
		    	<td width="40%" style="border-left-style: none; border-left-width: medium">
		    	<a id="errorData1" style="display:none;" href="${app}/errorfile/huishenjieguo${userid}.xls"><font color="red" size="3">下载"会审结果"错误信息</font></a>	        			
			...
			<tr>
				<td COLSPAN="17"><input type="button" value="导入" class="submit" onclick="saveImport()"></td>
			</tr>
		</table>
	</form>
  </div>
