...
Ext.onReady(function(){
   ...
   function changeType1(){
	...
	<html:form action="/pnrTroubleTicket.do?method=mainSecond" styleId="theform" >
     <input id="handleState" type="hidden" name="handleState" value="twoHandle">
     <input id="dueDate" type="hidden" name="dueDate" value="${eoms:date2String(pnrTroubleTicket.endTime)}">
