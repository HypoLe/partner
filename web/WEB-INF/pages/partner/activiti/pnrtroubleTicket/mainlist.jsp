...
<c:if test="${findForward != null && findForward == 'mainlist'}">
	<jsp:include page="/WEB-INF/pages/partner/activiti/common/listsendDoneJS.jsp"/>
</c:if>
<bean:define id="url" value="pnrTroubleTicket.do" />

	<display:table name="taskList" cellspacing="0" cellpadding="0"
		id="taskList" pagesize="${pageSize}" class="table taskList"
		export="true" requestURI="pnrTroubleTicket.do"
		sort="list" size="total" partialList="true"
		decorator="com.boco.eoms.partner.activiti.webapp.action.MainListDisplaytagDecoratorHelper">
