...
<bean:define id="url" value="pnrTroubleTicket.do"/>
	...
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="true"
			...
			<c:choose>
				<c:when test="${taskList.taskDefKey eq 'troubleShooting' || taskList.taskDefKey eq 'twoHandle'}">
				<a href="${app}/activiti/pnrTroubleTicket/pnrTroubleTicket.do?method=removeProcessInstance&processInstanceId=${taskList.processInstanceId}">
					删除
				</a>&nbsp;&nbsp;
				...
				<c:when test="${taskList.taskDefKey eq 'newDistribution'}">
				<a href="${app}/activiti/pnrTroubleTicket/pnrTroubleTicket.do?method=removeProcessInstance&processInstanceId=${taskList.processInstanceId}">
					删除
				</a>	
				</c:when>
