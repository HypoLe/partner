...
--></script>
<div id="sheetform">
	<html:form action="/pnrStatistics.do?method=workOrderStatisticstijiao" styleId="theform">
		<table class="formTable">
		   ...
		   <!-- 工单类型 -->
              ...
              <td colspan="3">
				<input type="radio" value="trouble" name="taskType" onclick="alertData(1)"/>故障工单&nbsp;&nbsp;
				<input type="radio" value="task" name="taskType" onclick="alertData(2)"/>任务工单&nbsp;&nbsp;
				<input type="radio" value="all" name="taskType" onclick="alertData(3)" checked="true"/>全部
		   ...
		   <!-- 工单子类型 -->
              ...
              <c:forEach items="${troubleList}" var="trouble">
              			<input type="checkbox" value="${trouble.dictId}" name="subType" checked="true"/>${trouble.dictName}&nbsp;&nbsp;
               </c:forEach>
               </span>
               <span id="tasksub">
