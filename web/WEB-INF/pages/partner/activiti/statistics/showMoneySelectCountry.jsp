...
<form action="pnrStatistics.do?method=showMoneySelectCountry"
...
<table class="table list" cellpadding="0" cellspacing="0">
  	<thead>
  		<tr>
  			...
  			<th style="text-align:center;" >提交金额</th>  		
  ...
  <tr>
   <td style="text-align:center;">预检预修-常规工单</td>	
 	 <td style="text-align:center;"><fmt:formatNumber value="${list.balance}" pattern="##.##" maxFractionDigits="2" minFractionDigits="0" /></td>
   ...
   <td style="text-align:center;">收支比小于50%的大修改造工单</td>	
 	 <td style="text-align:center;"><fmt:formatNumber value="${list.projectMoney}" pattern="##.##" maxFractionDigits="2" minFractionDigits="0" /></td>
