...
<logic:present name="list" scope="request">
	<display:table name="list" cellspacing="0" cellpadding="0"
		...
		<display:column  title="申报完成比率" >
		    <fmt:formatNumber value="${list.auditPercent }" pattern="#.##"></fmt:formatNumber>%
		</display:column>
		...
		<display:column title="会审合格率" >
			<fmt:formatNumber value="${list.passPercent }" pattern="#.##"></fmt:formatNumber>%
		</display:column>
		<display:column title="审批同意率" >
			<fmt:formatNumber value="${list.auditPassPercent }" pattern="#.##"></fmt:formatNumber>%
		</display:column>
	</display:table>
</logic:present>
	</br>
