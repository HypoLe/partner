...
<html>
	<head>
		...
		<script type="text/javascript">
		 ...
		 $(function() {
	        ...
	        $("#submitButton").click(function() {
	        	...
	        	$.ajax({
	        		type:"POST",
	        		url:"${app}/activiti/pnrHiddendangerReported/pnrHiddendangerReported.do?method=linkRejected",
	        		data:{"handle":marker,"taskId":taskId,"processInstanceId":processInstanceId,"returnPerson":returnPerson,"themeId":titleId,"theme":title,"rejectReason":rejectReason,
		...
		<div id="sheetform">
			<html:form action="/pnrHiddendangerReported.do?method=rollback"
				styleId="theform">
