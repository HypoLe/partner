...
//先获得屏幕的宽度和高度
		...
		var src =document.getElementById(curPage).src;
	//	jq("#showImg").html("<img width='600' height='480'  src='"+src+"'>");
		jq("#showImg").html("<img width='600' height='480'  src='${app}/activiti/pnrTransferPrecheck/pnrTransferNewPrecheck.do?method=precheckShowPicture&id="+id+"&curPage="+curPage+"'>");
