...
<script type="text/javascript">
   ...
   //此刷新函数被弹出的子模态窗口调用
   function refresh(){
	    window.location.href = "${app}/activiti/pnrTransferPrecheck/pnrTransferArteryPrecheck.do?method=waitWorkOrderList";
	} 
...
//点击批量回退按钮，弹出子窗口
	 function batchRegression(){
		...
		<div id="sheetform">
			<html:form action="/pnrTransferArteryPrecheck.do?method=waitWorkOrderList"
				styleId="theform">
		...
		<display:table name="taskList" cellspacing="0" cellpadding="0"
			...
			export="${export}" requestURI="pnrTransferArteryPrecheck.do" sort="list"
...
<c:if test="${!empty taskList}">
	<eoms:excelExportToProcess modelName="com.boco.activiti.partner.process.po.TaskModel" serviceBeanId="pnrTransferNewPrecheckService" title="待办工单" queryFlag="waitWorkOrderList" processKey="transferArteryPrecheckProcess" flag="wait">		
