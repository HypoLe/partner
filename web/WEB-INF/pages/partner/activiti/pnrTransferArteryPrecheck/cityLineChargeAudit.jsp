...
<html:form action="/pnrTransferArteryPrecheck.do?method=transferProgram" styleId="theform" >
            ...
            <input type="hidden" id="returnPerson" name="returnPerson" value="${pnrTransferOffice.secondCreateWork}"><!-- 驳回人 -->
			...
			<input type="hidden" name="cityLineDirectorAudit" value="${pnrTransferOffice.cityLineDirector}">
			<input type="hidden" name="nextPerson" value="${pnrTransferOffice.cityLineDirector}">
