...
<script type="text/javascript">
	...
	function deleteData(id){
		if(window.confirm("确定删除?")){
			...
			window.location="${app}/activiti/pnrTransferPrecheck/pnrTransferArteryPrecheck.do?method=removeProcessInstance&processInstanceId="+id+condition;
		}
	}
</script>
...
<div id="sheetform">
			<html:form action="/pnrTransferArteryPrecheck.do?method=listRunningProcessInstances"
				styleId="theform">
