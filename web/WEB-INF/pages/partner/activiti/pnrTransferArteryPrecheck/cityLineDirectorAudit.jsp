...
<html:form action="/pnrTransferArteryPrecheck.do?method=transferProgram" styleId="theform" >
			<!-- 带注释为驳回时需要的参数 -->
			<input type="hidden" id="marker" name="marker" value="cityLineDirectorAudit" /><!-- 流程标识 -->	
            ...
            <input type="hidden" name="cityLineDirectorState" value="handle">
            <input type="hidden" name="step" value="4">
			<input type="hidden" name="nextTaskAssignee" value="${pnrTransferOffice.provinceLineCharge}">
			<input type="hidden" name="nextPerson" value="${pnrTransferOffice.provinceLineCharge}">
			<input type="hidden" name="linkName" value="cityLineDirectorAudit">
 		...
 		<tr>
			...
			<td class="content" >
				<eoms:attachment name="sheetMain" property="sheetAccessories" 
		            scope="request" idField="cityLineDirectorAudit" appCode="pnrActTransferOffice" alt="allowBlank:false;请选择保存的附件"/> 
			</td>
