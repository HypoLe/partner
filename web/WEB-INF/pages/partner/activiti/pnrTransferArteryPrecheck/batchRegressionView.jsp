...
<html>
	<head>
		...
		<script type="text/javascript">
		 ...
		 $(function() {
	        ...
	        $("#submitButton").click(function() {
	        	...
	        	$.ajax({
	        		type:"POST",
	        		url:"${app}/activiti/pnrTransferPrecheck/pnrTransferArteryPrecheck.do?method=doBatchRegression",
		...
		<div id="sheetform">
			<html:form action="/pnrTransferArteryPrecheck.do?method=doBatchRegression"
				styleId="theform">
