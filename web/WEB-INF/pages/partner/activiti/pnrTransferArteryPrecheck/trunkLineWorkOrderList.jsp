...
<script type="text/javascript">
   ...
   function archive(){
       if(confirm("确定不需要手机端抽查，直接归档吗？")){
		...
		<div id="sheetform">
			<html:form action="/pnrTransferArteryPrecheck.do?method=trunkLineWorkOrderList"
				styleId="theform">
...
<!--					<html:button property="" styleClass="btn" onclick="batchRegression()">批量回退</html:button>-->
		...
		<display:table name="taskList" cellspacing="0" cellpadding="0"
			...
			<display:column property="sheetId" sortable="true" headerClass="sortable" title="工单编码" style = "width:100"/>
			...
			<display:column sortable="false" headerClass="sortable" title="工单状态" maxLength="15">
				${taskList.statusName}
			</display:column>
			...
			<display:column sortable="false" property="subTypeName" headerClass="sortable" title="工单子类型" maxLength="15"/>
...
<c:if test="${!empty taskList}">
	<eoms:excelExportToProcess modelName="com.boco.activiti.partner.process.po.TaskModel" serviceBeanId="pnrTransferNewPrecheckService" title="干线预检预修工单查询" queryFlag="localNetworkWorkOrder" processKey="transferArteryPrecheckProcess" flag="">		
