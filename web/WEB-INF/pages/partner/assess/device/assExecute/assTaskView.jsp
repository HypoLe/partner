...
<html:form action="/deviceAssExecute.do?method=taskDetailList" styleId="assTaskViewForm" method="post" > 
		...
		<td class="content">
			<select name="taskId" id="taskId" 
				...
				<option value="${taskList.id}">
					<eoms:id2nameDB id="${taskList.templateId}" beanId="deviceAssTemplateDao" />
				</option>
				</logic:iterate>
			</select>
		</td>
