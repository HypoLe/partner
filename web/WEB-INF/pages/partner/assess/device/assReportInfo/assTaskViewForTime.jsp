...
function getCycle()
		{    
			...
			var url="<%=request.getContextPath()%>/partner/assess/deviceAssExecute.do?method=getCycle&taskId="+taskId;
...
<html:form action="/deviceAssReportInfo.do?method=taskListForTime" styleId="assTaskViewForm" method="post" > 
...
<script type="text/javascript">
	...
	Ext.onReady(function(){
		...
		dataUrl : "${app}/partner/assess/deviceAssTrees.do?method=getTemplateNodes&areaId=${areaId}"
		});
