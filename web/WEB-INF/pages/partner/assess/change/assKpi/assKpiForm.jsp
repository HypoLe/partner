...
<html:form action="/changeAssKpis.do?method=saveKpi" styleId="assKpiForm" method="post"> 
	...
	<tr>
		...
		<td class="content">
			<html:text property="kpiName" styleId="kpiName" style="width:88%" 
						...
						alt="allowBlank:false,vtext:'请输入指标名称'" value="${changeAssKpiForm.kpiName}" />
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
			<html:textarea property="remark" styleId="remark" style="width:88%" 
						styleClass="textarea"  value="${changeAssKpiForm.remark}" />
		</td>
	</tr>
</table>
...
<html:hidden property="id" value="${changeAssKpiForm.id}" />
</html:form>
