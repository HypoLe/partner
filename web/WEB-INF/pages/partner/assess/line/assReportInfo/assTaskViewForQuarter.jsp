...
<html:form action="/lineAssReportInfo.do?method=taskDetailListForQuarter" styleId="assTaskViewForm" method="post" > 
<table class="formTable" id="form">
	<caption>
		<div class="header center">后评估结果查询(季度)</div>
	</caption>
...
<table id="submit-btn" align="left">
	<tr>
		<td valign="top">
			<input type="submit" class="btn" value="查看后评估" />
		</td>
		<td>
