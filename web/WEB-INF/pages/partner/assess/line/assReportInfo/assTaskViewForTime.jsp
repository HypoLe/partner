...
function getCycle()
		{    
			...
			var url="<%=request.getContextPath()%>/partner/assess/lineAssExecute.do?method=getCycle&taskId="+taskId;
...
<html:form action="/lineAssReportInfo.do?method=taskListForTime" styleId="assTaskViewForm" method="post" > 
