...
<html:form action="/siteAssExecute.do?method=taskDetailList" styleId="assTaskViewForm" method="post" > 
<table class="formTable" id="form">
	<caption>
		<div class="header center">后评估实例执行</div>
	</caption>
		...
		<td class="content">
			<select name="taskId" id="taskId" 
				...
				<option value="${taskList.id}">
					<eoms:id2nameDB id="${taskList.templateId}" beanId="siteAssTemplateDao" />
				</option>
				</logic:iterate>
			</select>
		</td>
...
<table id="submit-btn" align="left">
	<tr>
		<td valign="top">
			<input type="submit" class="btn" value="执行后评估" />
		</td>
		<td>
