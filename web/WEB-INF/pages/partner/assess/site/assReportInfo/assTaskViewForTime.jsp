...
function getCycle()
		{    
			...
			var url="<%=request.getContextPath()%>/partner/assess/siteAssExecute.do?method=getCycle&taskId="+taskId;
			...
			if(timeType == 'year'){
			 ...
			 document.getElementById('monthSpan2').style.display='none';
			 document.getElementById('month2').disabled=true; 
			 document.getElementById('quarterSpan2').style.display='none';
			 ...
			 document.getElementById('monthSpan2').style.display='none';
			 document.getElementById('month2').disabled=true; 
			 document.getElementById('quarterSpan2').style.display='';
			 ...
			 document.getElementById('quarterSpan').style.display='none';
			 document.getElementById('quarter').disabled=true; 
			 document.getElementById('monthSpan2').style.display='';
...
function sameYear(valueStr){
	document.getElementById("year").value = valueStr ;
	document.getElementById("year2").value = valueStr ;
}    
</script>

<html:form action="/siteAssReportInfo.do?method=taskListForTime" styleId="assTaskViewForm" method="post" > 
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<select name="taskId" id="taskId" 
						alt="allowBlank:false,vtext:'请选择后评估模板'" onsite="getCycle()">
	...
	<tr>
		...
		<td class="content" colspan="3">
			<select name="year" id="year" alt="allowBlank:false,vtext:'请选择年份'" onchange="sameYear(this.value)">
			...
			~
			<select name="year2" id="year2" alt="allowBlank:false,vtext:'请选择年份'" onchange="sameYear(this.value)">
				<option value="">请选择</option>
				<option value="2005">2005</option>
				<option value="2006">2006</option>
				<option value="2007">2007</option>
			...
			<span id='monthSpan2'>
			<select name="month2" id="month2" alt="allowBlank:false,vtext:'请选择月份'">
				<option value="">请选择</option>
				<option value="01">1</option>
				<option value="02">2</option>
				<option value="03">3</option>
			...
			<span id='quarterSpan2'>
			<select name="quarter2" id="quarter2" alt="allowBlank:false,vtext:'请选择季度'">
				<option value="">请选择</option>
				<option value="01">1</option>
				<option value="02">2</option>
				<option value="03">3</option>
...
<script type="text/javascript">
	...
	Ext.onReady(function(){
		...
		dataUrl : "${app}/partner/assess/siteAssTrees.do?method=getTemplateNodes&areaId=${areaId}"
		});
