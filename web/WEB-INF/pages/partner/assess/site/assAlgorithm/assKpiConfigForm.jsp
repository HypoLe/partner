...
<html:form action="/siteAssKpiConfigs.do?method=save" styleId="assKpiConfigForm" method="post"> 
			...
			<c:if test="${not empty assKpiConfigForm.id}">
				<input type="button" class="btn" value="<fmt:message key="button.delete"/>" 
					onclick="javascript:if(confirm('你确定删除?')){
						var url='${app}/partner/assess/siteAssKpiConfigs.do?method=remove&nodeId=${assKpiConfigForm.nodeId}';
						location.href=url}"
						/>
			</c:if>
		</td>
