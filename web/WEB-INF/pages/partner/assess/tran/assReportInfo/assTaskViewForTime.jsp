...
function getCycle()
		{    
			...
			var url="<%=request.getContextPath()%>/partner/assess/tranAssExecute.do?method=getCycle&taskId="+taskId;
...
<html:form action="/tranAssReportInfo.do?method=taskListForTime" styleId="assTaskViewForm" method="post" > 
	...
	<tr>
		...
		<td class="content">
			<select name="taskId" id="taskId" 
						alt="allowBlank:false,vtext:'请选择后评估模板'" ontran="getCycle()">
...
<script type="text/javascript">
	...
	Ext.onReady(function(){
		...
		dataUrl : "${app}/partner/assess/tranAssTrees.do?method=getTemplateNodes&areaId=${areaId}"
		});
