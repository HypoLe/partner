...
<table class="listTable" width="1300" >
	...
	%>
		<tr>
			...
			%>
				<td>
					<center><a href="${app}/partner/assess/tranAssReportInfo.do?method=taskList&month=${month}&taskId=${taskId}&areaId=<%=areaList.get(i)%>&year=${year}&quarter=${quarter}&timeType=${timeType}&partnerId=<%=partnerList.get(k)%>" target='_blank'>
