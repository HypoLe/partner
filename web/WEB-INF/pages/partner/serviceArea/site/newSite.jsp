...
<script type="text/javascript">
    ...
    Ext.onReady(function(){
        var tabConfig = {
            items:[
                {id:'sheet-site',  text:'站点信息',    url:eoms.appPath+'/partner/serviceArea/sites.do?method=edit&idSite=${idSite}', isIframe : true},
                {id:'sheet-papers',text:'基站证件信息', url:eoms.appPath+'/partner/serviceArea/sitePaperss.do?method=search&idSite=${idSite}', isIframe : true}
            ]
        };
    ...
    window.location.href=eoms.appPath+"/partner/serviceArea/sites.do?method=newExpert&idSite="+idSite;
    
      //  window.navigate("${app}/partner/serviceArea/sites.do?method=newExpert&siteNo="+siteNo);
    }
