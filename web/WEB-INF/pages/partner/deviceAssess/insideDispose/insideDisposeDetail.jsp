	...
	<div id="base-info" class="tabContent">
				<table id="sheet" class="formTable">
					...
					<tr>
						...
						<td class="content">
							${insideDispose.sheetNum}
						</td>
						<td class="label">
							建单时间*
						</td>
						<td class="content">
							${insideDispose.createTime}
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content">
							${insideDispose.affairName}
						</td>
						<td class="label">
							事件级别*
						</td>
						<td class="content">
							${insideDispose.affairLevel}
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content">
							<eoms:id2nameDB id="${insideDispose.factory}" beanId="IItawSystemDictTypeDao" />
						</td>
						<td class="label">
							专业*
						</td>
						<td class="content">
							<eoms:id2nameDB id="${insideDispose.speciality}" beanId="IItawSystemDictTypeDao" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content">
							<eoms:id2nameDB id="${insideDispose.equipmentType}" beanId="IItawSystemDictTypeDao" />
						</td>
						<td class="label">
							设备名称*
						</td>
						<td class="content">
							${insideDispose.equipmentName}
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content" colspan="3">
							${insideDispose.equipmentVersion}
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content">
							${insideDispose.beginTime}
						</td>
						<td class="label">
							业务恢复时间*
						</td>
						<td class="content">
							${insideDispose.resumeTime}
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content" colspan="3">
							<eoms:id2nameDB id="${insideDispose.deviceAssessApprove.approveUser}" beanId="tawSystemUserDao" />
						</td>
					</tr>
				</table>
	</div>
