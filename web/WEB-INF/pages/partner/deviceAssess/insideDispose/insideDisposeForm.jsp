...
Ext.onReady(function() {
	v = new eoms.form.Validation({form:'insideDisposeForm'});
	setTabs();
});
	...
	function changeFacility(con){
			...
			Ext.Ajax.request({
								...
								success: function ( result, request ) { 
									...
									if(con==1){
										var equipmentType = '${insideDisposeForm.equipmentType}';
										if(equipmentType!=''){
...
window.onload = function(){
    var speciality = '${insideDisposeForm.speciality}';
	if(speciality!=''){
...
<div id="info-page">
	<div id="base-info" class="tabContent">
						...
						<tr>
							...
							<td>
								<input type="button" class="btn" value="下载导入文件模板" 
										onclick="javascript:location.href='${app}/partner/deviceAssess/insideDisposes.do?method=download'"/>
							</td>
						</tr>
						<td class="label">
							选择审批人*
		...
		<br />
		<html:form action="/insideDisposes.do?method=save"
			styleId="insideDisposeForm" method="post">
			...
			<fmt:bundle
				...
				<table id="sheet" class="formTable">
					...
					<tr>
						...
						<td class="content">
							<html:text property="sheetNum" styleId="sheetNum"
								...
								value="${insideDisposeForm.sheetNum}" />
						</td>
						<td class="label">
							建单时间*
						</td>
						<td class="content">
							<html:text property="createTime" styleId="createTime"
								...
								value="${insideDisposeForm.createTime}" readonly="true" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content" colspan="3">
							<html:text property="pigeonholeTime" styleId="pigeonholeTime"
								...
								value="${insideDisposeForm.pigeonholeTime}" readonly="true" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content">
							<html:text property="affairName" styleId="affairName"
								styleClass="text medium" alt="allowBlank:false,vtext:''"
								value="${insideDisposeForm.affairName}" />
						</td>
						<td class="label">
							事件级别*
						</td>
						<td class="content">
							<eoms:comboBox name="affairLevel" id="affairLevel"
								...
								defaultValue="${insideDisposeForm.affairLevel}"
					...
					<tr>
						...
						<td class="content">
							<html:text property="province" styleId="province"
								styleClass="text medium" alt="allowBlank:false,vtext:''"
								value="${insideDisposeForm.province}" />
						</td>
						<td class="label">
							发生地市*
						</td>
					...
					<tr>
						...
						<td class="content">
							<eoms:comboBox name="factory" id="factory" initDicId="1121502"
								...
								defaultValue="${insideDisposeForm.factory}"
						...
						<td class="content">
							<eoms:comboBox name="speciality" id="speciality"
								...
								defaultValue="${insideDisposeForm.speciality}"
					...
					<tr>
						...
						<td class="content">
							<html:text property="equipmentName" styleId="equipmentName"
								styleClass="text medium" alt="allowBlank:false,vtext:''"
								value="${insideDisposeForm.equipmentName}" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content" colspan="3">
							<html:text property="equipmentVersion" styleId="equipmentVersion"
								styleClass="text medium" alt="allowBlank:false,vtext:''"
								value="${insideDisposeForm.equipmentVersion}" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content">
							<html:text property="beginTime" styleId="beginTime"
								...
								onclick="popUpCalendar(this,this,null,null,null,true,-1);"
								alt="vtype:'lessThen',link:'resumeTime,removeTime',vtext:'故障开始时间不能晚于业务恢复时间或故障消除时间',allowBlank:false"
								value="${insideDisposeForm.beginTime}" />
						</td>
						<td class="label">
							业务恢复时间*
						</td>
						<td class="content">
							<html:text property="resumeTime" styleId="resumeTime"
								readonly="true" styleClass="text medium"
								onclick="popUpCalendar(this,this,null,null,null,true,-1);"
								alt="vtype:'moreThen',link:'beginTime',vtext:'故障开始时间不能晚于业务恢复时间或故障消除时间',allowBlank:false"
								value="${insideDisposeForm.resumeTime}" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content" colspan="3">
							<html:text property="removeTime" styleId="removeTime"
								...
								onclick="popUpCalendar(this,this,null,null,null,true,-1);"
								alt="vtype:'moreThen',link:'beginTime',vtext:'故障开始时间不能晚于业务恢复时间或故障消除时间',allowBlank:false"
								value="${insideDisposeForm.removeTime}" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="content" colspan="3">
							<input type="text" name="textReviewer" id="textReviewer" value="<eoms:id2nameDB id="${insideDisposeForm.deviceAssessApprove.approveUser }" beanId="tawSystemUserDao" />"
								class="text" readonly="readonly" alt="allowBlank:false" />
							<input type="button" name="approvalButton" id="approvalButton"
								value="请选择审核人" class="btn" alt="allowBlank:false" />
							<input type="hidden" name="approvalUser" id="approvalUser" value="${insideDisposeForm.deviceAssessApprove.approveUser }"/>
			...
			<html:hidden property="disposalLong"
				value="${insideDisposeForm.disposalLong}" />
			<html:hidden property="resumeLong"
				value="${insideDisposeForm.resumeLong}" />
			<html:hidden property="amount" value="1" />
			<html:hidden property="id" value="${insideDisposeForm.id}" />
