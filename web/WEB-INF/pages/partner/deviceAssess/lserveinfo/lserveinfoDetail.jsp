...
<table class="formTable">
	<caption>
		<div class="header center">现场服务事件信息</div>
	</caption>
	 <tr>
        	<td colspan="4">
...
<tr>
	...
	<tr>
		...
		<td class="content">
		<eoms:id2nameDB beanId="IItawSystemDictTypeDao" id="${lserveinfo.factory}"/>		
		</td>
		<td class="label">
			专业
		</td>
		<td class="content">
		<eoms:id2nameDB beanId="IItawSystemDictTypeDao" id="${lserveinfo.speciality}"/>			
		</td>
	</tr>
	<tr>
		...
		<td class="content">
		<eoms:id2nameDB beanId="IItawSystemDictTypeDao" id="${lserveinfo.deviceType}"/>		
		</td>
	</tr>
	<tr>
						<td colspan="4">
		...
		<tr>
					...
					<tr>
						...
						<td class="content" colspan="3">
							<eoms:id2nameDB id="${lserveinfo.deviceAssessApprove.approveUser}" beanId="tawSystemUserDao" />
						</td>
					</tr>			
</table>
</div>
