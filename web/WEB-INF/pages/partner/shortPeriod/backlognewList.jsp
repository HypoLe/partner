...
//重置
		...
		<div id="sheetform">
			<html:form action="/shortPeriod.do?method=listBacklog"
				...
				<tr>
					<td class="label" style="width:10%">塔型（新）</td>
					<td class="content" style="width:20%">
				...
				<tr>
					<td class="label" style="width:10%">塔型（旧）</td>
					<td class="content" style="width:20%">
...
<tr>
					...
					<td class="content" style="width:20%" colspan = "5">
		...
		<display:table name="taskList" cellspacing="0" cellpadding="0"
			...
			<display:column sortable="true" headerClass="sortable" title="产品业务确认单编号">
				...
				<c:if test="${changePermissions eq false}">
					${taskList.productNum}
				</c:if>
			</display:column>
			...
			<display:column sortable="false" headerClass="sortable" title="地市">
				<eoms:id2nameDB id="${taskList.cityId}" beanId="tawSystemAreaDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="区县">
				<eoms:id2nameDB id="${taskList.countyId}" beanId="tawSystemAreaDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="站址编码" property="stationCode" />
			<display:column sortable="false" headerClass="sortable" title="需求确认单编号" property="needNo" />
			<display:column sortable="false" headerClass="sortable" title="塔型(原始)" property="towerType" />
			<display:column sortable="false" headerClass="sortable" title="机房类型(原始)" property="roomType" />
			<display:column sortable="false" headerClass="sortable" title="实际最高天线挂高（米）1(原始)" property="hangHigh1" /> 
			<display:column sortable="false" headerClass="sortable" title="RRU拉远时BBU是否放在铁塔公司机房1(原始)" property="rruRoom1" /> 
			<display:column sortable="false" headerClass="sortable" title="铁塔共享用户数(原始)" property="towerNum" /> 
			<display:column sortable="false" headerClass="sortable" title="机房共享用户数(原始)" property="roomNum" /> 
			<display:column sortable="false" headerClass="sortable" title="配套共享用户数(原始)" property="supportNum" /> 
			<display:column sortable="false" headerClass="sortable" title="维护费共享用户数(原始)" property="maitainNum" /> 
			<display:column sortable="false" headerClass="sortable" title="场地费共享用户数(原始)" property="fieldNum" /> 
			<display:column sortable="false" headerClass="sortable" title="电力引入费共享用户数(原始)" property="powerNum" />
			<display:column sortable="false" headerClass="sortable" title="RRU数量(原始)" property="rruNum" />
			<display:column sortable="false" headerClass="sortable" title="天线数量(原始)" property="antennaNum" /> 
			
			<display:column sortable="false" headerClass="sortable" title="塔型(核查)">
				<eoms:id2nameDB id="${taskList.BTowerType}" beanId="ItawSystemDictTypeDao" />	
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="机房类型(核查)">
				<eoms:id2nameDB id="${taskList.BRoomType}" beanId="ItawSystemDictTypeDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="实际最高天线挂高（米）1(核查)">
				<eoms:id2nameDB id="${taskList.BHangHigh1}" beanId="ItawSystemDictTypeDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="RRU拉远时BBU是否放在铁塔公司机房1(核查)">
				<eoms:id2nameDB id="${taskList.BRruRoom1}" beanId="ItawSystemDictTypeDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="铁塔共享用户数(核查)">
				<eoms:id2nameDB id="${taskList.BTowerNum}" beanId="ItawSystemDictTypeDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="机房共享用户数(核查)">
				<eoms:id2nameDB id="${taskList.BRoomNum}" beanId="ItawSystemDictTypeDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="配套共享用户数(核查)">
				<eoms:id2nameDB id="${taskList.BSupportNum}" beanId="ItawSystemDictTypeDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="维护费共享用户(核查)">
				<eoms:id2nameDB id="${taskList.BMaitainNum}" beanId="ItawSystemDictTypeDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="场地费共享用户数(核查)">
				<eoms:id2nameDB id="${taskList.BFieldNum}" beanId="ItawSystemDictTypeDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="电力引入费共享用户数(核查)">
				<eoms:id2nameDB id="${taskList.BPowerNum}" beanId="ItawSystemDictTypeDao" />
			</display:column>
			<display:column sortable="false" headerClass="sortable" title="RRU数量(核查)" property="BRruNum" />
			<display:column sortable="false" headerClass="sortable" title="天线数量(核查)" property="BAntennaNum" />
			<display:column sortable="true" headerClass="sortable" title="处理" media="html">
				<c:if test="${changePermissions eq true}">
					<a
