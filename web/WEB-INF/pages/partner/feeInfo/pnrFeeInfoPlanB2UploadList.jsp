...
<%
List planList = (List)request.getAttribute("pnrFeeInfoPlanB2UploadList");
...
function showPlan(trId)
{
  ...
  else
  {
	...
	<body>
		...
		<caption>
		<div class="header center"  style="text-align:center;font-weight:bold;">待提交材料任务列表</div>
	</caption>
	...
	(<font color="red"><%=planNumStr %>个等待录入材料的任务</font>) 
	</td>
	</tr>
