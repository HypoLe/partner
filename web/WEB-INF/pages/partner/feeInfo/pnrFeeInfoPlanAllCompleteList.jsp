...
<%
List planList = (List)request.getAttribute("pnrFeeInfoPlanAllCompleteList");
...
function showPlan(trId)
{
  ...
  else
  {
	...
	<body>
		...
		<caption>
		<div class="header center"  style="text-align:center;font-weight:bold;">付款完成列表</div>
	</caption>
	...
	(<font color="red"><%=planNumStr %>个付款已完成</font>) 
	</td>
	</tr>
