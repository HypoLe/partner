...
<%
List planList = (List)request.getAttribute("pnrFeeInfoPlanAuditBUploadList");
...
function showPlan(trId)
{
  ...
  else
  {
	...
	<body>
		...
		<caption>
		<div class="header center"  style="text-align:center;font-weight:bold;">待审核材料列表</div>
	</caption>
	...
	(<font color="red"><%=planNumStr %>个待审核付款材料任务</font>) 
	</td>
	</tr>
