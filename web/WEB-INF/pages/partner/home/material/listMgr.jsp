...
<%@ page language="java" 	import="java.util.*;"%>
	<form id="form1" method="post" action="materiaLib.do?method=search&operationType=mgr">
					<table id="sheet" class="formTable" >	
						 <tr>
							...
							<td class="content" >
								<input type="text" class="text" id="subject" name="subjectStringLike" value="${subjectStringLike }"/>
							</td>
							<td class="label"> 
								关键词
							</td>
							<td class="content" colspan="3">
								 <input type='text' class="text" id='keyWordStringLike' name="keyWordStringLike"   value="${keyWordStringLike }"  maxlength="80"/>
			  				</td>
						</tr>
						<tr>
							<td class="label"> 
