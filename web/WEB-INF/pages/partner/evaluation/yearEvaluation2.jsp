...
//				}
 ...
 try{
     ...
     aform=document.createElement("<form>");
     i=document.createElement("<input type='hidden' name='evaluationTarget'>");  
     i.value=evaluationTarget.value.trim();
     aform.appendChild(i);    
 }

 aform.action="${app}/partner/evaluation/evaluationEntity.do?method=yearEvaluation2&id="+monitorCompany.value.trim()
  +"&year="+year.value.trim()+"&templateId="+ myJ("input.checkAble:checkbox[checked]").val();  
 aform.method="post";
