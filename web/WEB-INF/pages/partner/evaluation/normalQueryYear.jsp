...
<div id="listQueryObject" 
	...
	<form action="${app}/partner/evaluation/evaluStatAndQur.do?method=queryNormalYear" 
	method="post" id="queryNormalConditionForm">
		<table id="sheet" class="listTable">
			...
			<tr>		
				...
				<td>
				  <eoms:comboBox name="xmdictid" id="xmdictid"  defaultValue="${xmdictid}" initDicId="112270102"  />
				</td>
...
<logic:present name="resultList" scope="request">
    <display:table name="resultList" cellspacing="0" cellpadding="0"
		...
		export="false" 
		requestURI="${app}/partner/evaluation/evaluStatAndQur.do?method=queryNormalYear"
		...
		<display:column  title="考核年份" sortable="true" headerClass="sortable" sortName="year">
			${listEL.year}
		</display:column>		
    	...
    	<display:column  title="状态">  
    	  <!-- public static final String XIANGMU_SUBMIT="02";//已经提交打分了，但是还没有确认
    	       public static final String XIANGMU_CONFIRMED="04";//已确认/审核
    	       public static final String MAJOR_SUBMIT="02";	
