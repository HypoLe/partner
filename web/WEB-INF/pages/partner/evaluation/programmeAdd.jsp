...
<script type="text/javascript">
  ...
  function proportionValidate2(proportion){
     Ext.get("proportionDiv").hide();  
       var prop= Ext.get("id_addcol_proportion").getValue();
     if(prop!=""){
     	Ext.getDom("id_addcol_fraction").value=(prop*proportion*0.01).toFixed(2);
     }
  }
  ...
  function fractionValidate2(proportion){
     ...
     var fraction= Ext.get("id_addcol_fraction").getValue();
     if(fraction!=""){
     	Ext.getDom("id_addcol_proportion").value=((fraction/proportion)*100).toFixed(2);
     }
...
<form action="${app}/partner/evaluation/evaluation.do?method=doAddProgramme" method="post" id="programmeForm" name = "programmeForm">
	...
	<table id="sheet" class="formTable">
	    <tr>
			...
			<td>
				<input type="text" class="text" name="nm_addcol_prgmnm" id="id_addcol_prgmnm" style="width: 80%;" 
			...
			<td>
				<input type="text" class="text" name="nm_addcol_owntmpl" id="id_addcol_owntmpl"					
		...
		<tr>
			  ...
			  <td>
				<input type="text" class="text" name="nm_addcol_fraction" id="id_addcol_fraction"
