...
<form action="${app}/partner/evaluation/evaluStatAndQur.do?method=monthRankReport" 
	method="post" id="monthRankReportForm" name="monthRankReportForm"> 
  <fieldset>
...
Ext.onReady(function(){             
	var v = new eoms.form.Validation({form:'monthRankReportForm'});
    v.custom = function(){            
        return true;
	};  		  
}); 
...
function displayRank(){
   ...
   rankDir.appendTo(myJ('#monthRankReportForm'));
   Ext.get(document.body).mask('处理中，请等待......');;
   myJ('#monthRankReportForm').submit();
}
</script>
