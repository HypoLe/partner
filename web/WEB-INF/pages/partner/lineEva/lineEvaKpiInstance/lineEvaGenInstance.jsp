...
<html:form action="/lineEvaKpiInstances.do?method=genInstance" styleId="lineEvaKpiInstanceForm" method="post"> 
...
<iframe id="fileList" name="fileList" frameborder="0" width="100%" height="100%" 
	src="${app}/partner/lineEva/lineEvaKpis.do?method=listKpiOfTemplate&templateId=${template.id}">
</iframe>
</c:if>
