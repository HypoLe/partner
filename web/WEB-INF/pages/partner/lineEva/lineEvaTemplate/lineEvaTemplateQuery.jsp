...
<html:form action="/lineEvaTemplates.do?method=search" styleId="lineEvaTemplateForm" method="post"> 
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-lineEva" dictId="templateStatus" defaultId="<%=LineEvaConstants.TEMPLATE_REPORTED%>"
