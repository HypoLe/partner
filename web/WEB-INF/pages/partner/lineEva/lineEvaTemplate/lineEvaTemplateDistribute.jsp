...
<html:form action="/lineEvaTemplates.do?method=distribute" styleId="lineEvaTemplateForm" method="post"> 
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content" colspan="3">
			${lineEvaTemplateForm.templateName}
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
			<eoms:dict key="dict-partner-lineEva" dictId="cycle" itemId="${lineEvaTemplateForm.cycle}" beanId="id2nameXML" />
		</td>
		<td class="label">
			接收单位类型
		</td>
		<td class="content">
			<eoms:dict key="dict-partner-lineEva" dictId="orgType" itemId="${lineEvaTemplateForm.orgType}" beanId="id2nameXML" />
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
			${lineEvaTemplateForm.startTime}
		</td>
		<td class="label">
			结束时间
		</td>
		<td class="content">
			${lineEvaTemplateForm.endTime}
		</td>
	</tr>
	<tr>
		<td class="label">
...
<html:hidden property="id" value="${lineEvaTemplateForm.id}" />
</html:form>
<c:if test="${lineEvaTemplateForm.id != null}">
<iframe id="fileList" name="fileList" frameborder="0" width="100%" height="100%" 
	src="${app}/partner/lineEva/lineEvaTemplateKpis.do?method=listKpiOfTemplate&templateId=${lineEvaTemplateForm.id}">
</iframe>
</c:if>
<script type="text/javascript">
  try{
...
<c:if test="${lineEvaTemplateForm.orgType == 'dept'}">
<script type="text/javascript">
document.getElementById('deptTr').style.display='block';
</script>
</c:if>
<c:if test="${lineEvaTemplateForm.orgType == 'user'}">
<script type="text/javascript">
