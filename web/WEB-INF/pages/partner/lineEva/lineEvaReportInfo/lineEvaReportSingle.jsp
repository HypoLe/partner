				...
				<tr>
					<logic:iterate id="taskDetail" name="rowList">
						...
						<td rowspan="${taskDetail.rowspan}"
							...
							<eoms:id2nameDB id="${taskDetail.kpiId}" beanId="lineEvaKpiDao" />
						</td>
						<%
						if (LineEvaConstants.NODE_LEAF.equals(leaf)) {
						%>
						<td align="left">
...
function  queryBack()
    {
      document.forms[0].action="lineEvaReportInfos.do?method=queryInitSingle";
    };
</script>
