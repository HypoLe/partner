...
<html:form action="/lineEvaTasks.do?method=saveTaskDetail" styleId="lineEvaReportMultiDeptForm" method="post">
...
function  queryBack()
    {
      document.forms[0].action="lineEvaReportMultiDepts.do?method=queryInitMultiDept";
    };
</script>