...
function changeTemplateTypeAndTime()
		{    		    
		    ...
		    if(year1!=""&&month1!=""&&templateTypeId!=""){
				...
				var url="<%=request.getContextPath()%>/partner/lineEva/lineEvaTasks.do?method=changeTemplateTypeAndTime&templateTypeId="+templateTypeId;
...
<html:form action="/lineEvaReportMultiDepts.do?method=reportMultiDept" styleId="lineEvaKpiInstanceForm" method="post"> 
