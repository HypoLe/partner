...
function check(flag){
   if(flag == 0){
     if(lineEvaAuditForm.auditInfo.value == ""){
       alert("请填写审批意见！");
       return false;
     }
     lineEvaAuditForm.auditFlag.value = "0";
     lineEvaAuditForm.submit();
     return true;
   }
   else{
     if(lineEvaAuditForm.auditInfo.value == ""){
     ...
     lineEvaAuditForm.auditFlag.value = "1";
     lineEvaAuditForm.submit();
     return true;
   }
}
...
<html:form action="/lineEvaAudit.do?method=audit" styleId="lineEvaAuditForm" method="post"> 
<table>
	...
	<tr height="30">
		...
		<td width="70%">
			<html:textarea property="auditInfo" styleId="auditInfo"
						styleClass="text medium"  value="${lineEvaAuditForm.auditInfo}" />
		</td>
	</tr>
	<tr height="30">
		<td colspan="2">
...
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-lineEva" dictId="cycle" itemId="${template.cycle}" beanId="id2nameXML" />
		</td>
	</tr>
	<tr>
		<td class="label">
	...
	<tr>
		...
		<td class="content">
			<a href="${app}/partner/lineEva/lineEvaAudit.do?method=auditInfoList&nodeId=${org.id}"
				 target="_blank">
				点击查看审核意见
			</a>
		</td>
...
<table class="listTable" id="list">
	...
	<tr>
		...
		<td>
			<bean:write name="kpiList" property="lineEvaScore"/>
		</td>
	</tr>
	</logic:iterate>
	</tbody>
