...
<div id="listQueryObject" 
	...
	<form action="${app}/partner/taskManager/carApprove.do?method=findCarApproveList" method="post">
		<table id="sheet" class="listTable">
			...
			<tr>
				<td class="label">处理环节</td>
				<td class="content">
					<select name="approveStatue" class="select">
			...
			<tr>
				...
				<td class="content" colspan="3">
					开始时间 
					<input id="startTime" class="Wdate text" name="startTime" readonly="readonly" class="Wdate" type="text" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endTime\')||\'%y-%M-%d\'}'})"/> 
					结束时间
					<input id="endTime" class="Wdate text" name="endTime" readonly="readonly" class="Wdate" type="text" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'startTime\')}',maxDate:'\'%y-%M-%d\''})"/>
				</td>
			</tr>
		</table>		
