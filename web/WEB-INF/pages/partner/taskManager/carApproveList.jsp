...
<div id="listQueryObject" 
	...
	<form action="${app}/partner/taskManager/carApprove.do?method=toCarApproveList" method="post">
	...
	<display:table name="list" cellspacing="0" cellpadding="0"
		...
		<display:column title="车牌号">
			...
			<c:if test="${list.approve_statue eq '1'}">
				<a href="${app}/partner/taskManager/carApprove.do?method=toBackCarForm&id=${list.id}"> 
				${list.car_num}<a>
			</c:if>
		</display:column>
