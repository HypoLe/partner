...
function download(){
    ...
    window.location.href = '<html:rewrite page="/excelParfile.do?method=download&mod='+frm.model.value+'"/>';
    }
}  
...
<table border="1" width="80%" cellspacing="1" class="table_show" >
	<tr class="tr_show">
    	...
    	<td width="80%" class="clsfth1">
						<eoms:dict key="dict-partner-excel" dictId="model" isQuery="false" alt="allowBlank:false,vtext:''"
