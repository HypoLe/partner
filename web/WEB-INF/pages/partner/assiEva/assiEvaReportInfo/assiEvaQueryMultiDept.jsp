...
function changeTemplateTypeAndTime()
		{    		    
		    ...
		    if(year1!=""&&month1!=""&&templateTypeId!=""){
				...
				var url="<%=request.getContextPath()%>/partner/assiEva/assiEvaTasks.do?method=changeTemplateTypeAndTime&templateTypeId="+templateTypeId;
...
<html:form action="/assiEvaReportMultiDepts.do?method=reportMultiDept" styleId="assiEvaKpiInstanceForm" method="post"> 
