...
<html:form action="/assiEvaTasks.do?method=saveTaskDetail" styleId="assiEvaReportMultiDeptForm" method="post">
...
function  queryBack()
    {
      document.forms[0].action="assiEvaReportMultiDepts.do?method=queryInitMultiDept";
    };
</script>