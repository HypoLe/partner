...
<html:form action="/assiEvaTemplates.do?method=search" styleId="assiEvaTemplateForm" method="post"> 
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-assiEva" dictId="templateStatus" defaultId="<%=AssiEvaConstants.TEMPLATE_REPORTED%>"
