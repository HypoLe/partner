...
Ext.onReady(function() {
	v = new eoms.form.Validation({form:'assiEvaKpiForm'});
});
</script>

<html:form action="/assiEvaKpis.do?method=saveKpi" styleId="assiEvaKpiForm" method="post"> 
	...
	<tr>
		...
		<td class="content">
			<html:text property="kpiName" styleId="kpiName" style="width:88%" 
						...
						alt="allowBlank:false,vtext:'请输入指标名称'" value="${assiEvaKpiForm.kpiName}" />
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
			<html:textarea property="remark" styleId="remark" style="width:88%" 
						styleClass="textarea"  value="${assiEvaKpiForm.remark}" />
		</td>
	</tr>
</table>
...
<html:hidden property="id" value="${assiEvaKpiForm.id}" />
</html:form>
