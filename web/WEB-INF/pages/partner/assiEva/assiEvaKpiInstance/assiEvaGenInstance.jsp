...
<html:form action="/assiEvaKpiInstances.do?method=genInstance" styleId="assiEvaKpiInstanceForm" method="post"> 
...
<iframe id="fileList" name="fileList" frameborder="0" width="100%" height="100%" 
	src="${app}/partner/assiEva/assiEvaKpis.do?method=listKpiOfTemplate&templateId=${template.id}">
</iframe>
</c:if>
