...
<html:form action="/assiEvaTemplateTypes.do?method=saveTemplateType" styleId="assiEvaTreeForm" method="post"> 
<table>
	<tr height="30">
		<td width="30%">
			模板分类名称
		...
		<td width="70%">
			<html:text property="nodeName" styleId="nodeName"
						...
						alt="allowBlank:false,vtext:'请输入模板分类名称'" value="${assiEvaTreeForm.nodeName}" />
		</td>
	</tr>
	<tr height="30">
		<td>
		...
		<td>
			<html:textarea property="nodeRemark" styleId="nodeRemark" style="width:88%" 
						styleClass="textarea"  value="${assiEvaTreeForm.nodeRemark}" />
		</td>
	</tr>
	<tr height="30">
		<td colspan="2">
