...
function check(flag){
   if(flag == 0){
     if(assiEvaAuditForm.auditInfo.value == ""){
       alert("请填写审批意见！");
       return false;
     }
     assiEvaAuditForm.auditFlag.value = "0";
     assiEvaAuditForm.submit();
     return true;
   }
   else{
     if(assiEvaAuditForm.auditInfo.value == ""){
     ...
     assiEvaAuditForm.auditFlag.value = "1";
     assiEvaAuditForm.submit();
     return true;
   }
}
...
<html:form action="/assiEvaAudit.do?method=audit" styleId="assiEvaAuditForm" method="post"> 
<table>
	...
	<tr height="30">
		...
		<td width="70%">
			<html:textarea property="auditInfo" styleId="auditInfo"
						styleClass="text medium"  value="${assiEvaAuditForm.auditInfo}" />
		</td>
	</tr>
	<tr height="30">
		<td colspan="2">
...
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-assiEva" dictId="cycle" itemId="${template.cycle}" beanId="id2nameXML" />
		</td>
	</tr>
	<tr>
		<td class="label">
	...
	<tr>
		...
		<td class="content">
			<a href="${app}/partner/assiEva/assiEvaAudit.do?method=auditInfoList&nodeId=${org.id}"
				 target="_blank">
				点击查看审核意见
			</a>
		</td>
...
<table class="listTable" id="list">
	...
	<tr>
		...
		<td>
			<bean:write name="kpiList" property="assiEvaScore"/>
		</td>
	</tr>
	</logic:iterate>
	</tbody>
