...
<logic:present name="irmsTransDirburyDSRList" scope="request">
	<display:table id="irmsTransDirburyDSRList"
					name="irmsTransDirburyDSRList" 
					pagesize="${pagesize}" size="${size}"
					requestURI="${app}/netresource/pnrNetResourceAction.do" export="true" 
					sort="list" cellspacing="0" cellpadding="0" class="table irmsTransDirburyDSRList" partialList="true" >
				<display:column sortable="true" headerClass="sortable" title="直埋名称">
						${irmsWlanRepeaterDSRList['dirbury_name']}
				</display:column>
