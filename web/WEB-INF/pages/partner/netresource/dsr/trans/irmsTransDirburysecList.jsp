...
<logic:present name="irmsTransDirburysecDSRList" scope="request">
	<display:table id="irmsTransDirburysecDSRList"
				...
				<display:column sortable="true" headerClass="sortable" title="直埋段名称">
						${irmsWlanRepeaterDSRList['dirbury_sec_name']}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="所属直埋">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['related_dirbury']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="承载光缆段">
						${irmsWlanRepeaterDSRList['related_opcable_sec']}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="起点名称">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['related_start_point_name']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="末端名称">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['related_end_point_name']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				...
				<display:column sortable="true" headerClass="sortable" title="是否共建">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['is_construt_shared']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
