...
<logic:present name="irmsTransPolelinesecDSRList" scope="request">
	<display:table id="irmsTransPolelinesecDSRList"
				...
				<display:column sortable="true" headerClass="sortable" title="杆路段名称">
						${irmsWlanRepeaterDSRList['poleline_section_name']}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="所属杆路">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['related_poleline']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="起点电杆名称">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['related_start_pole_name']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="末端电杆名称">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['related_end_pole_name']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				...
				<display:column sortable="true" headerClass="sortable" title="是否共建">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['is_construct_shared']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
