...
<logic:present name="irmsBsBbDSRList" scope="request">
	<display:table id="irmsBsBbDSRList"
				...
				<display:column sortable="true" headerClass="sortable" title="使用状态">
						<eoms:id2nameDB id="${irmsBsBbDSRList['status']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="额定制冷量（KW)">
						${irmsBsBbDSRList['rating_cooling_var']}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="维护负责人">
						${irmsBsBbDSRList['preserver']}
				</display:column>
