...
<logic:present name="irmsBsVensDSRList" scope="request">
	<display:table id="irmsBsVensDSRList"
				...
				<display:column sortable="true" headerClass="sortable" title="使用状态">
						<eoms:id2nameDB id="${irmsBsVensDSRList['status']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="额定功率（KVA）">
						${irmsBsVensDSRList['rating_power']}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="额定电压（V）">
						<eoms:id2nameDB id="${irmsBsVensDSRList['rating_voltage']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="维护负责人">
						${irmsBsVensDSRList['preserver']}
				</display:column>
