...
']}
				...
				<display:column sortable="true" headerClass="sortable" title="机楼（基站）编号">
						${irmsWlanRepeaterDSRList['related_site_no']}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="产权属性">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['property']}" beanId="tawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="重要级别">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['important_level']}" beanId="tawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="机楼(基站)地址">
						${irmsWlanRepeaterDSRList['room_addr']}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="变电站一">
						${irmsWlanRepeaterDSRList['one_substation']}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="变电站二">
						${irmsWlanRepeaterDSRList['two_substation']}
				</display:column>
