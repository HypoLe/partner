...
<logic:present name="irmsBsGrneratDSRList" scope="request">
	<display:table id="irmsBsGrneratDSRList"
				...
				<display:column sortable="true" headerClass="sortable" title="额定功率（KVA）">
						${irmsWlanRepeaterDSRList['rating_power']}
				</display:column>
