...
<logic:present name="irmsBsHesDSRList" scope="request">
	<display:table id="irmsBsHesDSRList"
				...
				<display:column sortable="true" headerClass="sortable" title="使用状态">
						<eoms:id2nameDB id="${irmsBsHesDSRList['status']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="额定功率（KVA）">
						${irmsBsHesDSRList['rating_power']}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="额定电压（V）">
						<eoms:id2nameDB id="${irmsBsHesDSRList['rating_voltage']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="维护负责人">
						${irmsBsHesDSRList['preserver']}
				</display:column>
