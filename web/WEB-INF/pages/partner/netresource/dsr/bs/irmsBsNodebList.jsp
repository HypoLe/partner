...
<logic:present name="irmsBsNodebDSRList" scope="request">
	<display:table id="irmsBsNodebDSRList"
				...
				<display:column sortable="true" headerClass="sortable" title="所属RNC">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['related_rnc']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				...
				<display:column sortable="true" headerClass="sortable" title="频段">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['site_category']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="vip基站">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['vip_type']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="蜂窝类型">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['beehive_type']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
				...
				<display:column sortable="true" headerClass="sortable" title="代维公司">
						<eoms:id2nameDB id="${irmsWlanRepeaterDSRList['manage_company']}" beanId="ItawSystemDictTypeDao"/>
				</display:column>
