...
<logic:present name="irmsBsStorageDSRList" scope="request">
	<display:table id="irmsBsStorageDSRList"
				...
				<display:column sortable="true" headerClass="sortable" title="所属设备编码">
						${irmsWlanRepeaterDSRList['related_deivce_seq']}
				</display:column>
