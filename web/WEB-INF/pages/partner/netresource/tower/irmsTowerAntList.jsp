...
function excelFileUpload() {
	...
	Ext.Ajax.request({
		...
		params :{resourceName:"IrmsTowerAnt"},
		method : 'post',
		form:'excel2xmlForm',
		isUpload:true,
...
<div align="center"><b>天线-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.tower.IrmsTowerAnt" method="post">
		<fieldset>
			<legend>快速查询</legend>
			<table id="sheet" class="formTable">
						...
						<td class="content" >
								<input class="text" type="text" name="relatedCellidStringEqual" value="${relatedCellidStringEqual}" />
						</td>
						...
						<td class="content" colspan="3">
								<eoms:comboBox id="antType" name="antTypeStringEqual" initDicId="11228040201" defaultValue="${antTypeStringEqual}" styleClass="input select" />
						</td>
						</tr>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.tower.IrmsTowerAnt'"/>
						</div>
					</td>
				</tr>
			</table>
...
<!--导出功能开始-->
<%--
<eoms:excelExport modelName="com.boco.eoms.partner.netresource.model.tower.IrmsTowerAnt" 
							 serviceBeanId="eomsService"   title="网络资源--铁塔及天馈--天线" >
		<eoms:row name="天线名称" value="labelCn"/>
		<eoms:row name="总俯仰角" value="sumAngle"/>
		<eoms:row name="所属小区" value="relatedCellid"/>
		<eoms:row name="天线厂家" value="vendor"/>
		<eoms:row name="挂高" value="highCube"/>
		<eoms:row name="天线类型" value="antType"/>
		<eoms:row name="方位角" value="maxazimuthValue"/>
		<eoms:row name="电调下倾角" value="adjustAngleEle"/>
		<eoms:row name="机械下倾角" value="adjustAngleMac"/>
		<eoms:row name="安装时间" value="installTime"/>
		<eoms:row name="天面" value="tianMian"/>
</eoms:excelExport>
--%>
<!--导出功能结束-->
