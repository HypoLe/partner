...
function excelFileUpload() {
	...
	Ext.Ajax.request({
		...
		params :{resourceName:"IrmsTransWell"},
		method : 'post',
		form:'excel2xmlForm',
		isUpload:true,
...
<div align="center"><b>人手井-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.trans.IrmsTransWell" method="post">
		<fieldset>
			<legend>快速查询</legend>
			<table id="sheet" class="formTable">
						...
						<td class="content" >
								<input class="text" type="text" name="nameStringEqual" value="${nameStringEqual}" />
						</td>
						...
						<td class="content" >
								<input class="text" type="text" name="relatedAreaStringLike" value="${relatedAreaStringLike}" />
						</td>
						</tr>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.trans.IrmsTransWell'"/>
						</div>
					</td>
				</tr>
			</table>
...
<!--导出功能开始-->
<%--
<eoms:excelExport modelName="com.boco.eoms.partner.netresource.model.trans.IrmsTransWell" 
							 serviceBeanId="eomsService"   title="网络资源--传输线路--人手井" >
		<eoms:row name="人手井名称" value="name"/>
		<eoms:row name="所属区域" value="relatedArea"/>
		<eoms:row name="人手井型号" value="wellMode"/>
		<eoms:row name="人手井类型" value="wellType"/>
		<eoms:row name="产权" value="ownership"/>
		<eoms:row name="用途" value="purpose"/>
		<eoms:row name="人手井具体类型" value="wellRealType"/>
