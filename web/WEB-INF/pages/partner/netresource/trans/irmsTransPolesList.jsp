...
function excelFileUpload() {
	...
	Ext.Ajax.request({
		...
		params :{resourceName:"IrmsTransPoles"},
		method : 'post',
		form:'excel2xmlForm',
		isUpload:true,
...
<div align="center"><b>电杆-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.trans.IrmsTransPoles" method="post">
		<fieldset>
			<legend>快速查询</legend>
			<table id="sheet" class="formTable">
						...
						<td class="content" >
								<input class="text" type="text" name="poleNameStringLike" value="${poleNameStringLike}" />
						</td>
						...
						<td class="content" >
								<input class="text" type="text" name="relatedDistirctStringEqual" value="${relatedDistirctStringEqual}" />
						</td>
						</tr>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.trans.IrmsTransPoles'"/>
						</div>
					</td>
				</tr>
			</table>
...
<!--导出功能开始-->
<%--
<eoms:excelExport modelName="com.boco.eoms.partner.netresource.model.trans.IrmsTransPoles" 
							 serviceBeanId="eomsService"   title="网络资源--传输线路--电杆" >
		<eoms:row name="电杆名称" value="poleName"/>
		<eoms:row name="所属区域" value="relatedDistirct"/>
		<eoms:row name="电杆高度" value="poleHeight"/>
		<eoms:row name="产权" value="poleProperty"/>
		<eoms:row name="用途" value="poleUse"/>
		<eoms:row name="使用单位" value="poleUseUnit"/>
		<eoms:row name="所有权人" value="poleOwership"/>
		<eoms:row name="经度" value="poleLongitude"/>
		<eoms:row name="纬度" value="poleLatitude"/>
</eoms:excelExport>
--%>
<!--导出功能结束-->
