...
function excelFileUpload() {
	...
	Ext.Ajax.request({
		...
		params :{resourceName:"IrmsTransPipe"},
		method : 'post',
		form:'excel2xmlForm',
		isUpload:true,
...
<div align="center"><b>管道-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.trans.IrmsTransPipe" method="post">
		<fieldset>
			<legend>快速查询</legend>
			<table id="sheet" class="formTable">
						...
						<td class="content" >
								<input class="text" type="text" name="pipeNameStringLike" value="${pipeNameStringLike}" />
						</td>
						...
						<td class="content" >
								<input class="text" type="text" name="relatedAreaStringEqual" value="${relatedAreaStringEqual}" />
						</td>
						</tr>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.trans.IrmsTransPipe'"/>
						</div>
					</td>
				</tr>
			</table>
...
<!--导出功能开始-->
<%--
<eoms:excelExport modelName="com.boco.eoms.partner.netresource.model.trans.IrmsTransPipe" 
							 serviceBeanId="eomsService"   title="网络资源--传输线路--管道" >
		<eoms:row name="管道名称" value="pipeName"/>
		<eoms:row name="所属区域" value="relatedArea"/>
		<eoms:row name="设施状态" value="status"/>
		<eoms:row name="工程名称" value="projectName"/>
		<eoms:row name="长度" value="length"/>
		<eoms:row name="竣工时间" value="completeTime"/>
</eoms:excelExport>
--%>
<!--导出功能结束-->
