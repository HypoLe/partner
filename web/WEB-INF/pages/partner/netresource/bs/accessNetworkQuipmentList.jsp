...
<div align="center"><b>接入网机房设备-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/bsbt/pnrbsbt.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.AccessNetworkQuipment" method="post">
		<fieldset>
			<legend>快速查询</legend>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/bsbt/pnrbsbt.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.AccessNetworkQuipment'"/>
						</div>
					</td>
				</tr>
			</table>
...
<logic:present name="accessNetworkQuipmentList" scope="request">
	<display:table id="accessNetworkQuipmentList"
					name="accessNetworkQuipmentList" 
