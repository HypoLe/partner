...
function excelFileUpload() {
	...
	Ext.Ajax.request({
		...
		params :{resourceName:"IrmsBsStorage"},
		method : 'post',
		form:'excel2xmlForm',
		isUpload:true,
...
<div align="center"><b>蓄电池组-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.IrmsBsStorage" method="post">
		<fieldset>
			<legend>快速查询</legend>
			<table id="sheet" class="formTable">
						...
						<td class="content" >
								<input class="text" type="text" name="groupCapacityStringLike" value="${groupCapacityStringLike}" />
						</td>
						</tr>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.IrmsBsStorage'"/>
						</div>
					</td>
				</tr>
			</table>
...
<!--导出功能开始-->
<%--
<eoms:excelExport modelName="com.boco.eoms.partner.netresource.model.bs.IrmsBsStorage" 
							 serviceBeanId="eomsService"   title="网络资源--基站设备及配套--蓄电池组" >
		...
		<eoms:row name="所属设备名称" value="relatedDeviceCui"/>
		<eoms:row name="所属设备编码" value="relatedDeivceSeq"/>
		...
		<eoms:row name="单组容量（AH）" value="groupCapacity"/>
		<eoms:row name="单体电压等级（V）" value="voltageLevel"/>
		<eoms:row name="单组蓄电池个数" value="accumulatorGroup"/>
