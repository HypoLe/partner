...
<div align="center"><b>室分-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/bsbt/pnrbsbt.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.RoomResource" method="post">
		<fieldset>
			<legend>快速查询</legend>
			<table id="sheet" class="formTable">
						...
						<td class="content" >
								<input class="text" type="text" name="reNameStringLike" value="${reNameStringLike}" />
						</td>
						<td class="label">
						 	室分地址
						</td>
						<td class="content" >
								<input class="text" type="text" name="addressStringLike" value="${addressStringLike}" />
						</td>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/bsbt/pnrbsbt.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.RoomResource'"/>
						</div>
					</td>
				</tr>
			</table>
...
<logic:present name="roomResourceList" scope="request">
	<display:table id="roomResourceList"
					name="roomResourceList" 
				...
				<display:column sortable="true" headerClass="sortable" title="室分名称">
						${roomResourceList.reName}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="室分编号">
						${roomResourceList.reNumber}
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="所属地市">
				<eoms:id2nameDB id="${roomResourceList.city}" beanId="tawSystemAreaDao"/>				
				</display:column>
				<display:column sortable="true" headerClass="sortable" title="所属地区">
				<eoms:id2nameDB id="${roomResourceList.country}" beanId="tawSystemAreaDao"/>
				</display:column>
