...
function excelFileUpload() {
	...
	Ext.Ajax.request({
		...
		params :{resourceName:"IrmsBsTransfor"},
		method : 'post',
		form:'excel2xmlForm',
		isUpload:true,
...
<div align="center"><b>变压器或调压器-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.IrmsBsTransfor" method="post">
		<fieldset>
			<legend>快速查询</legend>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.IrmsBsTransfor'"/>
						</div>
					</td>
				</tr>
			</table>
...
<!--导出功能开始-->
<%--
<eoms:excelExport modelName="com.boco.eoms.partner.netresource.model.bs.IrmsBsTransfor" 
							 serviceBeanId="eomsService"   title="网络资源--基站设备及配套--变压器或调压器" >
		<eoms:row name="机房（基站）名称" value="relatedRoom"/>
		...
		<eoms:row name="类型" value="type"/>
		<eoms:row name="额定功率" value="ratingPower"/>
		<eoms:row name="输入额定电压" value="impRatingVoltage"/>
		<eoms:row name="输出额定电压" value="extRatingVoltage"/>
