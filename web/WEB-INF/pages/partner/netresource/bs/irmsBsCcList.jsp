...
<div align="center"><b>风光互补控制器-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.IrmsBsCc" method="post">
		<fieldset>
			<legend>快速查询</legend>
			<table id="sheet" class="formTable">
						...
						<td class="content" >
								<eoms:comboBox id="deviceSubclass" name="deviceSubclassStringEqual" initDicId="11228022401" defaultValue="${deviceSubclassStringEqual}" styleClass="input select" />
						</td>
						</tr>
						<tr>
						<td class="label">
						...
						<td class="content" colspan="3">
								<input class="text" type="text" name="supplierStringLike" value="${supplierStringLike}" />
						</td>
						</tr>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.IrmsBsCc'"/>
						</div>
					</td>
				</tr>
			</table>
...
<!--导出功能开始-->
<%--
<eoms:excelExport modelName="com.boco.eoms.partner.netresource.model.bs.IrmsBsCc" 
							 serviceBeanId="eomsService"   title="网络资源--基站设备及配套--风光互补控制器" >
		...
		<eoms:row name="下挂太阳能板数(块)" value="solarPanelsCount"/>
