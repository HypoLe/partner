...
function excelFileUpload() {
	...
	Ext.Ajax.request({
		...
		params :{resourceName:"IrmsBsGrnerat"},
		method : 'post',
		form:'excel2xmlForm',
		isUpload:true,
...
<div align="center"><b>发电机组-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.IrmsBsGrnerat" method="post">
		<fieldset>
			<legend>快速查询</legend>
			<table id="sheet" class="formTable">
						...
						<td class="content" >
								<input class="text" type="text" name="ratingPowerStringLike" value="${ratingPowerStringLike}" />
						</td>
						...
						<td class="content" >
								<input class="text" type="text" name="ratingVoltageStringLike" value="${ratingVoltageStringLike}" />
						</td>
						</tr>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.IrmsBsGrnerat'"/>
						</div>
					</td>
				</tr>
			</table>
...
<!--导出功能开始-->
<%--
<eoms:excelExport modelName="com.boco.eoms.partner.netresource.model.bs.IrmsBsGrnerat" 
							 serviceBeanId="eomsService"   title="网络资源--基站设备及配套--发电机组" >
		...
		<eoms:row name="额定功率（KVA）" value="ratingPower"/>
		<eoms:row name="额定工作电压（V）" value="ratingVoltage"/>
		<eoms:row name="启动方式" value="startMode"/>
		<eoms:row name="冷却方式" value="coolMode"/>
		<eoms:row name="启动电池型号" value="startBatteryMode"/>
		<eoms:row name="启动电池组数" value="startBatteryCoun"/>
		<eoms:row name="启动电池容量（AH）" value="startBatteryCapa"/>
		<eoms:row name="油箱容积（L）" value="tankCapacity"/>
