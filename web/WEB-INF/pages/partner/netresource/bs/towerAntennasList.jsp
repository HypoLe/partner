...
<div align="center"><b>铁塔及天馈资源-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/bsbt/pnrbsbt.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.TowerAntennas" method="post">
		<fieldset>
			<legend>快速查询</legend>
			<table id="sheet" class="formTable">
						...
						<td class="content" >
								<input class="text" type="text" name="taNameStringLike" value="${taNameStringLike}" />
						</td>
						<td class="label">
						 	产权
						</td>
						<td class="content" >
								<input class="text" type="text" name="equityStringLike" value="${equityStringLike}" />
						</td>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/bsbt/pnrbsbt.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.bs.TowerAntennas'"/>
						</div>
					</td>
				</tr>
			</table>
...
<logic:present name="towerAntennasList" scope="request">
	<display:table id="towerAntennasList"
					name="towerAntennasList" 
