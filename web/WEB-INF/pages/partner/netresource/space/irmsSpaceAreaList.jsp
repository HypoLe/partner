...
function excelFileUpload() {
	...
	Ext.Ajax.request({
		...
		params :{resourceName:"IrmsSpaceArea"},
		method : 'post',
		form:'excel2xmlForm',
		isUpload:true,
...
<div align="center"><b>区域-列表页面</b></div><br><br/>
...
<div id="listQueryObject" style="border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;display:none">
	<form action="${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.space.IrmsSpaceArea" method="post">
		<fieldset>
			<legend>快速查询</legend>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app}/netresource/pnrNetResourceAction.do?method=gotoListPage&model=com.boco.eoms.partner.netresource.model.space.IrmsSpaceArea'"/>
						</div>
					</td>
				</tr>
			</table>
...
<!--导出功能开始-->
<%--
<eoms:excelExport modelName="com.boco.eoms.partner.netresource.model.space.IrmsSpaceArea" 
							 serviceBeanId="eomsService"   title="网络资源--空间资源--区域" >
		<eoms:row name="区域名称" value="areaName"/>
		<eoms:row name="区域名称中文缩写" value="abbreviation"/>
		<eoms:row name="拼音缩写" value="spellabbreviation"/>
		<eoms:row name="别名" value="areaAlias"/>
		<eoms:row name="长途区号" value="areaCode"/>
		<eoms:row name="所属区域名称" value="relatedSpace"/>
		<eoms:row name="地区类型" value="areaType"/>
		<eoms:row name="是否省会" value="isCapital"/>
