...
<html:form action="/chanEvaTemplates.do?method=search" styleId="chanEvaTemplateForm" method="post"> 
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-chanEva" dictId="templateStatus" defaultId="<%=ChanEvaConstants.TEMPLATE_REPORTED%>"
