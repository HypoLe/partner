...
<html:form action="/chanEvaTasks.do?method=saveTaskDetail" styleId="chanEvaReportMultiDeptForm" method="post">
...
function  queryBack()
    {
      document.forms[0].action="chanEvaReportMultiDepts.do?method=queryInitMultiDept";
    };
</script>