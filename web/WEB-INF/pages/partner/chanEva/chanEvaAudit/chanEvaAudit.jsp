...
function check(flag){
   if(flag == 0){
     if(chanEvaAuditForm.auditInfo.value == ""){
       alert("请填写审批意见！");
       return false;
     }
     chanEvaAuditForm.auditFlag.value = "0";
     chanEvaAuditForm.submit();
     return true;
   }
   else{
     if(chanEvaAuditForm.auditInfo.value == ""){
     ...
     chanEvaAuditForm.auditFlag.value = "1";
     chanEvaAuditForm.submit();
     return true;
   }
}
...
<html:form action="/chanEvaAudit.do?method=audit" styleId="chanEvaAuditForm" method="post"> 
<table>
	...
	<tr height="30">
		...
		<td width="70%">
			<html:textarea property="auditInfo" styleId="auditInfo"
						styleClass="text medium"  value="${chanEvaAuditForm.auditInfo}" />
		</td>
	</tr>
	<tr height="30">
		<td colspan="2">
...
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-partner-chanEva" dictId="cycle" itemId="${template.cycle}" beanId="id2nameXML" />
		</td>
	</tr>
	<tr>
		<td class="label">
	...
	<tr>
		...
		<td class="content">
			<a href="${app}/partner/chanEva/chanEvaAudit.do?method=auditInfoList&nodeId=${org.id}"
				 target="_blank">
				点击查看审核意见
			</a>
		</td>
...
<table class="listTable" id="list">
	...
	<tr>
		...
		<td>
			<bean:write name="kpiList" property="chanEvaScore"/>
		</td>
	</tr>
	</logic:iterate>
	</tbody>
