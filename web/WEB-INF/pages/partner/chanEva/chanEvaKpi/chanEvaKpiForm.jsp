...
Ext.onReady(function() {
	v = new eoms.form.Validation({form:'chanEvaKpiForm'});
});
</script>

<html:form action="/chanEvaKpis.do?method=saveKpi" styleId="chanEvaKpiForm" method="post"> 
	...
	<tr>
		...
		<td class="content">
			<html:text property="kpiName" styleId="kpiName" style="width:88%" 
						...
						alt="allowBlank:false,vtext:'请输入指标名称'" value="${chanEvaKpiForm.kpiName}" />
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
			<html:textarea property="remark" styleId="remark" style="width:88%" 
						styleClass="textarea"  value="${chanEvaKpiForm.remark}" />
		</td>
	</tr>
</table>
...
<html:hidden property="id" value="${chanEvaKpiForm.id}" />
</html:form>
