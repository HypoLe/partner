...
<html:form action="/chanEvaKpiInstances.do?method=genInstance" styleId="chanEvaKpiInstanceForm" method="post"> 
...
<iframe id="fileList" name="fileList" frameborder="0" width="100%" height="100%" 
	src="${app}/partner/chanEva/chanEvaKpis.do?method=listKpiOfTemplate&templateId=${template.id}">
</iframe>
</c:if>
