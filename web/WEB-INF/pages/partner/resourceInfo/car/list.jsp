...
<script type="text/javascript">
	function add(){
	window.location.href="<%=request.getContextPath()%>/partner/resourceInfo/car.do?method=goToAdd";
	}
	function openImport(){
 ...
 function checkCarCurrentTask(carNumber,applyId){
 	window.open("${app}/partner/resourceInfo/car.do?method=checkCarCurrentTask&&carNumber="+carNumber+"&&applyId="+applyId,
 	"newwindow","height=200,width=500,top=200,left=500,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no");
 }
