...
<script type="text/javascript">
	...
	function res(){
		var formElement=document.getElementById("checkAndSearchFrom")
	   	 ...
	   	 document.getElementById("maintainCompany").value="";
...
<form id="checkAndSearchFrom"	action="car.do?method=statistics" method="post">
	<fieldset>
		<legend>
			请输入统计条件
		</legend>
		<table class="formTable">
			<tr>
				...
				<td class="content">
					...
					<input type="text" name="area2" id="area2"    class="text medium"    onblur="changeCheckBox()" />
					...
					textField="area2" checktype="" data="${boxData}" single="true">
					</eoms:xbox>
				</td>
				<td class="label">
					代维公司&nbsp;
				...
				<td class="content">
					...
					<input type="text" name="maintainCompany" class="text medium" id="maintainCompany" onblur="changeCheckBox()"/>
	...
	<fieldset>
		...
		<table class="formTable">
			<tr>
				...
				<td class="label" colspan="2">
					<input id="car_number" type="checkbox" name="statisticsItem" value="car_number" checked="checked"/>
					车牌号
				</td>
			</tr>
			<tr>
				<td class="label" colspan="2">
					<input id="car_type" type="checkbox" name="statisticsItem" value="car_type" checked="checked"/>
					车型
				</td>
				<td class="label" colspan="2">
