...
<script type="text/javascript" src="${app}/deviceManagement/jquery-ui-1.8.14.custom/js/jquery-ui-1.8.14.custom.min.js"></script>
  ...
  <body>
  <html:form action="PnrResConfig.do?method=searchResBySheet" method="post" >
   <table class="formTable">
	...
	<display:table name="list" cellspacing="0" cellpadding="0"
		...
		<display:column  title="选择" >
        	<input type="radio" name="checkbox11" id="checkbox11"  value="${list.id},${list.resName },${list.resLongitude},${list.resLatitude}"/>
    	</display:column>
		...
		<display:column  sortable="区县" title="所在区县"
		 ...
		 <display:column sortable="true" headerClass="sortable" title="详情">
	        <a href="${app}/partner/res/PnrResConfig.do?method=detial&seldelcar=${list.id}&sheet=true" title="详情" target="newdetail">
