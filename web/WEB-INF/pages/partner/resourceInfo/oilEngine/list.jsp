...
<%@ page language="java" pageEncoding="UTF-8"%>
	...
	function del(id){
		if(confirm("确定要删除？")){
		 	Ext.Ajax.request({
		 		url:"${app}/partner/resourceInfo/oilEngine.do",
		 		params:{method:"delete",id:id},
		 		success:function(res,opt){
		 			//alert(Ext.util.JSON.decode(res.responseText).info);
...
<display:table name="oilEngineList" cellspacing="0" cellpadding="0"	id="oilEngineList" pagesize="${pageSize}"
	...
	<display:column sortable="false" headerClass="sortable" title="编辑" url="/partner/resourceInfo/oilEngine.do?method=edit"
	...
	<display:column sortable="false" headerClass="sortable" title="删除" media="html">
		 <a href="javascript:void(0)" onclick="del('${oilEngineList.id}')">
