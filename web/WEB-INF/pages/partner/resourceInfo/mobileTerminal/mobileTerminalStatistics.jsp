...
<form id="checkAndSearchFrom" action="mobileTerminal.do?method=statistics" method="post">
	<fieldset>
		<legend>
			请输入统计条件
		</legend>
	...
	<fieldset>
		...
		<table class="formTable">
			<tr>
				...
				<td class="label" colspan="2">
					<input id="mobileTerminal_number" type="checkbox" name="statisticsItem" value="mobileTerminal_number" />
					设备编号
				</td>
			--%>
				<td class="label" colspan="2">
					<input id="factory" type="checkbox" name="statisticsItem" value="factory" checked="checked"/>
					生产厂家
				</td>
