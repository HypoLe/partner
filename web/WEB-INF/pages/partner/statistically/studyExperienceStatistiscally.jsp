    ...
    //要显示的列
	    $("[name='rowsPramters_c']").change(function(){
               ...
               if($(this).attr("checked"))
			  	...
			  	str+="degreeTypeLikedict,"//学历，默认显示
...
<form action="statistics.do?method=studyStatistics" method="post">
<fieldset>
...
<table class="formTable">
		<tr>
			...
			<td>
				<eoms:comboBox name="select_degree"
					id="testParent" sub="testChildren" defaultValue=""
					initDicId="12405" alt="allowBlank:false"  />
			</td>
		</tr>
		<tr>
