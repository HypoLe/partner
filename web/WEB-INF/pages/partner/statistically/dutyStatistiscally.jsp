    ...
    //要显示的列
	    $("[name='rowsPramters_c']").change(function(){
               ...
               if($(this).attr("checked"))
			  	...
			  	str+="levels,total,percentageTypePer,";//在职人数，离职，流失率
      ...
      var width = '${width}'
     if(width!=null||width!=""){
 	    var myChart = new FusionCharts("${app}/FusionCharts/MSColumn3D.swf", "fusionchart", width, "480", "0", "0");
...
<form action="statistics.do?method=dutyStatistics" method="post">
<fieldset>
