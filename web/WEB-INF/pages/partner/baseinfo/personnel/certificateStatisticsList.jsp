...
<table class="formTable">
  	<caption><div class="header center">人员证书统计详细列表</div></caption>
</table>
	<br>	<div>操作提示：证书名称可查看详细信息</div><br>
	<display:table name="list" cellspacing="0" cellpadding="0"
		id="list" pagesize="${pageSize}" class="table" requestURI="${app}/personnel/statistics.do?method=certStatisticsSearchInto"
	...
	<display:column  sortable="true" headerClass="sortable" title="证书名称">
		<a   href="${app}/personnel/certificate.do?method=getDetail&id=${list['cuuid'] }&personCardNo=${list['person_card_no']}&hasRightGoBack=Y">
			${list['type1']}
		</a>		
	</display:column>			
</display:table>
