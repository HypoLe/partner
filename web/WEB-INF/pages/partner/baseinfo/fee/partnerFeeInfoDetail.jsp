...
<html:form action="/partnerFeeInfos.do?method=save"
	...
	<fmt:bundle
		...
		<table class="formTable">
			...
			<tr>
				<td class="label">
					<fmt:message key="partnerFeeInfo.name" />
					&nbsp;
					<font color='red'>*</font>
				</td>
				<td class="content">
				...
				<td class="content">
					<input type="text" id="collectUnitName" name="collectUnitName"
						...
						value='<eoms:id2nameDB id="${partnerFeeInfoForm.collectUnit}"  
			...
			<tr>
				...
				<td class="content">
				<input type="text" id="createUserName" name="createUserName"  readonly="readonly" class="text"
				...
				<td class="content">
				<input type="text" id="createDeptName" name="createDeptName" readonly="readonly" class="text" 
