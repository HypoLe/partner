...
<html:form action="/partnerDepts.do?method=editCompanyBaseInfoSub&isPartner=${isPartner}"
	...
	<table class="formTable">
			...
			<tr style="display: none" id="see1">
				...
				<td class="content">
					<eoms:comboBox name="type" id="type" initDicId="1120101"
						defaultValue='${partnerDeptForm.type}' styleClass="input select" alt="allowBlank:false,vtext:''" />
				</td>
				<td class="label">
					公司法人*
				</td>
		...
		<tr>
			...
			<td class="content">
				...
				alt="allowBlank:false,vtext:'email'" value="${partnerDeptForm.email}" />
			</td>
		</tr>
		<tr>
			<td class="label">
			...
			<td class="content">
				<input name="zip" id="zip" class="text" value="${partnerDeptForm.zip}" />
			</td>
		</tr>
		<tr>
			<td class="label">
		...
		<tr>
			...
			<td class="content" colspan="3">
				<textarea  name="remark" id="remark"  class="textarea max" >${partnerDeptForm.remark}
				</textarea>
			</td>
		</tr>
