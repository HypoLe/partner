...
<table align="center">
	...
	<html:form action="partnerDepts" method="post"
		...
		<display:table name="partnerDeptList" cellspacing="0" cellpadding="0"
			...
			<display:column
				title="<input type='checkbox' onclick='javascript:chooseAll();'>" media="html">
	...
	<display:column sortable="false"
			headerClass="sortable" title="查看下属组织"  paramId="id" paramProperty="id" media="html">
	<a href="${app}/partner/baseinfo/partnerDepts.do?method=findGroupGrandsonCompanyBaseInfo&id=${partnerDeptList.id }&parent_id=${parent_id }&isPartner=${isPartner}">查看</a>
	</display:column>
	<display:column sortable="false"
			headerClass="sortable" title="添加下属组织"  paramId="id" paramProperty="id" media="html">
	<a href="${app}/partner/baseinfo/partnerDepts.do?method=toCompanyBaseInfoGrandsonGroupForm&id=${partnerDeptList.id }&parentDeptname=${partnerDeptList.name }&parent_id=${parent_id }&isPartner=${isPartner}">添加巡检小组</a>
	</display:column>
