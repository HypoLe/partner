...
<html:form action="/partnerDepts.do?method=editCompanyBaseInfoGrandson&isPartner=${isPartner}"
		...
		<table class="formTable">
			<caption>
				<div class="header center">
					<fmt:message key="partnerDept.form.heading" />
				</div>
			</caption>
			<tr>
				<td class="label">
			...
			<tr style="display: none" id="see1">
				...
				<td class="content">
					<eoms:comboBox name="type" id="type" initDicId="1120101"
						defaultValue='${partnerDeptForm.type}'
			...
			<tr style="display: none" id="see3">
				...
				<td class="content">
					<eoms:comboBox name="selectedLevel" id="selectedLevel" styleClass="input select"
						initDicId="12403" defaultValue='${partnerDeptForm.selectedLevel}' alt="allowBlank:false,vtext:''" />
				</td>
			</tr>
			<tr>
				<td class="label">
				...
				<td class="content">
					<html:text property="email" styleId="email"
						styleClass="text medium" alt="allowBlank:false,vtext:'email'" value="${partnerDeptForm.email}" />
				</td>
				<td class="label">
					地市&nbsp;*
				</td>
				<td colspan="3">
					<c:if
						test="${partnerDeptForm.id == partnerDeptForm.interfaceHeadId }"
						var="condition">
						<input type="button" name="areatree" id="areatree" value="选择地域"
							class="btn" />
						<br />
			...
			<tr>
				...
				<td class="content">
					<html:text property="fax" styleId="fax" styleClass="text medium" value="${partnerDeptForm.fax}" />
				</td>
				<td class="label">
					邮编
				</td>
			...
			<tr>
				...
				<td class="content" colspan="3">
					<html:text property="address" styleId="address" styleClass="text max"  alt="allowBlank:false" value="${partnerDeptForm.address}" />
				</td>
			</tr>
			<tr>
				<td class="label">
				...
				<td class="content" colspan="3">
					<textarea class="textarea max"  name="companySynopses" id="companySynopses"  />
	...
	<c:if test="${qualifyConfig=='1'}">
		...
		<table class="formTable">
			...
			<tr>
				...
				<td class="content" colspan="3">
					<eoms:attachment idList="" idField="accessory" appCode="baseinfo" scope="request" name="partnerDeptForm" property="accessory" />
				</td>
			</tr>
			<tr>
				<td class="label">
