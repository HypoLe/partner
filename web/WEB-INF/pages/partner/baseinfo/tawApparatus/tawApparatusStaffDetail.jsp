				...
				<c:if test="${not empty tawApparatusForm.id}">
					<c:choose>
					   <c:when test="${not empty tawApparatusForm.noThumbnail}">
					   		<img id="imgNo" src="${app}/<%=basePath%>${tawApparatusForm.noThumbnail}" style="border-width: 0px;"/>
					   </c:when>
					   <c:otherwise>
					   		<img id="imgNo" src="${app}/<%=defaultNoPic%>" style="border-width: 0px;"/>
					   </c:otherwise>
				...
				<c:if test="${not empty tawApparatusForm.id}">
					<c:choose>
					   <c:when test="${not empty tawApparatusForm.thumbnail}">
					   		<img id="imgApparatus" src="${app}/<%=basePath%>${tawApparatusForm.thumbnail}" style="border-width: 0px;"/>
					   </c:when>
					   <c:otherwise>
