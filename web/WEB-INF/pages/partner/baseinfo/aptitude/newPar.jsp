...
<script type="text/javascript">
    ...
    Ext.onReady(function(){
        var tabConfig = {
            items:[
                {id:'sheet-provider',  text:'合作伙伴', url:eoms.appPath+'/partner/baseinfo/partnerDepts.do?method=${methodName}&nodeId=${nodeId}&proId=${proId}&proId1=${proId1}&searchInto=${searchInto}&hasRightForAdd=${hasRightForAdd}',collapsible: true, isIframe : true}
               // ,
