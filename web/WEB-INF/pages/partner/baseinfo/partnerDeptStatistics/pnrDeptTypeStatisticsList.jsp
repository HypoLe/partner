...
<table class="formTable">
  	<caption><div class="header center">组织企业性质统计列表</div></caption>
</table>
	<br>	<div>操作提示：点击组织名称可查看详细信息</div><br>
	<display:table name="partnerDeptList" cellspacing="0" cellpadding="0"
		id="partnerDeptList" pagesize="${pageSize}" class="table" requestURI="${app}/partner/baseinfo/pnrDeptStatistics.do?method=pnrDeptTypeSearchInto"
		export="false" sort="list" partialList="true" size="${resultSize}">
			...
			<display:column  sortable="true" headerClass="sortable" title="入围性质" paramId="id" paramProperty="id" >
					<eoms:id2nameDB id="${partnerDeptList.type}"	beanId="ItawSystemDictTypeDao" />
			</display:column>
