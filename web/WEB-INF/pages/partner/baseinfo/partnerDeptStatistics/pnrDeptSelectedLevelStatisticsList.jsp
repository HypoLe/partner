...
<table class="formTable">
  	<caption><div class="header center">组织入围级别列表</div></caption>
</table>
	<br>	<div>操作提示：点击组织名称可查看详细信息</div><br>
	<display:table name="partnerDeptList" cellspacing="0" cellpadding="0"
		id="partnerDeptList" pagesize="${pageSize}" class="table" requestURI="${app}/partner/baseinfo/pnrDeptStatistics.do?method=pnrDeptSelectedLevelSearchInto"
		export="false" sort="list" partialList="true" size="${resultSize}">
			...
			<display:column sortable="true" headerClass="sortable" title="入围级别" paramId="id" paramProperty="id">
