...
<form  id="checkAndSearchFrom" action="pnrDeptStatistics.do?method=pnrDetpFundStatistics" method="post">
	<fieldset>
	...
	<table class="formTable">
		<tr>
			...
			<td class="label"><input  value="sum(fund_1)" type="checkbox" name="statisticsItem" id="fund_1"  checked="true"/>&nbsp;&nbsp;100万以下</td>
		</tr>
		<tr>
			<td class="label"><input  value="sum(fund_2)" type="checkbox" name="statisticsItem" id="fund_2" checked="true" />&nbsp;&nbsp;100-500万</td>
			<td class="label"><input  value="sum(fund_3)" type="checkbox" name="statisticsItem" id="fund_3" checked="true" />&nbsp;&nbsp;500-1000万</td>
			<td class="label" colspan="4"><input  value="sum(fund_4)" type="checkbox" name="statisticsItem" id="fund_4"  checked="true" />&nbsp;&nbsp;1000万以上</td>
