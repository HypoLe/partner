				...
				new xbox(
						{
							...
							treeDataUrl : '${app}/partner/appops/partnerAppOpsDept.do?method=area',
							treeRootId : '-1',
							treeRootText : '四川',
							treeChkMode : '',
							treeChkType : 'area',
...
<html:form action="/partnerAppOpsDept.do?method=saveCompanyBaseInfoSub&isPartner=${isPartner}"
