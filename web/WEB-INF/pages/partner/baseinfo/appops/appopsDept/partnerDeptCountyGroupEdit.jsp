...
<html:form action="/partnerAppOpsDept.do?method=editCompanyBaseInfoGrandsonGroup&isPartner=${isPartner}"
	...
	<table>
		<tr>
			<td>
				...
				onclick="javasript:window.location='${app}/partner/appops/partnerAppOpsDept.do?method=findGrandsonCompanyBaseInfo&id=${parent_id }'"/>
			</td>
		</tr>
	</table>
