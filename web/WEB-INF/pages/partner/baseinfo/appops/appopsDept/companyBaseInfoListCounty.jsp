...
<fmt:bundle
	...
	<a href="${app}/partner/appops/partnerAppOpsDept.do?method=findGroupGrandsonCompanyBaseInfo&id=${partnerDeptList.id }&parent_id=${parent_id }&isPartner=${isPartner}">查看</a>
	</display:column>
	<display:column sortable="false"
			headerClass="sortable" title="添加下属组织"  paramId="id" paramProperty="id" media="html">
	<a href="${app}/partner/appops/partnerAppOpsDept.do?method=toCompanyBaseInfoGrandsonGroupForm&id=${partnerDeptList.id }&parentDeptname=${partnerDeptList.name }&parent_id=${parent_id }&isPartner=${isPartner}">添加小组</a>
	</display:column>
