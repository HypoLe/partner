...
<script type="text/javascript" src="${app}/scripts/adapter/ext-vtypes.js"></script>
		...
		*************************/	
		onLoadFunctions:function(){		
		  ...
		  new xbox({
				...
				treeDataUrl:treeAction2,treeRootId:'-1',treeRootText:'${eoms:a2u('临时用户')}',treeChkMode:'single',treeChkType:'user',
