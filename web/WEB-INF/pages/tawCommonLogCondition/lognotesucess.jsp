...
<c:set var="buttons">
    <input type="button" style="margin-right: 5px"
        onclick="location.href='<c:url value="/log/tawCommonLogConditions.do?method=search&searchbyoper=${searchbyoper}"/>'"
        value='${eoms:a2u('返回')}'/>
</c:set>
...
<display:table name="logList" cellspacing="0" cellpadding="0"
    ...
    export="true" requestURI="${app}/log/TawCommonLogCondition/querydo.do" sort="list" partialList="true" size="resultSize"
    >
