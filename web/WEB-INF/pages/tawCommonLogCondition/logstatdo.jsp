...
<table cellpadding="0" class="table logList" cellspacing="0">
 ...
 <tr class="sortable">
		    ...
		    <td width="20%" align='center'><a href="${app}/log/TawCommonLogCondition/logstatdeptdo.do?flag=<%=i%>&searchbystarttime=<%=starttime%>&searchbyendtime=<%=endtime%>" target="_blank"><%=obj.get(1)%></a></td>
		    <td width="20%" align='center'><a href="${app}/log/TawCommonLogCondition/logstatuserdo.do?flag=<%=i%>&searchbystarttime=<%=starttime%>&searchbyendtime=<%=endtime%>" target="_blank"><%=obj.get(2)%></a></td>
		    <td width="20%" align='center'><a href="${app}/log/TawCommonLogCondition/logstatalldo.do?flag=<%=i%>&searchbystarttime=<%=starttime%>&searchbyendtime=<%=endtime%>" target="_blank"><%=obj.get(3)%></a></td>
</tr>
		    <% }%>
