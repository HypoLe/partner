...
Ext.onReady(function(){
	...
	userTree = new xbox({
		...
		viewer:userViewer,saveChkFldId:'users',returnJSON:true,callback:getUserMessage
	});
...
<html:form action="/saveSmsMobilesTemplate.do?method=xsave&deleted=2" method="post" styleId="smsMobilesTemplateForm"> 
