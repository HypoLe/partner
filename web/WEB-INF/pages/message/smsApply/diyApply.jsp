...
<html:form action="/smsApplys.do?method=xsave" method="post" styleId="smsApplyForm"> 
    <table class="formTable">
    	...
    	<tr>
    		<td class="label">
    		    ...
    		    <c:if test='${smsApplyForm.isSendUnDuty==null||empty smsApplyForm.isSendUnDuty}'>
    		         　<c:set value="0" target="${smsApplyForm}" property="isSendUnDuty"></c:set>
    		    </c:if>
    		<td class="content">
    ...
    <html:hidden property="msgType"/>
        ...
        <html:button property="cancel" styleClass="button" onclick="javascript:window.history.back();">
