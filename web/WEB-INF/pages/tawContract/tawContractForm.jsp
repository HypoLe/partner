...
<html:form action="/tawContracts.do?method=save"
	...
	<fmt:bundle basename="com/boco/eoms/parter/baseinfo/config/applicationResource-tawcontract">
		...
		<table class="formTable">
			...
			<tr>
				<td class="label">
					<fmt:message key="tawContract.contractName" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.name_A" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				<td class="label">
					<fmt:message key="tawContract.name_B" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.maintenanceRange" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				<td class="label">
					<fmt:message key="tawContract.right_A" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.right_B" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				...
				<td class="label">
					<fmt:message key="tawContract.interface_A" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.interface_B" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				...
				<td class="label">
					<fmt:message key="tawContract.qualityCheck" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.qualityChangeDeal" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				<td class="label">
					<fmt:message key="tawContract.beyond" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.secret" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				<td class="label">
					<fmt:message key="tawContract.stopCondition" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.breachFaith" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				<td class="label">
					<fmt:message key="tawContract.solve" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.add_ons" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				<td class="label">
					<fmt:message key="tawContract.contact_A" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.contact_B" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				<td class="label">
					<fmt:message key="tawContract.cost" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.payType" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
			...
			<tr>
				<td class="label">
					<fmt:message key="tawContract.payCycle" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="label">
					<fmt:message key="tawContract.timeLimit" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
	...
	--%>
			<tr>
				<td class="label">
					<fmt:message key="tawContract.payed" />&nbsp&nbsp <font color="red">*</font>
				</td>
				<td class="content">
				...
				<td class="content">
					<eoms:attachment name="tawContractForm" property="accessory"
						scope="request" idField="accessory" appCode="contract"  
						 /> 
				</td>
			</tr>
			...
			<td>
				...
				<input type="button" class="btn" value="返回"
					...
					<input type="button" class="btn"
						...
						var url='${app}/contract/tawContracts.do?method=remove&id=${tawContractForm.id}';
