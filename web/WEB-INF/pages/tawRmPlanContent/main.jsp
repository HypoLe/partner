...
<script type="text/javascript">
  var config = { 
	...
	ctxMenu:[  
		{id:'Workplan', text:'${eoms:a2u('新增')}',cls:'new-mi',url:'${app}/duty/tawRmPlanContent.do?method=edit&folderPath='},
		{id:'WorkplanQuery', text:'${eoms:a2u('查询')}',cls:'list-mi',url:'${app}/duty/tawRmPlanContent.do?method=planSearch&folderPath='},
		{id:'GdRecord', text:'${eoms:a2u('新增')}',cls:'new-mi',url:'${app}/duty/tawRmWorkorderRecord.do?method=edit&folderPath='},
		{id:'GdRecordQuery', text:'${eoms:a2u('查询')}',cls:'list-mi',url:'${app}/duty/tawRmWorkorderRecord.do?method=workOrderSearch&folderPath='},
	 	{id:'DutyRecord', text:'${eoms:a2u('新增')}',cls:'new-mi',url:'${app}/workbench/memo/editTawWorkbenchMemoSendLog.do?folderPath='},
	 	{id:'DutyRecordQuery', text:'${eoms:a2u('查询')}',cls:'list-mi',url:'${app}/workbench/memo/tawWorkbenchMemoNodes.do?method=memoSearch&folderPath='},
	 	{id:'SfRecord', text:'${eoms:a2u('新增')}',cls:'new-mi',url:'${app}/duty/tawRmDispatchRecord.do?method=edit&folderPath='},
		{id:'SfRecordQuery', text:'${eoms:a2u('查询')}',cls:'list-mi',url:'${app}/duty/tawRmDispatchRecord.do?method=dispatchRecordSearch&folderPath='},
	 	{id:'PersonCheckin', text:'${eoms:a2u('新增')}',cls:'new-mi',url:'${app}/duty/tawRmVisitRecord.do?method=edit&folderPath='},
		{id:'PersonCheckinQuery', text:'${eoms:a2u('查询')}',cls:'list-mi',url:'${app}/duty/tawRmVisitRecord.do?method=visitRecordSearch&folderPath='},
		{id:'PersonCheckinStat', text:'${eoms:a2u('统计')}',cls:'list-mi',url:'${app}/duty/tawRmVisitRecord.do?method=visitRecordStat&folderPath='},
	 	{id:'WpCheckin', text:'${eoms:a2u('新增')}',cls:'new-mi',url:'${app}/duty/tawRmLoanRecord.do?method=edit&folderPath='},
		{id:'WpCheckinQuery', text:'${eoms:a2u('查询')}',cls:'list-mi',url:'${app}/duty/tawRmLoanRecord.do?method=loanRecordSearch&folderPath='},
	 	{id:'ReliefQuery', text:'${eoms:a2u('查询')}',cls:'list-mi',url:'${app}/duty/tawRmReliefRecord.do?method=reliefRecordSearch&folderPath='},
	 	{id:'LogUniteQuery', text:'${eoms:a2u('查询日志合并记录')}',cls:'list-mi',url:'${app}/duty/tawRmLogUnite.do?method=logUniteSearch&folderPath='},
	 	{id:'LogUnite', text:'${eoms:a2u('日志合并')}',cls:'list-mi',url:'${app}/duty/tawRmLogUnite.do?method=toLogUnite&folderPath='}
...
<div id="helpPanel" style="padding:10px;"
	...
	<dl>
		...
		<dd>
			${eoms:a2u('统计：鼠标右键点击树图中的【外来人员登记】，选择【统计】，进入统计界面，输入相关统计 条件后点击【统计】按钮。在一段时间内的统计数据就会显示出来。')}
		</dd>
		<dd>
