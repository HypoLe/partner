...
<script type="text/javascript">
  ...
  var config = {
 	...
 	* Tree Configs
 	**************/
	treeGetNodeUrl:"${app}/eva/evaTrees.do?method=getTemplateNodesByHistory",
    treeRootId:'<%=EvaConstants.TREE_ROOT_ID%>',
	treeRootText:'考核模板',
	pageFrameId:'formPanel-page',
	onClick:{url:"${app}/eva/evaReportInfos.do?method=getAllScroeView&nodeId=",text:""},
	ctxMenu:[
		{id:'executeTemplate', text:'考核执行情况',cls:'query-mi',url:'${app}/eva/evaReportInfos.do?method=getAllScroe&nodeId='}
	],//end of ctxMenu 
	/************************
