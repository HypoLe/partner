...
<script type="text/javascript">
  ...
  var config = {
	...
	onClick:{url:"${app}/eva/evaReportInfos.do?method=getAllScroeView&nodeId=",text:""},
	ctxMenu:[
		...
		{id:'editTemplate', text:'修改/激活模板',cls:'edit-mi',url:'${app}/eva/evaTemplates.do?method=editTemplate&nodeId='},
		{id:'detailTemplate', text:'查看考核模板',cls:'edit-mi',url:'${app}/eva/evaTemplates.do?method=editTemplate&nodeId='},
