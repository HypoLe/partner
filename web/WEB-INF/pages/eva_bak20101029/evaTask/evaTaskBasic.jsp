...
<div id="info-page">
	<table class="formTable" id="form">
		...
		<tr>
			<td colspan="4">
					<input type="button" name="closedTemplate" id="closedTemplate" value="关闭考核" class="btn" onclick="javascript:if(confirm('你确定关闭该任务么?')){var url=eoms.appPath+'/eva/evaTemplates.do?method=closeTemplate&id=${template.id}';location.href=url}"/>
			</td>
		</tr>		
	</table>
  </div>
