		...
		<tbody>
			<logic:iterate id="taskDetail" name="taskDetailList" indexId="index">
				<tr>
					...
					<td>
						<a href="${app}/eva/evaTasks.do?method=taskDetailList&taskId=${taskDetail.taskId}&partnerId=${taskDetail.partnerId}&time=${taskDetail.time}&timeType=${taskDetail.timeType}&queryType=${queryType }" title="查看" />查看
					</td>
				</tr>
			</logic:iterate>
		</tbody>
