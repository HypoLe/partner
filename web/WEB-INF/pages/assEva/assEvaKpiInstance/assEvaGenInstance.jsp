...
<html:form action="/assEvaKpiInstances.do?method=genInstance" styleId="assEvaKpiInstanceForm" method="post"> 
...
<iframe id="fileList" name="fileList" frameborder="0" width="100%" height="100%" 
	src="${app}/assEva/assEvaKpis.do?method=listKpiOfTemplate&templateId=${template.id}">
</iframe>
</c:if>
