...
<html:form action="/assEvaTemplates.do?method=search" styleId="assEvaTemplateForm" method="post"> 
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-assEva" dictId="templateStatus" defaultId="<%=AssEvaConstants.TEMPLATE_REPORTED%>"
