...
Ext.onReady(function() {
	v = new eoms.form.Validation({form:'assEvaKpiForm'});
});
</script>

<html:form action="/assEvaKpis.do?method=saveKpi" styleId="assEvaKpiForm" method="post"> 
	...
	<tr>
		...
		<td class="content">
			<html:text property="kpiName" styleId="kpiName" style="width:88%" 
						...
						alt="allowBlank:false,vtext:'请输入指标名称'" value="${assEvaKpiForm.kpiName}" />
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
			<html:textarea property="remark" styleId="remark" style="width:88%" 
						styleClass="textarea"  value="${assEvaKpiForm.remark}" />
		</td>
	</tr>
</table>
...
<html:hidden property="id" value="${assEvaKpiForm.id}" />
</html:form>
