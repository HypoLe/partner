...
function check(flag){
   if(flag == 0){
     if(assEvaAuditForm.auditInfo.value == ""){
       alert("请填写审批意见！");
       return false;
     }
     assEvaAuditForm.auditFlag.value = "0";
     assEvaAuditForm.submit();
     return true;
   }
   else{
     if(assEvaAuditForm.auditInfo.value == ""){
     ...
     assEvaAuditForm.auditFlag.value = "1";
     assEvaAuditForm.submit();
     return true;
   }
}
...
<html:form action="/assEvaAudit.do?method=audit" styleId="assEvaAuditForm" method="post"> 
<table>
	...
	<tr height="30">
		...
		<td width="70%">
			<html:textarea property="auditInfo" styleId="auditInfo"
						styleClass="text medium"  value="${assEvaAuditForm.auditInfo}" />
		</td>
	</tr>
	<tr height="30">
		<td colspan="2">
...
<table class="formTable" id="form">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-assEva" dictId="cycle" itemId="${template.cycle}" beanId="id2nameXML" />
		</td>
	</tr>
	<tr>
		<td class="label">
	...
	<tr>
		...
		<td class="content">
			<a href="${app}/assEva/assEvaAudit.do?method=auditInfoList&nodeId=${org.id}"
				 target="_blank">
				点击查看审核意见
			</a>
		</td>
...
<table class="listTable" id="list">
	...
	<tr>
		...
		<td>
			<bean:write name="kpiList" property="assEvaScore"/>
		</td>
	</tr>
	</logic:iterate>
	</tbody>
