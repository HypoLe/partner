...
<html:form action="/assEvaTasks.do?method=saveTaskDetail" styleId="assEvaReportMultiDeptForm" method="post">
...
function  queryBack()
    {
      document.forms[0].action="assEvaReportMultiDepts.do?method=queryInitMultiDept";
    };
</script>