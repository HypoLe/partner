...
function changeTemplateTypeAndTime()
		{    		    
		    ...
		    if(year1!=""&&month1!=""&&templateTypeId!=""){
				...
				var url="<%=request.getContextPath()%>/assEva/assEvaTasks.do?method=changeTemplateTypeAndTime&templateTypeId="+templateTypeId;
...
<html:form action="/assEvaReportMultiDepts.do?method=reportMultiDept" styleId="assEvaKpiInstanceForm" method="post"> 
