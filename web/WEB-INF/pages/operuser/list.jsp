...
<table class="formTable">
	...
	<tr>	
		...
		<td class="content">
			<eoms:id2nameDB id="${operuserForm.sex}" beanId="ItawSystemDictTypeDao" />
		</td>		
	</tr>
	...
	<tr>	
		...
		<td class="content">
			<eoms:id2nameDB id="${operuserForm.subarea}" beanId="ItawSystemDictTypeDao" />
		</td>		
	</tr>
	...
	<tr>	
		...
		<td class="content">
			<eoms:id2nameDB id="${operuserForm.majortype}" beanId="ItawSystemDictTypeDao" />
		</td>		
	</tr>
	...
	<tr>	
		...
		<td class="content">
			<eoms:id2nameDB id="${operuserForm.jobtype}" beanId="ItawSystemDictTypeDao" />
		</td>		
	</tr>
	...
	<tr>	
		...
		<td class="content">
			<eoms:id2nameDB id="${operuserForm.joblevele}" beanId="ItawSystemDictTypeDao" />
		</td>		
	</tr>
	...
	<tr>	
		...
		<td class="content">
			<eoms:id2nameDB id="${operuserForm.schoollevel}" beanId="ItawSystemDictTypeDao" />
		</td>		
	</tr>
	...
	<tr>	
		...
		<td class="content">
			<eoms:id2nameDB id="${operuserForm.powerlevel}" beanId="ItawSystemDictTypeDao" />
		</td>		
	</tr>
	...
	<tr>	
		...
		<td class="content">
			<eoms:id2nameDB id="${operuserForm.prizelevel}" beanId="ItawSystemDictTypeDao" />
		</td>		
	</tr>
	...
	<tr>	
		...
		<td class="content">
			<eoms:id2nameDB id="${operuserForm.worklevel}" beanId="ItawSystemDictTypeDao" />
