...
<html:hidden property="areaid"/> 
 ...
 <html:hidden property="leaf"/>  
    ...
    <li>
		<eoms:label styleClass="desc" key="tawSystemAreaForm.capital" />
		<eoms:dict key="dict-area" dictId="capital" beanId="selectXML" isQuery="false" selectId="capital" alt="allowBlank:false"  defaultId="${tawSystemAreaForm.capital}"/>
    </li>
    <li>
    ...
    <li class="buttonBar bottom">
        ...
        <html:submit styleClass="button" property="method.delete" onclick="bCancel=true; return confirmDelete('TawSystemArea')">
