...
var jq=$.noConflict(); //jquery交出控制权，以免和EXTJS冲突
		...
		<display:table name="schemeRatelist" cellspacing="0" cellpadding="0"
			...
			<display:column sortable="false" headerClass="sortable" title="区县"  property="county" />
			<display:column sortable="false" headerClass="sortable" title="工单类型"  property="themeinterface" />
