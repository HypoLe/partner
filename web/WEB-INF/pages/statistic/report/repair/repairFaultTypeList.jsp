...
var jq=$.noConflict(); //jquery交出控制权，以免和EXTJS冲突
		...
		<div id="sheetform">
			<html:form action="/repairFault.do?method=repairFaultTypeList"
				styleId="theform">
		...
		<form id="testform" name="testform" action="${app}/activiti/statistics/repairFault.do?method=repairFaultTypeList" method="post">	
		<display:table name="schemeRatelist" cellspacing="0" cellpadding="0"
			...
			size="total" partialList="${partialList}">
