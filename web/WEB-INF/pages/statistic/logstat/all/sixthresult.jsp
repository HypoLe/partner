...
<script language="JavaScript">
	  function GoBack(){
	   ...
	   colorRows('list-table');
		...
		String url="/statistic/logstat/stat.do?method=performStatistic&excelConfigURL=logstat_all&findListForward=all_statlist&reportIndex=4&beginTime="+beginTime+"&endTime="+endTime;
		           %>
