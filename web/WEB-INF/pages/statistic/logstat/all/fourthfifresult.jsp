...
<script language="JavaScript">
	  function GoBack(){
	   ...
	   colorRows('list-table');
		...
		String aurl="/statistic/logstat/stat.do?method=performStatistic&excelConfigURL=logstat_all&findListForward=all_statlist&reportIndex=6&beginTime="+beginTime+"&endTime="+endTime;
