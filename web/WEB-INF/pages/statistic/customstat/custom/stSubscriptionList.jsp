...
<fmt:bundle
	...
	<display:table name="stSubscriptionList" cellspacing="0"
      ...
      <display:column property="subId" sortable="true" headerClass="sortable"
          paramId="id" paramProperty="id"
         titleKey="stSubscriptionForm.subId"/>
     
      <display:column property="subscriber" sortable="true" headerClass="sortable"
          paramId="id" paramProperty="id"
      ...
      <display:column property="item" sortable="true" headerClass="sortable"
          paramId="id" paramProperty="id"
         titleKey="stSubscriptionForm.itemName"/>
      <display:column property="statMode" sortable="true" headerClass="sortable"
          paramId="id" paramProperty="id"
         titleKey="stSubscriptionForm.statMode"/>
      <display:column property="statfromdate" sortable="true" headerClass="sortable"
          paramId="id" paramProperty="id" format="{0,date,yyyy-MM-dd HH:mm:SS}" 
         titleKey="stSubscriptionForm.statfromdate"/>
      <display:column property="stattodate" sortable="true" headerClass="sortable"
          paramId="id" paramProperty="id" format="{0,date,yyyy-MM-dd HH:mm:SS}" 
         titleKey="stSubscriptionForm.stattodate"/>
     
         
     <display:column headerClass="sortable" titleKey="button.view">
		<html:link href="${app}/statistic/customstat/stSubscriptions.do?method=look" paramId="id" paramProperty="id" paramName="stSubscriptionList" titleKey="button.view" onclick="showDetail(this);return false;">
