...
var	areaTree='${app}/xtree.do?method=areaTree'; //地域树
  ...
  Ext.onReady(function(){
	...
	userByDeptTree = new xbox({
		...
		treeDataUrl:userByDeptTree,treeRootId:'-1',treeRootText:'${eoms:a2u("人员树")}',treeChkMode:'',treeChkType:'user',
...
function displayTR(sel){
	...
	// begin 
	if(sel.value=="commonfault-onetimepass-KPI2_oracle")
	{  <% findListForward="onetimepass-statisticsheetlist-kpi2";  %>
	...
	}else if(sel.value=="commonfault_delay_KPI3_oracle")
	{  <% findListForward="commonfault_delay_KPI3list";  %>
		eoms.form.disableArea("td4",true);
	...
	else if(sel.value=="commonfault_intime_KPI1_oracle")
	{ <% findListForward="intime_statisticsheetlist";  %>
		eoms.form.disableArea("td4",true);
        ...
        <option value="7">${eoms:a2u("周日")}</option>
		 ...
		 <tr class="tr_show">
          ...
          <td noWrap width="13%">
    	    ...
    	    <td noWrap width="85%">
                	${eoms:a2u('从')}
	                <input type="text" name="statfromdate" id="statfromdate" value="<%=before %>" readonly="readonly" onclick="popUpCalendar(this, this,null,null,null,true,-1);" class="text"/>
	     	          ${eoms:a2u('到')}
	                <input type="text" name="stattodate" id="stattodate" value="<%=current %>"  readonly="readonly" onclick="popUpCalendar(this, this,null,null,null,true,-1);" class="text"/>
         </td>
    </tr>
