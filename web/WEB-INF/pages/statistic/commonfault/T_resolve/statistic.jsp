           ...
           <tr>
			  ...
			  <td>
			  	 <eoms:comboBox name="${sheetPageName}mainNetSortOne" id="${sheetPageName}mainNetSortOne" 
			  	      sub="" initDicId="1010104" defaultValue="${sheetMain.mainNetSortOne}" alt="allowBlank:true" onchange="selectLimit(this.value);"/>
			  </td>
			</tr>
			...
			<tr>
				<td>
				<select name="reportFromType">
					<option value="StatFrom">${eoms:a2u("统计报表")}</option>
					<option value="graphicsFrom">${eoms:a2u("图形报表")}</option>
					<option value="StatFrom_graphicsFrom">${eoms:a2u("统计与图形报表")}</option>
				</select>
				</td>
				
				<!-- 选择图形报表的类型 column\line\columnline\pie-->
				<td>
					<select name="graphicReportType">
						<option value="column">${eoms:a2u("柱图")}</option>
						<option value="line">${eoms:a2u("线图")}</option>
						<option value="pie">${eoms:a2u("饼图")}</option>
						<option value="columnline">${eoms:a2u("线柱结合图")}</option>
					</select> 
				</td>
			</tr>
