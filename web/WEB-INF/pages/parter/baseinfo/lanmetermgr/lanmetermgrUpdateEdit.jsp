...
%>
<!--根据给定的实例名生成标题 -->
<title><fmt:message key="lanmetermgrDetail.title"/></title>
<fmt:bundle basename="com/boco/eoms/parter/baseinfo/config/ApplicationResources-parter-baseinfo-lanmetermgr">
<!-- <content tag="heading"><fmt:message key="lanmetermgrDetail.heading"/></content> <!--  -->
</fmt:bundle>
...
<table class="formTable middle"  cellspacing="1">
  ...
  <input name="typeName"  type="hidden" id="typeName" value="updateEdit"/> 
    <tr class="tr_show">   
		    <td >      
			  ...
			  <!--  
			    <eoms:comboBox name="maintenUnitIdName" id="a1" sub="a2" initDicId="11101"/>
