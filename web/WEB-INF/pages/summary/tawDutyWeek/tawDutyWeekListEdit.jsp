...
<content tag="heading">
	...
	<display:table name="tawDutyWeekList" cellspacing="0" cellpadding="0"
		...
		export="false"
		requestURI="${app}/summary/tawDutyWeeks.do"
		sort="list" partialList="true" size="resultSize">
		
        <display:column property="title" 
		headerClass="sortable" titleKey="tawDutyWeek.title" href="${app}/summary/tawDutyWeeks.do?method=edit" paramId="id" paramProperty="id"/>
