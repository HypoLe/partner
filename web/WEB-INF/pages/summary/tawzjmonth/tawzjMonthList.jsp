...
<br/>
	<input type="button" class="btn" value="<fmt:message key="button.update"/>" onclick="SubmitCheck();"/>
</html:form>
</fmt:bundle>
...
function SubmitCheck(){
    ...
    for(var i=0; i<objs.length; i++) {
     ...
     if(a!=1){
     	...
     	document.forms[0].action ="${app}/summary/tawzjMonths.do?method=edit&&id="+id;
