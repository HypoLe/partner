<%@ page language="java" import="java.util.*,com.boco.eoms.commons.mms.statreport.webapp.form.StatreportForm" pageEncoding="UTF-8"%>
...
<%
	...
	StatreportForm statreportForm = (StatreportForm)request.getAttribute("statreportForm");
 %>
...
<table class="formTable">
	...
	<%
		...
		if(statreportForm.getPicID() != null && !"".equalsIgnoreCase(statreportForm.getPicID()))
		{
	 %>
