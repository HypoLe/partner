<%@ page language="java" import="java.util.*,com.boco.eoms.commons.mms.mmsreporttemplate.model.MmsreportTemplate,java.util.List,com.boco.eoms.commons.mms.base.config.*,com.boco.eoms.base.util.StaticMethod" pageEncoding="UTF-8"%>
...
<table class="formTable">
 ...
 <tr class="tr_show">
        ...
        <% for(int i=1;i<8;i++){
         ...
         %>
        <option value="<%=i%>" <%=select %>>周<%= i%></option>
		<%}%>
        </select>	
      	   以此为周期    
        </td>
	...
	<tr>
	 ...
	 <tr>
	 	...
	 	<td>
	 		<%=mmsreportTemplate.getStatReportType() %>
	 	</td>>
	 </tr>
...
<table>
	<tr>
		<td>
			<input type="button" class="btn" return onclick=submitCheck() value="<fmt:message key="button.save"/>" />
