...
<div id="rolePanel" class="x-layout-inactive-content panel">
	...
	<div id="rolePanel-users" class="viewer-box">
		<div id="rolePanel-users-title" class="viewlistitem-role"></div> ${eoms:a2u('的人员列表:')}
...
<div id="gridPanel" class="x-layout-inactive-content panel">
	...
	<div id="subRoleUsers" class="viewer-box">
	  ...
	  <div id="user-subrolename" class="viewlistitem-role"></div> ${eoms:a2u('的人员列表:')}
...
<div id="crtSubRolesPanel" class="x-layout-inactive-content panel">
	...
	<div class="preHelp"><div class="preHeader">${eoms:a2u('1. 请选择流程:')}</div>
	  ...
	  <input style="display:none" id="addDistincter" type="button" value="${eoms:a2u('添加')}" onclick="javascript:doselect();"/>
	  <input style="display:none" type="button" value="${eoms:a2u('重置')}" onclick="javascript:resetDistincter();"/>
	  <br/>
		...
		<tr>
			...
			<div id="templates" style="display:none">
			  ...
			  <div id="t1"><label>${eoms:a2u('选择专业')}:</label><br/>
				<eoms:comboBox name="class1m" id="{id}" initDicId="10103" sub="{sub}" styleClass="select-class"/>
			  </div>
			
			  <div id="t2"><label>${eoms:a2u('选择专业')}:</label><br/>
				<eoms:comboBox name="class1" id="{id}" initDicId="10110" sub="{sub}" styleClass="select-class"/>
			  </div>
