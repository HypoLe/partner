...
<table class="formTable">
	...
	<tr>
	    <td class="label">
			<fmt:message key="kmTableColumn.colName" />
		</td>
		<td class="content" colspan="3">
		    ${kmTableColumnForm.colName}		    
		</td>		
	</tr>
	...
	<tr>	
		...
		<td class="content">
			<input type="text"   id="colDictName" name="colDictName" class="text" readonly="readonly" value='<eoms:id2nameDB id="${kmTableColumnForm.colDictId}" beanId="IItawSystemDictTypeDao" />' alt="allowBlank:false'"/>
