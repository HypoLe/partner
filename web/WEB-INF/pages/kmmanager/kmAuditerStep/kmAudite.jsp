	...
	<tr>
		...
		<td class="content" colspan="3">
		    ...
		    <c:when test="${item.colDictType == 1}">
		        ...
		        <!-- 普通字典_单选字段 -->
		        <eoms:id2nameDB id="${KmContentsMap[item.colName]}" beanId="IItawSystemDictTypeDao" />
			    </c:when>
...
<c:if test="${KmContentsMap.CONTENT_STATUS == 7}">
    ...
    <input type="hidden" id="contentTitle" name="TableInfo/CONTENT_TITLE" value="${KmContentsMap.CONTENT_TITLE}" />
