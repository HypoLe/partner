...
<table class="formTable">
	<caption>
		<div class="header center">本周知识库总量排行</div>
	</caption>
  <tr>
...
%>
  <tr>
    ...
    <td class="content"><a href="/eomsMain/kmmanager/kmContentss.do?method=searchLibWeek&node=<%=themeIds.get(i).toString() %>&nodeLeaf=false"><%=objs[1].toString() %></a></td>
  </tr>
