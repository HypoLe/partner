...
<table class="formTable">
	<caption>
		<div class="header center">员工贡献本季度排行</div>
	</caption>
  <tr>
...
%>
  <tr>
    ...
    <td class="content"><a href="/eomsMain/kmmanager/scoreOrderStatistic.do?method=quarterUserScoreMsg&orderNumber=5&userName=<%=objs[0].toString()%>"><%=objs[1].toString() %></a></td>
  </tr>
