...
<c:set var="buttons">
	<input type="button" class="btn" onclick="location.href='<html:rewrite page='/kmContentsApplys.do?method=add'/>'" value="<fmt:message key="button.add"/>" />
</c:set>
...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
	...
	<display:table name="kmContentsApplyList" cellspacing="0"
		cellpadding="0" id="kmContentsApplyList" pagesize="${pageSize}"
		class="table kmContentsApplyList" export="false"
		...
		<display:column property="applyTitle" sortable="true"
			headerClass="sortable" titleKey="kmContentsApply.applyTitle"
		...
		<display:column property="applyDate" sortable="true"
			format="{0,date,yyyy-MM-dd HH:mm:ss}" headerClass="sortable"
			titleKey="kmContentsApply.applyDate" paramId="id" paramProperty="id" />
