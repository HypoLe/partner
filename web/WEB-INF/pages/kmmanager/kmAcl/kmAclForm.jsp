		...
		<table class="tableEdit" style="width: 560px;" cellspacing="0"
			...
			<c:forEach items="${list1}" var="Pnode">
				<tr>
					...
					<td>
						<!-- 
				<input type="checkbox" id="${Pnode.nodeId }_C" onclick="saveOrUpdateKmAcl(this)" moduleId="${Pnode.nodeId}" permission="0" >C
				<input type="checkbox" id="${Pnode.nodeId }_R" onclick="saveOrUpdateKmAcl(this)" moduleId="${Pnode.nodeId}" permission="1" >R
				<input type="checkbox" id="${Pnode.nodeId }_U" onclick="saveOrUpdateKmAcl(this)" moduleId="${Pnode.nodeId}" permission="2" >U
				<input type="checkbox" id="${Pnode.nodeId }_D" onclick="saveOrUpdateKmAcl(this)" moduleId="${Pnode.nodeId}" permission="3" >D
				 -->
					</td>
					<td>
						<!-- <select lang="2"> <option>一级</option><option>二级</option><option>三级</option></select> -->
					</td>
				</tr>
				...
				<c:forEach items="${list2}" var="Cnode">
					<c:if test="${Cnode.parentNodeId ==Pnode.nodeId}">
						<tr>
							...
							<td></td>
							<td>
								<select id="${Cnode.nodeId}" onchange="changeGrade(this)" onclick="getOption(this)">
									<option id="0">
										一级
									</option>
									<option id="1">
