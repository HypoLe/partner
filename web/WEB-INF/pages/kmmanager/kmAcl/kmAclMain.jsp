...
<script type="text/javascript">
  ...
  var config = {
	 ...
	 * Tree Configs
	 **************/
	treeGetNodeUrl:"${app}/kmmanager/kmAcls.do?method=userFromDept",
	treeRootId:'-1',
	treeRootText:'权限管理',
	pageFrameId:'config-page',
	ctxMenu:[
		{id:'content', text:'知识内容权限',cls:'edit-mi',url:'${app}/kmmanager/kmAcls.do?method=edit'},
		{id:'file', text:'文件管理权限',cls:'edit-mi',url:'${app}/kmmanager/kmAcls.do?method=editFileAcl'}
	],//end of ctxMenu 
	/************************
...
<div id="helpPanel" style="padding:10px;" class="x-layout-inactive-content">
	<dl>
		<b>注：
		在您要配置权限的主体上点击鼠标右键选择知识内容权限(或文件管理权限)进行配置 </b><br>
	<br>
	<b>查看权限:</b><br>
	对目录或对应的文件有查看操作 <br>
	<br>
	...
	<br>
	<b>操作等级:</b><br>
	操作等级只针对查看 修改 删除等操作进行知识等级或者文件等级的控制 <br>
