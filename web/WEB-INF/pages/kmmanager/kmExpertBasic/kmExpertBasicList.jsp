...
<fmt:bundle	basename="com/boco/eoms/km/config/applicationResource-kmmanager">
	...
	<html:form action="/kmExpertBasics.do?method=search" styleId="kmExpertBasicForm" method="post">
	    <tr align = 'center'>
	        <td>
				...
				<input type="text" id="deptName" name="deptName" class="text" readonly="readonly" value="" alt="allowBlank:false,vtext:'请选择知识分类(字典)...'"/>
				<html:hidden property="deptId" styleId="deptId" styleClass="text medium" value="${kmExpertBasicForm.deptId}" />
				&nbsp;&nbsp;
				<fmt:message key="kmExpertBasic.specialty" />：	
				<input type="text" id="specialtyName" name="specialtyName" class="text" readonly="readonly" value="" alt="allowBlank:false,vtext:'请选择知识分类(字典)...'"/>
				<html:hidden property="specialty" styleId="specialty" styleClass="text medium" value="${kmExpertBasicForm.specialty}" />
				&nbsp;&nbsp;
	...
	<display:table name="kmExpertBasicList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="true" headerClass="sortable"
			...
			<eoms:id2nameDB id="${kmExpertBasic.specialty}" beanId="IItawSystemDictTypeDao" />
		</display:column>
		
		<display:column sortable="true" headerClass="sortable"
			titleKey="kmExpertBasic.expertClass">
			<eoms:id2nameDB id="${kmExpertBasic.expertClass}" beanId="IItawSystemDictTypeDao" />
		</display:column>
				
		<display:column sortable="true" headerClass="sortable"
			titleKey="kmExpertBasic.expertLevel">
			<eoms:id2nameDB id="${kmExpertBasic.expertLevel}" beanId="IItawSystemDictTypeDao" />
		</display:column>
