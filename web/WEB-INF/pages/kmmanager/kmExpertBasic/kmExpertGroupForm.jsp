    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager"><br>
        <table class="formTable">
			...
			<tr class="tr_show">
				...
				<td class="content">
					<input type="text" id="specialtyName" name="specialtyName" class="text" readonly="readonly" 
					    value="<eoms:id2nameDB id="${kmExpertGroupForm.specialty}" beanId="IItawSystemDictTypeDao" />" 
			...
			<tr class="tr_show">
				...
				<td class="content">
					<input type="text" id="groupLeaderName" name="groupLeaderName" value="<eoms:id2nameDB id="${kmExpertGroupForm.groupLeader}" beanId="tawSystemUserDao" />" readonly="readonly" class="text medium" 
			...
			<tr class="tr_show">
				...
				<td class="content">
				    <textarea name="groupMemberName" cols="50" id="groupMemberName" class="textarea medium" alt="allowBlank:false,vtext:'请选择团队组员...'">${kmExpertGroupForm.groupMemberName}</textarea>
