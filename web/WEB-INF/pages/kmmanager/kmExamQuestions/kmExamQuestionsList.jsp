...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
	<content tag="heading">
		<center><b><fmt:message key="kmExamQuestions.questionList" /></b></center>
	</content>
<!-- 
...
<html:form action="/kmExamQuestionss.do?method=searchX" styleId="kmExamQuestionsForm" method="post"> 
	题干：
	<input type="text"   id="testName" name="question" class="text" />
	<input type="submit" class="btn" value="<fmt:message key="kmTable.query"/>" onclick=" return testName.value.replace(/^s+│s+$/g,'')!='';"/>
</html:form>
<div id="container">
<div id="part1">
<br/>
