...
<content tag="heading">
	...
	<display:column property="typeContentID" sortable="true"
			headerClass="sortable" titleKey="kmExamTestTypeContent.typeContentID" href="${app}/kmExamTestTypeContent/kmExamTestTypeContents.do?method=edit" paramId="id" paramProperty="typeContentID"/>

	<display:column property="testTypeID" sortable="true"
			headerClass="sortable" titleKey="kmExamTestTypeContent.testTypeID" href="${app}/kmExamTestTypeContent/kmExamTestTypeContents.do?method=edit" paramId="id" paramProperty="typeContentID"/>

	<display:column property="score" sortable="true"
			headerClass="sortable" titleKey="kmExamTestTypeContent.score" href="${app}/kmExamTestTypeContent/kmExamTestTypeContents.do?method=edit" paramId="id" paramProperty="typeContentID"/>

	<display:column property="questionID" sortable="true"
			headerClass="sortable" titleKey="kmExamTestTypeContent.questionID" href="${app}/kmExamTestTypeContent/kmExamTestTypeContents.do?method=edit" paramId="id" paramProperty="typeContentID"/>
