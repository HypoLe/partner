...
<table class="formTable">
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-kmmanager" dictId="userLevel" isQuery="false" alt="allowBlank:false,vtext:'请选择是否开放(字典)...'"
	...
	<tr>
		...
		<td class="content">
			<eoms:dict key="dict-kmmanager" dictId="isCount" isQuery="false" alt="allowBlank:false,vtext:'请选择是否开放(字典)...'"
	...
	<tr>
		...
		<td class="content">
			<html:text property="score" styleId="score"
						...
						alt="allowBlank:false,vtext:'',vtype:'number',maxLength:2" value="${kmScoreSetForm.score}" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="content">
			<html:textarea property="remark" styleId="remark" cols="37" rows="8"
				alt="maxLength:1000,vtext:'',maxLength:1000" value="${kmScoreSetForm.remark}" />
		</td>
	</tr>
