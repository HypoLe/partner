			...
			<tr>
				...
				<td class="content">
					<html:text property="area" styleId="area"
								styleClass="text medium"
								alt="allowBlank:false,vtext:'',maxLength:100" value="${kmScoreWeightForm.area}" />
				</td>
			</tr>
			...
			<tr>
				...
				<td class="content">
					<html:text property="actionWeight" styleId="actionWeight"
								styleClass="text medium"
								alt="allowBlank:false,vtype:'number',maxLength:2" value="${kmScoreWeightForm.actionWeight}" />
				</td>
			</tr>
		</c:otherwise>
	</c:choose>
