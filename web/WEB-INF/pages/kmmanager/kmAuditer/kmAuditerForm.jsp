...
<eoms:xbox  id="role" dataUrl="${app}/kmmanager/kmAuditers.do?method=getRoleTreeNodes&id=1&nodeType=role" rootId="-1" single='true' rootText="选择角色" valueField="roleId" handler="rolet"
...
<eoms:xbox  id="master" dataUrl="${app}/xtree.do?method=userFromDept" rootId="-1" single='true' rootText="选择主管" valueField="masterId" handler="mastert"
	...
	<tr>
		...
		<eoms:comboBox name="masterAudit" id="masterAudit" 
            	      initDicId="10301" defaultValue="${kmAuditerForm.masterAudit}" styleClass="select-class"/>
	...
	<tr>				
		<td class="label">
			<fmt:message key="kmAuditer.isAuditer" />
		</td>
		<td class="content" colspan=3>
		<eoms:comboBox name="isAuditer" id="isAuditer" 
            	      initDicId="10301" defaultValue="${kmAuditerForm.isAuditer}" styleClass="select-class"/>
