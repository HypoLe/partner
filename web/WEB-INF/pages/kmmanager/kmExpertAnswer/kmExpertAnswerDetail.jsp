...
boolean otherUser = !operateUserId.equals(kmExpertAnswer.getAnswerUserId())&&!operateUserId.equals(kmExpertAnswer.getCreateUserId());
...
%>
	...
	<tr>
		...
		<td class="content">		
	 	<eoms:id2nameDB id="${kmExpertAnswer.type}" beanId="IItawSystemDictTypeDao" />
...
if(Create_1||Create_2||Answer_0||Answer_1||Answer_2||Answer_3||otherUser){
%>
<tr>
		<td class="label">
			创建人
...
<% 
if(Answer_2||Create_1||Create_2||otherUser){
%>
<tr>
<td colspan="4">
