...
<html:form action="/kmExamTests.do?method=isPublic" styleId="kmExamTestForm" method="post"> 
...
<div style="text-align:left;width:90%;margin-top:10px;">
	...
	<div style="color:#818181;margin-top:5px;">本试卷共<font color="red">
	<%
...
<c:if test="${kmExamTestForm.isPublic==0&&isNotOver}">
	...
	试题选项是否随机：是<input type="radio" name="answerRandom" value="1" style="position:absolute;"/>&nbsp;&nbsp;&nbsp;&nbsp;
	否<input type="radio" name="answerRandom" value="0" checked style="position:absolute;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	试题顺序是否随机：是<input type="radio" name="questionRandom" value="1" style="position:absolute;"/>&nbsp;&nbsp;&nbsp;&nbsp;
	否<input type="radio" name="questionRandom" value="0" checked style="position:absolute;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<c:if test="${kmExamTestTypeForm1.description!=null}">
	...
	<input type="hidden" name="testID" value="${kmExamTestForm.testID}">
</html:form>
</html> 
<script type="text/javascript">
