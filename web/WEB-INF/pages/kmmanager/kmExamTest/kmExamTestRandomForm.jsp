...
<table class="formTable">
	...
	<tr>
		...
		<td class="content" colspan="3">
		   <textarea name="testDescription"  id="question" class="textarea max" alt="allowBlank:false" >${kmExamTestForm.testDescription}</textarea>
		</td>
	</tr>
...
<!-- -->
	...
	<tr>
		...
		<td class="content">
			<input type="text"   id="specialtyName" name="specialtyName" class="text" readonly="readonly" value='<eoms:id2nameDB id="${kmExamTestForm.specialtyID}" beanId="kmExamSpecialtyDao" />' alt="allowBlank:false'"/>
		...
		<td colspan="3">
		  <table width="100%">
			<tr>
				...
				<td class="content" colspan="3">
		            <textarea name="description1"  id="description1" class="textarea max" alt="allowBlank:false" >${kmExamTestTypeForm1.description}</textarea>
		        </td>
			</tr>
			...
			<tr><td><input type="button" class="btn" value="选择试题" onclick="AddChoice(1);"> </td></tr>
	...
	<tr id="typeTable2">
		...
		<td colspan="3">
			...
			<tr>
				...
				<td class="content" colspan="3">
		            <textarea name="description2"  id="description2" class="textarea max" alt="allowBlank:false" >${kmExamTestTypeForm2.description}</textarea>
		        </td>
			</tr>
			...
			<tr><td><input type="button" class="btn" value="选择试题" onclick="AddChoice(2);"> </td></tr>				
		  </table>
	...
	<tr id="typeTable3">
		...
		<td colspan="3">
			...
			<tr>
				...
				<td class="content" colspan="3">
		            <textarea name="description3"  id="description3" class="textarea max" alt="allowBlank:false" >${kmExamTestTypeForm3.description}</textarea>
		        </td>
			</tr>
			...
			<tr><td><input type="button" class="btn" value="选择试题" onclick="AddChoice(3);"> </td></tr>
