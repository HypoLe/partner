...
<script type="text/javascript">
  var config = {
	 ...
	 * Tree Configs
	 **************/
	treeGetNodeUrl:"${app}/kmmanager/kmFileTrees.do?method=getNodes",
	treeRootId:'<%=KmFileTreeConstants.TREE_ROOT_ID%>',
	treeRootText:'<fmt:message key="kmFileTree.tree.rootText"/>',
	pageFrameId:'formPanel-page',
	onClick:{url:"${app}/kmmanager/kmFileTrees.do?method=edit&nodeId=",text:""},
	...
	ctxMenu:[
		...
		{id:'operate', text:'配置权去玩儿限',cls:'edit-mi',url:'${app}/kmmanager/kmOperates.do?method=userTree&nodeType=file&node='}		
	],//end of ctxMenu 
...
<div id="headerPanel" class="x-layout-inactive-content">
  <h1><fmt:message key="kmFileTree.tree.header" /></h1>
</div>
