<%@ page language="java" import="java.util.*,com.boco.eoms.base.util.StaticMethod,com.boco.eoms.extra.supplierkpi.model.TawSupplierkpiItem" %> 
...
function trInfo(kpiId, graphType){
 ...
 var url="<c:url value="/supplierkpi/tawSupplierkpiInstanceAsss.do?method=openWindow"/>";
 url = url + "&modelId=" + modelId + "&reportTime=" + reportTime + "&specialType=" + specialType + "&graphType=" + graphType + "&kpiId=" + kpiId;
