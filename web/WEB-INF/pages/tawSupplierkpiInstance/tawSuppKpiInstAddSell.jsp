			...
			<table>
				...
				<logic:notEmpty name="viewList">
					<logic:iterate id="aal" name="viewList"
						...
						<tr class="normal">
							<td>
								<input type=checkbox name=itemName  value="<%=kpiItemId%>,<%=manufacturerId%>" onClick="getAllKpiItemName(this);"></input>								
							</td>
							<td>
							...
							<td>
								<eoms:id2nameDB id="<%=unit%>" beanId="IItawSystemDictTypeDao" />
							</td>
					</logic:iterate>
				</logic:notEmpty>				
				...
				<tr align="right">
					...
					<input type="button" class="btn" value="${eoms:a2u('返回')}" onclick="javascript:window.history.back();" />
					</td>
				</tr>
			</table>
		</table>
