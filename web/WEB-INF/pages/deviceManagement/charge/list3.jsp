				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app }/deviceManagement/chargeFeeAppli/charge.do?method=list&&Type=3'"/>
						</div>          
					</td>
				</tr>
			</table> 
...
<!-- Information hints area end-->
	...
	<display:table name="feeApplicationMainList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="true" headerClass="sortable" title="状态"  >					 
					...
					<c:if test="${3==(feeApplicationMainList.feeApplicationStatus)}" >等待审批</c:if>
					<c:if test="${4==(feeApplicationMainList.feeApplicationStatus)}" >审批完成</c:if>			
