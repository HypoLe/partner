...
<table id="stylesheet" class="formTable">
	...
	<c:out value="墙体广告详情页面" />
		...
		<tr>
			<td class="label">宣传广告地点*</td>
			<td><eoms:id2nameDB beanId="tawSystemAreaDao" id="${publicizeArticle.publicizeArticlePlace}"/>aa
			</td>
			<td class="label">计划发放宣传单（份）*</td>
			<td class="content">${publicizeArticle.publicizeArticlePlanAmount}</td>
		</tr>
		<tr>
		<td class="label">实际发放宣传（份）*</td>
