...
Ext.onReady(function() {
	v = new eoms.form.Validation({form:'technicDataFolderForm'});
});
</script>
...
<html:form action="/technicDataFolders.do?method=saveFolder" styleId="technicDataFolderForm" method="post" onsubmit="return validate();"> 
