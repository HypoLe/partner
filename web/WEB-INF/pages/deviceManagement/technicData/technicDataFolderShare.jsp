...
Ext.onReady(function(){
	...
	roleUserTree = new xbox({
		...
		treeDataUrl:userTreeAction,treeRootId:'-1',treeRootText:'${eoms:a2u("用户")}',treeChkMode:'',treeChkType:'user,dept',
		viewer:userViewer,saveChkFldId:'userId'
	});
})
</script>
<form action="${app}/technicData/technicDataFolders.do?method=saveFolderShareInfo" name="technicDataFolderShareForm" method="post">
${eoms:a2u('请选择接受共享的用户：')}
	...
	<input type="submit" value="${eoms:a2u('共享给所有人')}" class="btn" onclick="javascript:document.forms[0].shareType.value='allUsers';" />
</form>
