...
<form id="theform" action="${app}/technicData/searchFiles.do?method=searchDo" method="post" styleId="theform">
		...
		<td class="label" align="right">${eoms:a2u('发布开始时间')}</td>
				 <td>
		           <input type="text" name="uploadStratTime" id="uploadStratTime" class="text"
					readonly="readonly"
					alt="vtype:'lessThen',link:'uploadEndTime',vtext:'开始时间不能晚于结束时间！'"
		         ...
		         <td>
		           <input type="text" name="uploadEndTime" id="uploadEndTime" class="text"
					readonly="readonly"
					alt="vtype:'moreThen',link:'uploadStratTime',vtext:'结束时间不能早于开始时间！'"
					onclick="popUpCalendar(this, this,null,null,null,true,-1);" />
		         </td>
	   </td>
    </tr>
