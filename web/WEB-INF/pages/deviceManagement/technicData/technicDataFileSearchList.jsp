...
<script type="text/javascript">
    function delFile(mappingName,folderMappingId) {
    	...
    	if(confirm('确定要删除该文件?')){
    		...
    		frm.action="${app}/technicData/searchFiles.do?method=deleteSearchFile&mappingName="+mappingName+"&folderMappingId="+folderMappingId;
    		frm.submit();
...
<fmt:bundle basename="com.boco.eoms.deviceManagement.technicData.config.ApplicationResources-hlj-technicData">
<display:table name="technicDataFiles" cellspacing="0" cellpadding="0"
    id="technicDataFiles" pagesize="15" class="table tawCommonsAccessoriesConfigList"
    decorator="com.boco.eoms.deviceManagement.technicData.util.FileTableDecorator"
