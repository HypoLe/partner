...
<div id="listQueryObject" 
	...
	<html:form action="mediaPublicity.do?method=approvalList" method="post">
 ...
 <logic:present
	...
	<display:table name="mediaPublicityApprovalList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="false" headerClass="sortable" title="审批"
			paramProperty="id" url="/deviceManagement/mediaPublicity/mediaPublicity.do?method=goToApproval"
