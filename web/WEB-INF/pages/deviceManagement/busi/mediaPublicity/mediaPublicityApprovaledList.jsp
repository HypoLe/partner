...
<div id="listQueryObject" 
	...
	<html:form action="mediaPublicity.do?method=approvaledList" method="post">
 ...
 <logic:present
	...
	<display:table name="mediaPublicityApprovalList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="false" headerClass="sortable" title="详情"
			media="html">
			<a
				href="${app }/deviceManagement/mediaPublicity/mediaPublicity.do?method=approvaledDetail&id=${mediaPublicityApprovalList.id }"
