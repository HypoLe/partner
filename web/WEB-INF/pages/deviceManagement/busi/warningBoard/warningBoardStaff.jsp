...
function openSelectAreas(){
	...
	function changeCheckBox(){
		...
		if(auditId){
		myjs('#de0auditIdTypeLikeUser').attr('checked',true);
		myjs('#de0auditIdTypeLikeUser').attr('disabled','disabled');
		}
		else{
			if((myjs('#de0auditIdTypeLikeUser').attr('disabled'))){
		myjs('#de0auditIdTypeLikeUser').attr('checked',false);
		myjs('#de0auditIdTypeLikeUser').attr('disabled','');
		}
		}
...
<form id="checkAndSearchFrom"
	action="warningboard.do?method=warningBoardStaff" method="post">
...
<tr>
		...
		<input type="hidden" name="de0areaIdT" id="de0areaIdT"  /> 			 
  		</td>

		<td class="label">项目名称</td>
		<td><input  class="text" id="de0itemNameT" type="text" name="de0itemNameT"
	...
	<td><input type="text"  class="text"  name="userName" id="userName" 
