...
<div id="listQueryObject" 
	...
	<form action="hiddenTrouble.do?method=handleList" method="post" id="searchForm" name="searchForm">
			<fieldset>
			<legend>快速查询</legend>
				...
				<tr>
					<td colspan="4">
						<div align="left">
							...
							&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn" value="查询所有" onclick="window.location.href='${app }/hiddenTrouble/hiddenTrouble.do?method=handleList'"/>
						</div>
					</td>
				</tr>
			</table>
...
<div id="tabs-1">
	...
	<logic:present name="hiddenTroubleList" scope="request">
		<display:table name="hiddenTroubleList" cellspacing="0" cellpadding="0"
			...
			<display:column sortable="false" headerClass="sortable" title="处理隐患"  media="html">
				<c:if test="${hiddenTroubleList.processStatus == '0'}">
					<a href="${app }/hiddenTrouble/hiddenTrouble.do?method=goToProcess&id=${hiddenTroubleList.id}"
