	...
	<table id="projectLineTable" class="formTable">
		...
		<tr>
			...
			<input type="button" name="userButton" id="userButton" value="请选择审核人" class="btn" alt="allowBlank:false"/>
	  		<input type="hidden" name="allower" id="allower" value="${projectBaseInfo.allower}"/>
		...
		<tr>
			<td colspan="4"><div class="ui-widget-header" >线路修缮驳回信息</div></td>
		</tr>
		<c:forEach items="${projectOperInfoList}" var="projectOperInfo">
			<tr>
				<td class="label">驳回人</td>
				<td class="content">
					<eoms:id2nameDB id="${projectOperInfo.operator}" beanId="tawSystemUserDao" />
				</td>
				<td class="label">驳回时间</td>
				<td class="content">
					${projectOperInfo.operateTime}
				</td>
			</tr>
			<tr>
				...
				<td colspan="3" class="content">
					...
					id="suggestion" alt="allowBlank:true" readonly="readonly">${projectOperInfo.operateRemarks}</textarea>
