...
<logic:present name="projectBaseInfoList" scope="request">
	<display:table name="projectBaseInfoList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="false" headerClass="sortable" title="委托"
			paramProperty="id" url="/lineProject/lineProjectAction.do?method=goToCommis"
