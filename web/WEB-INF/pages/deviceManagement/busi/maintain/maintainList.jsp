...
<html:form action="maintain.do?method=list" method="post">
		<table id="sheet" class="formTable">
			...
			<td>
			<input type="text" name="influenceSystemStringLike" value=""/>
				</td>
			</tr>
	</table>
...
<div id="loadIndicator" class="loading-indicator" style="display:none">载入详细数据中，请稍候</div>
 ...
 <logic:present
	...
	<display:table name="maintainList" cellspacing="0" cellpadding="0"
		...
		requestURI="maintain.do" sort="list" partialList="true"
		size="${size}">
		...
		<display:column sortable="false" headerClass="sortable" title="详情"
			...
			<a id="${maintainList.id }"
				href="${app }/deviceManagement/line/maintain.do?method=goToDetail&id=${maintainList.id}"
...
<a href="${app }/deviceManagement/line/maintain.do?method=goToAdd">添加割接</a>
</div>
</div>
