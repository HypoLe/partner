...
<div id="listQueryObject" 
	...
	<html:form action="maintainfinish.do?method=maintainFinishRecordedList" method="post">
...
<div id="loadIndicator" class="loading-indicator" style="display:none">载入详细数据中，请稍候</div>
 ...
 <logic:present
	...
	<display:table name="maintainList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="true" headerClass="sortable" title="归档状态">
			<c:if test="${maintainList.isRecord == 1}">
			已归档
			</c:if>
			<c:if test="${maintainList.isRecord != 1}">
			未归档
