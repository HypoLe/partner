...
<table id="stylesheet" class="formTable">
	...
	<!-- </content><br/><br/>
	 ...
	 查看合同版本信息 
  <div id="history-info" class="tabContent">--><br>
    <display:table name="publicizeArticleApprovalList" cellspacing="0" cellpadding="0"  class="table advertisementListApproval"  
        id="publicizeArticleApprovalList" export="false" sort="list" partialList="true" size="${size}">
		<display:column headerClass="sortable" title="审批项目">
			${publicizeArticleApprovalList.projectName}
        </display:column>
		<display:column headerClass="sortable" title="审批发放地点">
