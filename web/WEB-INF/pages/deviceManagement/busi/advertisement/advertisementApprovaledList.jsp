...
<div id="listQueryObject" 
	...
	<html:form action="advertisement.do?method=approvaledList" method="post">
...
<!--  		<display:column sortable="true" headerClass="sortable" title="备注">
		...
		<display:column sortable="false" headerClass="sortable" title="详情"
			...
			<a id="${advertisementApprovalList.id }"
				href="${app }/deviceManagement/advertisement/advertisement.do?method=approvaledDetail&id=${advertisementApprovalList.id}"
