...
<div id="listQueryObject" 
	...
	<html:form action="publicityCatchline.do?method=list" method="post">
 ...
 <logic:present
	name="publicityCatchlineList" scope="request">
	<display:table name="publicityCatchlineList" cellspacing="0" cellpadding="0"
		id="publicityCatchlineList" pagesize="${pagesize}"
		class="table publicityCatchlineList" export="true"
		...
		<display:column sortable="true" headerClass="sortable" title="媒体宣传标语">
			${publicityCatchlineList.publicityCatchline}
		</display:column>
		<display:column sortable="true" headerClass="sortable" title="提交审核人">
			...
			${publicityCatchlineList.creatTime}
		</display:column>
		<display:column sortable="true" headerClass="sortable" title="状态">
			${publicityCatchlineType[publicityCatchlineList.approvalType]}
		</display:column>
		...
		<display:column sortable="false" headerClass="sortable" title="编辑"
			...
			<a id="${publicityCatchlineList.id }"
				href="${app }/deviceManagement/publicityCatchline/publicityCatchline.do?method=goToEdit&id=${publicityCatchlineList.id}"
				shape="rect"> <img
				src="${app }/images/icons/edit.gif"> </a>
				</c:if>
				<c:if test="${publicityCatchlineType[publicityCatchlineList.approvalType]=='待审核'}">
				无
				</c:if>
		...
		<display:column sortable="false" headerClass="sortable" title="详情"
			...
			<a id="${mediaPublicityList.id }"
				href="${app }/deviceManagement/publicityCatchline/publicityCatchline.do?method=goToDetail&id=${publicityCatchlineList.id}"
