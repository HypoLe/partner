...
<html:form action="publicityCatchline.do?method=approvalList" method="post">
 ...
 <logic:present
	...
	<display:table name="publicityCatchlineApprovalList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="false" headerClass="sortable" title="审批"
			paramProperty="id" url="/deviceManagement/publicityCatchline/publicityCatchline.do?method=goToApproval"
