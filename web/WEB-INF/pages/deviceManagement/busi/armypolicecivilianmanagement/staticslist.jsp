...
<!--  <form action="armypolicecivilian.do?method=liststaticsss" method="post" name="armyPoliceCivilian">
	<fieldset>
		<legend>
			快速查询
		</legend>
	...
	<%-- 	<display:column sortable="true" headerClass="sortable" title="所属地市">
		...
		<display:column sortable="false" headerClass="sortable" title="详情"
			...
			<a id="${armyPoliceCivilian.id }"
				href="${app }/armypolicecivilian/armypolicecivilian.do?method=gotostaticsDetail&id=${armyPoliceCivilian.id}">
