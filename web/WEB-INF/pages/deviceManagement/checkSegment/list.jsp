...
<logic:present name="checkSegmentList" scope="request">
	<display:table name="checkSegmentList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="true" headerClass="sortable" title="线路类型">
			<eoms:id2nameDB id="${checkSegmentList.lineType}" beanId="IItawSystemDictTypeDao" />
			
		</display:column>
		<display:column sortable="true" headerClass="sortable" title="线路级别">
			
			<eoms:id2nameDB id="${checkSegmentList.lineLevel}" beanId="IItawSystemDictTypeDao" />
		</display:column>
		...
		<display:column sortable="false" headerClass="sortable" title="查看巡检点"
		
			paramProperty="id" url="/checkSegment/checkSegmentAction.do?method=checkpoint"
