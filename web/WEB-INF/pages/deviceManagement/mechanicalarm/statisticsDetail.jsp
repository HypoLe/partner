...
<form action="mechanicalArmManagement.do?method=list" method="post"
...
<div id="info-page">
  ...
  <div id="history-info" class="tabContent">
	...
	<logic:notEmpty name="MechanicalArmList" scope="request">
		...
		<table id="sheet" class="formTable">
			...
			<tr>
				...
				<td class="content" colspan="3">${MechanicalArmList.approvingtime}</td>
			</tr>
	...
	<html:button styleClass="btn" property="method.save"
		styleId="method.save" onclick="shutdown()" value="确定"></html:button>
