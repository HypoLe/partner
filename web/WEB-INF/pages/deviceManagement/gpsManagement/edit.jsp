...
<table class="formTable">
	...
	<tr>
		...
		<input class="text" type="text" name="gsmid"
					id="sheetId" alt="allowBlank:false"  value="${gpsModel.gsmid}"/></td>
		<td class="label">终端设备类型</td>
		<td>
		<eoms:comboBox name="type" id="type"  initDicId="12103" defaultValue="${gpsModel.gpstype}"
	...
	<td><input class="text" type="text" name="factory"
					id="sheetId" alt="allowBlank:false"  value="${gpsModel.factory}"/></td>
	<td class="label">型号</td>
	<td><input class="text" type="text" name="gpsmodel"
					id="sheetId" alt="allowBlank:false"   value="${gpsModel.gpsmodel}"/></td>
					
	</tr>
	<tr>
	<td class="label">机身序列号</td>
	<td colspan="3"><input class="text" type="text" name="gpsselfnumber"
					id="sheetId" alt="allowBlank:false"  value="${gpsModel.gpsselfnumber}"/></td>
	</tr>
	<tr>
	<td class="label">备注</td>
	<td colspan="3">
	<input type="textarea" id="remark" name="remark"
							class="textarea" style="height:50;width:100%"   value="${gpsModel.remark}"/>
	</td>
	</tr>
