...
<div id="info-page">
	...
	<div id="content-info" class="tabContent">
			<form action="" method="post" id="advertisementPlanForm"
			name="advertisementPlanForm">
		<logic:notEmpty name="advertisementPlan" scope="request">
	...
	<div id="history-info" class="tabContent">
		...
		<display:table name="operHis" cellspacing="0" cellpadding="0"  class="table operHis"  
        id="operHis" export="false" sort="list" partialList="true" size="size">

		<display:column headerClass="sortable" title="审批人">
			<eoms:id2nameDB id="${operHis.actionSendUser}" beanId="tawSystemUserDao" />
		</display:column>

		<display:column headerClass="sortable" title="审批时间">
			${operHis.actionHappenTime}
        </display:column>
        <display:column headerClass="sortable" title="审批结果">
			${operHis.actionStep}
        </display:column>
