...
<form action="advertisementPlanAction.do?method=resubmit" method="post" id="advertisementPlanForm" name="advertisementPlanForm" >
	...
	<table id="checkSegmentTable" class="formTable">
		...
		<tr>
			...
			<td class="content" >
				...
				id="advertisementCity" readonly="true" value="<eoms:id2nameDB id="${advertisementPlan.city}" beanId="tawSystemAreaDao" />"
			...
			<td class="content">
				<input class="text" type="text" name="advertisement" value="${advertisementPlan.advertisement}"
		...
		<tr>
			...
			<td class="content">
				<input class="text" type="text" name="generalStone" value="${advertisementPlan.generalStone}"
			...
			<td class="content">
				<input class="text" type="text" name="detectStone" value="${advertisementPlan.detectStone}"
		...
		<tr>
			...
			<input type="text" name="textReviewer" id="textReviewer" class="text" value="<eoms:id2nameDB id="${advertisementPlan.reviewer}" beanId="tawSystemUserDao" />"/>
		...
		<tr>
			...
			<td colspan="3" class="content">
				<textarea class="textarea max" name="remarks"
					id="remarks" alt="allowBlank:true">${advertisementPlan.remarks}</textarea>
			</td> 
		</tr>
	<%-- 	<tr>
			<td colspan="4"><div class="ui-widget-header" >宣传牌增补计划信息驳回历史</div></td>
		</tr>
		<c:forEach items="${rejectHis}" var="reject">
			<tr>
				<td class="label">驳回人</td>
				<td class="content">
					<eoms:id2nameDB id="${reject.actionSendUser}" beanId="tawSystemUserDao" />
				</td>
				<td class="label">驳回时间</td>
				<td class="content">
					${reject.actionHappenTime}
				</td>
			</tr>
			<tr>
				<td class="label">审核意见</td>
				<td colspan="3" class="content">
					<textarea class="textarea max" name="suggestion"
					id="suggestion" alt="allowBlank:true">${reject.actionStepExplain}</textarea>
