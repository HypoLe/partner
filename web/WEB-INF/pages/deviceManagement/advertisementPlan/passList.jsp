...
function jumpToState(){
	location.href='<html:rewrite page='/advertisementPlanAction.do?method=goToState'/>';
}
</script>
<script type="text/javascript">
...
<div id="listQueryObject" 
	...
	<form action="advertisementPlanAction.do?method=listPass" method="post" id="checkSegmentFindForm" name="checkSegmentFindForm">
		<fieldset>
			<legend>快速查询</legend>
...
<logic:present name="advertisementPlanList" scope="request">
	<display:table name="advertisementPlanList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="true" headerClass="sortable" title="通过时间">
			${advertisementPlanList.passTime}
		</display:column>
	...
	<br/>
	  ...
	  <input type="button" onclick="jumpToState()" value="统计" class="btn"/>
