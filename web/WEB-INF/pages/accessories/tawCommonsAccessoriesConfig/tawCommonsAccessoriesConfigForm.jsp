...
<%@page import="com.boco.eoms.commons.accessories.webapp.form.TawCommonsAccessoriesConfigForm" pageEncoding="UTF-8" %>
<%
...
<html:hidden property="id" />
    ...
    <li>
      ...
      <html:select property="allowFileType" multiple="true">
          <html:option value="xls"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.xls" /></html:option>
          <html:option value="xlsx"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.xlsx" /></html:option>
          <html:option value="doc"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.doc" /></html:option>
          <html:option value="docx"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.docx" /></html:option>
          <html:option value="ppt"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.ppt" /></html:option>
          <html:option value="pptx"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.pptx" /></html:option>
          <html:option value="txt"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.txt" /></html:option>
          <html:option value="jpg"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.jpg" /></html:option>
          <html:option value="gif"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.gif" /></html:option>
          <html:option value="png"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.png" /></html:option>
          <html:option value="jpeg">图片(jpeg 格式)</html:option>
          <html:option value="zip"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.zip" /></html:option>
          <html:option value="rar"><bean:message key="tawCommonsAccessoriesConfigForm.allowFileType.rar" /></html:option>
       </html:select>
    </li>
    <li class="buttonBar bottom">
        ...
        <html:submit styleClass="button" property="method.delete" onclick="bCancel=true; return confirmDelete('TawCommonsAccessoriesConfig')">
