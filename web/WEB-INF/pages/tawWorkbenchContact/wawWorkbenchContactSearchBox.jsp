...
return xmlHttp
    ...
    a.open("GET","search.aspx?q="+encodeURIComponent(t.value),true);//encodeURIComponent表示进行中文编码
    a.send(null);
    hid_q.value=t.value
    }
    }
...
text-decoration:underline;
  ...
  <body>
    <input type="text" value="" onmouseup="for_keyup(this)" onkeyup="for_keyup(this)" onkeydown="for_keydown(this,event)" maxlength="2048" size="55" id="q" onblur="set_visible(false)"/>
    <input id="search" type="button" value="查找" /><br />
<table cellspacing="0" cellpadding="0" class="gac_m" style="width: 398px;visibility: hidden" id="tab_down">
<tbody>
</tbody>
</table>
<input type="hidden" value="" id="hid_q"/>
  </body>
</html:html>
