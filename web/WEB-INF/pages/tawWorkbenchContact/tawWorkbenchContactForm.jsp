...
Ext.onReady(function(){
	...
	dispatcherTree = new xbox({
		...
		treeDataUrl:userTreeAction,treeRootId:'-1',treeRootText:'${eoms:a2u("部门列表")}',treeChkMode:'single',treeChkType:'dept',
...
<li>
		...
		<li>
			...
			<html:text property="tele" styleId="tele" styleClass="text medium"  alt="maxLength:13,vtext:'${eoms:a2u('请正确输入')}',vtype:'phonemobile'"/>
		</li>
