...
<display:table name="tawWorkbenchReportList" cellspacing="0" cellpadding="0"
    ...
    export="false" requestURI="/workbench/report/tawWorkbenchReports.do?method=list" sort="external" partialList="true" size="resultSize">
    ...
    <display:column property="reportPersonName" sortable="true" headerClass="sortable"
         url="/workbench/report/tawWorkbenchReports.do?method=edit&flag=${flag }"  paramId="id" paramProperty="id" titleKey="tawWorkbenchReportForm.reportPersonName"/>
