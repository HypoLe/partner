...
<content tag="heading">
<eoms:id2nameDB id="<%=serviceType%>" beanId="IItawSystemDictTypeDao" />
${eoms:a2u('-')}
<eoms:id2nameDB id="<%=specialType%>" beanId="IItawSystemDictTypeDao" />
...
<display:table name="tawSupplierkpiItemList" cellspacing="0" cellpadding="0"
    ...
    export="true" requestURI="/supplierkpi/tawSupplierkpiItems.do" sort="external" partialList="true" size="resultSize">
