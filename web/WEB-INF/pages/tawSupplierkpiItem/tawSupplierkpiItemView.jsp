<%@ page language="java" import="java.util.*, com.boco.eoms.commons.system.role.model.TawSystemRole, com.boco.eoms.base.util.StaticMethod" %> 
...
<table cellspacing="0" cellpadding="0" border="0" id="list-table">
	...
	<tr height="40">
		...
		<td width="30%">
			<eoms:dict key="dict-supplierkpi" dictId="dataSource" itemId="${tawSupplierkpiItemForm.dataSource}" beanId="id2nameXML" />
		</td>
		...
		<td width="30%">
			<eoms:dict key="dict-supplierkpi" dictId="dataType" itemId="${tawSupplierkpiItemForm.dataType}" beanId="id2nameXML" />
		</td>
	...
	<tr height="40">
		...
		<td>
			<eoms:dict key="dict-supplierkpi" dictId="isImpersonality" itemId="${tawSupplierkpiItemForm.isImpersonality}" beanId="id2nameXML" />
		</td>
		...
		<td>
			<eoms:dict key="dict-supplierkpi" dictId="unit" itemId="${tawSupplierkpiItemForm.unit}" beanId="id2nameXML" />
		</td>
	...
	<tr height="40">
		...
		<td>
			<eoms:dict key="dict-supplierkpi" dictId="assessMoment" itemId="${tawSupplierkpiItemForm.assessMoment}" beanId="id2nameXML" />
		</td>
		...
		<td>
			<eoms:dict key="dict-supplierkpi" dictId="statictsCycle" itemId="${tawSupplierkpiItemForm.statictsCycle}" beanId="id2nameXML" />
		</td>
