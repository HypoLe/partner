...
<ul id="fields">
  ...
  <li>派发人:
			<select id="sDrafter" name="sDrafter" value="${requestScope.sDrafter}">
				<option value="">全部</option>
				<logic:iterate id="userList" name="userList">
				<c:choose>
					<c:when test="${userList.managerid == requestScope.sDrafter}">
						<option value="${userList.managerid}" selected>${userList.managername}</option>
					</c:when>
					<c:otherwise>
						<option value="${userList.managerid}">${userList.managername}</option>
					</c:otherwise>
				</c:choose>
				</logic:iterate>
			</select></li>
  <li>开始时间:
			<input type="text" class="text" id="sStartTime" name="sStartTime" readonly="readonly" 
				...
				onclick="popUpCalendar(this, this,null,null,null,false,-1);" value="${requestScope.sStartTime}"/></li>
  <li>结束时间:
			<input type="text" class="text" id="sEndTime" name="sEndTime" readonly="readonly" 
				...
				onclick="popUpCalendar(this, this,null,null,null,false,-1);" value="${requestScope.sEndTime}"/></li>
  <li>状态:
...
<form action="?method=savePrincipalChanges">
<input type="hidden" name="grid" id="GridData">
<div style="width:100%;height:100%;">
<treegrid Layout_Data="&lt;Grid>
   &lt;Cfg id='TaskPrincipal' Version='4'  MainCol='name'/>
   &lt;Cfg EmptyDate=''/>
   &lt;Cfg FullId='1' NumberId='1' IdChars='0123456789'/>
   &lt;Cfg DropFree='1'/>
   &lt;Cfg ResizingMain='3' VarHeight='1' AcceptEnters='1' NoFormatEscape='0' MaxHeight='1' EnumKeys='1'/>
   ...
   &lt;LeftCols>
      ...
      &lt;C Name='drafter' Width='60' Type='Text' CanEdit='0' CanHide='1'/>
      ...
      &lt;C Name='remark' Width='100' Type='Lines' CanEdit='0' remarkVarHeight='0' remarkMaxHeight='1' ToolTip='1' CanHide='1'/>
   ...
   &lt;Cols>
      &lt;C Name='G' CanSort='0' Type='Gantt' CanEdit='0' CanResize='0' MenuName='Gantt chart'
         ...
         />
   &lt;/Cols>
   &lt;Header id='编号' name='任务' content='描述' drafter='派发人' principal='执行人' startTime='开始时间' endTime='结束时间' progress='进度' remark='完成情况描述' remind='短信提醒' accessories='附件' G='甘特图' />
   &lt;Panel 
      Visible='1' Select='0' Delete='1' Copy='1' CanHide='0' CanResize='0' CanMove='0' CanDrag='1'
      />
	&lt;Toolbar Cells='Save,ExpandAll,CollapseAll,Columns,Reload' Tag='' Visible='1' Styles='0' Copy='7' />
&lt;/Grid>" 
