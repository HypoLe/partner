...
<script type="text/javascript">
	...
	var config = {
		...
		* Tree Configs
		**************/
		treeGetNodeUrl:"${app}/dept/tawSystemDepts.do?method=getNodesNoPartner",
		treeRootId:'-1',
	...
	var searcher;
	var	searchConfig = {
		url:'tawSystemDepts.do?method=xsearchNoPartner',
		paramMapping : {deptName:'sDeptName'},
		fields : [{name: 'id', mapping: 'deptId'},{name: 'text', mapping: 'deptName'},{name: 'name', mapping: 'deptName'},'parentDeptid','deptmanager','deptphone'],
		cm : [
