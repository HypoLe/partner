...
<fmt:bundle basename="com/boco/eoms/cutapply/config/applicationResource-cutapply">
<table class="formTable">
	...
	<tr>
		...
		<td class="content">
			<html:textarea property="context" styleId="context"
						...
						alt="allowBlank:false,vtext:'请输入割接内容',maxLength:255" value="${cutApplyForm.context}" rows="3" cols="40"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="content">
			<html:text property="cutStartTime" styleId="cutStartTime" 
						styleClass="text medium"
						 value="${cutApplyForm.cutStartTime}" readonly="true" alt="allowBlank:false,vtype:'lessThen',link:'cutEndTime',vtext:'不得晚于割接结束时间'"
	...
	<tr>
		...
		<td class="content">
			<html:text property="cutEndTime" styleId="cutEndTime"
						styleClass="text medium"
						 value="${cutApplyForm.cutEndTime}" readonly="true" alt="allowBlank:false,vtype:'moreThen',link:'cutStartTime',vtext:'不得早于割接开始时间'"
					onclick="popUpCalendar(this, this,null,null,null,true,-1);"/>
		</td>
	</tr>
	...
	<tr>
		...
		<html:text property="fileId" styleId="fileId"
						styleClass="text medium"
						alt="allowBlank:false,vtext:'请输入申请割接工单号或者公文号',maxLength:32" value="${cutApplyForm.fileId}" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="content">
			<eoms:comboBox name="isAffect" id="isAffect" initDicId="11602" alt="allowBlank:false,vtext:'请选择是否影响业务'"
	...
	<tr>
		...
		<td class="content">
			<html:text property="affectStartTime" styleId="affectStartTime" 
						styleClass="text medium"
						 value="${cutApplyForm.affectStartTime}" readonly="true" alt="vtype:'lessThen',link:'affectEndTime',vtext:'不得晚于影响结束时间'"
					onclick="popUpCalendar(this, this,null,null,null,true,-1);"/>
		</td>
	</tr>
	<tr>
		...
		<td class="content">
			<html:text property="affectEndTime" styleId="affectEndTime"
						styleClass="text medium"
						 value="${cutApplyForm.affectEndTime}" readonly="true" alt="vtype:'moreThen',link:'affectStartTime',vtext:'不得早于影响开始时间'"
					onclick="popUpCalendar(this, this,null,null,null,true,-1);"/>
		</td>
	</tr>
	<tr>
