...
<html:form action="/threadAuditHistory.do?method=audit" method="post" styleId="threadAuditHistoryForm">
	...
	<display:table name="threadAuditHistoryList" cellspacing="0" cellpadding="0" id="threadAuditHistoryList" pagesize="${pageSize }" class="table threadAuditHistoryList" export="false" requestURI="${app}/workbench/infopub/threadAuditHistory.do?method=search"
		sort="external" defaultsort="1" partialList="true" size="resultSize" decorator="com.boco.eoms.workbench.infopub.displaytag.support.ThreadAuditHistoryListDisplayTagDecorator">
...
<display:setProperty name="export.rtf" value="false"></display:setProperty>
		...
		<display:column sortable="true" sortName="threadId" headerClass="sortable" titleKey="infopub.threadAuditHistoryForm.threadId" paramId="id" paramProperty="threadId" href="${app}/workbench/infopub/thread.do?method=detail">
			<eoms:id2nameDB id="${threadAuditHistoryList.threadId}" beanId="threadDao" />
		</display:column>


		<display:column property="status" sortable="true" sortName="status" headerClass="sortable" titleKey="infopub.threadAuditHistoryForm.status" href="${app}/workbench/infopub/threadAuditHistory.do?method=device" paramId="threadId" paramProperty="threadId"/>
