...
function onSave(flag){
  	if(flag == 0){
    	...
    	if(document.forms[0].threadTypeId.value==0){
    		alert('${eoms:a2u("请选择紧急程度!")}');
    		return false; 
    	}
    	if(document.forms[0].reply.value==0){
	...
	<ul>
		...
		<li>
			...
			<html:text property="title" styleId="title" styleClass="text medium"
				alt="allowBlank:true" style="width:300" />
		</li>
		<li>
			<eoms:label styleClass="desc" key="threadForm.porjectCV" />
			<html:errors property="porjectCV" />
			<html:text property="porjectCV" styleId="porjectCV"
				styleClass="text medium" alt="allowBlank:true" style="width:300" />
		</li>
		...
		<li>
			...
			<html:text property="startTime"
				onclick="popUpCalendar(this, this,'yyyy-mm-dd hh:ii');"
				styleId="startTime" styleClass="text left" alt="allowBlank:true"
				style="width:150" />
		</li>
		<li>
			...
			<html:text property="endTime" styleId="endTime"
				onclick="popUpCalendar(this, this,'yyyy-mm-dd hh:ii');"
				styleClass="text right" alt="allowBlank:true" style="width:150" />
		</li>

		<li>
			<eoms:label styleClass="desc" key="threadForm.range" />
			<html:errors property="range" />
			<html:text property="range" styleId="range" styleClass="text medium"
				alt="allowBlank:true" style="width:300" />
		</li>
		...
		<li>
			...
			<html:text property="effectTime"
				onclick="popUpCalendar(this, this,'yyyy-mm-dd hh:ii');"
				styleId="effectTime" styleClass="text medium" alt="allowBlank:true"
				style="width:150" />
		</li>
		...
		<li>
			...
			<html:text property="operater" styleId="operater"
				styleClass="text medium" alt="allowBlank:true" style="width:300" />
		</li>
	 ...
	 -->
		<li>
			<eoms:label styleClass="desc" key="threadForm.threadTypeId" />
			<html:select property="threadTypeId" value="threadTypeId" >
				<option id="0" value="0">
					${eoms:a2u("请选择")}
				</option>
				<option id="1" value="1">
		...
		<li>
			...
			<html:select property="reply" value="reply" >
				<option id="0" value="0">
					${eoms:a2u("请选择")}
				</option>
				<option id="1" value="1">
