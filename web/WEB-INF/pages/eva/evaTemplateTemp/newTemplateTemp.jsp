...
<html:form action="/evaTemplateTemps.do?method=saveTemplateTemp&nodeId=${nodeId}&agrwor=${agrwor}&evaDeptNodeNodeId=${evaDeptNodeNodeId}&orgDeptId=${orgDeptId}" styleId="pnrTemplateForm" method="post"> 
<table class="formTable">
	...
	<tr>
		...
		<td class="content" colspan="3">
			<html:textarea property="remark" styleId="remark" style="width:98%"   alt="maxLength:255" 
