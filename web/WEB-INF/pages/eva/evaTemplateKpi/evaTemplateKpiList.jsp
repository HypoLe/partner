	...
	<div id="kpiContent">
		<html:form action="/evaKpis.do?method=saveKpi" styleId="evaKpiForm">
			<table align="center">
				...
				<td  colspan="3">
					<eoms:dict key="dict-eva" dictId="algorithmType" defaultId="${evaKpiForm.algorithmType}"
				...
				<tr>
					...
					<td colspan="3">
						<input type="textarea" 
							...
							value="${evaKpiForm.workEvaContentByType}" />
					</td>
					<input type="hidden" id="algorithm" name="algorithm" value="${evaKpiForm.algorithm}" />
				</tr>		
				<tr>
					<td>
						备注
