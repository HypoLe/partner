...
<script type="text/javascript">
  ...
  var config = {
	...
	onClick:{url:"${app}/eva/evaReportInfos.do?method=getAllScroe&nodeId=",text:""},
	ctxMenu:[
		{id:'executeTemplate', text:'考核内容情况',cls:'query-mi',url:'${app}/eva/evaReportInfos.do?method=getAllScroeView&nodeId='}
	],//end of ctxMenu 
	/************************
