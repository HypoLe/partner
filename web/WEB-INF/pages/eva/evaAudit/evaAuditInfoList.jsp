...
<bean:message key="eva.auditHistoryList.heading" />
	...
	<display:table name="auditInfoList" cellspacing="0" cellpadding="0" id="auditInfoList" pagesize="${pageSize }" class="table auditInfoList" export="false"
		requestURI="${app}/eva/evaAudit.do?method=auditInfoList&templateId=${evaAuditForm.templateId}" sort="list" partialList="true" size="resultSize"
		...
		<display:column property="auditTime" sortable="false" headerClass="sortable" titleKey="eva.auditInfo.auditTime" format="{0,date,yyyy-MM-dd HH:mm:ss}" />

		<display:column property="auditInfo" sortable="false" headerClass="sortable" titleKey="eva.auditInfo.auditInfo" />
