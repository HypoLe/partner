...
<table class="listTable" id="list-table">
	<caption>
		<div class="header center">
			任务(${requestScope.taskName})-合作伙伴(<eoms:id2nameDB id="${requestScope.partner}" beanId="areaDeptTreeDao" />)-周期(${requestScope.timeType})-${requestScope.year}年(${requestScope.month1}月~${requestScope.month2}月) 考核报表
		</div>
	</caption>
	<thead>
	<tr>
