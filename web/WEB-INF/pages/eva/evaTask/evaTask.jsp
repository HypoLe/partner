...
<script type="text/javascript">
	Ext.onReady(function(){
        	...
        	tabs.addTab('unaudit-info', '待审核考核信息 ');
        	tabs.addTab('deny-info', '已驳回考核信息 ');
    		tabs.activate(0);
	});
</script>
<div id="info-page">
...
<table class="formTable" id="form">
	...
	<tr>
		<td class="label">
			<c:if test="${template.agrwor!='tempTask'}">
				关联协议
			</c:if>
			<c:if test="${template.agrwor=='tempTask'}">
				关联临时任务
		...
		<td class="content">
			...
			<c:if test="${template.agrwor=='tempTask'}">
				<a href="${app}/partner/tempTask/pnrTempTaskMains.do?method=detail&id=${template.agreementId}" target="_blank">
					<eoms:id2nameDB id="${template.agreementId}" beanId="pnrTempTaskMainDao" />
				</a>					
			</c:if>
  ...
  <table class="formTable" id="form">
    ...
    <div id="unaudit-info" class="tabContent">
  ...
  <table class="formTable" id="form">
    ...
    <div id="deny-info" class="tabContent">
