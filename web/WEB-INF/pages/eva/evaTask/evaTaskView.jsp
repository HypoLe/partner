...
function isSubmit(){
    if(checkEvaTime())return true;//document.getElementById("evaKpiInstanceForm").submit();
...
<html:form action="/evaTasks.do?method=taskDetailList" styleId="evaKpiInstanceForm" method="post" > 
