...
myJ(function() {
		...
		if(myJ(this)[0].checked){
			myJ('input#batchFlag').val('enable');
		}else{
			myJ('input#batchFlag').val('disable');
		}
		});
});
...
var config = {
	...
	**************/
	actions:{
		...
		editMenu : {
			url:"${app}/priv/saveTawSystemPrivMenu.do?method=xedit",
...
<div id="headerPanel" class="x-layout-inactive-content">
	 <span style="color: red">${eoms:a2u('是否启用批处理模式:')}</span>
...
<input type="hidden" id="batchFlag" value="disable"/>
