...
<div id="sheetform">
<html:form action="/pnrcomplaint.do?method=performTransferWorkItem" styleId="theform">
       <%@ include file="/WEB-INF/pages/wfworksheet/pnrcomplaint/baseinputlinkhtmlnew.jsp"%>
    <br/>
           <input type="hidden" name="beanId"   id="beanId"  value="iPnrComplaintMainManager"/>
           <input type="hidden" name="mainClassName" id="mainClassName"  value="com.boco.eoms.partner.sheet.pnrcomplaint.model.PnrComplaintMain"/>		
           <input type="hidden" name="linkClassName" id="linkClassName" value="com.boco.eoms.partner.sheet.pnrcomplaint.model.PnrComplaintLink"/> 
   ...
   <div class="form-btns">
        ...
        <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/pnrcomplaint/pnrcomplaint.do?method=performSaveInfo'" value="<bean:message bundle='sheet' key='button.save'/>" />
