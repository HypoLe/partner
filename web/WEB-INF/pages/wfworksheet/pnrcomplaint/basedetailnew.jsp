...
<table class="formTable">
     ...
     <tr>
	   ...
	   <td>
	     <eoms:id2nameDB id="${sheetMain.mainCustomerStatisfied}" beanId="IItawSystemDictTypeDao"/>
	   </td>
     </tr>    
      <tr>
       <td class="label">
	   ...
	   <td>
	     <eoms:id2nameDB id="${sheetMain.mainFaultReason}" beanId="IItawSystemDictTypeDao"/>
	   </td>
	   <td class="label">
       </td>
	   <td>
