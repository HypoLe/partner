...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="border2">
    ...
    <tr>
		<td align="center" valign="middle" class="tdbg_leftall">
			<iframe id='PhotoViewer' width='100%' frameborder=0 name='down' height='500' scrolling='no' src='${app}/sheet/pnrcomplaint/pnrcomplaint.do?method=showPic'  class=input2></iframe>
		</td>
	</tr>
</table>
