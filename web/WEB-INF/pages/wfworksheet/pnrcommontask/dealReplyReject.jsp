...
<div id="sheetform">
<html:form action="/pnrcommontask.do?method=performDealReplyReject" styleId="theform">
<%
...
<%@ include file="/WEB-INF/pages/wfworksheet/pnrcommontask/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.partner.sheet.commontask.model.PnrCommonTaskTask">  
        <tr>
          <td>
