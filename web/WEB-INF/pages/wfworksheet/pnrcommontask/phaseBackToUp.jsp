...
<div id="sheetform">
<html:form action="/pnrcommontask.do?method=newPerformNonFlow" styleId="theform">
<%
...
String sheetKey = (String) request.getParameter("sheetKey");
 %>
		<input type="hidden" name="linkBeanId" value="iInstrumentStorageLinkManager"/> 	
     <input type="hidden" name="beanId" value="iInstrumentStorageMainManager"/>
     <input type="hidden" name="mainClassName" value="com.boco.eoms.partner.sheet.commontask.model.PnrCommonTaskMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="linkClassName" value="com.boco.eoms.partner.sheet.commontask.model.PnrCommonTaskLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
...
<%@ include file="/WEB-INF/pages/wfworksheet/pnrcommontask/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.partner.sheet.commontask.model.PnrCommonTaskTask">  
        <tr>
          <td>
              ...
              <eoms:id2nameDB id="${toTask.taskOwner}" beanId="tawSystemSubRoleDao" /><eoms:id2nameDB id="${toTask.taskOwner}" beanId="tawSystemDeptDao" />
              <eoms:id2nameDB id="${toTask.taskOwner}" beanId="tawSystemSubRoleDao" /><eoms:id2nameDB id="${toTask.taskOwner}" beanId="tawSystemSubRoleDao" />&nbsp;
