...
var roleTree;
   ...
   Ext.onReady(function(){
	...
	tabs.addTab('sheetform', "<bean:message bundle="pnrrescheck" key="pnrrescheck.header"/>");
	tabs.activate('sheetform');     
    var el = Ext.get("idSpecial");
	var mgr = el.getUpdateManager();
	mgr.loadScripts = true;
	mgr.update("${app}/sheet/pnrrescheck/pnrrescheck.do?method=showNewInputSheetPage&processname=PnrResCheck");
...
<div id="sheetform" class="tabContent">
	<html:form action="/pnrrescheck.do?method=performAdd" styleId="theform" >
