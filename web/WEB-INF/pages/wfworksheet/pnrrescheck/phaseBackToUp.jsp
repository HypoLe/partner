...
<div id="sheetform">
<html:form action="/pnrrescheck.do?method=newPerformNonFlow" styleId="theform">
<%
...
String sheetKey = (String) request.getParameter("sheetKey");
 %>
     ...
     <input type="hidden" name="mainClassName" value="com.boco.eoms.partner.sheet.pnrrescheck.model.PnrResCheckMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="linkClassName" value="com.boco.eoms.partner.sheet.pnrrescheck.model.PnrResCheckLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
     <input type="hidden" name="processTemplateName" id="processTemplateName" value="PartnerResCheckProcess" />
...
<%@ include file="/WEB-INF/pages/wfworksheet/pnrrescheck/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.partner.sheet.pnrrescheck.model.PnrResCheckTask">  
        <tr>
          <td>
