...
<%@page import="com.boco.eoms.partner.sheet.pnrrescheck.model.PnrResCheckTask" %>
...
PnrResCheckTask task = new PnrResCheckTask();
String operaterType = "";
//String ifsub = "";
//String ifwaitfor="";
if(request.getAttribute("task")!=null){
	 task = (PnrResCheckTask)request.getAttribute("task");
...
Ext.onReady(function() {
	var tabConfig = {
		items : [{
			...
			url : 'pnrrescheck.do?method=showSheetDealList&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
		}, {
			text : '<bean:message bundle="sheet" key="sheet.flowchar"/>',
			url : 'pnrrescheck.do?method=showWorkFlow&linkServiceName=iPnrResCheckLinkManager&dictSheetName=dict-sheet-pnrrescheck&description=mainOperateType&sheetKey=${sheetMain.id}',
			isIframe : true
		  }
		,{
			text : '<bean:message bundle="sheet" key="sheet.filesView"/>',
			url : 'pnrrescheck.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
			isIframe : true
		}]
	};
    ...
    <%if(taskStatus.equals("2") || taskStatus.equals("3") || taskStatus.equals("8")){%>
    	<%if(taskName.equals("cc")){ %>
			var url2="pnrrescheck.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
			eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
	<%if(taskName.equals("reply")){ %>
		var url2="pnrrescheck.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
		eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
...
function forceOperation(obj){
	if(obj == 1){
		var url2="pnrrescheck.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
		eoms.util.appendPage("sheet-deal-content",url2);	
	}else if(obj == 2){
	    
		var url2="pnrrescheck.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
		eoms.util.appendPage("sheet-deal-content",url2);	
	}else{
	   
	    var url2="pnrrescheck.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
		eoms.util.appendPage("sheet-deal-content",url2);	
    }
   }
    function eventOperation(obj){
	if(obj == 1){
	     var url2="pnrrescheck.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page">
  ...
  <div id="sheetinfo">
	...
	<%@ include file="/WEB-INF/pages/wfworksheet/pnrrescheck/basedetailnew.jsp"%>
	<br/>
	<table id="sheet" class="formTable" > 
	  ...
	  <tr>
		    ...
		    <eoms:attachment name="sheetMain" property="sheetAccessories" 
		            scope="request" idField="sheetAccessories" appCode="pnrrescheck" 
		             viewFlag="Y"/> 
		    </td>
	  </tr>
</table>
...
<!-- 下面是流程中的步骤URL -->
 ...
 <!-- 回复到派单人 -->
<c:url var="urlShowReplyTaskPage" value="pnrrescheck.do">
 ...
 <!-- 派发 -->
<c:url var="urlSendTaskPage" value="pnrrescheck.do">
	<c:param name="method" value="showDealPage"/>
	<c:param name="sheetKey" value="${sheetMain.id}"/>
	<c:param name="piid" value="${sheetMain.piid}"/>
	<c:param name="taskId" value="${taskId}"/>
 ...
 <!-- 待归档 -->
<c:url var="urlShowHoldTaskPage" value="pnrrescheck.do">
	<c:param name="method" value="showDealPage"/>
	<c:param name="sheetKey" value="${sheetMain.id}"/>
	<c:param name="piid" value="${sheetMain.piid}"/>
	<c:param name="taskId" value="${taskId}"/>
...
<!-- 下面是公共的URL -->
<!-- 退回 -->
<c:url var="urlShowRejectDealPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowTransferkPage" value="pnrrescheck.do">
...
<c:url var="urlShowPhaseReplyPage" value="pnrrescheck.do">
...
<!--任务分派-->
<c:url var="urlShowInputSplit" value="pnrrescheck.do">
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="pnrrescheck.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="pnrrescheck.do">
...
<!-- 驳回上一级 -->
<c:url var="urlShowRejectBackPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 被驳回 -->
<c:url var="urlBackDealPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿 -->
<c:url var="urlShowDraftPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="pnrrescheck.do">
  <c:param name="method" value="showInputSplit"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 受理工单 -->
<c:url var="urlShowAcceptTaskPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 处理工单 -->
<c:url var="urlShowResCheckTaskPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 完成确认 -->
<c:url var="urlShowConfirmTaskPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 驳回到派发人 -->
<c:url var="urlShowReject2SendPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 驳回到受理人 -->
<c:url var="urlShowReject2AcceptPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 驳回到处理人 -->
<c:url var="urlShowReject2DealPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 退回到任务完成确认 -->
<c:url var="urlShowReject2ConfirmPage" value="pnrrescheck.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
				 ...
				 <td width="50%">  
					...
					<%if(taskName.equals("HoldTask")){%>	
						<select id="dealSelector">
							<option value="${urlShowHoldTaskPage}"><bean:message bundle="pnrrescheck" key="operateType.holdTask"/> </option>
					...
					<% }else if(taskName.equals("RejectTask")){%>	
			  		...
			  		<% }else if(taskName.equals("DraftTask")){%>	
						<select id="dealSelector">
						  <option value="${urlShowDraftPage}"><bean:message bundle="pnrrescheck" key="operateType.DraftTask"/></option>
						</select>
					<!-- 受理工单 -->
			   		...
			   		<% } else if(taskName.equals("ResCheckTask")){%>
						<select id="dealSelector">
							<option value="${urlShowResCheckTaskPage}">处理</option>
					  		<option value="${urlShowReject2AcceptPage}">驳回</option>
						</select>
			   		<% } else if(taskName.equals("ResultGatherTask")){%>	
						<select id="dealSelector">
...
<script type="text/javascript">
	Ext.onReady(function(){
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
   			url = "pnrrescheck.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId="+dealTemplateId
        }
		eoms.util.appendPage("sheet-deal-content",url);		
	});
</script>
