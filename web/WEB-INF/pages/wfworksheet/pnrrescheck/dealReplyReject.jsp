...
<div id="sheetform">
<html:form action="/pnrrescheck.do?method=performDealReplyReject" styleId="theform">
<%
 ...
 %>
	...
	<input type="hidden" name="processTemplateName" id="processTemplateName" value="PnrResCheckMainProcess" />
    ...
    <input type="hidden" name="taskNamespace" value="http://PnrResCheckProcess"/>  
...
<%@ include file="/WEB-INF/pages/wfworksheet/pnrrescheck/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.partner.sheet.pnrrescheck.model.PnrResCheckTask">  
        <tr>
          <td>
