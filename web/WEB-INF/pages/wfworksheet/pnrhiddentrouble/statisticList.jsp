...
<html>
  <logic:present name="querylist" scope="request">
   <display:table name="querylist" cellspacing="0" cellpadding="0"
      ...
      requestURI="${app}/sheet/pnrhiddentrouble/statistic.do?method=showIndexList"
      sort="list" partialList="true" size="resultSize">
		<display:column title="工单号"><a href="${app}/sheet/pnrhiddentrouble/pnrhiddentrouble.do?method=showMainDetailPage&sheetKey=${querylist.id}" >${querylist.sheetid}</a></display:column>
