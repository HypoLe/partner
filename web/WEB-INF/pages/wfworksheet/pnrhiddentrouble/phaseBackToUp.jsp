...
<div id="sheetform">
<html:form action="/pnrhiddentrouble.do?method=newPerformNonFlow" styleId="theform">
<%
...
String sheetKey = (String) request.getParameter("sheetKey");
 %>
     ...
     <input type="hidden" name="mainClassName" value="com.boco.eoms.partner.sheet.pnrhiddentrouble.model.PnrHiddenTroubleMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="linkClassName" value="com.boco.eoms.partner.sheet.pnrhiddentrouble.model.PnrHiddenTroubleLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
     <input type="hidden" name="processTemplateName" id="processTemplateName" value="PartnerHiddenTroubleProcess" />
...
<%@ include file="/WEB-INF/pages/wfworksheet/pnrhiddentrouble/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.partner.sheet.pnrhiddentrouble.model.PnrHiddenTroubleTask">  
        <tr>
          <td>
