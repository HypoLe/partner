...
<div id="sheetform">
<html:form action="/pnrhiddentrouble.do?method=performDealReplyAccept" styleId="theform">
...
<input type="hidden" name="processTemplateName" id="processTemplateName" value="PnrHiddenTrouble" />
