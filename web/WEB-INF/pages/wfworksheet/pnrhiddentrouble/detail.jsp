...
<%@page import="com.boco.eoms.partner.sheet.pnrhiddentrouble.model.PnrHiddenTroubleTask" %>
...
PnrHiddenTroubleTask task = new PnrHiddenTroubleTask();
String operaterType = "";
//String ifsub = "";
//String ifwaitfor="";
if(request.getAttribute("task")!=null){
	 task = (PnrHiddenTroubleTask)request.getAttribute("task");
...
Ext.onReady(function() {
	var tabConfig = {
		items : [{
			...
			url : 'pnrhiddentrouble.do?method=showSheetDealList&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
		}, {
			text : '<bean:message bundle="sheet" key="sheet.flowchar"/>',
			url : 'pnrhiddentrouble.do?method=showWorkFlow&linkServiceName=iPnrHiddenTroubleLinkManager&dictSheetName=dict-sheet-pnrhiddentrouble&description=mainOperateType&sheetKey=${sheetMain.id}',
			isIframe : true
		  }
		,{
			text : '<bean:message bundle="sheet" key="sheet.filesView"/>',
			url : 'pnrhiddentrouble.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
			isIframe : true
		}]
	};
    ...
    <%if(taskStatus.equals("2") || taskStatus.equals("3") || taskStatus.equals("8")){%>
    	<%if(taskName.equals("cc")){ %>
			var url2="pnrhiddentrouble.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
			eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
	<%if(taskName.equals("reply")){ %>
		var url2="pnrhiddentrouble.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
		eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
...
function forceOperation(obj){
	if(obj == 1){
		var url2="pnrhiddentrouble.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
		eoms.util.appendPage("sheet-deal-content",url2);	
	}else if(obj == 2){
	    
		var url2="pnrhiddentrouble.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
		eoms.util.appendPage("sheet-deal-content",url2);	
	}else{
	   
	    var url2="pnrhiddentrouble.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
		eoms.util.appendPage("sheet-deal-content",url2);	
    }
   }
    function eventOperation(obj){
	if(obj == 1){
	     var url2="pnrhiddentrouble.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page">
  ...
  <div id="sheetinfo">
	...
	<%@ include file="/WEB-INF/pages/wfworksheet/pnrhiddentrouble/basedetailnew.jsp"%>
	<br/>
	<table id="sheet" class="formTable" > 
		...
		<tr>
 		...
 		<tr>
			...
			<td class="content">
				<eoms:id2nameDB id="${sheetMain.mainhiddenTroubleType}" beanId="ItawSystemDictTypeDao" />
			</td>
			<td class="label">经度</td>
			<td class="content">
				${sheetMain.mainlongitude }
			</td>
		</tr>
		<tr>
 			<td class="label">纬度</td>
			<td class="content">
				${sheetMain.mainlatitude }
			</td>
			<td class="label">隐患紧急程度</td>
			<td class="content">
				<eoms:id2nameDB id="${sheetMain.mainurgentLevel}" beanId="ItawSystemDictTypeDao" />
			</td>
		</tr>
		...
		<tr>
			...
			<td class="content">
				<eoms:id2nameDB id="${sheetMain.maindealSituation}" beanId="ItawSystemDictTypeDao" />
			</td>
			<td class="label"></td>
			<td class="content">
		...
		<tr>
			...
			<td class="content" colspan="3">
				${sheetMain.mainhiddenTroublePhenomenon}
			</td>
		</tr>
		<tr>
			<td class="label">隐患位置描述</td>
			<td class="content" colspan="3">
				${sheetMain.mainhiddenTroubleLocation}
			</td>
		...
		<tr>
			...
			<td class="content" colspan="3">
				${sheetMain.mainprocessSuggest}
			</td>
		</tr>
		<tr>
			<td class="label">临时措施</td>
			<td class="content" colspan="3">
				${sheetMain.mainprocessMethod}
			</td>
		</tr>
...
<!-- 下面是流程中的步骤URL -->
 ...
 <!-- 回复到派单人 -->
<c:url var="urlShowReplyTaskPage" value="pnrhiddentrouble.do">
 ...
 <!-- 派发 -->
<c:url var="urlSendTaskPage" value="pnrhiddentrouble.do">
	<c:param name="method" value="showDealPage"/>
	<c:param name="sheetKey" value="${sheetMain.id}"/>
	<c:param name="piid" value="${sheetMain.piid}"/>
	<c:param name="taskId" value="${taskId}"/>
 ...
 <!-- 巡检人员直接归档 -->
<c:url var="urlHoldTaskPage" value="pnrhiddentrouble.do">
	<c:param name="method" value="showDealPage"/>
	<c:param name="sheetKey" value="${sheetMain.id}"/>
	<c:param name="piid" value="${sheetMain.piid}"/>
	<c:param name="taskId" value="${taskId}"/>
 ...
 <!-- 待归档 -->
<c:url var="urlShowHoldTaskPage" value="pnrhiddentrouble.do">
	<c:param name="method" value="showDealPage"/>
	<c:param name="sheetKey" value="${sheetMain.id}"/>
	<c:param name="piid" value="${sheetMain.piid}"/>
	<c:param name="taskId" value="${taskId}"/>
...
<!-- 下面是公共的URL -->
<!-- 退回 -->
<c:url var="urlShowRejectDealPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowTransferkPage" value="pnrhiddentrouble.do">
...
<c:url var="urlShowPhaseReplyPage" value="pnrhiddentrouble.do">
...
<!--任务分派-->
<c:url var="urlShowInputSplit" value="pnrhiddentrouble.do">
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="pnrhiddentrouble.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="pnrhiddentrouble.do">
...
<!-- 驳回上一级 -->
<c:url var="urlShowRejectBackPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 被驳回 -->
<c:url var="urlBackDealPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿 -->
<c:url var="urlShowDraftPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="pnrhiddentrouble.do">
  <c:param name="method" value="showInputSplit"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 受理工单 -->
<c:url var="urlShowAcceptTaskPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 联通受理工单 -->
<c:url var="urlMobileShowAcceptTaskPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
  ...
  <c:param name="taskStatus" value="${taskStatus}"/>
  <c:param name="preLinkId" value="${preLinkId}"/>
  <c:param name="operateType" value="52"/>
</c:url>

<!-- 移交给联通 -->
<c:url var="urlShowTransferkMobilePage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
  ...
  <c:param name="taskStatus" value="${taskStatus}"/>
  <c:param name="preLinkId" value="${preLinkId}"/>
  <c:param name="operateType" value="51"/>
</c:url>

<!-- 处理工单 -->
<c:url var="urlShowHiddenTroubleTaskPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 完成确认 -->
<c:url var="urlShowConfirmTaskPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 驳回到派发人 -->
<c:url var="urlShowReject2SendPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 驳回到受理人 -->
<c:url var="urlShowReject2AcceptPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 驳回到处理人 -->
<c:url var="urlShowReject2DealPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 退回到任务完成确认 -->
<c:url var="urlShowReject2ConfirmPage" value="pnrhiddentrouble.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
				 ...
				 <td width="50%">  
					...
					<% if(taskName.equals("DealTask")){ %>
						<select id="dealSelector">
							<option value="${urlShowHiddenTroubleTaskPage}">处理</option>
						</select>
					<% }if(taskName.equals("HoldTask")){%>	
							<select id="dealSelector">
								<option value="${urlShowHoldTaskPage}"><bean:message bundle="pnrhiddentrouble" key="operateType.holdTask"/> </option>
					...
					<% }else if(taskName.equals("RejectTask")){%>	
			  		...
			  		<% }else if(taskName.equals("DraftTask")){%>	
						<select id="dealSelector">
						  <option value="${urlShowDraftPage}"><bean:message bundle="pnrhiddentrouble" key="operateType.DraftTask"/></option>
						</select>
					<!-- 受理工单 -->
			   		<% } else if(taskName.equals("AcceptTask")){%>	
						<select id="dealSelector">
						  ...
						  <option value="${urlHoldTaskPage}"><bean:message bundle="pnrhiddentrouble" key="operateType.holdTask"/> </option>
						  <option value="${urlShowTransferkMobilePage}">移交给联通</option>
						</select>
			   		<% } else if(taskName.equals("HiddenTroubleTask")){%>	
						<select id="dealSelector">
							<option value="${urlShowHiddenTroubleTaskPage}">处理</option>
			   		...
			   		<% } else if(taskName.equals("ChinaMobileAcceptTask")){%>	
						<select id="dealSelector">
						  <option value="${urlMobileShowAcceptTaskPage}">受理</option>
						</select>
			   		<% } %>
			</td>
		</tr>
...
<script type="text/javascript">
	Ext.onReady(function(){
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
   			url = "pnrhiddentrouble.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId="+dealTemplateId
        }
		eoms.util.appendPage("sheet-deal-content",url);		
	});
</script>
