...
<div id="sheetform">
<html:form action="/pnrhiddentrouble.do?method=performDealReplyReject" styleId="theform">
<%
 ...
 %>
	...
	<input type="hidden" name="processTemplateName" id="processTemplateName" value="PnrHiddenTroubleMainProcess" />
    ...
    <input type="hidden" name="taskNamespace" value="http://PnrHiddenTroubleProcess"/>  
...
<%@ include file="/WEB-INF/pages/wfworksheet/pnrhiddentrouble/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.partner.sheet.pnrhiddentrouble.model.PnrHiddenTroubleTask">  
        <tr>
          <td>
