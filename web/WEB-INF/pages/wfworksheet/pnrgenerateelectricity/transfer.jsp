...
<div id="sheetform">
<html:form action="/pnrgenerateelectricity.do?method=performTransferWorkItem" styleId="theform">
   ...
   <div class="form-btns">
        ...
        <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/pnrgenerateelectricity/pnrgenerateelectricity.do?method=performSaveInfo'" value="<bean:message bundle='sheet' key='button.save'/>" />
