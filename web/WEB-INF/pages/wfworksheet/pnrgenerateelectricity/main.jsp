...
var roleTree;
   ...
   Ext.onReady(function(){
	...
	tabs.addTab('sheetform', "<bean:message bundle="pnrgenerateelectricity" key="pnrgenerateelectricity.header"/>");
	tabs.activate('sheetform');     
    var el = Ext.get("idSpecial");
	var mgr = el.getUpdateManager();
	mgr.loadScripts = true;
	mgr.update("${app}/sheet/pnrgenerateelectricity/pnrgenerateelectricity.do?method=showNewInputSheetPage&processname=InstrumentStorage");
...
<div id="sheetform" class="tabContent">
	<html:form action="/pnrgenerateelectricity.do?method=performAdd" styleId="theform" >
