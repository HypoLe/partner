...
function openSameTeam(){
this.document.forms[0].action=eoms.appPath+"/sheet/pnrgenerateelectricity/pnrgenerateelectricity.do?method=showUndoListForSameTeam";
...
工具栏： 
  ...
  <!-- 
  | <span id="openSameTeam"  style="cursor:pointer" onclick="openSameTeam();">查看同组处理列表</span>
  -->
  <c:if test="${'performListQuery' eq param.method || 'showUndoListForSameTeam' eq param.method}">
    | <a href="./${module}.do?method=showListsendundo&batch=true">返回列表</a>
  </c:if>
</div>
