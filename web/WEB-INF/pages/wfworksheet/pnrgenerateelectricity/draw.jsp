...
function smallit(){
	if(eoms.isFF){
		PhotoViewer.images1 = PhotoViewer.contentWindow.document.getElementById('images1');
	}
...
function realsize()
{
	if(eoms.isFF){
		PhotoViewer.images1 = PhotoViewer.contentWindow.document.getElementById('images1');
		PhotoViewer.images2 = PhotoViewer.contentWindow.document.getElementById('images2');
		PhotoViewer.block1 = PhotoViewer.contentWindow.document.getElementById('block1');
	}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="border2">
    ...
    <tr>
		<td align="center" valign="middle" class="tdbg_leftall">
			<iframe id='PhotoViewer' width='100%' frameborder=0 name='down' height='500' scrolling='no' src='${app}/sheet/pnrgenerateelectricity/pnrgenerateelectricity.do?method=showPic'  class=input2></iframe>
		</td>
	</tr>
</table>
