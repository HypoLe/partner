...
String sheetKey = (String) request.getParameter("sheetKey");
 %>
     ...
     <input type="hidden" name="mainClassName" value="com.boco.eoms.partner.sheet.generateelectricity.model.PnrGenerateElectricityMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="linkClassName" value="com.boco.eoms.partner.sheet.generateelectricity.model.PnrGenerateElectricityLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
