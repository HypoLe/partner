...
<%@page import="com.boco.eoms.partner.sheet.generateelectricity.model.PnrGenerateElectricityTask" %>
...
PnrGenerateElectricityTask task = new PnrGenerateElectricityTask();
String operaterType = "";
//String ifsub = "";
//String ifwaitfor="";
if(request.getAttribute("task")!=null){
	 task = (PnrGenerateElectricityTask)request.getAttribute("task");
...
Ext.onReady(function() {
	var tabConfig = {
		items : [{
			...
			url : 'pnrgenerateelectricity.do?method=showSheetDealList&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
		}, {
			text : '<bean:message bundle="sheet" key="sheet.flowchar"/>',
			url : 'pnrgenerateelectricity.do?method=showWorkFlow&linkServiceName=iPnrGenerateElectricityLinkManager&dictSheetName=dict-sheet-pnrgenerateelectricity&description=mainOperateType&sheetKey=${sheetMain.id}',
			isIframe : true
		  }
		,{
			text : '<bean:message bundle="sheet" key="sheet.filesView"/>',
			url : 'pnrgenerateelectricity.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
			isIframe : true
		}]
	};
    ...
    <%if(taskStatus.equals("2") || taskStatus.equals("3") || taskStatus.equals("8")){%>
    	<%if(taskName.equals("cc")){ %>
			var url2="pnrgenerateelectricity.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
			eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
	<%if(taskName.equals("reply")){ %>
		var url2="pnrgenerateelectricity.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
		eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
...
function forceOperation(obj){
	if(obj == 1){
		var url2="pnrgenerateelectricity.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
		eoms.util.appendPage("sheet-deal-content",url2);	
	}else if(obj == 2){
	    
		var url2="pnrgenerateelectricity.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
		eoms.util.appendPage("sheet-deal-content",url2);	
	}else{
	   
	    var url2="pnrgenerateelectricity.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
		eoms.util.appendPage("sheet-deal-content",url2);	
    }
   }
    function eventOperation(obj){
	if(obj == 1){
	     var url2="pnrgenerateelectricity.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page">
  ...
  <div id="sheetinfo">
	...
	<%@ include file="/WEB-INF/pages/wfworksheet/pnrgenerateelectricity/basedetailnew.jsp"%>
	<br/>
	<table id="sheet" class="formTable" > 
		...
		<!-- 
			...
			<td class="content"> 
			<eoms:id2nameDB id="${sheetMain.mainServiceArea}" beanId="tawSystemAreaDao" />
			</td> -->
			<td class="label">停电发生时间</td>
			<td class="content"> 
			<bean:write name="sheetMain" property="mainPowerCutOccurTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/>
			</td>
	  ...
	  <tr>
		    ...
		    <eoms:attachment name="sheetMain" property="sheetAccessories" 
		            scope="request" idField="sheetAccessories" appCode="pnrgenerateelectricity" 
		             viewFlag="Y"/> 
		    </td>
	  </tr>
</table>
...
<!-- 下面是流程中的步骤URL -->
 ...
 <!-- 回复到派单人 -->
<c:url var="urlShowReplyTaskPage" value="pnrgenerateelectricity.do">
 ...
 <!-- 派发 -->
<c:url var="urlSendTaskPage" value="pnrgenerateelectricity.do">
	<c:param name="method" value="showDealPage"/>
	<c:param name="sheetKey" value="${sheetMain.id}"/>
	<c:param name="piid" value="${sheetMain.piid}"/>
	<c:param name="taskId" value="${taskId}"/>
 ...
 <!-- 待归档 -->
<c:url var="urlShowHoldTaskPage" value="pnrgenerateelectricity.do">
	<c:param name="method" value="showDealPage"/>
	<c:param name="sheetKey" value="${sheetMain.id}"/>
	<c:param name="piid" value="${sheetMain.piid}"/>
	<c:param name="taskId" value="${taskId}"/>
...
<!-- 下面是公共的URL -->
<!-- 退回 -->
<c:url var="urlShowRejectDealPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowTransferkPage" value="pnrgenerateelectricity.do">
...
<c:url var="urlShowPhaseReplyPage" value="pnrgenerateelectricity.do">
...
<!--任务分派-->
<c:url var="urlShowInputSplit" value="pnrgenerateelectricity.do">
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="pnrgenerateelectricity.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="pnrgenerateelectricity.do">
...
<!-- 驳回上一级 -->
<c:url var="urlShowRejectBackPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 被驳回 -->
<c:url var="urlBackDealPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿 -->
<c:url var="urlShowDraftPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showInputSplit"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 转审 -->
<c:url var="urlShowTransferAuditPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showTransferWorkItemPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 受理 -->
<c:url var="urlShowAcceptTaskPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowExecuteTaskPage" value="pnrgenerateelectricity.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
  ...
  <c:param name="taskStatus" value="${taskStatus}"/>
  <c:param name="preLinkId" value="${preLinkId}"/>
  <c:param name="operateType" value="14"/>
</c:url>
			...
			<tr>
				 <td width="50%">  
					...
					<% }if(taskName.equals("HoldTask")){%>	
							<select id="dealSelector">
								<option value="${urlShowHoldTaskPage}"><bean:message bundle="pnrgenerateelectricity" key="operateType.holdTask"/> </option>
					...
					<% }else if(taskName.equals("RejectTask")){%>	
			  		...
			  		<% }else if(taskName.equals("DraftTask")){%>	
						<select id="dealSelector">
						  <option value="${urlShowDraftPage}"><bean:message bundle="pnrgenerateelectricity" key="operateType.DraftTask"/></option>
						</select>
					<!-- 受理发电 -->
			   		<% } else if(taskName.equals("AcceptTask")){%>	
						<select id="dealSelector">
						  <option value="${urlShowAcceptTaskPage}">受理发电</option>
						  <option value="${urlShowRejectBackPage}">驳回</option>
						</select>
					<!-- 执行发电 -->
			   		<% } else if(taskName.equals("ExecuteTask")){%>	
						<select id="dealSelector">
						  <option value="${urlShowExecuteTaskPage}">执行发电</option>
						  <%---
						  <option value="${urlShowRejectBackPage}">驳回</option>
						  --%>
						</select>
...
<script type="text/javascript">
	Ext.onReady(function(){
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
   			url = "pnrgenerateelectricity.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId="+dealTemplateId
        }
		eoms.util.appendPage("sheet-deal-content",url);		
	});
</script>
