...
<div id="sheetform">
    <html:form action="/pnrgenerateelectricity.do?method=performCreateSubTask" styleId="theform">
      	...
      	<tr>        
	       <td class="label">
			...
			<td colspan="3">			
               ...
               <input type="hidden" name="taskNamespace" value="http://InstrumentStorage"/>  
