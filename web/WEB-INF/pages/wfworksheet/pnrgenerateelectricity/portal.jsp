...
<div id="sheet-portal-page">
  ...
  <iframe id="portal-south" name="portal-south" frameborder="no" src="${app}/sheet/pnrgenerateelectricity/pnrgenerateelectricity.do?method=showListsendundo" width="0" height="0">
  </iframe>
</div>
