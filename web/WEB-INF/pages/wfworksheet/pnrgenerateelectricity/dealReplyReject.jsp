...
<div id="sheetform">
<html:form action="/pnrgenerateelectricity.do?method=performDealReplyReject" styleId="theform">
<%
 ...
 %>
    ...
    <input type="hidden" name="subtaskName" value="instrumentstorageSubTask"/> 
	...
	<input type="hidden" name="processTemplateName" id="processTemplateName" value="InstrumentStorageMainProcess" />
    ...
    <input type="hidden" name="taskNamespace" value="http://InstrumentStorageProcess"/>  
...
<%@ include file="/WEB-INF/pages/wfworksheet/pnrgenerateelectricity/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.partner.sheet.generateelectricity.model.PnrGenerateElectricityTask">  
        <tr>
          <td>
