           ...
           <tr>	
			...
			<tr>
	            ...
	            <td  class="content">
	               ...
	               <input type="button" name="showSendDpt" value="<bean:message bundle="sheet" key="query.status.selectDept"/>" class="btn" id="showSendDpt">
           ...
           <tr >
	            ...
	            <td class="content">
	               <select id="dealsel">
	                ...
	                <input type="button" name="showDealDpt" value="<bean:message bundle="sheet" key="query.status.selectDept"/>" class="btn" id="showDealDpt" >
	                <input type="button" name="showDealUser" value="<bean:message bundle="sheet" key="query.status.selectUser"/>" class="btn" id="showDealUser" >
