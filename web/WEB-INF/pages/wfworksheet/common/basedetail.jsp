<table cellspacing="0" cellpadding="0">
		<tr class="sheet-info-header"><td colspan='4'><bean:message bundle="sheet" key="mainForm.header"/></td></tr>
		...
		<tr class="sheet-info-row">
		    ...
		    <td><eoms:dict key="dict-sheet-common" dictId="sheetStatus" itemId="${sheetMain.status}" beanId="id2nameXML" /></td>
	   </tr>
       <tr class="sheet-info-row">
