...
<c:if test="${findForward != null && (findForward == 'mainlist' || findForward == 'newMainlist')}">
...
<bean:define id="url" value="${module}.do" />
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		decorator="com.boco.eoms.sheet.base.webapp.action.NewMainListDisplaytagDecoratorHelper">
