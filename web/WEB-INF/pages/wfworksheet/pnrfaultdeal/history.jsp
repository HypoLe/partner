...
<logic:present name="HISTORY" scope="request">  
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.partner.sheet.faultdeal.model.PnrFaultDealLink" >     
       <%         
        jNum += 1;       
       %>
      <div class="history-item">&nbsp;   
	      ...
	      <div class="history-item-title">
			 ...
			 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
	  	     ...
	  	     <eoms:dict key="dict-sheet-pnrfaultdeal" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
	  	     <bean:message bundle="pnrfaultdeal" key="pnrfaultdeal.operateType"/>:
	  	     <eoms:dict key="dict-sheet-pnrfaultdeal" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
	 ...
	 <!-- 流程中的历史页面 -->
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("CheckTask")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 93 || baselink.getOperateType().intValue() == 11)){ %>
		 					...
		 					<td class="label">
								<!-- 审批是否通过 -->
								<bean:message bundle="pnrfaultdeal" key="instrumentStorageLink.linkIfCheckPass"/>
							</td>
     ...
     <%if(baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 95)){%> 
			<tr>
				...
				<td class="content">
					<bean:write name="baselink" property="linkFaultRecoverTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>
				</td>
				<td class="label">故障原因分类</td>
				<td class="content">
						<eoms:id2nameDB id="${baselink.linkFaultReasonType}" beanId="ItawSystemDictTypeDao" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="content" colspan=3>
				    <pre><bean:write name="baselink" property="linkFaultReasonDescription" scope="page"/></pre>
			    </td>	  				                  
			</tr>
			<tr>
				<td class="label">解决方案</td>
				<td class="content" colspan=3>
				    <pre><bean:write name="baselink" property="linkFaultSolution" scope="page"/></pre>
			    </td>	  				                  
			</tr>
			<tr>
				<td class="label">遗留问题</td>
				<td class="content" colspan=3>
				    <pre><bean:write name="baselink" property="linkLeftOverProblem" scope="page"/></pre>
			    </td>	  				                  
			</tr>
...
<script type="text/javascript">
 ...
 function copy(id){
    ...
    Ext.Ajax.request({
		method:"get",
		url: "pnrfaultdeal.do?method=getJsonLink&id="+id+"&beanName=InstrumentStorage",
		success: function(x){
