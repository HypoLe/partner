...
<div id="sheetform">
<html:form action="/pnrfaultdeal.do?method=performDealReplyReject" styleId="theform">
<%
...
<%@ include file="/WEB-INF/pages/wfworksheet/pnrfaultdeal/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.partner.sheet.faultdeal.model.PnrFaultDealTask">  
        <tr>
          <td>
