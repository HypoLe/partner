...
String sheetKey = (String) request.getParameter("sheetKey");
 %>
     ...
     <input type="hidden" name="mainClassName" value="com.boco.eoms.partner.sheet.faultdeal.model.PnrFaultDealMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="linkClassName" value="com.boco.eoms.partner.sheet.faultdeal.model.PnrFaultDealLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
...
<%@ include file="/WEB-INF/pages/wfworksheet/pnrfaultdeal/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.partner.sheet.faultdeal.model.PnrFaultDealTask">  
        <tr>
          <td>
