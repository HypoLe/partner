  ...
  <body>
	...
	<table class="formTable" id="sheet">
		...
		<tr>
			...
			<td class="content" >
					<eoms:comboBox name="pnrResConfig.resLevel" initDicId="${pnrResConfig.resType}" defaultValue="${pnrResConfig.resLevel}" id="resourceLevel" alt="allowBlank:false" styleClass="select" /> 
			</td>
		</tr>
		<tr>
			...
			<td class="content">
				<html:text property="pnrResConfig.resLongitude" styleId="car_number"
						...
						alt="allowBlank:false,vtext:'',maxLength:32,re:/^(\d+)(\.\d{1,15})?$/,re_vt:'请输入整数（小于8位）或小数（小数位小于15位）'" value="${pnrResConfig.resLongitude}" />
			</td>
			...
			<td class="content">
				<html:text property="pnrResConfig.resLatitude" styleId="car_number"
						...
						alt="allowBlank:false,vtext:'',maxLength:32,re:/^(\d+)(\.\d{1,15})?$/,re_vt:'请输入整数（小于8位）或小数（小数位小于15位）'" value="${pnrResConfig.resLatitude}"  />	
			</td>
		</tr>
		<tr>
			...
			<td class="content">
				...
				<logic:iterate id="city" name="city">
					<c:if test="${pnrResConfig.city==city.areaid}" var="result">
			...
			<td class="content">
				<select name="city" id="city" class="select" alt="allowBlank:false,vtext:'请选择所在县区'">
					<option value="">
						--请选择所在县区--
					</option>
				</select>
		...
		<tr>
			...
			<td class="content">
				<html:text property="pnrResConfig.phone" 
						...
						alt="allowBlank:false,vtext:'',maxLength:50" value="${pnrResConfig.phone }"  />
			</td>
			<td class="label" ></td>
			<td class="content">
		...
		<tr class="jieke">
			...
			<td>
				<select name="pnrResJieke.clientType" class="select">
					...
					<option id="client1">传输专线</option>
					<option id="client2">GPRS</option>
					<option id="client3">短彩信</option>
				</select>
	...
	<table id="transData">
		...
		<tr>
			<td>
				<html:text property="pnrResConfig.inspectCycle" styleId="resId"
						styleClass="text medium" name="pnrResConfig.resId"
