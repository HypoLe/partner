...
<body class="easyui-layout" onload="fff();">
	<div id="east" region="east" split="true" title="信息栏" style="width:500px;height:100%;padding:3px;">
		<div class="easyui-tabs" fit="true" border="false"   style="height:100%;weight:100%">
			...
			--%>
			<div id="yj" title="<a id='oilList' class='tabTitle' href='${app}/partner/arcGis/arcGis.do?method=oilSearch' target='oilList-page' onclick='addblock();' >油机列表</a>"  style="weight:100%;overflow:hidden;"> 
			<iframe id="oilList-page" name="oilList-page" frameborder="no" style="width:100%;height:100%" src=""></iframe>
			</div>
