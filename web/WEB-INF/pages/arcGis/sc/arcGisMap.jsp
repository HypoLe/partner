...
<html>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8"> 
    ...
    <script type="text/javascript">
		...
		<script type="text/javascript" src="${app}/arcGis/js/sc/iconConfig.js"></script>
		...
		<script type="text/javascript" src="${app}/arcGis/js/sc/setArcGis.js"></script>
	    ...
	    **/
		...
		document.getElementById("map").style.height=parentDivHeight;
	    	...
	    	parentDivWidthIe=parentDivWidthIe-520;
