...
<script type="text/javascript" src="${app}/arcGis/js/jx/arcGisPing.js"></script>
...
<td>
<div id="divInput" >
<input id="txtURL" type="hidden"  value="http://10.181.163.199:8399/arcgis/rest/services/JiangXi/MapServer"/>
