...
Ext.onReady(function() {
	v = new eoms.form.Validation({form:'importLinesForm'});
	setTabs();
});
	...
	function setTabs() {
		...
		tabs.addTab('base-info', '线路信息Excel批量导入');
   		tabs.activate(0);
	}
...
var jq=jQuery.noConflict();
Ext.onReady(function() {
	v1 = new eoms.form.Validation({form:'importLinesForm'});
	v1.custom = function() {
		var reg = "(.xls)$";
...
function saveImport() {
	...
	new Ext.form.BasicForm('importLinesForm').submit({
	method : 'post',
	url : "${app}/netresource/line/linesImport.do?method=importData",
	  	waitTitle : '请稍后...',
		waitMsg : '正在导入数据,请稍后...',
...
<div id="info-page">
	<div id="base-info" class="tabContent">
		...
		<div id="listQueryObject"
			...
			<form action="linesImport.do?method=importData" method="post"
				enctype="multipart/form-data" id="importLinesForm" name="importLinesForm">
					<table class="formTable">
						...
						<tr>
							...
							<td>
								<input type="button" class="btn" value="线路批量导入模板下载" 
										onclick="javascript:location.href='${app}/netresource/line/linesImport.do?method=download'"/>
								&nbsp;&nbsp;
