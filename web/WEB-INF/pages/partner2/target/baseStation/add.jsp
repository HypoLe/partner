...
<form action="${app }/partner2/target/baseStation.do?method=add" id="baseStationTargetForm" method="post">
...
<div class="ui-widget-header ui-corner-top ui-state-default " style="margin-top: 15px">基站考核指标信息
<table class="formTable" >
			<tr>
				<td class="label">
					小区完好性*
			...
			<tr>
				...
				<td>
					<input type="text" name="myText5" class="text" alt="allowBlank:false"  />
				</td>
			</tr>
		</table>
</div>
...
myJ(function() {
	...
	v = new eoms.form.Validation({form:'baseStationTargetForm'});
