...
<form action="${app}/partner2/appraisal.do?method=appraisalResultSearch" method="post">
...
<table class="formTable" width="75%">
	...
	<td class="label" align="right">
		...
		<td>
			<input type="text" value="${appraisalRealScore}" name="appraisalRealScore" class="text" id="appraisalRealScore"/>
		</td>
	</tr>
	<tr>
...
<display:table name="appraisalCountList" cellspacing="0" cellpadding="0"
		...
		requestURI="appraisal.do" sort="list" partialList="true"
		size="${size}">
		...
		<display:column sortable="true" headerClass="sortable" title="执行结果">
			<a href="${app}/partner2/appraisal.do?method=showAppraisalResultDetail&proxyScaleId=${appraisalCountList.proxyScaleId}" >详情</a>
		</display:column>
</display:table>
