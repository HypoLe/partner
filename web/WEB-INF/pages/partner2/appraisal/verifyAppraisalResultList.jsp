...
<display:table name="appraisalCountList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="true"
			headerClass="sortable" title="考核结果" >
		...
		<display:column sortable="true"
			...
			<a href="${app}/partner2/appraisal.do?method=goToAppraisalNextStep&flag=readyToPublish&proxyScaleId=${appraisalCountList.proxyScaleId}">确认</a>
