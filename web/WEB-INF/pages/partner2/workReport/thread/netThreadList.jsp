...
<fmt:bundle basename="com.boco.partner2.workReport/config/applicationResource-workbench-infopub">
	<display:table name="threadList" cellspacing="0" cellpadding="0" id="threadList" pagesize="${pageSize }" offset="${offset }" class="table threadList" export="true" requestURI="${app}/partner2/workReport/thread.do?method=list&forumsId=${forumsId }"
		...
		<display:column property="title" sortable="true" sortName="title" headerClass="sortable" titleKey="infopub.threadForm.title" paramId="id" paramProperty="id" href="${app}/partner2/workReport/thread.do?method=netDetail" />
	...
	<priv:region url="<%=InfopubConstants.WORKBENCH_INFOPUB_PERMISSION_THREAD_MGR%>">
		...
		<input type="text" id="forumsName" name="forumsName" class="text" readonly="readonly" value="所有专题信息" />
