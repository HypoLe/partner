...
<eoms:id2nameDB id="${threadForm.forumsId }" beanId="forumsDao" />
	...
	<display:table name="threadList" cellspacing="0" cellpadding="0" id="threadList" pagesize="${pageSize }" offset="${offset }" class="table threadList" export="true" requestURI="${app}/partner2/workReport/thread.do?method=list&forumsId=${forumsId }"
	 sort="external" defaultsort="1"
		...
		<display:column property="title" sortable="true" sortName="title" headerClass="sortable" titleKey="infopub.threadForm.title" paramId="id" paramProperty="id" href="${app}/partner2/workReport/thread.do?method=detail" />
		
		<display:column sortable="true" sortName="status" headerClass="sortable" titleKey="infopub.threadForm.status" href="${app}/partner2/workReport/threadAuditHistory.do?method=device" paramId="threadId" paramProperty="id" >
