...
<fmt:bundle basename="com/boco/partner2/workReport/config/applicationResource-workbench-infopub">
	<display:table name="threadHistoryList" cellspacing="0" cellpadding="0"
		...
		requestURI="${app}/partner2/workReport/threadHistory.do?method=search&threadId=${threadId}"
		sort="list" partialList="true" size="resultSize"
		decorator="com.boco.partner2.workReport.displaytag.support.ThreadBrowseHistoryListDisplaytagDecorator" >
...
<display:setProperty name="export.rtf" value="false"></display:setProperty>
		...
		<display:column property="readTime" sortable="true"
			headerClass="sortable" titleKey="threadHistoryForm.readTime" format="{0,date,yyyy-MM-dd HH:mm:ss}"/>
