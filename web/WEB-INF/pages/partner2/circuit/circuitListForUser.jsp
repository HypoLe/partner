...
<logic:present name="circuitList" scope="request">
	<display:table name="circuitList" cellspacing="0" cellpadding="0"
		...
		<display:column sortable="false" headerClass="sortable" title="记录详情与历史" media="html" >
			...
			<a id="${circuitList.id }" href="circuit.do?method=goToHistory&id=${circuitList.id}" target="blank" shape="rect">处理过程</a>
		</display:column>
	...
	<table id="sheet" class="formTable">
		...
		<tr>
			...
			<td class="content"><select id="operateType" name="operateType">
				<option value='USER_TO_MASTER_1' selected="selected">同意核减</option>
				<option value='USER_TO_MASTER_2'>不同意核减</option>
				<option value='USER_TO_MASTER_3'>已审核</option>
			</select></td>
		</tr>
		<tr>
			<td class="label">分公司意见说明*</td>
