...
<fmt:bundle basename="com/boco/eoms/workbench/memo/config/ApplicationResources-workbench-memo">
<display:table name="tawWorkbenchMemoList" cellspacing="0" cellpadding="0"
    ...
    requestURI="${app}/workbench/memo/tawWorkbenchMemoNodes.do?method=xSearchRecord&folderPath=<%=str%>" 
