...
<script type="text/javascript">
	...
	userTree = new xbox({
		...
		treeDataUrl:userTreeAction,treeRootId:'-1',treeRootText:'${eoms:a2u("所有联系人")}',treeChkMode:'',treeChkType:'user',
		viewer:userViewer,saveChkFldId:'reciever' 
	});
	userTree2 = new xbox({
		btnId:'userTreeBtn2',dlgId:'dlg-user',	
		treeDataUrl:userTreeAction2,treeRootId:'-1',treeRootText:'${eoms:a2u("所有联系人")}',treeChkMode:'',treeChkType:'contact',
		viewer:userViewer,saveChkFldId:'reciever' 
	});
})
Ext.onReady(function() {
...
<html:form action="/tawWorkbenchMemo.do?method=save" method="post"
			...
			<tr>
				...
				<td width="500" colspan="5">
					<html:textarea property="content" styleId="content"
						styleClass="text medium" rows="5" cols="17"  alt="allowBlank:false,vtext:'${eoms:a2u('请输入便签内容')}'" />
				</td>
			</tr>
...
<!-- 		<tr>
			 ...
			 -->
			 <input type="hidden" name="sendmanner" id = "sendmanner" value="3" />
		</table>
		<br>
		<table>
			<tr>
