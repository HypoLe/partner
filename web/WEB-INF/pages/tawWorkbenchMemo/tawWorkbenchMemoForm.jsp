...
<title><fmt:message key="tawWorkbenchMemoDetail.title" />
</title>
<content tag="heading">
 ...
 window.onload = function setup(){
   ...
   changeType(send);
	...
	userTree = new xbox({
		...
		treeDataUrl:userTreeAction,treeRootId:'-1',treeRootText:'${eoms:a2u("所有联系人")}',treeChkMode:'',treeChkType:'contact',
		...
		<table>
			<tr>
				...
				<td>
					...
					<input type="button" name="button" class="button" value="<fmt:message key="button.delete" />" onclick="return confirmDelete('<%=memoId%>')">
				</td>
