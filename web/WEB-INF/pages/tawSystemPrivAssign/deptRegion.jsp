...
<script type="text/javascript">
	Ext.onReady(function(){
		deptViewer = new Ext.JsonView("deptList",
			'<div class="viewer-list" style="width:200">{name}<input type="hidden" name="regionId" value="{id}"></div>',
			{ 
		...
		deptTree = new xbox({
		   btnId:'btnDept',dlgId:'hello-dlg2',
		   treeDataUrl:treeAction,treeRootId:'-1',treeRootText:"${eoms:a2u('部门树')}",treeChkMode:'',treeChkType:'dept',
		   viewer:deptViewer
		});
	});
</script>
