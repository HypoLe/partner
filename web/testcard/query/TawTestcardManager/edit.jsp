...
<script language="JavaScript"
			src="<%=request.getContextPath()%>/testcard/css/area.js"></script>
<SCRIPT LANGUAGE=JavaScript>
var s=["s1","s2","s3"];
var opt0 = ["","",""];
var dsy = new Dsy();
...
function setup()
{
	for(i=0;i<s.length-1;i++)
		document.getElementById(s[i]).onchange=new Function("changesp(dsy,"+(i+1)+",s,opt0)");
	changesp(dsy,0,s,opt0);
}
</SCRIPT>
...
<br>
<form method="post" action="../TawTestcardManager/editlist.do" onsubmit="true">
	...
	<center>
		<table width="50%" align="center" class="formTable">
			...
			<tr id="localleave" style="display:none">
