...
<%@ page import="com.boco.eoms.common.util.*,com.boco.eoms.common.controller.SaveSessionBeanForm,java.util.*,java.io.*"%>
<html:html>
<head>
<title>
分数情况查询
...
<center>
<div id="divTable" style="position: relative; align: center; top: 0px;width:  95%; height:  380; z-index: 1; overflow: auto; overflow-x: hidden">
