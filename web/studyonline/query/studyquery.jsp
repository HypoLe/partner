...
<div id="tree">
<font face="ËÎÌו" style="font-size: 9pt" COLOR="#990000" ><B><bean:message key="label.deptTree"/></B>&nbsp;[&nbsp;<A HREF="javascript:headerDisplay(0);"><bean:message key="label.hide"/></A>&nbsp;]</FONT>
		  <BR>
...
<table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
  <tr class="tr_show">
    ...
    <td width="70%" height="25">&nbsp;&nbsp;&nbsp;<html:text property="userId" size="30" styleClass="clstext"/></td>
  </tr>
  <tr class="tr_show">
    <td width="30%" height="25" class="clsfth">&nbsp;<bean:message key="TawRmUser.userName"/></td>
    <td width="70%" height="25">&nbsp;&nbsp;&nbsp;<html:text property="userName" size="30" styleClass="clstext"/></td>
  </tr>
  <tr class="tr_show">
    <td width="30%" height="25" class="clsfth">&nbsp;<bean:message key="TawRmUser.deptId"/></td>
    <td width="70%" height="25">&nbsp;&nbsp;&nbsp;<html:text property="deptName" size="30" styleClass="clstext" readonly="true"/>
