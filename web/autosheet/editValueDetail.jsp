...
<div align="center">
  <p><b><font size="5">修改输入框</font></b></p>
      <form name="addEForm" method="post" action="<%=request.getContextPath()%>/sheetvalueservlet"  onsubmit="javascript: return checkValueInput();">
    <table cellspacing=0 cellpadding=0  border=1 width="760" bordercolordark="#FFFFFF" bordercolorlight="#66CCFF" bgcolor=#F3F3F3 align="center">
      <tr>
        ...
        <td width="18%">
          ...
          <input type="text" name="vName" size="10" maxlength="200" value="<%out.print(shValue.getVName(value_id));%>" onchange="isVariable(this)">
        </td>
        <td width="15%" nowrap>
          <div align="right">所属部分</div><input type=hidden name=sheet_id value=<%=sheet_id%>>
        </td>
        <td width="18%">
...
%>
        ...
        <td width="18%">
          <input type="text" name="index" size="10" maxlength="10" value="<%out.print(shValue.getIndex(value_id));%>">
        </td>
      </tr>
      <tr>
        <td width="15%" nowrap>
...
%>
        ...
        <td width="18%">
          <select name="attrID">
            ...
            %>
            <option value="<%=shValue.getAttrID(value_id)%>" "selected"><%=shAttribute.getAttrName(shValue.getAttrID(value_id))%></option>
              <%
              shAttribute.reset();
              shValue.reset();
      ...
      <tr>
        ...
        <td width="18%">
          <input type="text" name="width" size="10" maxlength="10"  value="<%out.print(shValue.getWidth(value_id));%>"> 象素
        </td>
        <td width="15%" nowrap>
          <div align="right">单元格高度</div>
        </td>
        <td width="18%">
          <input type="text" name="height" size="10" maxlength="10"  value="<%out.print(shValue.getHeight(value_id));%>"> 象素
        </td>
        <td width="15%" nowrap>
          <div align="right">跨列宽</div>
        </td>
        <td width="18%">
          <input type="text" name="colspan" size="10" maxlength="10"  value="<%out.print(shValue.getColspan(value_id));%>"><font color="red">**</font>
        </td>
      </tr>
      <tr>
        <td nowrap width="15%">
        ...
        <td width="18%">
          <input type="text" name="rowspan" size="10" maxlength="10"  value="<%out.print(shValue.getRowspan(value_id));%>"><font color="red">**</font>
        </td>
        <td nowrap width="15%">
...
%>
        ...
        <td width="18%">
          <input type="text" name="color" size="10" maxlength="10"  value="<%out.print(shValue.getColor(value_id));%>" ondblclick="openColorWin()">
        </td>
...
%>
        ...
        <td width="18%">
          <input type="text" name="formWidth" size="10" maxlength="10"  value="<%out.print(shValue.getFormWidth(value_id));%>" > 字符
        </td>
        ...
        <td width="18%">
          <input type="text" name="formHeight" size="10" maxlength="10"  value="<%out.print(shValue.getFormHeight(value_id));%>"
       ...
       <td width="15%" nowrap>
        ...
        <td width="18%">
          ...
          while(codetype.next()){
           ...
           %>><%=codetype.getTypeName()%></option>
           <%
          }
          %>
          <option value="0" <% if(shValue.getTypeid(value_id).equals("0"))
            out.println(" selected");%>>无</option>
          </select>
        ...
        <td width="18%" height="18">
           ...
           <input type="text" name="defaultval" size="10" maxlength="10" value="<%out.print(shValue.getDefaultVal(value_id));%>">
