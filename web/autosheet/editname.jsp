...
<table cellSpacing=0 cellPadding=0  border=1 width="760" bordercolordark="#FFFFFF" bordercolorlight="#66CCFF" bgcolor=#F3F3F3 align="center">
    <tr>
      ...
      <td>
          <input type="text" name="sh_cname" size="20" maxlength="200" value="<%out.print(shName.getSh_cname(sheet_id));%>"><font color="red">**</font>
        </div>
      </td>
	  <td>
    ...
    <tr>
      ...
      <td width="27%">
              <input type="text" name="height" size="10" maxlength="10" value="<%out.print(shName.getHeight(sheet_id));%>">
        </div>
      </td>
    </tr>
  <!--
