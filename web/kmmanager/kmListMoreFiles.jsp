...
<fmt:bundle	basename="com/boco/eoms/km/config/applicationResource-kmmanager">
	...
	<display:table name="kmContentsList" cellspacing="0" cellpadding="0"
		...
		requestURI="${app}/kmmanager/kmIndexs.do?method=listMoreFiles" 
		...
		<display:column  titleKey="kmContents.themeId">
			<eoms:id2nameDB beanId="kmFileTreeDao" id="${kmContentsList[0]}" />
		</display:column>
		...
		<display:column title="查看" headerClass="imageColumn">
			<a href="javascript:var id = '${kmContentsList[5] }';
		                        var url='${app}/kmmanager/files.do?method=detail&id='+id;
		                        location.href=url">
