...
<table width='100%'>
	<tr>
		...
		<table>
			<tr>
				<td width=60 align=center><input type="button" name="b_001" value="保  存" alt="保存录入的数据" onclick="javascript:formsubmit()" class="clsbtn2"></td>
				<td width=20></td>
				<td width=60 align=center><input type="button" name="b_001" value="取  消" alt="取消录入的数据" onclick="javascript:clearinput()" class="clsbtn2"></td>
			</tr>
		</table>
		</td>
	</tr>
