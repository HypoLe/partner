...
//out.println("<script>alert('»¶Ó­Ê¹ÓÃËÑË÷ÒýÇæ£¬ÄúµÄËÑË÷ÒýÇæºÅÂë£º"+opt.getIUserInt()+"');</script>");
%>
<html>
<head>
...
if(TabNum != 0)
{
	...
	%>
	<tr class=td_label>
	<td align=left width='50%'><font size=2>ÍøÂç»ù´¡Êý¾Ý->×ÊÔ´¹ÜÀíÁÐ±í</font></td>
	</tr>
	<br>
	<br>
	<font size=2>ÇëÑ¡ÔñÒ»¸öÄúÒª¹ÜÀíµÄÊµÌå:</font>
	<br><br>
	<table bgcolor=#dddddd width='100%'><tr>
	<td align=center colspan="4"><font size=2 color=#000000><b>ÊµÌåÃû³Æ</b></font></td>
	</tr>
	<%
	int flag = 0;
