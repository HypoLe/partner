...
out.println("<td align=left width='50%'><font size=2>请您选择一个要录入图片的"+tabname+"</font></td>");
if (ug.getRoot() && !sId.equals("1"))
{
...
<%if(rs.getCurrentPageIndex() != rs.getFirstPageId())
				  out.println("<font face=webdings color=#06b020>4</font><a href=selectRoom.jsp?id="+sId+"&pageid="+rs.getFirstPageId()+"&cityid="+cityId+">首页</a>");%>
				  <%if(rs.getCurrentPageIndex() != rs.getFirstPageId())
				  out.println("<font face=webdings color=#06b020>4</font><a href=selectRoom.jsp?id="+sId+"&pageid="+rs.getPreviewPageId()+"&cityid="+cityId+">上一页</a>");%>
				  <%if(rs.getCurrentPageIndex() != rs.getLastPageId() && rs.getRowCount() > 15)
				  out.println("<font face=webdings color=#06b020>4</font><a href=selectRoom.jsp?id="+sId+"&pageid="+rs.getNextPageId()+"&cityid="+cityId+">下一页</a>");%>
				  <%if(rs.getCurrentPageIndex() != rs.getLastPageId() && rs.getRowCount() > 15)
				  out.println("<font face=webdings color=#06b020>4</font><a href=selectRoom.jsp?id="+sId+"&pageid="+rs.getLastPageId()+"&cityid="+cityId+">末页</a>");%>				  </td>
<td></td>
<td></td>
</table>
