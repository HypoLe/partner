...
out.println("<td align=left width='50%'><font size=2>"+cc_location+"->"+tabname+"µÄÐÞ¸Ä</font></td>");
%>
				  ...
				  //out.println("col values is :" +colValue);				
					...
					/*if (refTableTemp!=null)
					{
						if (!refTableTemp.equalsIgnoreCase("sys_sub_code"))
					     {
						  out.println("<option value=0>ÎÞ</option>");
						 }
					}*/
...
<table width='100%'>
	<tr>
		...
		<table>
			<tr>
				<td width=60 align=center><a href="javascript:formsubmit()"><img src="../images/button_submit.gif" alt="±£´æÐÞ¸ÄµÄÊý¾Ý" border=0></a></td>
				<td width=60 align=center><a href="javascript:clearinput()"><img src="../images/button_cancel.gif" alt="È¡ÏûÂ¼ÈëµÄÊý¾Ý" border=0></a></td>
			</tr>
		</table>
		</td>
	</tr>
...
<!-- <input type="submit" value="Ìá½»"></input>
 --></form>
