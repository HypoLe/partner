...
if (cityVec.size()==0)
{
	out.println("<script>alert('Ã»ÓÐÈ¨ÏÞ,ÇëÓëÏµÍ³¹ÜÀíÔ±ÁªÏµ£¡"+"');</script>");
	return;
}
%>
<body>
...
<form name=condition action="" method=post>
<tr class=td_label>
<%
...
{
	//if(Integer.parseInt(typeid) == 33)
		out.println("<tr class=td_label><td align=right width='50%'><font size=2>ÇëÄúÑ¡ÔñÒ»¸ö³ÇÊÐ:</font></td><td align=left><select name=city onchange='gofilter()'>");
	//else
	//	out.println("<tr class=td_label><td align=right width='50%'><font size=2>ÇëÄúÑ¡ÔñÒ»¸ö³ÇÊÐ:</font></td><td align=left><select name=city>");
}*/
/*if(Integer.parseInt(typeid) == 33)
	out.println("<tr class=td_label><td align=right width='50%'><font size=2>ÇëÄúÑ¡ÔñÒ»¸ö³ÇÊÐ:</font></td><td align=left><select name=city onchange='gofilter()'><option value=0>--È«²¿--</option>");
else
...
{
	out.println("<tr class=td_label><td align=right width='50%'><font size=2>ÇëÄúÑ¡ÔñÒ»¸öÇøÏØ:</font></td><td align=left><select name=region><option value=0>--È«²¿--</option>");
