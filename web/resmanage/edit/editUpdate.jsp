...
<%
	...
	if(colNum != 0)
	{
		...
		out.println("<br><table border='0' width='100%' cellspacing='1' cellpadding='1' class='table_show' align=center>");
		int colorCounter = 0;
		for(int Col = 0; Col < SysVect.size(); Col ++)
		{
			...
			if (ass_flag!=1 && ass_flag!=2 && !SysColIndex.getCc_code().equals("date_badge") && read_flag!=1 && SysColIndex.getPi_id()!=80003)
			{
				...
				out.println("<td align=center class=clsfth><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'>"+StaticMethod.dbNull2String(SysColIndex.getCc_name())+"</font></td>");
			}
			//println  input text
			switch(ref_flag)
			{
...
<table width='100%'>
	<tr>
		<td align=right width='100%' height="32">
		<table>
			<tr>
				<td width=60 align=center>
				<input type="button" name="b_001" value="保  存" alt="保存修改的数据" onclick="javascript:formsubmit()" class="clsbtn2"></td>
				<td width=60 align=center>
