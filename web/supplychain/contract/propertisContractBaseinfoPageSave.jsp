			    	...
			    	var request={
						...
						load: function(type,data,evt){
							...
							if(echo == 0){
					            ...
					            if(confirm("存在多个同名工作区，请使用选择功能选择")){
					                document.forms[0].workAroundName.value = "";
					                document.forms[0].workAroundName.focus;
					            }
					            flag=false;
		...
		<html:form action="/contract/propertiesContractSave_BaseInfo" method="post"  enctype="multipart/form-data" 
			...
			<table class="table_show" width="56%" cellspacing="1" cellpadding="1"
				...
				<tr class="tr_show">
					...
					<td width="35%" height="25">
						<html:text styleClass="clstext" maxlength="200" property="workAroundAddress"  title="基站地址"/>
						&nbsp;&nbsp;
					</td>
					<td width="15%" height="25" class="clsfth">
						乙方收款银行帐号
				...
				<tr class="tr_show">
					...
					<td width="35%" height="25">
						<html:text styleClass="clstext" maxlength="200" property="taster"  title="审批人"/>
						&nbsp;&nbsp;
					</td>
					<td width="15%" height="25" class="clsfth">
						合同期限
			...
			<tr>
				<td>
					<OL>
						...
						<LI>
							合同编号可以手动输入,提交时做合同号是否重复的验证.
						<LI>
							点击<img id="checkNet" src="<%=webapp%>/images/082.gif" style="cursor: hand;">可以对合同编号是否已经存在进行验证,并得到相应的验证结果提示.
						<LI>
