...
<html>
	...
	<body>
		...
		<html:form action="/contract/property/update" method="post"  enctype="multipart/form-data" 
				onsubmit="return checkForm();">
			<P align="center" class="table_title"
				style="margin-bottom: -1em;margin-top: 1em">
				<b>合同基本信息</b>
			</P>
			<table class="table_show" width="90%" cellspacing="1" cellpadding="1"
				...
				<tr class="tr_show">
					...
					<td width="*" height="25">
						<html:text styleClass="clstext" maxlength="120"
							property="contractNo" size="30" title="合同编号"/>
						&nbsp;&nbsp;
					...
					<td width="*" height="25">
						<html:textarea  styleClass="clstext"
							property="contractName" cols="33" title="合同名称"></html:textarea>
						&nbsp;&nbsp;
						<span class="requisite">**</span>
					</td>
				</tr>
				...
				<tr class="tr_show">
					...
					<td width="*" height="25">
						<html:text styleClass="clstext" maxlength="200" property="partA"
							size="30" title="合同甲方"/>
						&nbsp;&nbsp;
						<span class="requisite">**</span>
					</td>
					...
					<td width="*" height="25">
						<html:text styleClass="clstext" maxlength="200" property="partB"
							size="30"  title="合同乙方"/>
						&nbsp;&nbsp;
						<span class="requisite">**</span>
					</td>
					...
					<td width="*" height="25">
						<html:text styleClass="clstext" maxlength="14" size="30"
					...
					<td width="*" height="25">
						<html:text styleClass="clstext" maxlength="200" size="30"
				...
				<tr class="tr_show">
					...
					<td width="*" height="25">
						<html:text styleClass="clstext" maxlength="200" property="workAroundAddress" size="30" title="基站地址"/>
						&nbsp;&nbsp;
					</td>
					<td width="15%" height="25" class="clsfth">
						乙方收款银行帐号
					...
					<td width="*" height="25">
						<html:text styleClass="clstext" maxlength="50" size="30"
				...
				<tr class="tr_show">
					...
					<td width="*" height="25">
						<html:text styleClass="clstext" maxlength="20" size="30"
				...
				<tr class="tr_show">
					...
					<td width="*" height="25" colspan="3">
						<html:textarea property="contractContent" styleClass="clstext"  cols="100%" rows="3" title="内容描述">
						</html:textarea>
					</td>
				</tr>
				<tr class="tr_show">					
					...
					<td width="*" height="25" colspan="3">
						<html:textarea property="remark" styleClass="clstext" cols="100%" rows="6" title="备注">
						</html:textarea>
					</td>
				</tr>
				...
				<tr class="tr_show">
					...
					<td width="*" height="25">
						<html:text styleClass="clstext" maxlength="20" property="taster" size="30"  title="审批人"/>
						&nbsp;&nbsp;
					</td>
					<td width="15%" height="25" class="clsfth">
						合同期限
				...
				<tr class="tr_show">
					<td align="left" height="25" colspan="4">
						<a href="<%=webapp%>/contract/propertiesContract_SubContract_PageSaveUpdate.do?contractId=<bean:write name="contractForm" property="contractId" />">编辑合同子项...</a>
					</td>
				</tr>
			</table>
		</html:form>
