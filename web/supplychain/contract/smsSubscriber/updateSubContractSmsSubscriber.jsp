...
<script type="text/javascript">
		...
		function updateInfo(){
				...
				if(contractNo.Trim()!=""){
					var request={
						url:"<%=request.getContextPath()%>/pay/util/executeListProviderByContractNo.do?contractNo="+contractNo,
						mimetype:"text/plain",
						method:"get",
						...
						load: function(type,data,evt){
							if(data.length==0){
							  // window.alert("您输入的合同号码没有对应供应商！");
								document.forms[0].partB.value='';	
								document.forms[0].contractNo.focus();
							}else{
								document.forms[0].partB.value=data;	
							}
						...
						<table class="table_show" width="55%" cellspacing="1" 
							...
							<tr class="tr_show">
								...
								<td width="35%" height="25">
									...
									<img id="selectWorkAround" src="<%=webapp%>/images/058.gif"
							...
							<tr class="tr_show">
								...
								<td width="35%" height="25">
									<html:text  styleClass="clstext" maxlength="20"
										property="deductDependency" size="20" />
									&nbsp;&nbsp;
								</td>
							</tr>
							<tr class="tr_show">
