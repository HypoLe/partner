...
//		        return isSourceCopy(e, n) || isReorder(e, n);
		    ...
		    ptree.on('nodedrop', function(e){
		    	...
		    	var myBatchFlag = document.getElementById('batchFlag');
		    	var myDragUrlForSave = config.actions.saveMenuItem.url;
		    	if(myBatchFlag&&myBatchFlag.value){
		    		myDragUrlForSave += ('&batchFlag='+myBatchFlag.value);
		    	} 
    	...
    	doEdit : function(){
    		...
    		try{config.actions.editMenu.init();}catch(e){};
